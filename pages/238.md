...
*[[Chris Brav|Chris]]: 
  * Replied to Urs on fiber product, suggesting that
fiber products be computed using a cobar resolution and 
that we should eventually make a section about derived
