...
Apart from [[quantum mechanics]], the abstract scattering theory has other interesting special cases, applying to the theory of [[automorphic functon]]s (due to an idea of [[Israel Gelfand]], later realized by B. S. Pavlov and L. D. Faddeev), zeta function analysis and so on.
...
Application of the method which Lax and Phillips used for automorphic forms ($SL(2,\mathbf{R})$-case), the case of more general harmonic analysis on more general Riemannian [[symmetric spaces]] is studied in
