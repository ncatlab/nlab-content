...
I'm not *necessarily* saying we shouldn't use the [outdoor fountains](http://www.outdoorfountains.com/) term "regular epimorphism" in this sense, since as we know the notion of "plain epimorphism" in 1-categories is not usually very useful anyway.  But if I'm right, I think it would be good to alert the reader that the [[red herring principle]] is coming into play.
