...
Each vertex also corresponds to a version of [[homotopy theory]].  The stable strict groupoid vertex corresponds to [[chain complexes]] as used in ordinary [[cohomology]].
