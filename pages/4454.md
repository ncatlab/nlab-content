...
A [[strict ∞-groupoid]] is modeled by a [[crossed complex]]. Under [[ω-nerve]] it embeds into all [[∞-groupoid]]s, modeled as [[Kan complex]]es.
...
A strictly stable strict ∞-groupoid is modeled by a bounded-below [[chain complex]] of abelian groups. Under [[ω-nerve]] it embeds into all ([[connective spectrum|connective]]) [[spectra]]s, modeled as [[spectrum object]]s in [[Kan complex]]es.
