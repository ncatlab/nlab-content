A **coherent category** is a [[regular category]] in which the [[subobject]] [[partial order|posets]] $Sub(X)$ all have finite unions which are preserved by the pullback functors $f^*:Sub(Y)\to Sub(X)$.
