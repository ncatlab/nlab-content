...
In a [[finitely complete category]] $C$, a **partially ordered object** is a [[preordered object]] $(X, R, s, t, \rho, \tau_p)$ with a [[monomorphism]] $\alpha:R \times_X R^\op \hookrightarrow X$ into the [[diagonal subobject]] $X$. 
