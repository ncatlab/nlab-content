...
A version of [[cancellative semigroup|cancellative]] [[magmas]] where the binary function is not required to be either valued in the same domain set as the codomain set, this allows the concept to be generalised from [[magmas]] and [[monoids]] to other binary functions such as [[actions]] and [[modules]]. 
