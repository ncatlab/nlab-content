...
[[random variable|Random variables]] or [[random elements]] in a sequence $f_n:\Omega\to X$ on a [[probability space]] $(\Omega,\mu)$ are said to be **iid**, or **independent and identically distributed**, if their [[joint distribution]] $p$ is in the form 
