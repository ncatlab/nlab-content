...
In the setup of operator algebras, the multiplicative unitaries were introduced as so called Kac-Takesaki operator. Following some ideas on noncommutative extensions of Pontrjagin duality (in Tannaka-Krein spirit) by [[George Kac|George's Kac]] and also M. Takesaki, Lecture Notes in Mathematics. 247, Berlin: Springer; 1972. pp. 665–785. The followup work of Baaj and Skandalis introduced two more fundamental axioms, regularity and irreducibility, important in $C^*$-algebraic setup. 
...
The monograph on [[Kac algebra]]s is

* M. Enock, J. M. Schwartz, _Kac algebras and duality of locally compact groups_,  Springer-Verlag, 1992, , x+257 pp. [gBooks](http://books.google.com/books/about/Kac_algebras_and_duality_of_locally_comp.html?id=U6e6aD1gj3oC), [MR94e:46001](https://mathscinet.ams.org/mathscinet-getitem?mr=1215933)
...
* [[Shahn Majid]], _Quantum random walks and time reversal_ [doi](https://doi.org/10.1142/S0217751X93001818)
