...
We discuss the abstract formulation of [[modules]] and [[quasicoherent sheaves]] on petit $\infty$-toposes in differential cohesion.

For $X \in \mathbf{H}_{th}$ an object and $(Sh_{\mathbf{H}}(X), \mathcal{O}_X)$ its $\mathbf{H}$-[[structured (infinity,1)-topos]] according to def. \ref{TheStructureSheafOfX}, exhibited by the functor

$$
  \mathcal{O}_X \;\colon\; \mathbf{H} \stackrel{i_!}{\hookrightarrow} \mathbf{H}_{th} \stackrel{Et X^\ast}{\longrightarrow} Sh_{\mathbf{H}}(X)
$$
...
In particular $\mathcal{O}_X$ is canonically a module over itself.
...
See at _[quasicoherent sheaf -- In higher geometry -- As extension of the structure sheaf](quasicoherent+sheaf#HigherGeometryAsExtensionsOfStructureSheaf)_.
