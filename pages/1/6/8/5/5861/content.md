...
We need to check that $\mathcal{O}_{X}$ preserves [[finite (∞,1)-limits]] and [[covers]]. The first statement follows 
...
For the second statement, observe that $(-)\times X$ preserves [[effective epimorphisms in an (∞,1)-category]] since it is both left and right adjoint. That also $Et$ preserves effective epis follows from (...)
