...
A [[functor9] $p\colon E\to B$ is a **strict Conduch&#233; functor** if for any 88morphism]] $\alpha\colon a\to b$ in $E$ and any factorization $p a \overset{\beta}{\to} c \overset{\gamma}{\to} p b$ of $p \alpha$ in $B$, we have:
