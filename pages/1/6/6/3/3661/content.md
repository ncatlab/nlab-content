...
[Ayala and Francis](#AyalaFrancis) prove an analogous characterization of exponentiable [[(∞,1)-functors]].  The $(\infty,1)$-categorical context eliminates the "level-shifting" in the characterization via $Prof$ (i.e. the presence of a bicategory $Prof$ when discussing only exponentiable 1-functors).  Thus, there is an $(\infty,1)$-category $(\infty,1)Prof$ such that exponentiable $(\infty,1)$-functors into an $(\infty,1)$-category $B$ correspond to $(\infty,1)$-functors $B\to (\infty,1)Prof$.
