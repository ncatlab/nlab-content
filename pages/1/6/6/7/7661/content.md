...
{#TableOfSpinCobordismGroups} Here is a table of the first 100 spin (co)bordism groups:

\begin{imagefromfile}
    "file_name": "BuchananMcKean-SpinCobordismGroups.png",
    "width": 700,
    "unit": "px",
    "margin": {
        "top": -20,
    ...
    "caption": "(from [Buchanan-McKean 2026](#BuchananMcKean26))"
\end{imagefromfile}
