...
Bayesians are typically critical of this $\sigma$ language for its incoherence and argue that background knowledge should be employed to allow model comparison, see, for instance ([D'Agostini 03](#DAgostini03)).

## References 

Review includes

* [www.cise.ufl.edu/~adobra/approxqp/introToStatistics.pdf](https://www.cise.ufl.edu/~adobra/approxqp/introToStatistics.pdf)

* Pekka K. Sinervo, _Signal Significance in Particle Physics_ ([arXiv:hep-ex/0208005](https://arxiv.org/abs/hep-ex/0208005))
