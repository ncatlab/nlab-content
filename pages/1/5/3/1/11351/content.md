...
The motivation for constructing Dirac operator on smooth loop spaces is mainly due to the observations in
...
Proposals for precise definitions/constructions of Dirac operators on smooth loop spaces include the following:
