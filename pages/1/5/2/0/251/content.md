...
In particular, a **double groupoid** is an [[internal groupoid]] in the category of groupoids.  

It is also useful to think of a double category as having two edge categories, and a class of squares with two category structures. A special case of double categories is when the two edge categories coincide. Another special case is when one of the edge categories consists only of identities. This is essentially the same as a [[2-category]]. 
