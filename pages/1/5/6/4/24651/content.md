...
A monoidal setoid is **univalent** or a **[[monoid]]** if the canonical function 
$$idtoequiv(a, b):(a =_M b) \to (a \equiv_M b)$$
is an equivalence of types for all elements $a:M$ and $b:M$. 

## Properties

Every monoidal setoid is (the delooping of) a [[(2, 1)-preorder]] with only 1 object. 
