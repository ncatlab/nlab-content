...
To its eternal shame, the category of Fr&#246;licher spaces is __not__ locally cartesian closed.
...
3. Let us give an example that shows that the category of Fr&#246;licher spaces is not locally cartesian closed.
Consider a coequaliser $\mathbb{R} \setminus \{0\} \to \mathbb{R} \coprod \mathbb{R}$ where the two maps are the inclusions into the two factors.

   The coequaliser of this diagram is $\mathbb{R} \cup \{*\}$ where the $*$ is a doubled-point at $0$.
...
The colimit is the same whether we work in the full category of Fr&#246;licher spaces or just those over $\mathbb{R}$.
   ...
   Now let $Y$ be any Fr&#246;licher space and consider it as a space over $\mathbb{R}$ via the zero map, $\omicron : Y \to \mathbb{R}$.
We take the product over $\mathbb{R}$ of the coequaliser diagram.
Since $\mathbb{R} \setminus \{0\}$ has no points mapping to $0$, $(\mathbb{R} \setminus \{0\}) \times_{\mathbb{R}} Y = \emptyset$.
For the third space, we see that $(\mathbb{R} \coprod \mathbb{R}) \times Y = Y \coprod Y$.
Thus the coequaliser diagram is now $\emptyset \to Y \coprod Y$.
The coequaliser is thus $Y \coprod Y$.
Note that smooth curves into $Y \coprod Y$ are curves of the form $(i, \beta)$ where $i$ distinguishes the factors and $\beta : \mathbb{R} \to Y$ is a smooth curve in $Y$.

   Let us consider the product over $\mathbb{R}$ of $\mathbb{R} \cup \{*\}$ with $Y$.
As a set, this is just $Y \coprod Y$ again.
However, as a Fr&#246;licher space it has different functions to those on $Y \coprod Y$.
...
Thus _any_ curve is allowed by this and so the smooth curves into $(\mathbb{R} \cup \{*\}) \times_\mathbb{R} Y$ are of the form $(\alpha, \beta)$ where $\alpha$ is any function into $\{0,*\}$ and $\beta : \mathbb{R} \to Y$ is a smooth curve in $Y$.
