...
A _linear-non-linear polycategory_ or simply _LNL polycategory_ is a generalization of a symmetric [[polycategory]] to include "non-linear" objects in the same way that [[linear-non-linear logic]] generalizes [[symmetric multicategories]]. Just as linear-non-linear logic provides a setting in which the exponential [[comonad]] ! in intuitionistic linear logic can be decomposed into an [[adjunction]], LNL polycategories provide a setting in which the exponential comonad ! and the monad ? in classical linear logic can each be decomposed into adjunctions.
...
* [[Michael Shulman]], _LNL polycategories and doctrines of linear logic_, [arxiv](https://arxiv.org/abs/2106.15042)