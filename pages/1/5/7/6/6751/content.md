...
More in detail, the [[linear dual space]] $\mathfrak{g}^*$ of a (finite-dimensional real) [[Lie algebra]] $\mathfrak{g}$ has a canonical structure of a [[Poisson manifold]] -- its _[[Lie-Poisson structure]]_ --, namely for any $a\in \mathfrak{g}^*$, 

$$
  \{ f, g\}(a) 
  \;\coloneqq\; 
  \big\langle 
    [\mathrm{d} f_a, \mathrm{d} g_a]
    ,\,
    a
  \big\rangle
  \,.
...
This Poisson manifold is [[foliation|foliated]] by [[symplectic leaves]] which are the [[coadjoint orbits]]. The [[line bundles]] in question are the _[[prequantum line bundles]]_ of these [[symplectic manifolds]].

Hence, in the language of [[quantum physics]], the orbit methods identifies unitary representations of Lie groups $G$ with the $G$-action on [[spaces of quantum states]] of the [[geometric quantization]] of a [[classical mechanical system]] with a global $G$-[[symmetry]].
...
The case of non-compact Lie groups is much less well understood, see for instance [Graham & Vogan 1999](#GrahamVogan), [Vogan 1999](#Vogan99).


## Definitions and constructions
 {#DefinitionsAndConstructions}

We list and discuss the basic notions, definitions and constructions in the context of the orbit method. A useful review is also in [Beasley 2011, section 4](#Beasley11).

### The group and its Lie algebra

Throughout, let $G$ be a [[semisimple Lie group|semisimple]] [[compact Lie group]]. For some considerations below we furthermore assume it to be [[simply connected topological space|simply connected]].
...
$$
  G_\lambda \xhookrightarrow{\phantom{--}} G
$$ 

for the [[stabilizer subgroup]] of $\langle \lambda,-\rangle$ under the coadjoint action.

=--

\begin{proposition}\label{CoadjointOrbitsAsCosetSpaces}
...
$$
  \array{
    ...
    g G_\lambda 
    &\mapsto& 
    Ad_g^* \langle\lambda,-\rangle
   \mathrlap{\,.}
  }
$$
\end{proposition}

\begin{definition}\label{RegularElement}

An element $\langle\lambda,-\rangle \in \mathfrak{g}^*$ is called *regular* if its [[coadjoint action]] [[stabilizer subgroup]] coincides with the [[maximal torus]]: $G_\lambda \simeq T$. 
...
For generic values of $\lambda$, the dual $\langle \lambda, - \rangle$ it is regular (Def. \ref{RegularElement}).
...
We describe a canonical [[symplectic form]] on the [[coadjoint orbit]]/[[coset space]] $\mathcal{O}_\lambda \simeq G/G_\lambda$ (from Prop. \ref{CoadjointOrbitsAsCosetSpaces}).
...
1. satisfies
   ...
   $$
    ...
    \frac{1}{2}
    \big\langle 
      \lambda, [\theta\wedge \theta]
    \big\rangle
    \,,
   $$

1. descends to a closed $G$-invariant 2-form on the [[coset space]], to be denoted by the same symbol 
...
1. which is non-degenerate and hence defines a [[symplectic form]] on $G/G_\lambda$.
...
$$
  ...
  \exp(\xi) 
    \;\mapsto\; 
  \exp(i \langle \alpha, \xi\rangle)
  \,.
$$

=--

\begin{proposition}\label{IntegralityOfSymplecticForm}
The [[symplectic form]] $\nu_\lambda \in \Omega^2_{cl}(G/T)$ of prop. \ref{TheSymplecticFormOnTheCoset} is [[integral form|integral]] precisely if $\langle \lambda, - \rangle$ is in the [[weight lattice]].
\end{proposition}

\begin{remark}
Integrality of the symplectic form (via Prop. \ref{IntegralityOfSymplecticForm}) is known as the [[geometric quantization|*Bohr--Sommerfeld condition*]], which is equivalent to the existence of a [[prequantum line bundle]].
\end{remark}


### The Hamiltonian $G$-action / coadjoint moment map

The group $G$ canonically [[group action|acts]] on the [[coset space]] $G/G_{\lambda}$ (by multiplication from the left). We discuss a lift of this action to a [[Hamiltonian action]] with respect to the [[symplectic manifold]] structure $(G/T, \nu_\lambda)$ of Prop. \ref{TheSymplecticFormOnTheCoset}, equivalently a [[momentum map]] exhibiting this Hamiltonian action.
...
This was hinted at in [Witten 89, p. 22, 23](#Witten89), details are in [Beasley 2011, section 4](#Beasley11).
...
See for instance [Beasley 2011 (4.55)](#Beasley11). 
...
* L. Auslander, [[Bertram Kostant]], _Quantization and representations of solvable Lie groups_, Bull. Amer. Math. Soc. __73__, 1967, 692&#8211;695, [pdf](http://www.ams.org/journals/bull/1967-73-05/S0002-9904-1967-11829-9/S0002-9904-1967-11829-9.pdf); _Polarization and unitary representations of solvable Lie groups_, Invent. Math. __14__ (1971), 255&#8211;354, [MR293012](http://www.ams.org/mathscinet-getitem?mr=293012), [doi](http://dx.doi.org/10.1007/BF01389744)
...
* {#Beasley11} [[Chris Beasley]], _Localization for Wilson Loops in Chern-Simons Theory_, in J. Andersen, H. Boden, A. Hahn, and B. Himpel (eds.) _Chern-Simons Gauge Theory: 20 Years After_, AMS/IP Studies in Adv. Math. **50**, AMS (2011) &lbrack;[arXiv:0911.2687](http://arxiv.org/abs/0911.2687), [ISBN:9780821853535](https://www.intlpress.com/site/pub/pages/books/items/00000258/index.php)&rbrack;
 
referring to 

* [[Shmuel Elitzur]], [[Greg Moore]], A. Schwimmer, [[Nathan Seiberg]], _Remarks on the Canonical Quantization of the Chern-Simons-Witten Theory_, Nucl. Phys. B 326 (1989) 108&#8211;134.
