...
$$
  \begin{aligned}
    \star F &=
     - E_1 \; d x^2 \wedge d x^3 
     +
     - E_2 \; d x^3 \wedge d x^1
     +
     - E_3 \; d x^1 \wedge d x^2
     \\
     & +
     B_1 \; d x^1 \wedge d t
     +
...
This are a bunch of equations on the components involved -- called Maxwell's equations in total. Their components are 
...
* **Amp&#232;re's law** $- \frac{d}{d t} E + rot B = j_{el}$
