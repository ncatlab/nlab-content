...
Indeed, there are physical processes (described by the [[wave equation]]) which are not type-I computable ([Pour-El et al. 83](#PourEl83)), but they are type-II computable ([Weihrauch-Zhong 01](WeihrauchZhong01), [Weihrauch-Zhong 02](#WeihrauchZhong02)). For more on this see at _[[computable physics]]_.
