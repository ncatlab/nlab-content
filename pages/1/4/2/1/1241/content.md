...
On quasi-realistic "flipped" [[SU(5)|$SU(5)$]]-[[GUT]],  modeled in 4d [[heterotic string theory]] and subsuming realistic [[Starobinsky model of cosmic inflation|Starobinsky-type cosmic inflation]]:
...
* George Lazarides, Rinku Maji, Rishav Roshan, Qaisar Shafi, *A Predictive $SO(10)$ Model* &lbrack;[arXiv:2210.03710](https://arxiv.org/abs/2210.03710)&rbrack;
...
On the [[symmetry breaking]] from [[Spin(10)]] to the [[standard model of particle physics|standard model]] [[gauge group]] in terms of [[real normed division algebras]] ([[octonions]], [[quaternions]]):
