Let $H\colon A &#8696;B$ be a [[profunctor]], i.e. a functor $B^{op}\times A\to Set$.  Its **cograph** is the [[category]] $\bar{H}$ whose set of objects is the [[disjoint union]] of the sets of objects of $A$ and $B$, and where
...
The cograph of a profunctor can be given a universal property: it is a certain [[lax colimit]] in the [[bicategory]] of profunctors (a "representable Kleisli object"), and it is a [[cotabulation]] in the [[proarrow equipment]] of profunctors.  Furthermore, the [[cospans]] $A\to \bar{H} \leftarrow B$ which are cographs of profunctors can be characterized as the [[Grothendieck fibration|two-sided codiscrete cofibrations]] in the [[2-category]] [[Cat]].
