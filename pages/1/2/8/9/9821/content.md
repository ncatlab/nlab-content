Let $X$ be a [[noetherian scheme]].  One defines a **$k$-dimensional [[cycle|algebraic cycle]]** as an element of the [[free abelian group]] $Z_k(X)$ generated by the [[closed subspace|closed]] [[integral scheme|integral]] subschemes of [[dimension]] $k$, and dually a $k$-codimensional cycle is an element of the free group $Z^k(X)$ generated by the closed integral subschemes of [[codimension]] $k$ in $X$.  (An important special case is the group $Z^1(X)$ of 1-codimensional cycles, better known as the group of **Weil divisors**.)  One usually writes a cycle as a formal sum
