...
is effectively the [[Kan extension]] of the [[schreiber:Differential Nonabelian Cohomology|differential cocycle]] $\nabla$ on a target space $X$ that describes the background field; the Kan extension being along a bundle $A \to \Sigma$ over parameter space $\Sigma$ (the "worldvolume") which is such that sections $\Sigma \to A$ are the _fields_ of theory.
