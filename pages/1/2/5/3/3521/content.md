...
Since the [[left adjoint]] to $\sigma^*$ is the _[[join of simplicial sets]]_ operation $(-)\star (-) : sSet \to sSet$ this means that equivalently

$$
  (Dec X)_n = Hom_{sSet}( \Delta[n] \star \Delta[0], X)
  \,.
$$

Here $\Delta[n] \star \Delta[0]$ is manifestly the simplicial [[cone]] over the $n$-[[simplex]]. So this exhibits the $n$-cells of $Dec X$ as being the cones of $n$-simplices in $X$.
...
* the morphism $Dec X \to X$ is induced by the canonical inclusion $\Delta[n] \to \Delta[n] \star \Delta[0]$ of the base of the cone.
...
For the second, notice that by remark \ref{InTermsOfCones} the lifitng problem
...
For $X$ a [[Kan complex]], the d&#233;calage morphism $Dec X \to X$ is a [[Kan fibration]] [[resolution]] of the inclusion $const X_0 \to X$ of the set of 0-cells of $X$, regarded as a [[discrete object|discrete]] simplicial set:
