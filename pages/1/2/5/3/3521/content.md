...
What is called the _d&#233;calage_ of a [[simplicial set]] is a model for its [[path space object]] --or rather: the union of all based path space objects for all basepoints $x \in X_0$ -- similar to, but a little smaller than, the model $X^I \times_X X_0$, which is discussed for instance at _[[factorization lemma]]_:
