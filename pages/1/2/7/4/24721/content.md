...
Product regularity and propositional impredicativity imply the axiom of empty set, because propositional impredicativity implies that $\mathrm{Prop}_U$ is essentially $U$-small, and then product regularity implies that $\prod_{A:\mathrm{Prop}_U} T(A)$ is essentially $U$-small. 
