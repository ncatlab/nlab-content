...
This is based on work by Michele Giry, which in turn was based on earlier work by Lawvere. This definition differs from Giry's in the second clause where subprobability measures are allowed, rather than ordinary probability measures.
...
There is a monad on Measure Spaces, $1 + -: Meas \to Meas$. A probability measure on $1 + X$ is a subprobability measure on $X$. Panangaden's monad is a composite of Giry's and $1 + -$.
...
Giry, Mich&#232;le, A categorical approach to probability theory. Categorical aspects of topology and analysis (Ottawa, Ont., 1980), pp. 68&#8211;85, Lecture Notes in Math., 915, Springer.
