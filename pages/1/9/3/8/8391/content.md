...
* the first-order theory of [[group]]s
...
[[Type checking]] refers to the problem whether the judgment $\Gamma\vdash a : A$ is derivable in a given type theory. For instance, [[intensional type theory]] has decidable type checking, but [[extensional type theory]], which add the rule of [[equality reflection]] does not.
