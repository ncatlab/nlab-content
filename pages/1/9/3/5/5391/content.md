...
The dual problem is the problem of [[lifting]] a morphism $p: Y\to B$ along an epimorphism (or more general map) $f:X\to B$ to become a morphism $\tilde{f}: Y\to X$ such that $p = f\circ\tilde{f}$.
