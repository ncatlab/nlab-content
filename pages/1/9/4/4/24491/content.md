...
$$
D_{Y_{1}...Y_{n}}(P) = \left[\underset{\substack{1 \le i \le q \\ X_{i} | Y_{1}...Y_{n}}}{\prod}\binom{nbre\;of\;time\;X_{i}\;in\;P}{nbre\;of\;time\;X_{i}\;in\;Y_{1}...Y_{n}}\right]\frac{P}{Y_{1}...Y_{n}}
$$
