...
Crystallographic groups (also: "space groups") are [[subgroups]] $S \subset Iso(D)$ of [[Euclidean groups]] containing a full [[lattice (discrete subgroup)|lattice]] $\mathbb{Z}^d \subset \mathbb{R}^D$ and having a [[finite group|finite]] *point group* $G \coloneqq S/\mathbb{Z}^D$ (a [[finite rotation group]]). For $D \in {2,3}$ these appear in [[physics]] as [[symmetry groups]] of (idealized) [[crystals]], whence the name.
...
In 3 dimensions, there are 219 distinct types, or 230 if chiral copies are considered distinct. The classification of space groups has been carried out up to  dimension $D=6$.

On the classification of symmorphic space groups see also [MO:a/77882](https://mathoverflow.net/a/77882/381)
...
* Walter Borchardt-Ott, chapter 10 of: *Crystallography*, Springer (2012) &lbrack;[doi:10.1007/978-3-642-16452-1](https://doi.org/10.1007/978-3-642-16452-1)&rbrack;
