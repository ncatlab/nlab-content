...
Other approaches that are closer to naive or common sense set-theoretic reasoning are possible. In the case of quotient objects, to form the coequalizer of a parallel pair $f, g: X \rightrightarrows Y$, we outline a possible path to take: 
