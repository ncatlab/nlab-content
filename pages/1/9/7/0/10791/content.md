...
A morphism of [[affine schemes]] $Spec A \to Spec B$ is _pro-&#233;tale_ if it is a [[cofiltered limit]] of [[étale morphisms of schemes]] over $Spec B$, dually if $B \to A$ is an [[ind-object|ind-]][[étale algebra]].
