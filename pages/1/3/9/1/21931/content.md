...
\begin{proof}
  From [Toda 1962 p. 186](#Toda62) we know that $\pi_3^s \simeq \mathbb{Z}_{/24}$. With this, [Adams 1966 Thm. 1.5](#Adams1966) implies that the [[J-homomorphism]] is [[surjective]] onto $\pi_3^s$. (Use here that, in Adams's notation, $s = 1$, and then that the [[Bernoulli number]] $B_{2s} = B_2 = 1/6$ so that $B_{2s}/4s = 1/24$.) Finally, [Adams 1966 §10](#Adams1966) observes (stated more explicitly in [Ravenel 2004 Thm. 1.13](#Ravenel2004)), that the [[image]] of the [[J-homomorphism]] in degree 3 is generated by the ([[suspensions]] $\nu$ of) the [[quaternionic Hopf fibration]].
\end{proof}
