...
where the generator $[1] \in \mathbb{Z}/24$ is represented by (the [[suspensions]] of) the [[quaternionic Hopf fibration]] $S^7 \overset{h_{\mathbb{H}}}{\longrightarrow} S^4$ (cf. [Kirdar 2021 §4](#Kirdar2021) and Prop. \ref{QuaternionicHopfFibrationIsGenerator} below).
