...
Moreover, in [[chain complexes]] over a [[field]] of [[characteristic zero]]  the [[E-n operad]] is [[formal dg-algebra|formal]] (see _[[the little n-disk operad is formal]]_), hence equivalent to its homology, and so in this context $E_n$-algebras are equivalent to Poisson $n$-algebras.

This fact is a higher analog of [[Kontsevich formality]]. It means that every higher dimensional [[prequantum field theory]] given by a $P_n$ algebra does have a [[deformation quantization]] (as [[factorization algebras]]) and that the space of choices of these is a torsor over the [[automorphism infinity-group]] of $E_n$, a higher analog of the [[Grothendieck-Teichmüller group]].
