...
+-- {: .un_def}
###### Definition
A linear functional $\rho$ of an $C*$-algebra is **positive** if $A \ge 0$ implies that  $\rho(A) \ge 0$.

A **state** of an unital $C*$-algebra is linear functional $\rho$ such that $\rho$ is positive and $\rho(\mathbb{1}) = 1$.
=--
