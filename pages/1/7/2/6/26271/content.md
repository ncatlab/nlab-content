...
\begin{definition}
For a $\mathbb{K}$-[[module]] $\mathscr{V} \,\in\, \mathbb{K}Mod$ (say *right* modules for possibly non-commutative $\mathbb{K}$, but being just $\mathbb{K}$-[[vector spaces]] if $\mathbb{K}$ is a [[field]]), its *anti-dual* space $\mathscr{V}^\ast$ is the space of [[anti-linear maps]] to the [[ground ring]] ([[ground field]])
