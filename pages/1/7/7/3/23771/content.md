...
The context modification rules needed in higher observational type theory via [[type telescopes]] or some other mechanism likely makes the theory less logically clean compared to that of [[Martin-Löf dependent type theory]] equipped with the [[univalence axiom]]. However, the context modification rules of higher observational type theory are probably still comparable to [[cubical type theory]], where variables of the second-class interval primitive defined via [[type theory with shapes]] behave as whole context-modifying modal locks in the sense of [[multimodal dependent type theory]]. 
