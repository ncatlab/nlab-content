...
of [flat Ehresmann infinity-connections](cohesive (infinity,1)-topos -- structures#FlatEhresmannConnections) realized in $Smooth\infty Grpd$. We show that when applied to an ordinary [[Lie group]] this reproduces the traditional notion of [[Ehresmann connection]].
