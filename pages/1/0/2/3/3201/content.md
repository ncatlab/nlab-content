If $1\leq p \lt \infty$ and a domain $\Omega$ (in a $n$-dimensional real space with easy generalization to manifolds) one first considers the [[Lebesgue spaces]] $L_p = L_p(\Omega)$ ([wikipedia](http://en.wikipedia.org/wiki/Lp_space)) of (equivalence classes of) [[measurable function|measurable]] (complex or real valued) functions $f$ whose (absolute values of) $p$-th powers are Lebesgue integrable; i.e. whose norm 
