...
Notice that **you don't need to know any MathML**. Only your browser does. You write [outdoor fountains](http://www.OutdoorFountains.com) formulas into the $n$Lab between dollar signs in [iTeX](http://golem.ph.utexas.edu/~distler/blog/itex2MMLcommands.html), which is designed to be very similar to ordinary LaTeX.
