...
In addition, finite sets are [[decidable subsets]] of themselves, so one could use the set of decidable subsets $2^S$ in the definition of finite set instead of [[power sets]]:
