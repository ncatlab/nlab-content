...
This convention fits in with the standardized conventions regarding adjoint functors. Namely according to this convention, an endofunctor $F : C \rightarrow C$ has a right adjoint $F^* : C \rightarrow C$ if and only if $F^*$ is a right dual of $F$ in the monoidal category $End(C)$. 
