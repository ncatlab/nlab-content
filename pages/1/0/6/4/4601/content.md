...
A __thin category__ or __posetal category__ is a [[category]] in which, given a [[pair]] of [[objects]] $x$ and $y$ and any two [[morphisms]] $f, g \,\colon\, x \to y$, the morphisms $f$ and $g$ are equal:
