...
1. the topology with which we glue families must be subcanonical: this is the assumption that fails for the situations in which one would speak of [[classifying space]]s instead of moduli spaces: 
   ...
   In fact, there is a theorem by [[Danny Stevenson]] and [[David Michael Roberts]], extending a theorem by [[John Baez]] and Danny Stevenson  that shows that large classes of [[principal ∞-bundle]]s, even, do have classifying topological spaces in this sense. These are objects that not only have automorphisms, but have automorphisms of automorphisms, etc, and hence seem to contradict the above slogan in a maximal way. 
