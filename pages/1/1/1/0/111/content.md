...
This section lists a few well-known categories (with links to articles on these categories, if such articles exist) and some of their properties. 
...
Here is a list with a few more examples, as well as their properties.
