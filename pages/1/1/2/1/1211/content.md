...
We begin with the historically first definition, which is correct for [[well-founded relation]]s.  We then consider ways to extend this to more general relations, where the last version seems to be most correct.
