...
* [[Steve Awodey]], [[Thierry Coquand]], [[Maria Emilia Maietti]] (orgs.):
  ...
  **[Types, Homotopy Type Theory, and Verification](https://www.him.uni-bonn.de/programs/past-programs/past-trimester-programs/types-sets-constructions/workshop-types-homotopy-type-theory-and-verification/)**
  ...
  [Hausdorff Institute for Mathematics](https://www.mathematics.uni-bonn.de/him), Bonn
...
* Douglas S. Bridges, Michael Rathjen, Peter Schuster, Helmut Schwichtenberg (orgs.):

  \linebreak 

  **[Types, Sets and Constructions](https://www.mathematics.uni-bonn.de/him/programs/past/tp_2018_05)**
...
Videos of most talks are collected as 

* [YouTube playlist](https://youtube.com/playlist?list=PLul8LCT3AJqQxIaZhaSNCTuLYfIFB1AiI).
...
* {#Tutorial1} 11:00--12:00	

  [[Dan Licata]]: 

  [Tutorial](#Tutorial) 1: *A Fibrational Framework for Modal Simple Type Theories*

  ([slides pdf](http://dlicata.web.wesleyan.edu/pubs/lsr17multi/him-tutorial.pdf), [recording](https://www.youtube.com/watch?v=uLLbSAYd3yI))
...
* 14:00--15:00	
  ...
  *Do cubical models of type theory also model homotopy types?*
  ...
  > I will give an alternative exposition of [[Chris Kapulkin|Kapulkin]] and [[Vladimir Voevodsky|Voevodsky]]'s result about simplicial sets forming a subtopos of certain cubical sets: https://arxiv.org/abs/1805.04126. I will also give a brief summary of my current state of knowledge on which cubical models do or do not model homotopy types.
...
* 15:00--16:00
  ...
  *Spectral Sequences in Homotopy Type Theory*
  ...
  ([pdf slides](/nlab/files/vanDoorn.pdf))
...
* 16:30--17:30
  ...
  *Towards higher models and syntax of type theory*
  ...
  ([slides pdf](http://www.cs.nott.ac.uk/~psztxa/talks/bonn18.pdf))
...
* 09:30--10:30
  ...
  *Algorithms of Type and Proof Checking*
...
* {#Tutorial2} 11:00--12:00

  [[Felix Wellen]]: 

  [Tutorial](#Tutorial) 2: *The Shape Modality in Real-cohesive HoTT and Covering Spaces*

  ([recording](https://www.youtube.com/watch?v=ACGjJDarEc4))
...
* 15:00--16:00
  ...
  *Cartesian cubical computational type theory* 
  ...
  ([slides pdf](http://favonia.org/files/ccctt-bonn2018-slides.pdf))
...
* {#Tutorial3} 09:30--10:30

  [[Dan Licata]]: 

  [Tutorial](#Tutorial) 3: *Discrete and Codiscrete Modalities in Cohesive HoTT, I* 

  ([slides pdf](http://dlicata.web.wesleyan.edu/pubs/lsr17multi/him-tutorial.pdf), [recording](https://www.youtube.com/watch?v=OHN9vEVPBN8))


* {#Tutorial4} 11:00--12:00

  [[Felix Wellen]]: 

  [Tutorial](#Tutorial) 4: *Discrete and Codiscrete Modalities in Cohesive HoTT, II*

  ([recording](https://www.youtube.com/watch?v=KXx9UDQdWPw))

* 15:00--16:00

  [[Anders Mörtberg]]: 

  *Yet Another Cartesian Cubical Type Theory (yacctt)*

  ([[MortbergBonn.pdf:file]])
  ...
  > This is joint work with [[Carlo Angiuli]] and we have implemented a primitive proof assistant based on this type theory: [https://github.com/mortberg/yacctt](https://github.com/mortberg/yacctt).
...
* {#Tutorial5} 09:30--10:30

  [[Dan Licata]]: 

  [Tutorial](#Tutorial) 5: *A Fibrational Framework for Modal Dependent Type Theories* 

  ([slides pdf](http://dlicata.web.wesleyan.edu/pubs/lsr17multi/him-tutorial.pdf), [recording](https://www.youtube.com/watch?v=R4SsxUnIcng))

* 11:00--12:00

  [[Bas Spitters]]: 

  *Modal Dependent Type Theory and the Cubical Model* 

  ([pdf slides](http://www.cs.au.dk/~spitters/bonn-slides.pdf))
  ...
  > Ranald Clouston, Bassel Mannaa, Rasmus Ejlers Møgelberg, Andrew M. Pitts, Bas Spitters: *Modal Dependent Type Theory and Dependent Right Adjoints* [https://arxiv.org/abs/1804.05236](https://arxiv.org/abs/1804.05236)
  ...
  > Daniel R. Licata, Ian Orton, Andrew M. Pitts, Bas Spitters, *Internal Universes in Models of Homotopy Type Theory FSCD18* [https://arxiv.org/abs/1801.07664](https://arxiv.org/abs/1801.07664)
...
* 14:00--15:00	
  ...
  *Embedding the effective topos into cubical assemblies*
...
* 16:30--17:30	
  ...
  *Investigations into cubical type theory*
...
* {#Tutorial6} 09:30-10:30

  [[Felix Wellen]]: 

  [Tutorial](#Tutorial) 6: *Differential Cohesive HoTT*

  ([recording](https://www.youtube.com/watch?v=uEZXHPdwvJU&t=226s))

* 11:00-12:00	

  [[Andrej Bauer]]: 

  *Toward an initiality theorem for general type theories*
...
* [[Felix Wellen]]: 
  ...
  [Tutorial](#Tutorial) 6: _Differential Cohesive HoTT_, 
...
* 15:00-16:00	
  ...
  *Refinement type systems and Martin-Löf type theory*
...
* [[Daniel R. Licata]] and [[Felix Wellen]]:

  **Synthetic Mathematics in Modal Dependent Type Theories**

  ([pdf](http://dlicata.web.wesleyan.edu/pubs/lsr17multi/him-tutorial.pdf), [[LicataWellen-ModalTutorial.pdf:file]])

  1. *[A Fibrational Framework for Modal Simple Type Theories](#Tutorial1)*

     ([recording](https://www.youtube.com/watch?v=uLLbSAYd3yI))

  2. *[The Shape Modality in Real-cohesive HoTT and Covering Spaces](#Tutorial2)*

     ([recording](https://www.youtube.com/watch?v=ACGjJDarEc4))

  3. *[Discrete and Codiscrete Modalities in Cohesive HoTT, I](#Tutorial3)*

     ([recording](https://www.youtube.com/watch?v=OHN9vEVPBN8))

  4. *[Discrete and Codiscrete Modalities in Cohesive HoTT, II](#Tutorial4)*

     ([recording](https://www.youtube.com/watch?v=KXx9UDQdWPw))

  5. *[A Fibrational Framework for Modal Dependent Type Theories](#Tutorial5)*

  6. *[Differential Cohesive HoTT](#Tutorial6)* 

     ([recording](https://www.youtube.com/watch?v=uEZXHPdwvJU&t=226s))

  > **Abstract:** Several [[modal homotopy type theory|modal extensions]] of [[homotopy type theory]] have been or are being developed, with applications to [[synthetic mathematics|synthetic]] formalizations of aspects of topology, differential geometry, and spectra, as well as internal language presentations of cubical models of HoTT. In this tutorial, we will describe some recent work on these type theories, the frameworks we use to design them, and their applications in real-cohesive and differential-cohesive HoTT.
