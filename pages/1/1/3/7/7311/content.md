...
* $\Pi$-closed morphisms are a right class of an [[orthogonal factorization system in an (∞,1)-category]] and hence (see [catlab](http://ncatlab.org/joyalscatlab/show/Factorisation+systems#orthogonality_16)) are closed under limits, composition, retracts and satisfy the left cancellation property.
