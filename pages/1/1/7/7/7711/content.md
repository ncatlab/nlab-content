...
* the [[extra structure|extra]] [[structure]] which such an algebra has with respect to its [[underlying]] [[object]]. 

There are several notions of an __algebraic structure__ on an [[object]] of some [[category]] or [[higher category]], which differ in generality. It may be to be an algebra over an [[algebraic theory]], [[algebra over an operad]] (or higher operad) or an [[algebra over a monad]], or over a [[PROP]], over a [[properad]] etc. See also at *[[variety of algebras]]*.
