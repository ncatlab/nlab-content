...
As a span from $1$ to $B$, that is as a bundle over $B$, this is indeed a covering space over $B$, and is the desired functor 

$$\overline{Path}(B) \otimes_{\Pi_1(B)} -: Set^{\Pi_1(B)} \to Cov/B$$ 

that is quasi-inverse to the fiber functor 
