...
Recall that given a space $X$ with an [[action]] of a [[group]] $G$ on it, an $U(1)$-[[cocycle]] on the [[action groupoid]] $X// G$, i.e., a [[functor]] $X//G \to \mathbf{B} U(1)$, can be explicitly described as a function 
