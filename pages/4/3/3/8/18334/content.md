...
The [[axioms]] of traditional [[algebraic quantum field theory]], where one assigns a plain [[algebra]] (e.g. a [[C*-algebra]]) of [[observables]] to a [[spacetime]] region, fail when one considers [[gauge theory]] on [[spacetimes]] more general than [[Minkowski spacetime]] ([[AQFT on curved spacetimes]]): 
