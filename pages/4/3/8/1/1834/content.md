...
He obtained his Ph.D. in 2007 in Bonn under [Gerd Faltings](http://en.wikipedia.org/wiki/Gerd_Faltings), Durov's mathematical work preceding his study in Bonn includes his work on classical [[Galois theory]] of polynomial equations; it provides essentially the third historically available method to compute algorithmically a Galois group of a given equation. His method is however statistical and some random data are included in input. The algorithm terminates with probability $1$ for all equations iff the [[Riemann hypothesis]] is true. The exposition of these results is in
