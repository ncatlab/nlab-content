...
[[Brower group]] $Br(X)$ classifies Azumaya algebras over $X$ up to suitably defined equivalence relation: $\mathcal{A}\sim\mathcal{B}$ if $\mathcal{A}\otimes_{\mathcal{O}_X} \mathbf{End}(\mathcal{E}) \cong \mathcal{A}\otimes_{\mathcal{O}_X}\mathbf{End}(\mathcal{F})$ for some locally free sheaves of $\mathcal{O}_X$-modules $\mathcal{E}$ and $\mathcal{F}$ of finite rank.  The group operation o $Br(X)$ is induced by the tensor product. Brower group can be reexpressed in terms of second nonabelian cohomology; indeed a sheaf of Azumaya algebras over $X$ determines an $\mathcal{O}_X^*$-gerbe (or $U(1)$-gerbe in manifold context).  

Brower groups and Azumaya algebras are closely related to Morita theory and they make sense in the context of algebras and bimodules in the context of braided monoidal categories. [[Karoubi K-theory]] involves an element in a Brower group and in the original Karoubi-Donovan paper is related to a twisting with a "local system" which involves Azumaya algebras.
