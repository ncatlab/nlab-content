...
In section 7.3 of the [[HoTT Book]] [UFP13](#UFP13), the authors give another definition of the propositional truncation using the hubs and spokes construction developed in section 6.7. Since the [[boolean domain]] is the zero-[[dimensional]] [[sphere]], the propositional truncation of $A$ is a [[higher inductive type]] generated by 
