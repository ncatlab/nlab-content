...
The axiom of **small violations of choice**, or **SVC**, introduced by [Blass (1979)](#Blass79) asserts that
...
When we move to [[constructive mathematics]], however, SVC quickly becomes unreasonable, because in the absence of LEM there are usually very few choice objects.  In particular (see [MO:a/339314](https://mathoverflow.net/a/339314/49)) [[Simon Henry]] argues that any Grothendieck topos satisfying both SVC and $\neg LEM$ (i.e. $\neg \forall P, P\vee \neg P$, which holds in many toposes such as $Sh([0,1])$) is trivial.
