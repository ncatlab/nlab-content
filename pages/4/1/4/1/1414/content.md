...
The original motivation for the introduction of the homotopy coherent nerve is that it provides a neat simplicial formulation of idea of [[homotopy coherent diagram|homotopy coherent diagrams]]. Homotopy coherent algebraic structures were studied in the 1970s by [[Michael Boardman|Boardman]] and [[Rainer Vogt|Vogt]] in joint work,  and then Vogt individually looked at homotopy coherenc diagrams.  The  homotopy coherent nerve was first explicitly defined by [[Jean-Marc Cordier|Cordier]] (reference below). 
