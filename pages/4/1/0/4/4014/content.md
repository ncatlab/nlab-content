...
* The probability of a "1" on the next toss, given the record of outcomes a long sequence of tosses, will approach the observed relative frequency with which a "1" has been observed.
...
Richard von Mises said that it makes no more sense to say the conditional probability that the outcome of the first trial was "1", given the state of complete ignorance of relative frequencies, is 1/6, than it does to say that the heights of all members of a group of people are estimated to be equal because one is ignorant of their heights.  von Mises missed the point.  The problem was not to estimate the relative frequencies, but to say how epistemically probable that outcome is, given a particular state of knowledge.
