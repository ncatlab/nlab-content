...
* Devon Stockall, [[Matthew Yu]]. *Geometric Categories for Continuous Gauging* (2025). ([arXiv:2511.08254](https://arxiv.org/abs/2511.08254)).
...
Technically, the observation is that "non-invertible" actions on local operators, that is, operators supported at a point, do not exist in $D \gt 2$. Up to gaugings, the same conclusion is reached for finite generalized symmetries in $D=3,4$ in:
