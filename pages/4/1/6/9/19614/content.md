...
Piecewise flat spacetimes appear naturally in [[3d quantum gravity|3-dimensional gravity]] and also as the "[[far-horizon geometry]]" (see there) of [[BPS state|BPS]] [[black brane]] spacetimes in [[supergravity]] theories, where considerations such as at _[[M-theory on G2-manifolds]]_ suggest that the [[conical singularities]] have to be taken seriously as part of the physical model.
