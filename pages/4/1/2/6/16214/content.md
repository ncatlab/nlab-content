...
* [[Dennis Gaitsgory]], [[Nick Rozenblyum]]: 
  ...
  **A study in derived algebraic geometry**
  ...
  [book webpage](https://people.mpim-bonn.mpg.de/gaitsgde/Book/)
...
The book states a number of claims on (its definition of) the [[Gray tensor product]] of [[(∞,2)-categories]] without proof. These have all since been proved, see the references [there](Gray+tensor+product#Loubaton25).
...
* Chapter II.1: _Ind-coherent sheaves on schemes_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/IndCohSch.pdf)
...
* Chapter II.2: _The !-pullback and base change_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/corrtext.pdf).
...
* Chapter II.3: _Relation between QCoh and IndCoh_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/QCohandIndCoh.pdf).
...
* Chapter III.1: _Deformation theory_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/deftext.pdf).

  Sets up [[derived deformation theory]].

* Chapter III.2: _(Ind)-inf-schemes_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/InfSchtext.pdf).

  Introduces [[inf-schemes]], which are algebro-geometric objects that include [[derived schemes]] and de Rham [[prestacks]] of schemes

* Chapter III.3: _Ind-coherent sheaves on (ind)-inf-schemes_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/InfSchtext.pdf).

  Extends the formalism of [[ind-coherent sheaves]] to [[inf-schemes]] and discusses functoriality.

* Chapter III.4: _An application: crystals_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/crystext.pdf).

  Studies the [[six operations]] for [[D-modules]].

* Introduction to Part IV: Formal geometry

* Chapter IV.1: _Lie algebras and co-commutative co-algebras_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/Lie.pdf).

  Sets up the theory of [[Lie algebras]] from the point of view of [[Koszul-Quillen duality]].

* Chapter IV.2: _Formal moduli_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/formalmoduli.pdf).

  Reinterprets [[Jacob Lurie]]'s theory of [[formal moduli problems]] using the language of [[inf-schemes]].

* Chapter IV.3: _Formal groups and Lie algebras_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/exp.pdf).

  Explains how to pass between [[Lie algebras]] and [[formal groups]] within the framework of [[derived algebraic geometry]].

* Chapter IV.4: _Lie algebroids_, [pdf](https://people.mpim-bonn.mpg.de/gaitsgde/Book/algebroids.pdf).
