...
The Schwartz space $\mathcal{S}$ of functions with rapidly decreasing derivatives (def. \ref{SchwartzSpaceOfFunctionsWithRapidlyDecreasingDerivatives})
is a [[Fréchet space]].
...
Specifically the Schwartz spaces of functions with rapidly decreasing derivatives are discussed for instance in
