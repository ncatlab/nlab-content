...
is the [[left adjoint|left]] [[adjoint (∞,1)-functor]] to the inclusion of [[abelian ∞-groups]] ([[connective spectra]]) into [[commutative monoid object in a symmetric monoidal (∞,1)-category|commutative ∞-monoids]] in [[∞Grpd]].
