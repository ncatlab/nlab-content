...
In its restricted sense the _Grothendieck group completion_ of an abelian [[monoid]] $A$ is a certain [[group]] structure on a quotient of $A \times A$. This is such that applied to the additive monoid of [[natural number]]s $\mathbb{N}$ it produces the additive group of [[integer]]s $\mathbb{Z}$.
