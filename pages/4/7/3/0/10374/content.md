...
where "on shell" means up to the ideal generated by the classical free equations of motion. Hence for the case of [[local observables]] of the form $div J$, the quantum Ward identity expresses the possible failure of the [[conserved current]] to be conserved, due to both quantum effects ($\hbar$) and interactions ($g$). This is the form in which Ward identities are usually understood.
