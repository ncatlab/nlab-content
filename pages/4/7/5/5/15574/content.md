...
* Aufhebung unites _determinateness_ with annihilation of being. These recur at the mathematical level as the correspondence between being-being a sheaf, annihilation -being the adjoint opposite of sheaf (anti-sheaf), and the determination of Aufhebung as being the least (=the Leibnizian best) level of being simultaneously a sheaf and an anti-sheaf.
...
Moreover by assumption on [[cohesive sites]], for every object $U\in \mathcal{S}$ there exists a morphism $i \colon \ast \to U$ hence for every $X\in \mathbf{H}$ and every $U$ there exists a morphism $i^\ast \colon X(U)\to \flat X$. This means that if $\flat X \simeq \emptyset$ then $X(U) \simeq \emptyset$ for all $U \in \mathcal{S}$ and hence $X\simeq \emptyset$. From this the claim follows with prop. \ref{AufhebungOfBecomingMeansOnlyInitialObjectHasNoGlobalPoints}.
...
* [[F. William Lawvere]], _Toposes generated by codiscrete objects in combinatorial topology and functional analysis_, Reprints in Theory and Applications of Categories, No. 27 (2021) pp. 1-11, [tac](http://tac.mta.ca/tac/reprints/articles/27/tr27abs.html).
