...
On the other hand, the enhanced _global_ [[supersymmetry]] of [[target space]] is also reflected in enhanced _local_ supersymmetry on the [[worldsheet]] of the string. For instance for the [[heterotic string]] whose worlsheet [[2d SCFT]] apriori has $N=(1,0)$ supersymmetry, the target space theory has $N=1$ supersymmetry precisely if the worldsheet theory's supersymmetry enhanced to $N=(2,0)$. ([BDFF 88](#BDFF88)). For more on this see at _[[2d (2,0)-superconformal QFT]]_.
