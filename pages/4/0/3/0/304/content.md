A _0-groupoid_ is a [[set]]. This terminology may seem strange at first, but it is very helpful to see sets as the beginning of a sequence of concepts: sets, [[groupoid|groupoids]], [[2-groupoid|2-groupoids]], [[3-groupoid|3-groupoids]], etc. Doing so reveals patterns such as the [[periodic table]]. (It also sheds light on the theory of [[homotopy group]]s and [[n-stuff]].)
