...
We say that $T$ is a **parametric right adjoint**, or **p.r.a.**, if the functor $T_1$ is a [[right adjoint]].  Parametric right adjoints are also called **local right adjoints**. It is equivalent to the notion of right [[multi-adjiont]], but [[multi-adjoints]] can be formulated without assuming $$A$$ has a terminal object.
