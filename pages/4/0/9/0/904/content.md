...
The fundamental group $\pi_1(X,a)$ of a [[pointed object|pointed]] [[topological space]] $(X,a)$ is the group of [[homotopy]] classes of [[loop]]s at $x$ ([[path]]s from $x$ to $x$), with multiplication defined by concatenation (following one path by another).  
