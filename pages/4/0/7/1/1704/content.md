...
**Remark** For the simple case that 
$G$ is [[group]],
...
Notably in this [[(infinity,1)-topos]] $(\infty,1)Sh(X)$
...
[[Diff]] of [[manifold]]s as discussed for instance in some detail in

* Daniel Dugger, _Sheaves and homotop theory_ ([pdf](http://www.uoregon.edu/~ddugger/cech.html)).
