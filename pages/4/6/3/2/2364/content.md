...
Notice that since every [[formal group law]] over a [[ring]] $R$ is classified by a ring homomorphism $f : MP({\ast}) \to R$ where $MP({\ast})$ is the [[Lazard ring]]. So for every formal group one obtains a contravariant [[functor]] on [[topological space]]s given by the assignment
