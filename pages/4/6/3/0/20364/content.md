...
\begin{definition}
A _pyknotic set_ is a [[sheaf]] of sets on the site of [[compact Hausdorff space|compact Hausdorff]] [[topological spaces]] whose underlying set has [[rank]] smaller
...
Pyknotic sets form a [[coherent topos]], whereas the closely related category of [[condensed sets]] does not form a topos ([BarHai 19, Sec. 0.3](#BarHai19)), only an [[infinitary pretopos]].
