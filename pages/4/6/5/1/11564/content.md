...
$$
  \array{
    \Pi_{dR}\Omega A && \stackrel{\mathbf{d}}{\longrightarrow} && \flat_{dR}\Sigma A
    \\
    & \searrow && \nearrow
    \\
    && A
...
Given that conceptually, as made explicit in the [Idea-section](#Idea) above, we may think of cocycles in $\Pi \flat_{dR}\Sigma A$ as the rationalized characteristic classes and of coycles in $\flat \Pi_{dR}\Omega A$ as flat differential forms, this expresses the conceptual content of the [[de Rham theorem]].
...
1. $\flat_{dR} \Sigma (\Omega \otimes_{\mathbb{R}} C)^{\bullet \geq n} 
   \simeq 
   (\Omega \otimes_{\mathbb{R}} C^{\bullet \leq n-1})^{\bullet \geq n}$


1. $\Pi_{dR} \Omega (\Omega \otimes_{\mathbb{R}} C)^{\bullet \geq n} 
   \simeq 
   (\Omega \otimes_{\mathbb{R}} C )^{\bullet \leq n-1}[-1]$

1. $\Pi \flat_{dR} \Sigma (\Omega \otimes_{\mathbb{R}} C)^{\bullet \geq n} \simeq C^{\bullet \leq n-1}$
...
$$
  \array{
    \Pi_{dR}\Omega(\cdots) && \stackrel{\mathbf{d}}{\longrightarrow} &&
    \flat_{dR}\Sigma (\cdots)
    \\
    \simeq && \simeq 
    \\
    \Omega(-,D)^{\bullet \lt 0}
...
* [[Urs Schreiber]], _[[schreiber:Differential generalized cohomology in Cohesive homotopy type theory]]_, talk at IHP trimester on _Semantics of proofs and certified mathematics_, _Workshop 1: Formalization of Mathematics_, Institut Henri Poincar&#233;, Paris, 5-9 May 2014
