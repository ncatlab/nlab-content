...
We discuss several differential refinements, def. \ref{DifferentialCoefficients}, to [[smooth spectra]], of the complex [[topological K-theory]] spectrum [[KU]] or of its [[connective cover]] $ku$.

#### Hopkins-Singer differential $ku$

Let $\mathbb{C}[b]$ be the [[polynomial ring]] with [[complex numbers]] [[coefficients]] on a single generator $b$. With $b$ regarded as in degree 2, rehard this as a [[chain complex]] with vanishing differentials. 

Then the complex ordinary [[Chern character]] on K-theory is a mpa
...
Then $ku_{conn_ch}$ (def. \ref{HopkinsSingerPullback}) is the Hopkins-Singer version of [[differential K-theory]]. ([Bunke-Nikolaus-V&#246;lkl 13, section 6.1](#BunkeNikolausVoelkl13))




#### Via geometric vector bundles with connection
