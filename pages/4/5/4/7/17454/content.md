...
The _Curtis algorithm_ is an [[algorithm]] for computing the second page of the [[classical Adams spectral sequence]] using an algebraic version of the [[EHP spectral sequence]] for the [[Lambda-algebra]].
