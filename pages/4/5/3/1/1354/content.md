It is well-known that the concept of a [[triangulated category]] is suffering many deficencies for the purposes of [[homological algebra]], geometry and topology. For that reason, Bondal and Kapranov in
...
A __dg-enhancement of a triangulated category__ $T$ is a (pretriangulated) [[differential graded category]] $A$ together with an equivalence $H^0(A)\to T$. The triangulated
