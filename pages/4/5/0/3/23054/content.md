...
The notion is used in the theory of [[additively idempotent semiring|idempotent semirings]] to give a form of `pseudo-solution' to equations which fail to have actual solutions.
