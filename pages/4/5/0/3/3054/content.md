...
1. The category of [[Banach spaces]] with linear [[short maps]] is [[monadic category|monadic]] over Set but not [[algebraic category|algebraic]].  The "nearest" algebraic theory is that of [[totally convex space]]s.
