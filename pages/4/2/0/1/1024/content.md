...
The stability or slice theorem for [[toposes]] says that if $\mathbf{E}$ is a topos, then also the [[slice category]] $\mathbf{E}/U$ is a topos for any object $U$, and the [[pullback#PullbackFunctor|pullback functor]] $U^\ast: \mathbf{E} \to \mathbf{E}/U$ is a [[logical functor]]. 
