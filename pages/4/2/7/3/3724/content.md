...
This definition is due to [Vickers15](#Vickers15). 

Let us define the family of upwards unbounded [[open intervals]] $\left(]a,\infty[\right)_{a \in \mathbb{Q}}$ and lower unbounded [[open intervals]] $\left(]-\infty, a[\right)_{a \in \mathbb{Q}}$. The set of **Dedekind cuts** is a [[frame]] generated by $]a,\infty[$ and $]-\infty, a[$ such that

$$\mathbb{Q} \subseteq \bigcup_{a \in \mathbb{Q}} ]a,\infty[$$

$$\mathbb{Q} \subseteq \bigcup_{a \in \mathbb{Q}} ]-\infty,a[$$

* for all $a \in \mathbb{Q}$ and $b \in \mathbb{Q}$, 
$$(a \lt b) \implies (]b,\infty[ \subseteq ]a,\infty[)$$

* for all $a \in \mathbb{Q}$ and $b \in \mathbb{Q}$, 
$$(b \lt a) \implies (]-\infty,b[ \subseteq ]-\infty,a[)$$

* for all $a \in \mathbb{Q}$
$$]a,\infty[ \subseteq \bigcup_{b \in ]a,\infty[} ]b,\infty[$$

* for all $a \in \mathbb{Q}$
$$]-\infty,a[ \subseteq \bigcup_{b \in ]-\infty,a[} ]-\infty,b[$$

* for all $a \in \mathbb{Q}$ and $b \in \mathbb{Q}$, 
$$]a \lt b[ \Rightarrow \mathbb{Q} \subseteq ]a, \infty[ \cup ]-\infty, b[$$

* for all $a \in \mathbb{Q}$ and $b \in \mathbb{Q}$, 
$$]a,\infty[ \cap ]-\infty,b[ \subseteq ]a,b[$$
