...
If $x$ and $y$ are elements of a [[partial order|poset]] $P$, then their __join__ (or __supremum__, abbreviated _sup_, or __least upper bound__, abbreviated _lub_), is an element $x \vee y$ of the poset such that:
