...
### Geometry and structure $\infty$-sheaves
 {#StructureSheaves}
...
The [[geometry (for structured (infinity,1)-toposes)|pregeometry]] structure on $CartSp_{Smooth}$ intrinsic to the notion of infinitesimal cohesion given by the canonical includion $Smooth \infty Grpd \hookrightarrow SynthDiff \infty Grpd$ has as [[open map]]s/admissible maps precisely the inclusions of open balls.
