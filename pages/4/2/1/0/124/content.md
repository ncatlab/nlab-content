...
There are alternative ways to state the definition.  For instance, from finite limits and _[[power objects]]_ $\Omega^X$ we can construct all exponentials and the subobject classifier $\Omega = \Omega^1$.
...
Some of the most important examples of toposes are [[Grothendieck topoi]], which are the categories of [[sheaf|sheaves]] on [[sites]].  The word "topos" was originally used only to mean Grothendieck's sort.
