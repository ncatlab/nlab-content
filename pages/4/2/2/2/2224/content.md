...
Given a [[field]] $k$, the $n$-th __Weyl algebra__ $A_{n,k}$ is an [[associative unital algebra]] over $k$ generated by the symbols $x^1,\ldots,x^n,\partial_1,\ldots,\partial_n$ modulo relations $x^i x^j = x^j x^i$, $\partial_i\partial_j = \partial_j\partial_i$ and $\partial_i x^j - x^j \partial_i = \delta_i^j$ (the [[Kronecker delta]]). 
...
Please distinguish from _[[Weil algebra]]_.  
