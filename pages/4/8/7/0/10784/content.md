...
Given a [[field]] $k$ with [[separable closure]] $\overline{k}$, then the pro-etale site of $Spec(\overline{k})$ is equivalently the category of [[profinite sets]]. The pro-etale site of $Spec(k)$ identifies with the category of profinite continuous $Gal(\overline k/k)$-sets. ([Bhatt-Scholze 13, example 4.1.10](#BhattScholze13)).
