...
If $Set$ exists, it is called the __[[universe]] of [[set]]s__, a global element $I:G \rightarrow Set$ is called an [[indexed family]] and an element $A:* \rightarrow Set$ is called a set, where all these terms refer to the [[internalization|internal]] [[set theory]] of the (2,1)-category $C$. 
