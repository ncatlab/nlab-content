The __core__ of a [[category]] is its underlying [[groupoid]], that is the [[subcategory]] consisting of all objects but only the [[isomorphism]]s.
...
The __core__ of an $n$-[[n-category|category]] is the $n$-[[n-groupoid|groupoid]] consisting only of [[equivalence]]s at each level; the __core__ of an $\infty$-[[infinity-category|category]] is similarly an $\infty$-[[infinity-groupoid|groupoid]].
