In 1980-s, [[Grothendieck]] in _Pursuing Stacks_ introduced test categories to make the variants of the [[homotopy theory]] based on the usage if combinatorial models with some kind of cell structure (e.g. [[simplicial set]]s, [[cubical set]]s and cellular sets) independent of a particular combinatorial model.
