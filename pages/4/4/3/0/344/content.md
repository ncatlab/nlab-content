...
Any extensive category admits a [[Grothendieck topology]] whose [[cover|covering families]] are (generated by) the families of inclusions into a coproduct (finite or small, as appropriate).  We call this the **extensive [[coverage]]** or **extensive topology**.  The self-indexing of any extensive category is a [[stack]] for its extensive topology.

In general, we call a [[site]] __superextensive__ if its underlying category is extensive, its covering families are generated by (finite or small) families, and its coverage includes the extensive one. (Here, the prefix 'super-' is opposite to 'sub-' as in '[[subset]]'; compare [[subcanonical site]].) In this case, one can replace any (finite or small) covering family $(j_i: U_i \to B)_i$ with the single map $[j_i]_i: \coprod_i U_i \to B$.  The original coverage is then generated by these single maps together with the extensive coverage.

Well known examples of infinitary superextensive sites include [[Top]] and [[Diff]] with their usual topologies, generated by the open covers.  Also, the [[coherent topology]] on any extensive coherent category is (finitely) superextensive, and thus generated by the extensive topology together with the [[regular topology]].
