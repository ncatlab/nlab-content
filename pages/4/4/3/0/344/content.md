...
An __finitely extensive category__ (which is the more usual unqualified meaning of __extensive category__) is a category $E$ with finite [[coproduct|coproducts]] such that one, and hence all, of the following equivalent conditions holds:
...
An __infinitary extensive category__ is a category $E$ with all (small) [[coproduct]]s such that coproducts are disjoint and stable under pullback.  Similarly, a __$\kappa$-ary extensive category__ is one with disjoint and stable coproducts of size $\kappa$.  The unqualified term **extensive category** can refer to either the finitary or infinitary version, depending on the author.
