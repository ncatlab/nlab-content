...
\begin{proposition}
\label{NerveOfACategoryIsTwoCoskeletal}
The nerve $N(C)$ of a category is [[coskeleton|2-coskeletal]].
\end{proposition}
(e.g. [Duskin 1975, §0.18(b)](monadic+cohomology#Duskin75), [Joyal 2008, Cor. 1.2](quasi-category#Joyal08))
...
\linebreak
The [[simplicial nerve]] of a [[category]] (i.e. of a [[1-category]]) is a [[coskeleton|2-coskeletal]] [[simplicial set]] (Prop. \ref{NerveOfACategoryIsTwoCoskeletal}): The unique filler of the [[boundary of a simplex|boundary of an $n \geq 3$-simplex]] encodes the [[associativity]]-condition on [[n-tuple|$n$-tuples]] of composable morphisms.
...
In fact, a [[simplicial set]] is the [[nerve]] of a [[category]] iff it has *unique* [[inner horn|inner $n$-horn]]-fillers for $n \geq 2$ (Prop. \ref{sSetIsNerveOfCategoryIffAllInnerHornsHaveUniqueFillers}).
...
Similarly for [[groupoids]] (byProp. \ref{sSetIsNerveOfGroupoidIffAllHornsHaveUniqueFillers}):
