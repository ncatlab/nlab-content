...
(It's important that the cross product is [[alternating form|alternating]], so that it makes sense to apply it to a $k$-vector rather than to $k$ individual vectors.)
