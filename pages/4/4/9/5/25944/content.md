...
A [[topological space]] $(X,\tau)$ is called an **accessible topological space** or an **$T_0$-topological space** if it is both a [[Kolmogorov topological space]] and a [[symmetric topological space]]. Or equivalently, if its [[specialization preorder]] is [[equality]]. 
