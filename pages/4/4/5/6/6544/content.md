...
Joke as it may be, the quote above is very nearly the truth. The missing ingredient are conditions to _guarantee_ that the process terminates; formally, what we need are _base cases_ and a [[well-founded relation]] on the domain on which we are recursing.
