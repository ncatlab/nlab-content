...
Let $X$ be an [[orientation|oriented]] [[connected topological space|connected]] [[smooth manifold]] of [[finite number|finite]] [[dimension]]. Let $n=\dim X$ and write $\Omega^n_{cp}(X)$ for the [[vector space]] of [[differential n-forms]] with [[compact support]] and
