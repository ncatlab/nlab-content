...
* For $U = \coprod_i U_i$ the disjoint union of over a covering [[sieve]] $\{U_i \to X\}$ with respect to a [[coverage]], the objectwise [[simplicial homotopy group|connected components]] of the Cech nerve is the subfunctor corresponding to the sieve
  $$
