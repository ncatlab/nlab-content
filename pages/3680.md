...
But beware that this convention is not universal
(for instance [[Lurie]]'s work is a notable exception to this rule):
...
* [[Lurie]]'s [[Kerodon]]: colimit-preserving: _right cofinal_ ([Tag 02N1](https://kerodon.net/tag/02N1)); limit-preserving ([[initial (∞,1)-functors]]): _left cofinal_.
