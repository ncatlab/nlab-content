...
The category of [[descent]] data $\mathrm{Desc}(S/R)$ for the categories of right modules along $k$-algebra extension $R\to S$ can be expressed solely in terms of the canonical coring $(C,\Delta,\epsilon)$ as the category of right $C$-comodules.
