...
1920-s for a  construction that starts with a space and an open cover of it and builds a [[simplicial complex]]. 
...
a homology theory in the sense of Steenrod-Eilenberg axioms. It is also not the (Alexander-Spanier) dual of Čech cohomology.  The two problems  can be avoided at the same time using coherent homotopy theory. The resulting homology is one which is exact.  It alsois one that satisfies the wedge axiom, and then it is the unique such theory, nowadays sometimes called [[strong homology]] and in special cases it reduces to what was called [[Steenrod-Sitnikov homology]] (but which was originally constructed in a different way).
