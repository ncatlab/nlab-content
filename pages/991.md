...
form a [[simplicial set]], $C(X,\alpha)$, whose $n$-[[simplex|simplices]] are $(n + 1)$-strings
of open sets  from $\alpha$, i.e. $\langle U_0, \ldots, U_n\rangle$, each $U_i \in \alpha$,
satisfying $\cap U_i \neq \emptyset$.

+-- {: .query}
The word [[Cech nerve|nerve of a covering]] has been used in late 
...
* see [[Cech cohomology]] for more on this.
