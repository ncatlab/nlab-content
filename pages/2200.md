...
__Note on notation.__  The sign &ldquo;$\text{&#x232D;}$&rdquo; is used here to indicate an order of relation composition, in particular, function composition, where $f \:\text{&#x232D;}\: g$ means that a relation of the form $f \subseteq X \:\times\: Y$ is composed with a relation of the form $g \subseteq Y \:\times\: Z$.
