...
Furthermore $KK$ naturally refines to an [[enriched category]] over the [[monoidal category of symmetric spectra]] ($\sim$ [[stable (infinity,1)-category]]) ([Joachim-Stolz 09](#JoachimStolz09) [Mitchener 07](#Mitchener07)).
...
Refinement of the KK-category to a [[spectrum]]-[[enriched category]] ($\sim$ [[stable (infintiy,1)-category]]) is in 
