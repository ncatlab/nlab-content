...
A generalization of this, where one algebra $C(Y)$ is generalized to $C(Y) \otimes A$ for $A$ a unital separable $C^\ast$-algebra, is in 

* [[Jonathan Block]], S. Weinberger, _Arithmetic manifolds of positive scalar curvature._, J. Diff. Geom. 52, no. 2, 375–406 (1999).
...
* G. Corti˜nas and A. Thom, _Bivariant algebraic K-theory_. J. Reine Angew. Math. 510 (2007), 71–124.
