...
###Note
This entry is entitled 'spherical objects and Pi(A)-algebra' as the title environment conventions for entry names do not allow for Latex within the name.
