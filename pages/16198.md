...
which hence vanishes if the [[vacuum state]] is supersymmetric, hence if supersymmetry is not [[spontaneous symmetry breaking|spontaneously broken]].

Conversely, this means that supersymmetry, as opposed to ([[gauge symmetry|gauge]]) [[symmetries of the Lagrangian]] not related to [[gravity]], is broken by a positive vacuum energy 

(e.g [Witten 81, (3), (4)](#Witten81))

<img src="https://ncatlab.org/nlab/files/SupersymmetryBreaking.png" width="800">
