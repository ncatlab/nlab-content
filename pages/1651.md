A space is **locally path-connected** if it has a basis of [[connected space|path-connected]] [[neighbourhood]]s. In other words, if for every point $x$ there exists a path-connected open set $U$ that contains $x$.
