...
(Only if the map $\widehat R \to R$ is finite, such as for [[Weil  algebras]], then this may be cast as "epimorphism with nilpotent kernel", by [[Stacks Project]] [lemma 10.106.6](http://stacks.math.columbia.edu/tag/04VM).)
