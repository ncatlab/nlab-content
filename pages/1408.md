...
Let $S$ be an $(\infty,1)$-[[site]], i.e. some small [[(∞,1)-category]] equipped with a [[coverage]], and let $Sh(S)$ be the [[(∞,1)-topos]] of [[(∞,1)-category of (∞,1)-sheaves]] on $S$. 
...
A helpful general introduction as well as a detailed discussion of the special case of [[derived smooth manifold]]s is in 

* **DerSmooth** David Spivak, _Quasi-smooth derived manifolds_ ([arXiv](http://arxiv.org/abs/0810.5174), [blog](http://golem.ph.utexas.edu/category/2008/08/david_spivak_on_derived_manifo.html))
