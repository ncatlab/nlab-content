...
for this purpose. Fix a formula $\phi$. 
...
ii. in s&#x12CB; there is a morphism $\tau:T^\leq_\bullet\to M_\bullet$ such that
    for each tuple $k$-tuple $v_1,..,v_k$, for each $k$, 
     of immediate descendants of a single vertex, 
...
This implies that ii. and iii. are equivalent. \end{proof}

A similar reformulation might exist for 
