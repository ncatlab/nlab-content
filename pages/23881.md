...
In a [[finitely complete category]] $C$, a **bicartesian closed preordered object** is a [[bicartesian preordered object]] $(X, s, t, \rho, \tau_p \wedge, \top, \tau, \lambda_l, \lambda_r, \vee, \bot, \beta, \kappa_l, \kappa_r)$ with a morphism $(-)\Rightarrow(-):X \times X \to X$ and functions
