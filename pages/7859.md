...
1. For $R$ a connective $E_\infty$ ring, any Azumaya $R$-algebra $A$ is &eacute;tale locally trivial: there is an [[etale topology|etale cover]] $R \to S$ such that $A \wedge_R S \stackrel{Morita \simeq}{\to} S$.
   ...
   (Think of this as saying that an Azumaya $R$-algebra is &eacute;tale-locally a Matrix algebra, hence Morita-trivial: a "bundle of compact operators" presenting a (torsion) $GL_1(R)$-2-bundle).
