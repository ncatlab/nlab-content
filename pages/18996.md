...
\begin{eqnarray*}
H \wedge \alpha_{\widehat{i_1\cdots i_{\ell_0}}} &=& \sum_{i=1}^{k} \beta_i \wedge \alpha_i \wedge \alpha_{\widehat{i_1\cdots i_{\ell_0}}} \\
&=& \sum_{j=1}^{\ell_0} (-1)^{i_j+j}\beta_{i_j} \wedge \alpha_{\widehat{i_1\cdots \widehat{i_j}\cdots i_{\ell_0}}} \\
&=& \sum_{j=1}^{\ell_0} (-1)^{i_1 + \cdots + i_{\ell_0}+\ell_0+j+1}\beta_{i_j} \wedge \\ && \left(H \wedge \gamma_{i_1\cdots \widehat{i_j}\cdots i_{\ell_0}}+\sum_{k=1}^{j-1}(-1)^{k+1}\beta_{i_k}\wedge \gamma_{i_1\cdots \widehat{i_k} \cdots \widehat{i_j} \cdots i_{\ell_0}} + \sum_{k=j+1}^{\ell_0}(-1)^k\beta_{i_k}\wedge \gamma_{i_1\cdots \widehat{i_j} \cdots \widehat{i_k} \cdots i_{\ell_0}}\right) \\
