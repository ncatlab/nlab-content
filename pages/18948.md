...
This is far more general than is usually assumed. One can additionally assume that either $X_1$ is locally compact or $X_0$ is locally compact, or that $X_0$ is Hausdorff or $X_1$ is locally Hausdorff, or that $X_1$ is [[sigma-compact|σ-compact]]
