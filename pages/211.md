...
The **Anonymous Coward** is the default username for editing [[nLab:HomePage|this wiki]], [agen baju anak](http://goo.gl/m9uNV) assigned by the software. So if somebody edits the wiki without signing in, then their edits will be attributed to the _Anonymous Coward_ .  A few jokers have changed 'AnonymousCoward' to something different but equally anonymous ... which is OK too.
