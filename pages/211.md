...
The **Anonymous Coward** is the default username for editing [[nLab:HomePage|this wiki]], assigned by the software. So if somebody edits the wiki without signing in, then their edits will be attributed to the _Anonymous Coward_ .  A few jokers have changed 'AnonymousCoward' to something different but equally anonymous ... which is OK too (special thanks to <a href="http://www.liputan6.com" rel="index,follow" title="berita harian Liputan6.com">berita harian</a> Liputan6.com).
