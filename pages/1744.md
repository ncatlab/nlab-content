...
\linebreak
The [[simplicial nerve]] of a [[category]] (i.e. of a [[coskeleton|1-category]]) is a [[coskeleton|2-coskeletal]] [[simplicial set]] (e.g. [Duskin 1975, §0.18(b)](monadic+cohomology#Duskin75), [Joyal 2008, Cor. 1.2](quasi-category#Joyal08)).
Beware that the converse fails: Not every 2-coskeletal simplicial set is the nerve of a category. For example the [[boundary of a simplex|boundary]] $\partial \Delta^2$ is 2-coskeletal but not the nerve of a category, since it is missing a [[composition]] of the edges $0 \to 1 \to 2$, namely it is missing a filler of this [[inner horn]].


So a simplicial set is the nerve of a [[1-category]] iff it is 1. an [[inner Kan complex]] and 2. [[coskeleton|2-coskeletal]] (cf. e.g. [[Higher Topos Theory|Lurie 2009, Def. 2.3.4.1]]).

In particular, a simplicial set is the nerve of a [[1-groupoid]] iff it is 1. a [[Kan complex]] and 2. [[coskeleton|2-coskeletal]]. 
\end{example}
