...
Because of the first clause, we really do not need to mention $O$ in the data except to cover the possibility that $\alpha = 0$.  (In that case, the composite is just $O$.)
