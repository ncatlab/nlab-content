...
In [[nuclear physics]] ([[quantum chromodynamics]]) the _Cheshire cat principle_ ([NNZ 85](#NNZ85)) is the observation that in the [[quark bag model]] for [[confinement|confined]] [[quarks]] inside [[hadrons]] the [[radius]] of the "bag" is not actually [[observable]]. Hence the "bag" of the the bag model disappears, leaving only its [[confinement|confined]] content behind, whence the colorful term. 
