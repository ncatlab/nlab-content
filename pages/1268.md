...
In as far as an $O$-modules on a [[ringed site]] $(X, O)$ can be interpreted as a ([[sheaf]] of sections of a) vector bundle on $X$, a D-module can be interpreted as a ([[sheaf]] of sections of a) vector bundle on $X$: 
