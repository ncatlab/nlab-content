...
For $Y := \coprod_i U_i$ a cover, there is a [[simplicial presheaf]] $ Y_\bullet$ -- the [[Čech nerve]] of the cover -- that in degree $n$ is the $(n+1)$-fold [[fiber product]] $Y_n = Y^{[n+1]} = Y \times_X Y \times_X \cdots \times_X Y$.
