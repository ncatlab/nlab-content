...
Segal categories were defined in 1974 (implicitly) by [[Graeme Segal]]. They were named Segal categories first by William Dwyer--[[Daniel Kan]]--Jeffrey Smith in 1989. In their famous book _Homotopy invariant algebraic structures on topological spaces_, John Boardman and Rainer Vogt called them [[quasi-category|quasi-categories]]. A quasi-category is a simplicial set satisfying the weak Kan condition, so quasi-categories are also called [[weak Kan complex]]es.
