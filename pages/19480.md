...
For the second statement, consider the case that $Y$ is $W$-local. Since by [[idempotent monad|idempotency]] (Prop. \ref{ModalOpIdempotent}) the [[adjunction unit]] $\eta_Y$ is in $W$, this implies that we have a [[bijection]] of the form
