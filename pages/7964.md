...
Curiously, the Higgs [[potential energy|potential]] is such that the Higgs field at this mass it at least close to being in a [[false vacuum]] ([DVEEGI 12](#DVEEGI12)):

[[HiggsVacuumStability.png:file]]

<img src="https://ncatlab.org/nlab/files/HiggsVacuumStability.png" width="700">

More detailed computation confirms this result, showing that the observed Higgs vacuum is indeed very close to the boundary between the stable and the meta-stable region:
...
Speculation about what this near-criticality of the Higgs vacuum could be pointing to includes ([BDGGSSS 13, section 7](#BDGGSSS13)).
