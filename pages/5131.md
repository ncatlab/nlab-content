...
Our second case will be (3,2).  Again we will write $(i,j,k)$ instead of $i<j<k$ in order to save confusion over the various different orders being considered.  The shuffle poset, $\mathrm{Shuff}(3,2)$, has Hasse diagram given below:
