...
* The archetypical and motivating class of examples is: $X$ a [[topological space]], $S_X = Op(X)$ the [[category of open subsets]] of $X$ with its standard [[Grothendieck topology]] and $O_X := C(-,\mathbbb{R})$ the sheaf of continuous functions with values in (say) the real numbers.
