...
**Van Kampen Theorem** _If $A$ meets each path component of each three-fold intersection of the $U_i$ then (Conn) $A$ meets each path-component of $X$; and (Iso) $c$ is the coequaliser of $a,b$ in the category of groupoids._

Note:1. _three-fold_ here includes two- and one-fold! 
