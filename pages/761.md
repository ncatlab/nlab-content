...
The *Seifert-van Kampen theorem* is a classical theorem in [[algebraic topology]] which computes the [[fundamental group]] of a [[topological space]] in terms of a decomposition into [[open subsets]].
...
Applications to $1$-dimensional homotopy theory are given in:

*[[Ronnie Brown]] _Topology and Groupoids_, Booksurge (2006). 
([web page] <http://pages.bangor.ac.uk/~mas010/topgpds.html>)
