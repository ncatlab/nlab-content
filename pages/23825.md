...
This current definition actually define supercommutative super rings, so aren't actually super rings. 
...
* for all $a:R$, and $b:R$, $\mathcal{D}_0(a \cdot b) = \mathcal{D}_0(a) \cdot \mathcal{D}_0(b)$
* for all $a:R$, and $b:R$, $\mathcal{D}_1(a \cdot b) = \mathcal{D}_1(a) \cdot \mathcal{D}_1(b)$
