...
for the _variational Lie derivative_ along $v$, analogous to [[Cartan's homotopy fomula]] (prop. \ref{CartanHomotopyFormula})
...
$$
  \begin{aligned}
    ...
    \Leftrightarrow
    & 
    \delta \iota_v \Theta_{BFV} + \iota_v \undderset{= \Omega_{BFV}}{\underbrace{\delta \Theta_{BFV}}} = \delta \tilde H_v
    \\
    \Leftrightarrow
    & 
    \delta \left(
...
$$
  \iota_{v_1} \iota_{[v_2, v_3]^{var}}   \Omega_{BFV} + (cyclic) = 0
$$
