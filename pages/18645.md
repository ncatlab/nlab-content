...
of the "two-component spinor notation" that is traditionally used in physics texts. spring
...
Then we say that the difference vector $v$ is
...
This concludes our discussion of [[spin]] and [[spacetime]]. In the [next chapter](#FieldBundles) we cosider the concept of _[[field (physics)|fields]]_ on [[spacetime]].
