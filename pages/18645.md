...
* the hermitian matrix $A = \left( \array{  -x_0 + x_1 & \vec x  \\ \vec x^\ast & -x_0 - x_1 } \right)$ regarded
...
[[differential forms]]; we write its [[de Rham differential]] (def. \ref{deRhamDifferential}) in boldface:
...
and all of these are odd-graded elements in a [[Grassmann algebra]], hence anti-commuting.
...
See for instance ([Dermisek I-9](Dirac+field#Dermisek)).
