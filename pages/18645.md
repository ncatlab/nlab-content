...
available for the analysis of [[field theory]], notably the theory of _[[propagators]]_, such as _[[Feynman propagators]]_, which we turn to 
...
Among the polynomial on-shell observables characterized thereby, the focus is furthermore on the _[[local observables]]_:
...
Under passing to [[dual vector spaces]] this in turn yields linear isomorphism
...
###### Theorem
**(linear [[observables]] of [[Green hyperbolic differential operator|Green]] [[free field theory]] are the [[distributional solution to a PDE|distributional solutions]] to the [[formally adjoint differential operator|formally adjoint]] [[equations of motion]])**
...
1. The _$P$-Peierls bracket_ is the [[bilinear map]]
   ...
   $$
     \array{
       \Gamma_{\Sigma,cp}(E^\ast) \otimes \Gamma_{\Sigma,cp}(E^\ast)
         &
           \overset{
