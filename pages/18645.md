...
###### Proposition
**(plots of a smooth set actually are the smooth functions into the smooth set)**
...
For $k = 1$ the smooth set $\mathbf{\Omega}^0$ actually is a [[diffeoloigal space]], in fact
...
For $k \in \mathbb{N}$ there is a canonical [[morphis]] of [[smooth sets]] of the form
...
That this satisfied the compatibility with precomposition of plots
