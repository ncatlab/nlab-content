...
We will eventually consider [below](#FieldBundles) much more general "[[smooth spaces]]" than just the [[Cartesian spaces]] $X$;
...
We introduce [[Minkowski spacetime]] of dimension 3,4,6 and 10, naturally expressed in terms of the
...
is _[[Minkowski spacetime]]_ as such.
...
"two-component spinor notation" as follows:
...
* an element of $S = S_+ \oplus S_-$ is denoted $(\psi^\alpha) = \left( (\chi_a), (\xi^{\dot a}) \right)$ and called a _[[Dirac spinor]]_;
...
(e. g. [Hörmander 90, theorem 4.1.5](non-singular+distribution#Hoermander90#Hoermander90))
