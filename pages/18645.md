...
$\Phi_{(-)}(-)  U \times X \times Y$ an ordinary [[differential n-form]] on $U$, suggestively denoted 
...
of the background solution $\varphi$ (eq:FunctionsOnInfinitesimalNeighbourhoodOfBackgroundSolition) to the BV-complex  
...
By inspection we find that the [[cochain cohomology]] of the [[BV-complex]] 
...
$$
  \begin{aligned}
    H^0(\Omega^{0,0}_\Sigma(E,\varphi)\vert_{\mathcal{E}_{BV}})
      & \simeq
    \Omega^{0,0}_{\Sigma}(E,\varphi)\vert_{\mathcal{E}}
  \end{aligned}
$$
