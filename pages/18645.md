...
a smooth [[tangen vector field]] (example \ref{TangentVectorFields}).
...
$U \times \Sigma \overset{pr_1}{\longrightarrow} U$ (def. \ref{DifferentialForms}) (def. \ref{IntegrationOfDifferentialFormsOverSmoothSingularChainsInCartesianSpaces})
