...
Stated more [[category theory|abstractly]], this statement is an example of the _[[Yoneda lemma]]_
...
beome, upon squaring them, not just tinier, but actually zero:
...
(Stated more [[category theory|abstractly]], this is an instance of the _[[Yoneda lemma]]_ over a _[[subcanonical site]]_.)
...
We explain now how we may recover the concepf of [[smooth manifolds]] inside the much more general [[formal smooth sets]].
