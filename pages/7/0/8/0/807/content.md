...
Specifically, whereas cardinality counts elements in a set, the Euler characteristic counts [[object]]s up to [[equivalence]]s, up to [[2-morphism|2-equivalence]]s, up to [[3-morphism|3-equivalence]], and so on.  For that reason it has also come to be known as [[groupoid cardinality]].
...
### Homotopical Euler characteristic ($\infty$-groupoid cardinality)
