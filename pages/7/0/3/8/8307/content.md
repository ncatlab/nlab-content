...
For $A, B$ two [[abelian groups]], their **tensor product of abelian groups** is the abelian group $A \otimes B$ which is the [[quotient]] of the [[free abelian group]] on the [[product]] of their underlying sets $A \times B$
...
Equipped with the tensor product $\otimes$ of def. \ref{ExplicitTensorProduct} and the exchange map $\sigma_{A, B}: A\otimes B \to B \otimes A$ generated by $\sigma_{A, B}(a, b) = (b, a)$, [[Ab]] becomes a [[symmetric monoidal category]]. 
