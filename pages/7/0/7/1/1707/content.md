...
#### Cohomology of $\mathbb{Z}_2^n$

The cohomology of $\mathbb{Z}_2^n$ with coefficients in $\mathbb{Z}_2$ admits a very simple description (see ([p.66 of Adem & Milgram (2004)](#AM04finite))). There exists a ring isomorphism
$$
H^{\bullet} (\mathbb{Z}_2^n ,\mathbb{Z}_2 ) \cong \mathbb{Z}_2 [e_1 ,\cdots,e_n ]
$$
of the cohomology ring $H^n (\mathbb{Z}_2^n,\mathbb{Z}_2 )$ to the polynomial ring of $n$ commuting variables with coefficients in $\mathbb{Z}_2$. Furthermore, each cohomology group $H^q (\mathbb{Z}_2^n,\mathbb{Z}_2 )$ is generated by the classes of the functions:
$$
(x^{(1)},\cdots, x^{(q)} )\mapsto x^{(1)}_{i_1}\cdots x^{(q)}_{i_q}
$$
with $i_1 \leq \cdots \leq i_q$, where each argument $x^{(j)}\in \mathbb{Z}_2^n$ is an $n$-tuple $(x^{(j)}_1 ,\cdots, x^{(j)}_n )$. 
...
*  {#AM04finite} [[Alejandro Adem]], [[R. James Milgram]], _Cohomology of Finite Groups_, Springer 2004
