...
Another usage of equality is in the computation rules and uniqueness rules for the various type formers, such as [[beta conversion]] or [[eta conversion]] (the choice of rules depends on the type theory). The usage of equality in this manner is called *computational*, *conversional*, or *reductional* equality, and is the congruence on terms generated by the conversion or reduction rules. 
