...
Let $\mathcal{T}$ be a [[triangulated category]] such that in addition to the existence of [[direct sums]] ([[additive category|additivity]]) the objectwise direct sum of any two distinguished triangles is itself a distinguished triangles ([B&#246;kstedt-Neeman 93, def. 1.2](#BokstedtNeeman93)).
