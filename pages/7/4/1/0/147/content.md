...
The structure of a **site** on a category $C$ is a structure that regards each object of $C$ as a space and determines which morphisms from collections of objects of $C$ to a given object of $C$ behave as _covers_ of spaces.
