...
This states that the article "should have been written" in terms of [[smooth infinity-stacks]]. For references that do so see for instance at _[[differential cohomology hexagon]]_ the [list of references](differential+cohomology+diagram#References).
