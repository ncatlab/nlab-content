...
Clearly for the cylinder nothing special happens to the fibers as one moves around the cricle (one says this is a _trivial vector bundle_) while the M&#246;bius strip is "locally trivial" but globally has a twist: as one moves once around the circle the original fiber comes back identified with its reflection at the origin.
...
An important class of exmaples of vector bundles are [[tangent bundles]] of [[differentiable manifolds]] $X$. Here the [[vector space]] at each point of $X$ is the [[tangent space]] of that point, the space of all [[tangent vectors]] based at that point. The graphics on the right shows one of the tangent space of the [[2-sphere]].
