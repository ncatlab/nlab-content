...
for the [[Hilbert space]] of single-electron [[wavefunctions]], being [[square-integrable functions]] on the ambient $d$-[[Euclidean space]] 
...
In the computations practice of computing [[ground states]] etc. in [[solid state physics]], one tries to use as few multi-indices $\mathcal{I}$ as possible:
