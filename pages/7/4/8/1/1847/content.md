...
Often one requires a paracompact space to be [[Hausdorff space|Hausdorff]] as well. The term _paracompactum_ accordingly often denotes a paracompact and Hausdorff space. This convention is in line with that for compact spaces, see the remark [there](compact+space#DifferingTerminology).
