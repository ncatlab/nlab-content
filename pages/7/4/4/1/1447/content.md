...
Another perspective is that a geometric embedding $F \hookrightarrow E$ is the [[localization]] of $E$ at the class $W$ of morphisms that the [[left adjoint]] $E \to F$ sends to isomorphisms in $F$.
