...
The "foundational" work tries to find the best foundational theory to formalize mathematics (see also at _[[foundations of mathematics]]_). Out of that work first came [[dependent type theory|dependent types]] ([[Automath]], in the late 60s), then the [[calculus of constructions]] (early [[Rocq]]), and the [[calculus of inductive constructions]] (current [[Rocq]]). More recently a new wave of such work is being done in [[homotopy type theory]] as another step in this direction. Rocq's library is not that large, except in the area of [[group theory]] where the results of the work on [[Feit-Thompson theorem]] has produced something larger.
