...
The axiom of __subset collection__ combines fullness with of the [[axiom of collection]] to apply in the situations where fullness is used.  In the presence (I think) of either collection or [[axiom of separation|separation]], subset collection is equivalent to fullness.
...
In the presence of the usual basic axioms of set theory (in particular, the axioms of [[axiom of separation|bounded separation]] and [[axiom of pairing|pairing]] in a material set theory and the existence of [[equalisers]] and [[products]] in a structural set theory), we have:
