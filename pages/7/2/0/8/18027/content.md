...
Given a [[language]] $L$ generated by a set of (single-sorted) finitary operations, and a [[class]] $C$ of [[structure in model theory|structures]] for $L$. Then $C$ is the class of models for a set of universally quantified equations between terms of $L$ (a [[Lawvere theory]]) if and only if 
