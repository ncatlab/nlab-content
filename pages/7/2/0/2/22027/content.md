...
it is not itself [[cartesian monoidal category|cartesian]], but just [[symmetric monoidal category|symmetric monoidal]]. 
...
\begin{proposition}
  ...
  makes the [[symmetric monoidal category]] (eq:SmashMonoidalCategoryOfPointedTopologicalSpaces) of [[pointed topological spaces]] with [[smash product]] a [[monoidal category with diagonals]], in that
...
the smash-monoidal diagonal structure (eq:SmashMonoidalDiagonalOnSuspensionSpectra) on suspension spectra serves to define the [[cup product]] $(-)\cup (-)$ in the corresponding [[multiplicative cohomology theory|multiplicative cohomology theory structure]]:
