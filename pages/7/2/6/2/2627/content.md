...
The analog role in 2-rigs to the role played by the [[natural numbers]] among ordinary [[rigs]] should be played by the standard [[categorification]] of the natural numbers: the [[category of finite sets]], or at least its [[core]]. One is therefore inclined to demand that a reasonable definition of 2-rigs should be such that $Core(FinSet)$ is the [[initial object]] (in the suitably higher categorical sense) in the [[2-category]] of 2-rigs. 
