...
In [[physics]], given a [[physical system]] then its _space of [[field histories]] (e.g. _[[trajectories]]_ for [[sigma models]]) is the [[space]] of all ways that the system may be configured in space and _[[time]]_, hence in _[[spacetime]]_. 
