...
This was proved by Dyer and Eilenberg in [MR0963792][] and applied to the question of fibrations over numerable spaces.
...
+-- {: .num_theorem #schthm}
###### Theorem
Let $X$ be a [[topological space]].  Let $\mathcal{U}$ be a [[locally finite]] [[open covering]] of $X$ by [[numerable]] open sets with indexing set $A$.  Then there is a [[local covering]] $\mathcal{F}$ of $P X$ and a family of [[continuous functions]] $f \colon F \to S A$, indexed by $F \in \mathcal{F}$ such that:
