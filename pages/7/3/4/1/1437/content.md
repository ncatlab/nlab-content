...
Ad&#225;mek's theorem may be adapted to this 2-categorical situation. The iterated wreath product $(Set \wreath)^n 1$ may be identified with the category of $n$-stage trees: 

$$(Set \wreath)^n 1 = Set^{[n]^{op}}$$ 
...
$$\Sigma: Set \wreath Set^{[n]^{op}} \simeq Set^{[n+1]^{op}}$$ 
...
$$(Set \wreath)^n !: (Set \wreath)^n Set \to (Set \wreath)^n 1$$ 
