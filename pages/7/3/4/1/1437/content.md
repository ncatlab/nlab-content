...
Ad&#225;mek's theorem may be adapted to this 2-categorical situation. The iterated wreath product $(Set &#8768;)^n 1$ may be identified with the category of $n$-stage trees: 
...
$$\Sigma: Set &#8768; Set^{[n]^{op}} \simeq Set^{[n+1]^{op}}$$ 
