...
which discusses the theory of [[(∞,1)-categories]] in general and that of $(\infty,1)$-categories of $(\infty,0)$-category valued [[sheaf|sheaves]] -- called (Grothendieck-Rezk-Lurie) [[(infinity,1)-topos|(∞,1)-topoi]] -- in particular.
...
for more on $\infty$-sheaves (usually known as [[∞-stacks]]) see
...
The book _Higher topos theory_ together with Lurie's work on [[Stable ∞-Categories]] is pretty much exactly the $(\infty,1)$-categorical analog of the 1-categorical material as presented for instance in
