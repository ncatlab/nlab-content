...
Based on work by Andr&#233; Joyal on the [[quasi-category]] model for [[(infinity,1)-category|(infinity,1)-categories]], Lurie presents a comprehensive account of the theory of [[(infinity,1)-category|(infinity,1)-categories]] including the definitions and properties of all the standard items familiar from category theory (limits, fibrations, etc.)
