...
* As trivial examples, any [[initial object]] or [[terminal object]] is rigid, as is every object of a [[poset#AsACategoryWithExtraProperties]].

* In [[graph theory]], a rigid object in a category of undirected graphs is called an _asymmetric graph_.
