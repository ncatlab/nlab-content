...
* Page titles should contain only ASCII characters.
  ...
  * PS: If you would like to be a rebel and create a page using symbols in the title anyway, one way to do so is to copy the symbol from somewhere within a page and paste it into the double brackets; e.g., `[[∞-category]]` produces '[[∞-category]]'.
