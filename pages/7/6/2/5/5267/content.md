...
But in the case that $V$ is an infinite-dimensional complex [[separable Hilbert space]], the ([[normal eigenvalue|normal]]) eigenvalues only form the *[[discrete spectrum]]*.  Instead, the full spectrum is the set of all $\lambda \in \mathbb{C}$ for which the [[resolvent]] $(A-\lambda I)^{-1}$ is not a [[bounded operator]]. 
...
* [[Valter Moretti]], _Spectral Theory and Quantum Mechanics_, Springer (2017) &lbrack;[doi:10.1007/978-3-319-70706-8](https://doi.org/10.1007/978-3-319-70706-8)&rbrack;
...
[[!redirects spectra of operators]]

[[!redirects spectrum of a linear operator]]
[[!redirects spectra of linear operators]]

[[!redirects operator spectrum]]
[[!redirects operator spectra]]
