...
### By iterated wreath product

([Berger](#Berger))

### Relation to products of simplices
...
for the functor canonically induced from the wreath product presentation of $\Theta_n$.
...
$\Theta_n$ is the smallest [[full subcategory]] of $Str n Cat_{gaunt}$ containing the image of $\delta_n : \Delta^{\times n}$ and closed under [[retracts]].
...
A characterization in terms of $n$-fold [[wreath product]]s is in 
