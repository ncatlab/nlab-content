...
The origin of all [[string phenomenology]] is the [[top-down model building|top-down approach]] in the [[heterotic string]] due to ([Candelas-Horowitz-Strominger-Witten 85](heterotic+string#CHSW85)).
