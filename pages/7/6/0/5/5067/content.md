...
(Should link this to some discussion on the relevant adjunction: this [[free functor]] is [[left adjoint]] to the closed-unit ball functor.) Then $\ell^1(S)$ is a projective Banach(able) space.
...
Put another way: as we (will) have defined it above, projectivity of a Banach space $P$ is stronger than merely asking that the functor $\operatorname{hom}(P,\cdot)$ preserves [[epimorphism]]s...
