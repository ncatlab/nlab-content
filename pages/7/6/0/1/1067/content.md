...
By the [[Dold-Kan correspondence]] there is an equivalence between the category of *[[connective chain complex|connective]] chain complexes of abelian groups* and the category of [[abelian simplicial groups]]* (i.e. [[simplicial objects]] in $Ab$). The functor
