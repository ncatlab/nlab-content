...
Then given a type $U$, the cover relation is a higher inductive type family $a \lhd_U e$ between elements $a:A$ and [[embeddings of types]] $e:U \hookrightarrow A$ generated by the constructors 

$$\frac{\Gamma \vdash a:A \quad \Gamma \vdash U \; \mathrm{type} \quad \Gamma \vdash e:U \hookrightarrow A \quad \Gamma \vdash p:\exists x:U.e(x) =_A a}{\Gamma \vdash \mathrm{dir}_U(a, e, p):a \lhd_U e}$$

$$\frac{\Gamma \vdash a:A \quad \Gamma \vdash U \; \mathrm{type} \quad \Gamma \vdash e:U \hookrightarrow A \quad \Gamma \vdash b:B(a) \quad \Gamma \vdash f:\prod_{c:C(a, b)} d(a, b, c) \lhd_U e}{\Gamma \vdash \mathrm{branch}_U(a, e, b, f):a \lhd_U e}$$

$$\frac{\Gamma \vdash a:A \quad \Gamma \vdash U \; \mathrm{type} \quad \Gamma \vdash e:U \hookrightarrow A \quad \Gamma \vdash p:a \lhd_U e \quad \Gamma \vdash q:a \lhd_U e}{\Gamma \vdash \mathrm{squash}_U(a, e, p, q):p =_{a \lhd_U e} q}$$
...
$$\frac{\Gamma \vdash a:A \quad \Gamma \vdash U \; \mathrm{type} \quad \Gamma \vdash e:U \hookrightarrow A \quad \Gamma \vdash b:B \quad \Gamma \vdash p:f(b) =_A a \quad \Gamma \vdash h:\prod_{c:C} (g(c) =_B b) \to (d(c) \lhd_U e)}{\Gamma \vdash \mathrm{branch}_U(a, e, b, p, h):a \lhd_U e}$$
