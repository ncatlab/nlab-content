...
If one doesn't have type universes, then given a type $I$, the cover relation for $I$ is a higher inductive type family $a \lhd_I e$ between elements $a:A$ and [[embeddings of types]] $e:I \hookrightarrow A$ generated by the constructors 
