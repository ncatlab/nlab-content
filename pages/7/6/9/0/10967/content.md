...
In other words when [[quantum physics]] is axiomatized by [[quantum logic]] in the guise of [[linear logic]]/[[linear type theory]], the content of "no-cloning" and "no-deleting" is (see [there](linear+logic#AsAQuantumLogic)) the very "linearity" of this logic, the absence of a [[diagonal]] map and of a [[projection]] map for the non-[[cartesian monoidal category|cartesian]] [[tensor product]] in the [[categorical semantics]] given by non-[[cartesian monoidal category|cartesian]] [[symmetric monoidal categories]] such as that of Hilbert spaces. See also at _[[quantum information theory via dagger-compact categories]]_.
...
* Wikipedia, *[No-deleting theorem](https://en.wikipedia.org/wiki/No-deleting_theorem)*

Discussion via [[quantum information theory via dagger-compact categories]]:

* [Abramsky 2009, Section 5](*Abramsky09)
