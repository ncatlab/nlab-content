...
Also, totality lifts along [[solid functors]]; that is, if the [[codomain]] of a solid functor is total, then so is its domain.  See Tholen's paper for a proof.  This implies that the following types of categories are total:
