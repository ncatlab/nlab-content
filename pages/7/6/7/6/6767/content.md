...
> This entry is superceded by _[[configuration space of points]]_. See there for more.
...
Given a [[manifold]] $M$, the __Fadell's configuration space__ (in [[topology]] called simply _[[configuration space]]_) is the manifold of $N$-tuples of pairwise distinct points in $M$.
...
See at _[[configuration space of points]]_ for more.
...
* [[Edward Fadell]], [[Sufian Husseini]], _Geometry and topology of configuration spaces_, Springer Monographs in Mathematics (2001), [MR2002k:55038](http://www.ams.org/mathscinet-getitem?mr=2002k:55038), xvi+313 pp.
