...
In informal mathematical speech and writing, a **numeral** refers to any notation or terms (for instance [[string (computer science)|strings]] of digits) which *denote* a [[natural number]]. In [[computer science]] one may say that a numeral is [[syntax]] whose [[denotational semantics]] is a [[number]] &lbrack;[Scott & Strachey (1971, §0)](#ScottStrachey71)&rbrack;.

Usually, in mathematics, this refers to [[decimal number|base ten place-value notation]], so that for instance $0$, $2$, $13$, and $890$ are numerals.

In [[type theory]], a **numeral** generally means (e.g. [Martin-Löf (1973)](#MartinLoef73)) a [[term]] whose [[type]] is the [[natural numbers type]] and which is of [[canonical form]].  The meaning of "canonical form" may vary with the formal theory, but with the usual presentation of the [[natural numbers]] as an [[inductive type]] generated by [[zero]] $0$ and the [[successor]] operation $s$, the numerals are the terms of the form
