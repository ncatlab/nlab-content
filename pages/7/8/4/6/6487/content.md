...
"But in the category of pure motives, from the start one dealt only with algebraic
cycles, represented by correspondences, and it was intuitively not at all clear how
on earth they could convey information about transcendental cycles. Indeed, the
main function of the "Standard Conjectures" was to serve as a convenient bridge
from algebraic to transcendental. Everything that one could prove without them
