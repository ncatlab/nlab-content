...
First, prime ideals in Boolean algebras (or Boolean rings) $B$ are the same as maximal ideals, and these just correspond to ultrafilters (see [here](/nlab/edit/Boolean+algebra#aremax)). So UF, which says that every filter in $B = P X$ 
