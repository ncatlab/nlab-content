...
Given a [[regular scheme]] $X$ and subschemes $Y,Z$ with defining ideal sheaves $\mathcal{I}_X,\mathcal{I}_Y$, respectively, the intersection multiplicity $m(x,Y,Z)$ at a generic point $x$ at the intersection $Y\cap Z$ us given by the Serre intersection (or multiplicity) formula in terms of torsion groups

$$
m(x,Y,Z) = \sum_{i\geq 0} (-1)^i length_{\mathcal{O}_{X,x}} Tor_i^{\mathcal{O}_{X,x}}
(\mathcal{O}_{X,x}/\mathcal{I}_{X,x},\mathcal{O}_{X,x}/\mathcal{I}_{Y,x)
$$
