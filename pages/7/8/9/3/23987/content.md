...
* {#ItaniFeb2025} 3 Feb 2025
  ...
  **Towards a Quantum Algorithm for Lattice Boltzmann (QALB) Simulation with a Nonlinear Collision Term**
  ...
  slides: [[ItaniAtCQTS-Feb2025.pdf:file]]

  cf. [arXiv:2304.05915](https://arxiv.org/abs/2304.05915)
...
* 05 May 2025 
  ...
  [Malo Cadoret](https://scholar.google.fr/citations?user=T5UevQgAAAAJ&hl=fr) (ONERA, The French Aerospace Lab, Centre de Palaiseau):
...
* {#GajjalaMay2025} 12 May 2025 

  [Rishikesh Gajjala](https://sites.google.com/view/rishikeshg) (NYUAD, CQTS):

  **Designing Quantum Experiments via Graph Theory**

  slides: [[Gajjala-CQTS-May2025.pdf:file]]

  > Greenberger–Horne–Zeilinger (GHZ) states are [[quantum states]] involving at least three [[quantum entanglement|entangled]] particles. They are foundational in [[quantum information theory]], with practical applications in [[quantum communication]] and [[quantum cryptography|cryptography]]. [Krenn, Gu, and Zeilinger discovered](https://arxiv.org/abs/1705.06646) a correspondence between a class of [[quantum optics|quantum‐optical]] experiments that produce GHZ states and edge‐weighted, edge‐coloured [[multigraphs]] called *GHZ graphs*. A graph parameter called dimension can be defined on such a graph, which equals the dimension of the GHZ state generated by the corresponding experiment. Constructing a GHZ graph with a large number of [[vertices]] and high dimension would be a major breakthrough, while proving the non‐existence of such graphs (and hence the experiments) has deep implications for quantum resource theory.

  > In this talk, I will present our results on this [[graph theory|graph‐theoretic]] question and how they translate to quantum experiments. When there is no destructive [[quantum interference|interference]], these experiments correspond to the special case of unweighted graphs. We provide a complete structural characterization of unweighted GHZ graphs for each dimension. In the more general (edge‐weighted) case, Cervera‑Lierta, Krenn, and Aspuru‑Guzik conjectured that the maximum dimension of an $n$-vertex GHZ graph is less than $n/2$. They verified this via SAT solvers for graphs with up to eight vertices, but nothing was known for larger values of n. We introduce a technique called local sparsification of GHZ graphs, with which we give the first analytical upper bound of $n/1.41$ on the dimension for simple GHZ graphs. Krenn and Gu made a stronger conjecture: that the dimension of any GHZ graph with more than four vertices is at most two (i.e., destructive interference does not help). We show that this holds for infinitely many graphs. Namely, graphs of vertex‐connectivity at most two and for all cubic graphs. Moreover, we prove that any minimal counterexample must be 4‑vertex‑connected. These structural insights both deepen our theoretical understanding and guide automated GHZ‐graph searches (e.g., via PyTheus).
...
* {#TrugenbergerFeb2025} 5 Feb 2025
  ...
  **Superinsulation: Magnetic Monopoles and Electric Confinement in Condensed Matter**
  ...
  slides: [[Trugenberger-CQTSFeb2025.pdf:file]]

  cf.: [arXiv:1807.01984](https://arxiv.org/abs/1807.01984), [arXiv:2008.12541](https://arxiv.org/abs/2008.12541), [arXiv:2207.00791](https://arxiv.org/abs/2207.00791)
...
* {#BonettiFeb25} 19 Feb 2025
  ...
  **Generalized global symmetries from string theory**
  ...
  slides: [[BonettiAtCQTS-Feb2025.pdf:file]]
...
* {#StoimenowOct2025} 27 Oct 2025
  ...
  **Strong quasipositivity, Thurston-Bennequin invariants, and arc index**
  ...
  cf.: [arXiv:2407.15859](https://arxiv.org/abs/2407.15859), and [further articles](https://stoimenov.net/stoimeno/homepage/papers.html)
...
* {#KubotaNov2025} 5 Nov 2025
  ...
  **Stable homotopy theory of invertible gapped quantum spin systems**
  ...
  slides: [[Kubota-CQTS-251105.pdf:file]]
...
* {#BolsNov2025} 12 Nov 2025
  ...
  **Sector theory for Levin-Wen models**
  ...
  slides: [[Bols-CQTS-Nov2025.pdf:file]]
...
* {#NeemanJan2026} 26 Jan 2026
  ...
  **Excellent metrics and enhancements **
  ...
  slides: [[Neeman-CQTS-2026.pdf:file]]
...
* {#Tellez-DominguezApr2026} 01 Apr 2026
  ...
  **$T_2$-Duality: Lifting Geometric T-Duality to M-theory via adjusted Lie 3-groups**
  ...
  slides: [[TellezDominguez-CQTS2026.pdf:file]]
