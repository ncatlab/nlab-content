...
> We hope to bring all this theoretical progress into contact with efforts to use (`L`)`HoTT` for actual ([[quantum computing|quantum]]) [[computing]], [[quantum simulation|simulation]] and [[software verification|verification]].
