...
The assgnment which takes a $Y \in Schemes$ to the [[spectrum of a ring|spectrum]] $Spec(-)$ of the [[global sections]] $\Gamma_Y(-)$ of its [[structure sheaf]] $\mathcal{O}_Y$
$$
  Y
   \mapsto 
  Spec\big(
...
More precisely, defines the category $AffSch$ of [[affine schemes]] as the [[opposite category]] of commutative (unital) rings.
