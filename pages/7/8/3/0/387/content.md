...
If the diagram is just commutative in the [[homotopy category]], that is not much use and one can do little with it.  Surprisingly often however, the homotopies involved in such a diagram's 'almost comutative' nature can be specified, but then the question arises as to whether those homotopies form some sort of diagram, so homotopies between composite homotopies become involoved. This begins to look like parts of 2-category theory, or rather '[[higher category theory|higher weak category theory]]' and the development of homotopy coherent category theory was initiated in an attempt to merge homotopy theory with categorical tools for handling higher categories.
...
ONE main point is the definition and discussion of a [[homotopy coherent end]] for the case of enrichment over the [[model structure on simplicial sets|model category of simplicial sets]].
