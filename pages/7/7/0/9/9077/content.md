...
A **[[torus]]** in $G$ is an [[abelian group|abelian]] [[subgroup]] $T \hookrightarrow G$ which is [[connected topological space|connected]] (and [[compact topological group|compact]]). Note that any compact connected abelian Lie group must be a torus $U(1)^{\times n}$, hence the name.
