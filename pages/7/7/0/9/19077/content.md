...
two points, $\rho$ is arbitrarily (by homogeneity) chosen constant and $\tau = t/u$ is a variable parameter determining a point. For $t = 0$ and $u = 0$ we get $b$ and $a$ respectively. If $\lambda_1,\lambda_2,\lambda_3,\lambda_4$ are the parameters of 4 points than the parameter cross ratio
$$
