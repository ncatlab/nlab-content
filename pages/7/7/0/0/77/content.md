...
A _Lie algebra_ is a [[vector space]] $\mathfrak{g}$ equipped with a bilinear skew-symmetric map $[-,-]  _\mathfrak{g} \vee \mathfrak{g} \to \mathfrak{g}$ which satisfies the [[Jacobi identity]]:
