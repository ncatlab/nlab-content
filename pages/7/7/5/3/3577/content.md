...
A quick but  someehat deceptive definition is:
...
An equivalent but more natural definition is 
...(see references below for the moment)...

## Properties

**Proposition** Structures of $(\infty,1)$-sites on an [[(∞,1)-category]] $C$ correspond bijectively to [[topological localization]]s of the [[(∞,1)-category of (∞,1)-presheaves]] to a [[(∞,1)-category of (∞,1)-sheaves]]. See there for more details.
