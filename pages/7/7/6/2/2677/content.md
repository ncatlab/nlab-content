...
[[Jacques Tits]] first observed that many identities coming from algebraic geometry (and particularly algebraic groups) over finite [[fields]] $\mathbb{F}_q$ made perfect sense _as expression in $q$_ when extrapolated to the case $q=1$, even though, of course, there is no actual field with a single element.
