...
Again, the above ought to be understood *in its historical context*, in particular with an awareness of the state  mathematics was in in 1949, at a time when [[homotopy groups of spheres]], to which Serre first applied a calculating [[spectral sequence|method]] developed about a decade earlier by [[Jean Leray]], were still being chipped away at in pioneering reasearch papers, using ad hoc methods, and a systematizing theory like [[category theory]] was in its [[General Theory of Natural Equivalences|infancy|]]. 
