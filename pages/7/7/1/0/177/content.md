...
This page also briefly treats similar technical terms **oriented graph**, **signed graph** and **bidirected graph**, each of which has a standard meaning but none of which an nLab page of its own.
...
| technical term | distinctive feature |  short verbal definition  | comments |  
|---------------------|---|-----|---------------|
|  directed graph |   n/a (context-dependent umbrella-term)       |  n/a |   |  
