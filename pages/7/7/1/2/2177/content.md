...
Read as an assertion, under the interpretation where $1 = \mathop{true}$, $\text{&#10647;}\: x_1 \text{&#65104;} \ldots \text{&#65104;} x_k \:\text{&#10648;}$ makes a statement to the effect that exactly one of its arguments is $\mathop{false}$.
