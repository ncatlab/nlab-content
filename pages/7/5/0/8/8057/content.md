...
In [[combinatory logic]], in the [[∞-calculus]], or more generally in [[type theory]], a fixed-point [[combinator]] is a term $Y$ which, when applied to a term $n$, yields a term $Y n$ that is a fixed-point of $n$:
$$ n (Y n) = Y n .$$
