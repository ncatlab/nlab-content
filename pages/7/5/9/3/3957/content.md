...
* The definition of a convenient vector space has a natural interpretation in terms of [[Frölicher space]]s. It may also be related to [[synthetic differential geometry]]: convenient vector spaces form a [[full subcategory]] of the [[Cahiers topos]] ([Kock 86](#Kock86), [Kock-Reyes 86](#KockReyes86)) and in fact already of the topos of [[smooth sets]], hence (being [[concrete object|concrete]]) of the category of [[diffeological spaces]] ([Kock-Reyes 04, p. 5](#KockReyes04)).
