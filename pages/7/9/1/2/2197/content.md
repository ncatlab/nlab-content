...
Let $V$ be a [[real vector space]] and $\tau$ a [[topological space|topology]] on $V$ that makes it a locally convex topological vector space, induced from a [[directed set]] of [[seminorms]] $\{p_q \colon V \to \mathbb{R}\}_{q \in Q}$. Then a [[linear function]] 

$$
  L \colon V \to \mathbb{R}
$$ 

is a [[continuous function]] with respect to $\tau$, hence a [[continuous linear functional]], precisely if it is $q$-continuous for some $q \in Q$:
...
e.g. prop. 4.6.1 here: [pdf](http://www.math.uni-konstanz.de/~infusino/Lect13.pdf), or remark 3-4 4. here: [pdf](https://www.math.ksu.edu/~nagy/func-an-2007-2008/lcvs-5.pdf)
