...
A __possibly empty left loop__ is a [[magma]] $(G,\backslash)$ such that:
  ...
  * For all $a$ in $G$, $(a\backslash a)\backslash a=a$
...
A __posdibly empty loop__ is a possibly empty left and right loop as defined above such that the following are true:
