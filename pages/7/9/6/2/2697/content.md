...
If the [[(∞,1)-topos]] $\mathcal{X}$ is [[n-localic (∞,1)-topos|1-localic]] and hence has a [[1-site]] of definition, then if the  [[sheaf topos]] on that site, hence the [[(n,1)-topos|(1,1)-topos]] of [[truncated object in an (∞,1)-category|0-truncated objects]] has [[point of a topos|enough points in the 1-topos sense]], then also $\mathcal{X}$ has enough points in the sense of def. \ref{PointOfAndInfinityTopos}. 

=--

This follows by the fact that 1-localic [[(∞,1)-sheaf (∞,1)-toposes]] may be [[presentable (∞,1)-category|presented]] by the Cech-localization of the global [[model structure on simplicial presheaves]] on the given site of definition, and that in the presence of enough 1-topos points the [[weak equivalences]] of that model structure are the [[stalk]]-wise weak equivalences in the [[model structure on simplicial sets]]. (See at _[[model structure on simplicial presheaves]]_ for details.)
