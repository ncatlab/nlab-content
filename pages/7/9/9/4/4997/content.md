...
On [[dependent type theory]] and its [[categorical semantics]] ([[categorical semantics of dependent types]]):
...
* [[Bart Jacobs]], *Structured Probabilistic Reasoning*, ([pdf](https://www.cs.ru.nl/B.Jacobs/PAPERS/ProbabilisticReasoning.pdf))

On [[CD-categories]] ([[gs-monoidal categories]]) and what came to be known as *[[Markov categories]]* (affine CD categories):
