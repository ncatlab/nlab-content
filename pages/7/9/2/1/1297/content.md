...
This is clearly a left ideal again. The special case $(I:R)$ is a two-sided ideal, namely the largest ideal of $R$ contained in $I$. If $r\in R$ then we write $(I:r) := (I:\{r\})$.
