...
The **inverse function theorem** says that given any [[continuously differentiable function]] $f:I \to \mathbb{R}$ from an [[open interval]] $I \subseteq \mathbb{R}$ such that for all real numbers $a \in I$,
...
with initial condition $f^{-1}(f(a)) = a$. 

As a result, it is a special case of the [[Picard–Lindelöf theorem]] in one dimension. 
