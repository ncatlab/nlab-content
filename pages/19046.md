...
+-- {: .num_def}
###### Definition
A [[Grothendieck topos]] $\mathcal{E}$ is called _exponentiable_ (in the [[2-category]] of Grothendieck toposes) if the 2-functor $-\times\mathcal{E}$ has a right 2-adjoint denoted $(_)^\mathcal{E}$.
=--
