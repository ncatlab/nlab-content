...
This is the image under $\Gamma$ of the composite

$$
  Disc \Gamma X \to X \to Disc \Pi x  
$$

of the counit of $(Disc \dashv \Gamma)$ with the unit of $(\Pi \dashv Disc)$ (remember that $Disc$ is by definition [[full and faithful (∞,1)-functor|full and faithful]]). 

+-- {: .un_remark}
###### Remark

Below in the [section on interpretations](#Interpretation) we introduce for this the notation

$$
  \mathbf{\flat} X\to \mathbf{\Pi} X
  \,.
$$
...
The coreflector $Lie : \mathbf{H} \to \mathbf{L}$ acts as Lie-differentiation: for $\mathbf{B}\mathfrak{h} \in \mathbf{L} \hookrightarrow \mathbf{H}$ and $\mathbf{B}G \in \mathbf{H}$ we have
