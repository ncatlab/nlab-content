...
A cohesive $(\infty,1)$-topos is an $(\infty,1)$-topos whose terminal [[geometric morphism]] admits an extenson to such a quadruple of adjoints, possibly satisfying some further properties.
...
*  it is _local_ and _connected_ in the following sense:
   ...
   1. it is _strongly connected_ : $f_!$ preserves even all [[finite]] [[(∞,1)-limit|(∞,1)-product]]s;
