...
_[[Mike Shulman]]_: I'm guessing that what Urs had in mind is more like "intuitively obvious."  Taking the example of [[Batanin ω-categories]] with which I'm a little more familiar, the underlying globular set of the fundamental $\omega$-groupoid is certainly "obvious" but some work is required to produce the globular operad and its action.  (Perhaps the amount of work required is roughly proportional to the "algebraicity" of the definition of $\omega$-category in use?)
