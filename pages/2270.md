...
A relation from $X$ to $X$ is also said to be an __internal binary relation on $X$__, and an object $X$ with an internal binary relation is a [[loop digraph object]]. 
