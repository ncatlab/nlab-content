...
We then want to identify "&eacute;tale" morphisms in $\mathbf{H}$ and declare that a morphism of locally T-algebra-ed $\infty$-toposes $(f, \alpha) : (\mathcal{X}, \mathcal{O}_{\mathcal{X}}) \to (\mathcal{Y}, \mathcal{O}_{\mathcal{Y}})$
