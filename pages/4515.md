...
$$
  E_n Algebras_{\mathbb{F}} 
    \stackrel{\simeq}{\longrightarrow} 
  P_n Algebras_{\mathbb{F}}
$$

from [[E-n algebras]] to [[Poisson n-algebras]] is an [[equivalence]] (since $P_n$ is the [[homology]] of $E_n$, this says that _The $E_n$" operad is formal_ over a field of [[characteristic zero]], see at _[[the little n-disk operad is formal]]_) 
