...
(Noticing that "$\infty$-stack" is synonymous to "$\infty$-sheaf" here, "$\infty$-stackification" to "$\infty$-sheafification", and so on.
...
are the gloablly [[Kan complex]]-valued (i.e. [[infinity-groupoid]]-valued) presheaves that satisfy [[descent and codescent|descent]]. Therefore here $\infty$-stackification is given by _fibrant replacement_ in the model category.