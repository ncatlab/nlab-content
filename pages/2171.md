...
The braid group $Br(n)$ may be alternatively described as the [[mapping class group]] of a 2-disk $D^2$ with $n$ punctures -- i.e. of the [[complement]] $D^2 \setminus \{z_1, \cdots, z_n\}$ of $n$ distinct points in the [[closed disk]]. 

(...)

(review includes [González-Meneses 2011, §1.4](#González-Meneses11))
