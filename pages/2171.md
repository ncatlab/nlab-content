...
Explicitly, the generator $y_i$ used in the Artin presentation above (Def. \ref{ArtinPresentation}) is mapped to the automorphism $\sigma_i$ on the free group on $n$ generators $x_1, \ldots, x_n$ given as follows:
