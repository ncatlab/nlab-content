...
A dendroidal set is something that consists of [[tree category|trees]] on the way a [[simplicial set]] consists of [[simplex|simplices]]. But we may Poincar&eacute;dually think of the trees as being the [[string diagram]]s of something like [[opetopes]]. (?)
