...
## Relation to Diophantine equations

The theory of o-minimal structures has applications to the study of Diophantine equations, for example via the Pila-Wilkie theorem, which is used in proofs of Lang's conjecture, the Manin-Mumford conjecture, and the Andre-Oort conjecture (see [Tsimerman19](#Tsimerman19)).
