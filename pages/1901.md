...
This entry is about a theorem by [[Dominic Verity]] that characterizes the [[descent]] condition for [[(∞,1)-sheaves]]/[[∞-stack]]s that take values not in arbitrary [[∞-groupoid]]s, but in [[strict ω-groupoid]]s.
...
While general [[∞-groupoid]]s are useful due to their generality and conceptual simplicity, for many concrete computations it is useful to get a more concrete [[algebraic definition of higher category|algebraic model]] and consider just [[strict ω-groupoid]]s. Under the [[oriental]]-[[nerve]] 
