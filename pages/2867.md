...
For $n \in \mathbb{N}$ the category $\Theta_n$ -- **Joyal's disk category** -- may be thought of as the full subcategory of the category $Str n Cat$ of [[strict ω-category|strict n-categories]] on $n$-categories that are something like free $n$-categories on pasting diagrams of $n$-[[globe]]s.
