...
1. for $\mathbf{L}\colon \mathbb{R}^7 \longrightarrow \mathbf{B}^3 U(1)_{conn}$ a potential for the [[associative 3-form]], then a definite flobalization is a [[G2-manifold]] $(X,\omega_3)$ equipped with a [[bundle gerbe with connection]] whose 3-form curvature is $\omega_3$.
...
For $V$ [[super Minkowski spacetime]], then the [[super L-∞ algebra]] of $BPS(X,\mathbf{g}, \mathbf{L})$, def. \ref{BPSChargeGroup} is the [[Poisson bracket L-∞ algebra]] $\mathfrak{Pois}(X,\omega)$ of $\omega = F_{\mathbf{L}}$ regarded as a [[pre-n-plectic form|pre-(p+1)-plectic form]] on $X$. 
...
By cor. \ref{KSExtensionForHeis} this is an extension of $\mathbf{Iso}(X,\mathbf{g})$
...
This extension group receives a map from 
$\mathbb{G}_2\mathbf{FlatConn}({\hat X})$.


### Example: M5-brane charges in an M2-brane condensate

Consider $\mathbf{H}= $ [[SuperFormalSmooth∞Grpd]].

From the [[odd line|super point]] $\mathbb{R}^{0|1} \in \mathbf{H}$ there emanates a [[schreiber:The brane bouquet|bouquet]] of [[super L-∞ algebra]] [[L-∞ algebra extensions|extensions]] ([FSS 13](#FSS13)), part of which looks as follows
...
We now concentrate on the branch of this classified by the cocycles $\mu_4$ for the [[M2-brane]] $\mu_7$ for the [[M5-brane]]:
...
Here $\mathfrak{m}2\mathfrak{brane}$ denotes the "[[supergravity Lie 3-algebra]]" regarded as an [[extended super Minkowski spacetime]] and $\mathfrak{m}5\mathfrak{brane}$ denotes the "[[supergravity Lie 6-algebra]]". Both hooks in the diagram are [[homotopy fiber sequences]].

By the discussion at _[geometry of physics -- WZW terms -- Consecutive WZW terms](geometry+of+physics+--+WZW+terms#ConsecutiveWZWTermsAndTwists)_, following ([FSS 13](#FSS13)) applying differentially refined [[Lie integration]] to this yields two consecutive higher WZW terms

$$
  \array{
     \widetilde {\hat{\mathbb{R}}}^{10,1\vert \mathbf{32}}
...
extended superspacetime $\widetilde{\hat X}$ which is a [[higher Cartan geoemtry]] of locally modeled on the [[supergravity Lie 3-algebra]] on which the local [[M5-brane]] [[Green-Scharz sigma model]] is defined, and hence may ask for a choice of definite globalization of that 
...
This extension group receives a map from 
$(\mathbf{B}^5 (\mathbb{R}/\Gamma_2))\mathbf{FlatConn}({\hat X})$.



Under [[Lie differentiation]] and 0-truncation as in prop. \ref{0TruncationOfHigherPoissonBracket} this is the degree-$5$ real cohomology of the $K(\mathbb{Z},3)$-fibration over $X$ underlying the first of the globally defined M2-brane WZW term.

By the [[Serre spectral sequence]] this is the cohomology in the middle of
...
This gives the corrected group of M2-brane and M5-brane charges in the corrected [[M-theory super Lie algebra]] for $(X,g)$.
...
* {#FSS13} [[Domenico Fiorenza]], [[Hisham Sati]], [[Urs Schreiber]], _[[schreiber:The brane bouquet|Super Lie n-algebra extensions, higher WZW models and super p-branes with tensor multiplet fields]]_, International Journal of Geometric Methods in Modern Physics, Volume 12, Issue 02 (2015) 1550018 (35 pages) ([arXiv:1308.5264](http://arxiv.org/abs/1308.5264))
