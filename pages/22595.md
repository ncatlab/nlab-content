...
Let $(-)\div(-):\mathbb{Z} \times \mathbb{Z}_{+} \to \mathbb{N}$ be a [[Euclidean domain|Euclidean division function]] on the [[integers]], and let $(-)\%(-):\mathbb{Z} \times \mathbb{Z}_{\neq 0} \to \mathbb{N}$ be the remainder function on the integers. Then there is a function called **approximate division** 
$$(-)/(-): \mathbb{Z}[1/10] \times {\mathbb{Z}[1/10]}_{\neq 0} \to (\mathbb{N} \to \mathbb{Z}[1/10]$$
to a sequence of decimal fractions called the **infinite decimal representation** of the fraction of decimal fractions
$$(a/b)_n \coloneqq (a \cdot 10^n \div b)/10^n)$$

The set where every infinite decimal representation of the fraction of decimal fractions converges is the [[rational numbers]]. 
