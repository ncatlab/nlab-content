...
from def. \ref{InfinitesimalCotangentBundleOfFieldAndGaugeParameterBundle}. On the [[smooth functions]] on the [[jet bundle]] of this bundle the _[[local antibracket]]_
...
$$
  ...
  C^\infty\left(
    J^\infty_\Sigma
    \left(
      T^\ast_{\Sigma,inf}\left( E \times_\Sigma (\mathcal{G}[1]) \right)
     \right)
  \right)
    \otimes
  C^\infty\left(
...
is the map given in the [[local coordinates]] spring
