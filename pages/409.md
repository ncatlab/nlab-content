...
A **strict $\omega$-groupoid** or **strict $\infty$-groupoid**is a [[strict ω-category]] in which all [[k-morphism]]s have a strict [[inverse]] for all $k \in \mathbb{N}$
...
[[!redirects strict ω-groupoid]]
[[!redirects strict ω-groupoids]]
