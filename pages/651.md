...
###### Proposition
A Fr&ouml;licher space $(X,C,F)$ is Hausdorff if and only if the map $X \to Spec(F)$ is injective.
=--
...
+-- {: .num_lemma #SpecSurj}
###### Lemma
For a Fr&ouml;licher space $(X,C,F)$ the following conditions are equivalent.
