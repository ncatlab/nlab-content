...
Fr&ouml;licher spaces are examples of [[generalized smooth space|generalised smooth spaces]].  They are also examples of [[generalized object|generalised objects]] (indeed, concrete ones).
...
There is a close relationship between Fr&ouml;licher spaces and the category of generalised $\mathcal{R}$-objects satisfying Isbell Duality.

+-- {: .num_prop #IsbellIsFroelicher}
###### Proposition
A generalised $\mathcal{R}$-object that satisfies Isbell duality is a Fr&ouml;licher space.
=--
...
This suggests a simple notion that is certainly required for a Fr&ouml;licher space to satisfy Isbell duality.
...
###### Lemma
The Fr&ouml;licher space corresponding to a generalised $\mathcal{R}$-object satisfying Isbell duality is Hausdorff.
=--
...
+-- {: .num_prop #FroFSat}
###### Proposition
The generalised $\mathcal{R}$-object corresponding to a Fr&ouml;licher space is $F$-saturated.
=--

+-- {: .proof}
Let $(X,C,F)$ be a Hausdorff Fr&ouml;licher space.
...
Notice that this did not require the Fr&ouml;licher space to be Hausdorff.

The other half is more complicated.

+-- {: .num_prop #FroHausCSat}
###### Proposition
A Hausdorff Fr&ouml;licher space is $C$-saturated.
=--
