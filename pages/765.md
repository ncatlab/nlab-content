...
1. for all $i \geq 1$, $(\phi_i): \pi_i(X_r,X_i,v)=0$  for all $r \gt i$  and $ v \in  X_0$.
...
1. for all $i \geq 1$, $(\phi_i'): \, \pi_j(X_r,X_i,v)=0$  for all  $v \in X_0$ and all $ j,r$ such that $ 1 \leq j \leq i \lt r$.