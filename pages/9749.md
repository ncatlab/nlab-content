...
The factorization of the Giry monad, defined on the category of measurable spaces, through the category of super convex spaces, is given in

* {#Sturtz19} [[Kirk Sturtz]], _Erratum and Addendum: The factorization of the Giry monad, (http://arxiv.org/abs/1907.00372)

which avoids the assumption  ``if no measurable cardinals exist'' made in
* {#Sturtz18} [[Kirk Sturtz]], _The Factorization of the Giry monad_, Advances in Mathematics, 340, pp. 76-105,  15 Dec. 2018

 (That's a really really bad assumption; though done in light of similar results such as Isbell's result that the countable numbers are right adequate in Set iff no measurable cardinals exist.)
