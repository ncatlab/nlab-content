_Nonabelian algebraic topology_ is a program developed by [Ronnie Brown](http://www.bangor.ac.uk/~mas010/index.html) and his collaborators. It redoes and enhances [[algebraic topology]] by making use of the tool of [[strict ω-groupoid]]s and in particular the [[crossed complex]]es equivalent to them, which generalize the [[chain complex]]es of _abelian_ groups used in traditional algebraic topology.
...
For $D \in Chn$ a [[chain complex]] (of [[abelian groups]]), we may regard it as a [[crossed complex]] $\Theta D$, hence as a [[strict ω-groupoid]] $q \Theta D$. The [[ω-nerve]] $N^\Delta q \Theta D$ of this is the [[Kan complex]] underlying the image of $D$ under the [[Dold-Kan correspondence]] $Chn \to sAb$.
