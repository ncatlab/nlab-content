_Nonabelian algebraic topology_ is a program developed by [Ronnie Brown](http://www.bangor.ac.uk/~mas010/index.html) and his collaborators. Ît redoes and enhances [[algebraic topology]] by making use of the tool of [[strict ω-groupoid]]s and in particular the [[crossed complex]]es equivalent to them, which generalize the [[chain complex]]es of _abelian_ groups used in trditional algebraic topology.
