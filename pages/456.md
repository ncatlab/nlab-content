...
Another motivation of the concept comes from the fact that a [[functor]] such as $f^*$ that preserves finite [[limits]] and arbitrary [[colimits]] (since it is a [[adjoint functor|left adjoint]]) necessarily preserves all constructions in [[geometric logic]].  See also [[classifying topos]].
...
is a geometric morphism. Hence $(\coprod_k \dashv k^* \dashv \prod_k)$ is an [[essential geometric morphism]].
