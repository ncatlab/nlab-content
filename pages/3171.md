...
\begin{imagefromfile}
    "file_name": "HenriCartan_Portrait.jpg",
    "float": "right",
    "width": 200,
    "unit": "px",
    "margin": {
    ...
    "caption": "from [Tu 2020, p. 31](equivariant+de+Rham+cohomology#Tu20)"
\end{imagefromfile}

**Henri Cartan** (son of [[Élie Cartan|Élie Joseph Cartan]]) was a French mathematician, one of the founders of modern [[homological algebra]] (including aparatus of [[spectral sequence]]s), complex [[analytic geometry]] (several complex variables), [[sheaf theory]], [[cohomology]] theory. 
...
* *Séminaire Henri Cartan* 1948-1964 ([numdam:SHC](http://www.numdam.org/actas/SHC/))
...
* [[Cartan model]] for [[equivariant de Rham cohomology]]
