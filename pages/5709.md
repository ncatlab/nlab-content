...
Hence UV-regularization via [[counterters]] is a method of [[renormalization|("re"-)normalization]] of [[perturbative QFT]] ([this def.](S-matrix#ExtensionOfTimeOrderedProoductsRenormalization)).
...
$$
  PolyObs(E_{\text{BV-BRST}})[ [ \hbar, g, j] ]\langle g,j\rangle
    \hookrightarrow
  PolyObs(E_{\text{BV-BRST}})[ [ \hbar, g, j] ]
$$
...
Discussion of the effective field theories induced by [[perturbative string theory]] includes
