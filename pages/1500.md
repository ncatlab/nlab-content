...
A **fusion category** is a [[rigid monoidal category|rigid]]  [[semisimple category|semisimple]] [[enriched category|linear]] [[monoidal category]], with only finitely many isomorphism classes of simple objects, such that the endomorphisms of the unit object is just the ground field $k$.
...
**Conjecture (Etingof, Nikshcych and Ostrik)**. Every fusion category admits a [[pivotal structure]].

Providing a certain condition is satisfied, a pivotal structure on a fusion category can be shown to correspond to a 'twisted' monoidal natural transformation of the identity functor on the category, where the twisting is given by the [[Pivotal symbols|pivotal symbols]].
...
* M. Mueger, [Tensor categories: A selective guided tour](http://arxiv.org/abs/0804.3587).
