...
The polarization condition is 

$$
  \frac{\partial}{\partial p} \psi = 0
  \,.
$$

Hence the quantum state space may be taken to consist of functions that depend just on $q$.


The phase space functions $q$ and $p$ act on this quantum state space via the [[covariant derivative]] of their [[Hamiltonian vector fields]] with respect to the connection $p d q$. The Hamiltonian vector fields are
...
$$
  \nabla_{v_q} \psi = \frac{\partial}{\partial} p \psi + q \psi = q \psi
$$

$$
  \nabla_{v_p} = \frac{\partial}{\partial q} \psi
$$
