...
which is the alternating [[direct sum]] of the [[Dolbeault cohomology]] space of $X$ with [[coefficients]] in the [[holomorphic line bundle]] $L_\omega \otimes \sqrt{\Omega^{0,n}}$. 
...
+-- {: .num_prop #SpinStructuresOnKählerManifolds}
###### Proposition

A choice of [[spin structure]] on the [[Kähler manifold]] $X$ is equivalently a choice of [[square root]] ("[[Theta characteristic]]") $\sqrt{\Omega^{n,0}}$ of the [[canonical line bundle]] $\Omega^{n,0}$. 

Given such a choice, there is a [[natural isomorphism]] between the [[spinor bundle]] and the (anti-)holomorphic form bundle tensored by this square root

$$
  S_X \simeq \Omega^{0,\bullet}_X \otimes \sqrt{\Omega^{n,0}}
 \,.
$$
...
It follows that the [[Dirac operator]] on $X$ which is twisted by the [[connection on a bundle|connection]] of the [[prequantum line bundle|prequantum]] [[holomorphic line bundle]] $L_\omega$ is

$$
  \overline{\partial}_\nabla + \overline{\partial}^\ast_\nabla
  \;\colon\;
  \Omega^{0,even/odd}(X, L_\omega \otimes \sqrt{\Omega^{n,0}})
  \to 
  \Omega^{0,odd/even}(X, L_\omega \otimes \sqrt{\Omega^{n,0}})
  \,.
$$
...
The *Dolbeault-Dirac* space of quantum states of $(X,\omega, L_\omega)$ is the [[index]] of the $L_\omgega$-twisted [[Dolbeault-Dirac operator]]
...
Given a [[spin^c structure]] $\mathbf{c}$ on $X$ whose underlying [[determinant line bundle]] coincides, up to equivalence, with $L_\omega$, then the _[[spin^c quantization]]_ of this prequantum data is the [[index]] of the corresponding [[spin^c Dirac operator]] $D_{\mathbf{c}}$:
