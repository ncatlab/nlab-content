...
### Geometric prequantization --  The space of quantum states
...
In the Kähler it is best to write $\Omega^{n,0}$ for the [[canonical line bundle]] of the polarization and $\sqrt{\Omega^{n,0}}$ for the corresponding choice of [[metaplectic correction]]/[[Theta characteristic]].
