...
The smallest [[regular cardinal]] is [[ℵ]]${}_0 = {\vert \mathbb{N}\vert}$: every finite union of finite sets is itself a finite set. (See the entry omn [[regular cardinal]]s for a discussion as to whether one might consider some finite cardinals as being `regular'.)
