...
Equivalently, a **monoid** is a set $M$ with a binary operation $\mu_2:M \times M \to M$, a ternary operation $\mu_3:M \times M \times M \to M$, and an element $1 \in M$ such that they satisfy the **associative laws**:

$$ \mu_2(\mu_2(x, y), z) = \mu_3(x, y, z) = \mu_2(x, \mu_2(y, z)) $$
