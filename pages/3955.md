...
+-- {: .num_prop #PropLin}
###### Proposition ######
Let $N = (N, C_N, F_N)$ be a [curvaceously compact Fr&ouml;licher space](nlab/show/Froelicher+space#DefCurvComp).  Let $E$ be a [[convenient vector space]].  Let $U$ be a $0$-neighbourhood in $E$ in the $c^\infty$-topology.  Then the set
