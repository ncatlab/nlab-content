...
As a result, the [[image]] of the two decompostion functions $\im(\mathcal{D}_0)$ and $\im(\mathcal{D}_1)$ are commutative monoids and there exists a [[monoid]] [[isomorphism]] $i:V \cong \im(\mathcal{D}_0) \otimes \im(\mathcal{D}_1)$, where $A \otimes B$ is the [[tensor product of commutative monoids]]. There exists a parity function $\deg:\im(\mathcal{D}_0) \uplus \im(\mathcal{D}_1) \to \mathbb{Z}/2\mathbb{Z}$ where $A \uplus B$ is the [[disjoint union]] of $A$ and $B$, such that the [[fiber]] of $\deg$ at $0$ is $\im(\mathcal{D}_0)$ and the fiber of $\deg$ at $1$ is $\im(\mathcal{D}_1)$. 
