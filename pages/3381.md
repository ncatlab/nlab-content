...
As automorphisms $\sigma : X \to X$ in [[Set]], the permutations of $X$ naturally form a [[group]] under [[composition]], called the __[[symmetric group]]__ (or __permutation group__) on $X$.
