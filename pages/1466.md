...
A uniform structure could be represented as a family of binary relations on a set $X$ indexed by a set $S$, or equivalently by [[currying]], as a ternary relation $(-)\approx_{(-)}(-)$ on $X \times S \times X$, such that 

1. for every $U \in S$ and $x \in X$, $x \approx_U x$

2. for every $U \in S$, there exists a $V \in S$ such that for every $x \in X$, $y \in X$, and $z \in X$, if $x \approx_V y$ and $y \approx_V z$, then $x \approx_U z$. 

3. For every $U \in S$, there exists an element $V \in S$ such that for every $x \in X$ and $y \in X$, if $x \approx_V y$, then $y \approx_U x$. 

4. $S$ is inhabited. 

5. If there are elements $U \in S$ and $V \in S$, then there is an element $T \in S$ such that for every element $x \in X$ and $y \in X$, if $x \approx_T y$, then $x \approx_U y$ and $x \approx_V y$. 

6. If there is an element $U \in S$, then there is an element $V \in S$ such that for all $x \in X$ and $y \in X$, if $x \approx_U y$, then $x \approx_V y$. 
