...
While an [[algebraic definition of higher category|algebraic]] definition of [[strict ω-categories]] is comparatively straightforward, algebraic definitions of fully weak $\omega$-categories (aka $\infty$-[[infinity-category|categories]]) are difficult to work with (although some definitions exist, such as those of [[Batanin ω-category|Batanin]], [[Trimble n-category|Trimble]], [[Leinster n-category|Leinster]], and [[n-category|Penon]]).
