...
A [[complex number]] $z$ is __imaginary__ if it is not [[real number|real]]; it is __purely imaginary__ if its [[real part]] $\Re{z}$ is [[zero]].  

Beware that often one says "imaginary" for "purely imaginary".
...
### Within a star-algebra

More generally, an element $z$ of a [[star algebra]] (notably of a [[real normed division algebra]] like the [[quaternions]] or [[octonions]]) is purely imaginary if $z^\ast = - z$.

### In constructive mathematics

For purposes of [[constructive mathematics]], we only accept $z$ as imaginary if its [[imaginary part]] $\Im{z}$ is [[apartness|apart from]] zero, or equivalently if $z$ is apart from $\Re{z}$.  This all generalizes to other kinds of [[hypercomplex numbers]].
