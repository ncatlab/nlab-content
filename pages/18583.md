...
* $Inj$ is a [[quasitopos#inj]]. It is a  [[reflective subcategory]] of the [[category of presheaves|presheaf topos]] $Set^{\to}$ ($Set$'s  [[arrow category]]). It contains the  [[separated presheaf|separated presheaves]] under the [[double negation#in_topos_theory|double negation topology]] on $Set^{\to}$.
