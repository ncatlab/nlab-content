...
For $p$ a [[prime number]], the [[field]] of _complex $p$-adic numbers_ $\mathbb{C}_p$ is to the [[p-adic numbers]] $\mathbb{Q}_p$ as the [[complex numbers]] $\mathbb{C}$  are to the [[real numbers]].
