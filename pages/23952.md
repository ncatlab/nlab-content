...
Let $(M, \leq, \wedge, \top)$ be a [[monoidal poset]], such as a [[meet-semilattice]]. A **$M$-enriched [[proset]]** or **proset enriched over/in $M$** is a [[set]] $P$ with a [[binary function]] $o:P \times P \to M$ such that 
