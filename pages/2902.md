...
By the golden triangle lemma for isosceles triangles with angles of 36&deg;, triangle $N O P$ gives us $r=t\Phi$.  From the same lemma, applied to triangle $P N Q$, we have $2b=t/\Phi$.
