...
The [[higher van Kampen theorem]] which has been proven for [[strict ω-category]]-valued $\Pi_\omega$, asserts that $\Pi_\omega(X)$ is not only equivalent to the _homotopy_ colimit over $\Pi_\omega(Y^n)$, for a cover $Y \to X$, but also to the _strict_ colimit. For further discussion of this see
