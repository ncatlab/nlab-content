Here we ask whether it might be possible to prove the irrationality of $\pi$ by using trigonometric identities.
...
+-- {: .query}
A student in India whom I encountered via the internet told me that the problem of proving that identity recurs perennially on the joint entrance exam of the Indian Institutes of Technology.  Hence "well known".  I don't know if I ever knew his name.
=--
