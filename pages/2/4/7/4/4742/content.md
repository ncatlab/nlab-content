...
If the category has a single [[object]] it is a [[monoid]] and this condition is the _associativity_ condition on the binary operation of monoids such as [[group]]s, [[ring]]s, [[algebra]]s, etc.
