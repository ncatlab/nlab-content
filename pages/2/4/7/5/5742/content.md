...
given by product operation. This defines a log-structure on $\mathbb{C}$. The coresponding log-space is often denoted $T$ (e.g. [Kato-Nakayama 99, p. 5](#KatoNakayama99))
