...
For instance the symbol $\phi$ may denote a [[proposition]] in a [[formal system]], but the statement "$\phi$ can be proven" is not itself a proposition in the formal system, but a statement in the metalanguage, often denoted
