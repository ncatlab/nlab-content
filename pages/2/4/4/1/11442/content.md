...
(Typically, to get an interesting theory, Kan-fibrancy on simplicial manifolds is imposed in a suitable local sense, meaning that [[horns]] have fillers in a  [[open neighbourhoods]] of all points, but not possibly globally.)

Motivated by the standard way (see at _[[homotopy hypothesis]]_) in which bare [[Kan complexes]] (hence Kan-fibrant [[simplicial sets]]) present [[geometrically discrete ∞-groupoids]] and given that the [[nerve]] of a [[Lie groupoid]] is an example of a locally Kan-fibrant simplicial manifold (a [[1-truncated]] one), such Kan-fibrant simplicial manifolds are often referred to _Lie $\infty$-groupoids_ (or _Lie $n$-groupoids_ for finite [[n-truncated object in an (infinity,1)-category|truncation]]) ([Zhu 06](#Zhu06)).
...
A homotopy-correct characterization of the sub-$\infty$-category presented by the Kan-fribtant simplicial objects as that of _[[geometric ∞-stacks]]_ modeled on manifolds is in ([Pridham 09](#Pridham09)) (see around p. 17 for the differential geoemtric version).
...
* {#Zhu06} [[Chenchang Zhu]], _Lie $n$-groupoids and stacky Lie groupoids_, Int Math Res Notices (2009) 2009 (21): 4087-4141. ([arXiv:math/0609420](http://arxiv.org/abs/math/0609420))
