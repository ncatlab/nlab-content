...
1. to every [[causally closed subset]] $\mathcal{O} \subset X$ of [[spacetime]] $X$ there as associated a [[C*-algebra]] $\mmathcal{A}(\mathcal{O})$;
