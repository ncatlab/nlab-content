...
Let $k$ be an [[algebraically closed field]] of [[positive number|positive]] [[characteristic]]. Then the only [[smooth variety]] over $k$ which is &#233;tale [[contractible homotopy type|contractible]] is the point $Spec(k)$. In fact thisis the only smooth variety which is [[n-connected object of an (infinity,1)-topos|2-connected]].
...
Discussion from the point of view of [[(∞,1)-topos theory]] is in 
