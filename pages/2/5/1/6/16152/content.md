...
+-- {: .un_defn}
###### Definition
The **pretriangulated envelope** (or _pretriangulated hull_, _pretriangulated completion_) of $T$, denoted $tri(T)$, is the full sub-[[dg-category]] of the [[derived dg-category]] $D(T)$ generated by the representable [[dg-modules]] under [[homotopy fibres]] and [[homotopy cofibres]].
=--
