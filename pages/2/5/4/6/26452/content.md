...
Any [[closed monoidal category|closed]] [[symmetric monoidal category|symmetric]] [[distributive monoidal category]] | $X \mapsto I \sqcup X$ given [[tensor unit]] $I$ and [[coproduct]] $\sqcup$ | [[natural numbers object]] | conatural numbers object | |
Any [[closed monoidal category|closed]] [[symmetric monoidal category|symmetric]] [[distributive monoidal category]] | $X \mapsto I \sqcup (A \otimes X)$ given [[tensor unit]] $I$, [[tensor product]] $\otimes$, [[coproduct]] $\sqcup$, and object $A$ | [[list object]] of $A$ | stream object of $A$ | [[free monoid]], [[list monad]] |
