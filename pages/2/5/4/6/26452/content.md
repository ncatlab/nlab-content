...
[[linearly ordered sets]] | $X \mapsto \omega \cdot X$, where $\omega \cdot X$ is the cartesian product of the natural numbers with the underlying set of $X$, equipped with the [[lexicographic order]]. | ? | The non-negative [[real numbers]] $\mathbb{R}_{\geq 0}$ | [[real number]] | |
[[Archimedean ordered fields]] | $X \mapsto \mathcal{D}(X)$ where $\mathcal{D}(X)$ is the [[Dedekind completion]] of the Archimedean ordered field $X$ | The [[real numbers]] $\mathbb{R}$ | The [[real numbers]] $\mathbb{R}$ | | |
