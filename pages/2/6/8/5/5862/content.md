...
In the [[first order formulation of gravity]] the [[Einstein-Hilbert action]] in [[dimension]] 3 happens to be equivalent to the [[action functional]] of [[Chern-Simons theory]] for [[connection on a bundle|connections]] with values in the [[Poincare Lie algebra]] ([[spin connection]] and [[vielbein]], see [[first order formulation of gravity]]), for a suitable quadratic [[invariant polynomial]]. Similarly for 3-dimensional [[supergravity]]. See [[3d quantum gravity]].
