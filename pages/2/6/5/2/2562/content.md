...
* in [[mathematical analysis]], a domain or region is a nonempty connected open subset of $\mathbb{R}^n$ (or $\mathbb{C}^n$, or topological manifold), see wikipedia: [domain (mathematical_analysis)](https://en.wikipedia.org/wiki/Domain_(mathematical_analysis))
and [[eom]]: [domain](https://encyclopediaofmath.org/wiki/Domain) 
