...
It sends a localizable Boolean algebra $A$
to the [[complexification]] of the [[completion]] of the free real algebra on $A$,
given by the left adjoint to the functor that takes idempotents.
...
[[!redirects localizable Boolean algebras]]
