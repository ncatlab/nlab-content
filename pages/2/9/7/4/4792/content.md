...
Once we have given the octonions their natural inner product, we can equivalently define a basic triple to be an orthonormal triple of imaginary octonions such that the third is orthogonal to the subalgebra generated by the first two.   (Given this, each is orthogonal to the subalgebra generated by the other two.)
