...
1. $E$ Banach space, $F$ arbitrary:
    1. $C^1_\Theta$, $C^1_\Delta$, $C^1_\Pi$, $C^1_{q b}$, $C^1_b$ are equivalent
    2. $C^1_c$, $C^1_{p k}$, $C^1_k$, $C^1_s$ are equivalent
1. $E$ Fr&#233;chet space, $F$ arbitrary:
    1. $C^1_{q b}$, $C^1_b$ are equivalent
    2. $C^1_c$, $C^1_{p k}$, $C^1_k$, $C^1_s$ are equivalent
1. $E$ Fr&#233;chet-Schwartz, $F$ arbitrary: $C^1_\Pi$, $C^1_{q b}$, $C^1_c$, $C^1_b$, $C^1_{p k}$, $C^1_k$, $C^1_s$ are equivalent
1. $E$ finite dimensional and $F$ arbitrary, or $E$ Fr&#233;chet-Schwartz and $F$ normable: All equivalent
...
We make the obvious definition:
