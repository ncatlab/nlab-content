...
|1963| |[[Jean Giraud (mathematician)|Jean Giraud]]| |[[Grothendieck topos|Giraud characterization theorem]] characterizing Grothendieck toposes as categories of sheaves over a small site|
...
|1964| |[[William Lawvere]]| |ETCS [[Elementary Theory of the Category of Sets]]: An axiomatization of the [[category of sets]] which is also the constant case of an [[topos|elementary topos]]|
...
|1998| |[[John Baez]]-[[James Dolan (mathematician)|James Dolan]]| |[[microcosm principle|Microcosm principle]]: Certain algebraic structures can be defined in any category equipped with a categorified version of the same structure|
...
<table markdown="1" width="" bgColor="">
  <tr>
    <td>1890</td>
    <td>[[David Hilbert]]</td>
    <td>[[resolution of modules|Resolution]] and free resolution of modules</td>
  </tr>
  <tr>
    <td>1890</td>
    <td>[[David Hilbert]]</td>
  ...
  <tr>
    <td>1893</td>
    <td>[[David Hilbert]]</td>
    <td>[[nullstellensatz|Fundamental theorem of algebraic geometry]] also called Hilbert Nullstellensatz. It was later reformulated to: the category of [[affine variety|affine varieties]] over a field $k$ is equivalent to the [[opposite category|dual]] of the category of reduced finitely generated (commutative) $k$-[[associative unital algebra|algebras]]</td>
  </tr>
  <tr>
    <td>1972</td>
    <td>[[Jean Bénabou]]-[[Ross Street]]</td>
    <td>[[Cosmoses (category theory)]] which categorize [[universe (mathematics)|universe]]s: A cosmos is a generalized universe of 1-categories in which you can do category theory. When set theory is generalized to the study of a [[Topos#|Grothendieck topos]], the analogous generalization of category theory is the study of a cosmos.
Ross Street definition: A [[bicategory]] such that<BR>
1) small bicoproducts exist<BR>
2) each [[monad (category theory)|monad]] admits a Kleisli construction (analogous to the quotient of an equivalence relation in a topos)<BR>
3) it is locally small-cocomplete<BR>
4) there exists a small [[Generator_(category_theory)|Cauchy generator]].<BR>
...
Jean B&#233;nabou definition: A bicomplete [[symmetric monoidal closed category]]</td>
  </tr>
</table>
...
Rafael: Have anyone figured out how to make line breaks or do i have to change the code to HTML table markup?
...
* A very brief sketch of the concept or result that was introduced.
* Links to pages containing definitions of the technical terms that are used.  If such pages don't exist yet we can include a link and create the page later.


+-- {: .query}

Rafael had written some rather different guidelines, including:
