...
[[Toby]]:  You\'re putting stuff in the table that Instiki\'s primitive table handling can\'t do.  I\'m fixing it a bit, but it\'s a kludge just to make things readable.  All in all, this would probably work better as a list; you can do all of this stuff in a list here, and it\'s easy to enough to separate out year and person with dashes.  I\'ll write the first three entries in that style so you can look at it.  (PS: You\'re Fotino?)
