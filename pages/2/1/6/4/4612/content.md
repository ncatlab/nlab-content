...
A morphism of quadratic algebras is just a morphism as graded algebras. Alternatively, a morphism of quadratic algebras $f: A \to B$ determines and is determined by a linear map $f_1: A_1 \to B_1$ such that $f_2(R_A) \subseteq R_B$. 
...
$$(V \otimes W, \sigma(R_A \otimes 1_{W \otimes W}) + \sigma(1_{V \otimes V} \otimes R_B)).$$ 
