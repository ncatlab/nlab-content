...
* for structure like distinguished objects $R$, we need to have chosen distinguished objects $R'$ of $C$, $T R'$ (which we think of as the tangent bundle of $R'$)  of $L(R')$ and $T^* R'$ (the cotangent bundle of $R'$) of $L(R')$;
* for structure like distinguished morphisms $(*):R\times R\to R$, we need to have chosen distinguished morphisms $(*)'$ in $C(R'\times R', R')$ (the primal computation of $(*)$), $T(*)'$ in $L(R'\times R')(T R'\times T R', T R')$ (the derivative of $(*)$) and $T^*(*)'$ in $L(R'\times R')(T R', T R'\times T R')$ (the transposed derivative of $(*)$).
