...
The set of Cauchy filters on a Cauchy space has a natural Cauchy structure which is complete and (as a convergence space) [[Hausdorff space|Hausdorff]]; this is the (Hausdorff) __completion__ of the original Cauchy space.  The complete Cauchy spaces thus form a [[reflective subcategory]] of $Cau$.  This completion agrees with the completion of a metric or uniform space; that is, Cauchy completion, even of a metric space, is an operation on its Cauchy structure only.
