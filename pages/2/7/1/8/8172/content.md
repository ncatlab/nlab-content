...
In order to finally state sufficient conditions under which the $E$-Adams spectral sequence converges we need the following ring-theoretic concept.
...
> under construction, for the moment the following is just scratch material
