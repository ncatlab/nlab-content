Any group $G$ has a category of finite-dimensional complex representations, often denoted $Rep(G)$.  This is a symmetric monoidal abelian category and thus has a [[Grothendieck ring]], which is called the **representation ring** of $G$ and denoted $R(G)$.

More concretely, we get $R(G)$ as follows.  It has a basis $e_i$ in one-to-one correspondence with the **irreps** of $G$: that is, the irreducible finite-dimensional complex representations of $G$.  It has a product given by 
