...
A __Plücker embedding__ is an [[embedding]] of [[algebraic varieties]] from the [[Grassmannian]] of $k$-planes in a $n$-[[dimension of a vector space|dimensional]] [[vector space]] $V$ to the [[projective space]] $P(\wedge^k V)$ of the $k$-th [[exterior power]] of $V$.
