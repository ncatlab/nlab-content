[[!redirects W. T. Tutte]]
Bill Tutte (1917--2002) was a mathematician. 
...
He [published](#Tutte1958I) the [[Tutte homotopy theorem]] which can be regarded as a generalization of the notion of [[paths]] to matroids, and about which [[Gian-Carlo Rota]] wrote 

> The (...) motivation, (...) in Tutte's vertiginously profound papers, was graph-theoretic. Matrois are objects tha play the role of the dual graph of a graph when the graph is not [[planar]]. Almost every fact about graphs that can be formulated without using the term "vertex" has a matroidal analogue. The deepest insight obtained from this yoga is Tutte's homotopy theorem, a unique combinatorial achievement whose far reaching implications are a long way from being fully understood. 
