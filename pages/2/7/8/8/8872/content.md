...
For $X \hookrightarrow \mathbb{A}^n$ an [[affine algebraic variety]] defined by an [[ideal]] $I \hookrightarrow R[x_1, \cdots, x_n]$, hence $X \simeq Spec(R[x_1, \cdots, x_n]/I)$, then  its _tangent cone_ at the origin is 
