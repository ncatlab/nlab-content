...
When regarding a [[sheaf]] as a [[space]] defined by how it is probed by test spaces (cf. *[[functorial geometry]]*), a _concrete sheaf_ is a generalized space that has an _[[underlying]] [[set]] of points_ out of which it is built.
