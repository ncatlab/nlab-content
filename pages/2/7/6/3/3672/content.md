...
This is based on the fact that in certain dimensions, spinor representations are naturally identified with a $\mathbb{K}^n$, for $\mathbb{K}$ one of the division algebras.
