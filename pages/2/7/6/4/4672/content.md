...
The [[category]] **$Lie Alg$** is that whose [[object]]s are [[Lie algebra]]s $(\mathfrak{g}, [-,-]_{\mathfrak{g}})$ and whose morphisms are Lie algebra [[homomorphisms]], that is linear maps $\phi\colon \mathfrak{g} \to \mathfrak{h}$ such that for all $x,y \in \mathfrak{g}$ we have
