...
_Matt Insall_:  I think that including some literature references would be helpful as well. In that case, listing more categories with the uses of them and properties would be a bit more meaningful to users of this database. 
