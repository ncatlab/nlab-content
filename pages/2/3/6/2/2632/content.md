...
Two subsystems $B_1, B_2 \hookrightarrow \mathcal{A}$ are called **independent subsystems** if the map linear map
...
through the algebra $B_1 \vee B_2$ that is generated by $B_1$ and $B_2$ insice $\mathcal{A}$ (the smallest subalgebra containing both).
