...
There is some terminological variance in the literature to the notion of atomic poset as defined here. In particular, [Wikipedia](http://en.wikipedia.org/wiki/Atom_%28order_theory%29) defines an _atomic poset_ to be a poset in which every element has an atom below it, and refers to our notion of atomic poset by the term "atomistic poset". The Wikipedia conventions are observed in (many? most?) lattice-theoretic texts such as the book by Gr&#228;tzer (citation needed). 
