## Idea
A **CMon-enriched symmetric monoidal category** is a [[symmetric monoidal category]] such that each homset is a commutative monoid and the tensor product on morphisms and the composition are bilinear.
