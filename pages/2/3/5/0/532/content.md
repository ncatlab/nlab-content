...
##Connection with complicial sets##
Together with very similar ideas of John Roberts, adapted by Ross Street, the notion of $T$-complex is one of the precursors of Verity's notion of [[complicial set|complicial set]].

They are also related to Duskin's notion of [[hypergroupoid]].(The connection is explored in the papers by Nan Tie listed be;low.)
