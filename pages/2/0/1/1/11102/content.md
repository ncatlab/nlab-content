...
A variation of the [[configuration space of points]]-model by [McDuff 1975](configuration+space+of+points#McDuff75) to properly model the [[iterated loop spaces]] $\Omega^n \Sigma^n X$ for arbitrary $X$:
