...
The definition of anti-Yetter--Drinfeld modules differs very slightly to that of [[Yetter-Drinfeld module]]s. Stable anti-Yetter--Drinfeld modules are natural coefficients for Hopf cyclic homology. 

## Definition

Given a commutative ring $k$ and a Hopf $k$-algebra $H$ with an invertible antipode $S$, a $k$-module $M$ is called a left-left anti-Yetter--Drinfeld module if 
...
Related pages include [[Yetter-Drinfeld module]], [[Hopf module]], [[cyclic homology]]
