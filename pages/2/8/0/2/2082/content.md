...
Mathematically better defined are notions (sometimes equated by various authors with the class of quantum groups) like quasitriangular Hopf algebras, [[quantum matrix group]]s (quantum linear groups, more general FRT-algebras and Majid's $A(R)$ where $R$ is a Yang-Baxter matrix), quantized enveloping algebras, quantum function algebras, compact matrix pseudogroups, Kac algebras, Yangians etc. The representations of quasitriangular Hopf algebras form [[braided monoidal categories]], which are in main examples related to the mathematics of Iwahori--Hecke algebras, braid groups, knot theory, finite group Chern--Simons theory and Wess--Zumino--Novikov--Witten theory of [[CFT]]. One should note that in the classical limit quantum function algebras give not simply (functions on) algebraic (or Lie) groups but also a compatible (= multiplicative) Poisson structure giving rise to Poisson--Lie or Poisson algebraic groups. 
