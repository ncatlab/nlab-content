...
that the resulting [[interacting field theory|interacting]] [[formal deformation quantization]] may equivalently be expressed in terms of _[[scattering amplitudes]]_ (example \ref{ScatteringAmplitudeFromInteractingFieldObservables} beow): These are the [[probability amplitudes]] for [[plane waves]] of [[free fields]] to come in from the far [[past]], then [[interaction|interact]] in a compact region of [[spacetime]] via the given [[interaction]] ([[adiabatic switching|adiabatically switched-off]] outside that region) and emerge again as [[free fields]] into the far [[future]].
