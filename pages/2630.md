A **ringoid** is a [[horizontal categorification]] of a [[ring]].  Since a ring is a [[monoid object]] in [[Ab]], or equivalently a one-object category [[enriched category|enriched over]] $Ab$, a ringoid is equivalently a [[Ab-enriched category]], often assumed to be [[small category|small]].
