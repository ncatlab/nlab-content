...
* such that interesting classes of [[σ-model]] [[FQFT|extended TQFTs]] $Z_P$ are [[representable functor|represented]] by [[motivation for sheaves, cohomology and higher stacks|generalized spaces]] $P$ 
