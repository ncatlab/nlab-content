...
and whose structure maps are the equivalences
...
The _Thom spectrum_ $M O$ is the [[spectrum]], which, as a [[sequential prespectrum]], has $n$th component space  the [[Thom space]] 
...
More abstractly, sufficient condition for a Thom spectrum of an ∞-module bundle (as [above](#ForInfinityModuleBundles)) to have [[E-∞ ring]] structure is that it arises,  as the [[(∞,1)-colimit]] of a homomorphism of [[E-∞ spaces]]  $B \to A Line$ ([ABG 10, prop.6.21](#ABG10)).
