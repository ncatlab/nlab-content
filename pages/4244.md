...
An $n$-dimensional _Calabi-Yau variety_ is an $n$-dimensional [[Kähler manifold]] with (holomorphically, rather than topologically) trivial [[canonical bundle]]. This is equivalent to say that it is an even dimensional real Riemannian manifold of dimension $2 N$ whose [[holonomy]] is in the subgroup $SU(N)\subset O(2 N, \mathbb{R})$. 
