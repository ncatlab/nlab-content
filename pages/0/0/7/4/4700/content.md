...
Graph homology $H\mathcal{G}_{\nullet\bullet}$ is the cohomology of the graph complex $(\mathcal{G}_{\bullet\bullet}, \partial)$ which is the free $\mathbf{C}$-vector space generated by isomorphism classes of oriented [[ribbon graph]]s modulo relation $(\Gamma,-\sigma) = - (\Gamma, \sigma)$ where $\Gamma$ is a ribbon graph with orientation $\sigma$. The differential is given by
