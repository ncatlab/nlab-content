...
This appears for instance as [Lenstra, main theorem 1.11](#Lenstra). It is fully discussed in SGA1.
...
* If $K$ is an arbitrary [[field]], then $\pi_1(Spec K)$ is the [[absolute Galois group]] of $K$; i.e. the [[Galois group]] of the [separable closure](#SeparableClosure) $K_S$ over $K$. In this case the [above theorem](#TheoremGaloisTheoryForSchemes) is a reformulation of [classical Galois theory](#ClassicalGaloisTheory).
