...
__Note on notation.__  The sign "&#10814;" is used here to indicate an order of relation composition, in particular, function composition, where $f \:\text{&#10814;}\: g$ means that a relation of the form $f \subseteq X \times Y$ is followed by a relation of the form $g \subseteq Y \times Z$.
