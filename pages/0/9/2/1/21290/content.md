...
where $(\sigma,x)$ represents a line that passes through $x$ with direction $\omega$. It is an open problem to determine the exponents $1\le p,q,r\le\infty$ for which the following inequality holds: