...
There are the following [[Green functions]] for the [[Klein-Gordon operator]] on $\Sigma$
...
$\mathcal{F}_{ml}$ a formal parameter $\hbar$ adjoined and equipped with the [[Moyal star product]] induced by the [[Hadamard state]]:
