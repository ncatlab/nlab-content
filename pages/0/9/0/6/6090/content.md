...
called _[[Bogoliubov's formula]]_ (e.g. [Rejzner 16 (6.12)](#Rejzner16)).
It was then considered within a rigorous construction of the perturbative S-matrix in ([Epstein-Glaser 73 around (74)](#EpsteinGlaser73)).
...
$$
  -i \hbar \frac{d}{d \epsilon} V_{L_{int}}(\epsilon \epsilon J)\vert_{\epsilon = 0} 
    \coloneqq  
