...
where the integration is thought to be over the space of field configurations
...
the causality property of the time-ordered products.

Notice that also the simple factorization property
