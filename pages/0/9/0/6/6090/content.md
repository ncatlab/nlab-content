   ...
   1. The S-matrix is the [[exponential]] of the time-ordered products: For $L \in \mathcal{F}_{loc}$
      ...
      $$
        \begin{aligned}
          S( L )
          & =
          T( \exp_{\otimes}( \tfrac{-g }{i \hbar} L ) )
          \\
          & \coloneqq
          \underoverset{k = 0}{\infty}{\sum} \tfrac{1}{k!}
          \left(\tfrac{-g}{i \hbar}\right)^k
          \langle    T(\underset{n\, \text{arguments}}{\underbrace{ L \cdots L}})   \rangle
        \end{aligned}
      $$
...
As a corollary of prop. \ref{GeneratingAlgebrasIsLocalNet} we then have:
