...
If you don\'t have (extensional) power sets either, then you\'ll have to either use [[setoid]]s (in which case, perhaps you\'d do better to change your terminology as described there) or include the existence of quotient sets as an axiom (such as if your foundations are some sort of [[pretopos]]).
