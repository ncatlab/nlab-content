...
Here we could even allow some categories that are not small, without running into Russell's paradox. More precisely: if one assumes the [Axiom of Universes](http://en.wikipedia.org/wiki/Universe_mathematics#In_category_theory), there is a sequence of [Grothendieck universes](http://en.wikipedia.org/wiki/Grothendieck_universe)
