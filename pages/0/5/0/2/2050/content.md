...
Full details may be found in [May](#Maybook). Key technical ingredients include: (1) each connected graph $X$ contains a maximal [[tree]] $T$ (using [[Zorn's lemma]]), (2) the quotient map $X \to X/T$ is a homotopy equivalence, and $X/T$ is a bouquet of circles. 
=-- 
