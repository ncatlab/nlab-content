...
### Relation with monoidal monads 
 {#RelationWithMonoidalMoands}

The structure of a commutative monad is closely related to that of a [[monoidal monad]], namely a [[monad#definition|monad in the bicategory]] of [[monoidal categories]], [[lax monoidal functors]] and [[monoidal natural transformations]]. 

For the details see [this Proposition](monoidal+monad#BijectSymmMonoidalMonadsWithCommStrongMonads) at *[[monoidal monad]]*.
...
A reference for this is [Kock '71, Section 2](#Kock71).
