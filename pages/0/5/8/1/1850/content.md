...
models the **electric current** on $X$. IF $X$ is globally hyperbolic and $\Sigma \subset X$ is any spacelike hyperslice, then
...
While electric current is modeled by just a differential form, magnetic charge has a more subtle model. See
