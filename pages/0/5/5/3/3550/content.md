...
Recall the definition and <a href="http://ncatlab.org/nlab/show/reflective+sub-(infinity%2C1)-category#ExactLocalizations">properties of exact reflective sub-(∞,1)-categories</a>. Roughly, a reflective sub $(\infty,1)$-category is obtained by localization at a collection $S$ of morphisms, and the embedding is _exact_ if this collection of morphisms is sufficiently stable under forming pullbacks.
