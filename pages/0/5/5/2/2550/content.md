...
The slice filtration is a functorial filtration of $SH(S)$ which is analogous to the [[Postnikov tower in an (∞,1)-category|Postnikov filtration]] for [[(∞,1)-topoi]]. It generalizes the _coniveau filtration_ in [[algebraic K-theory]], the _fundamental filtration_ on [[Witt groups]], and the _weight filtration_ on [[mixed motives]].
...
In analogy with the complex cobordism spectrum $MU$, Voevodsky defined the _algebraic cobordism spectrum_ $MGL \in SH(S)$ by
