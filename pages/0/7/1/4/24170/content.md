[[!redirects category of injective maps]]
...
Given a [[dagger 2-poset]] $A$, the **category of monic maps** $MonoMap(A)$ is the [[subobject|sub]]-[[2-poset]] whose [[objects]] are the objects of $A$ and whose [[morphisms]] are the [[injective map in a dagger 2-poset|injective maps]] of $A$. 
