...
In ([ABSP 19](#ABSP19)) it was proved that an electromagnetic duality ([[S-duality]]) transformation on the single copy gauge fields corresponds to an [Ehlers transformation](https://en.wikipedia.org/wiki/Ehlers_group) on the double copy gravitational field. In other words the following ideal diagram commutes:
