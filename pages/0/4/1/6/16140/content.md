...
* [[Eric M. Friedlander]], [[Christian Haesemeyer]], [[Mark E. Walker]]: _Techniques, computations, and conjectures for semi-topological K-theory_, Math. Ann., **330**  4 (2004) 759--807 &lbrack;[web](http://www.math.uiuc.edu/K-theory/0621/)&rbrack;

Survey:

* [[Eric M. Friedlander]], [[Mark E. Walker]]: _Semi-topological K-theory_, in *[[Handbook of K-theory]]*, Springer (2005) &lbrack;[web](http://www.math.illinois.edu/K-theory/handbook/)&rbrack;

Semi-topological K-theory for [[dg-categories]] was introduced in:

* {#Toen10} [[Bertrand Toen]]; lecture III of: _Saturated dg-categories_, lectures at *Workshop on Homological Mirror Symmetry and Related Topics*, University of Miami (Jan 2010) &lbrack;[notes](https://math.berkeley.edu/~auroux/frg/miami10-notes/)&rbrack;

Some discussion and interesting conjectures are in the last section of

* {#Kaledin10} [[D. Kaledin]]: _Motivic structures in non-commutative geometry_ &lbrack;[arXiv:1003.3210](http://arxiv.org/abs/1003.3210)&rbrack;

A state of the art treatment via [[dg-categories]], from the point of view of [[derived noncommutative algebraic geometry]]:

* {#Blanc13} [[Anthony Blanc]], _Topological K-theory of complex noncommutative spaces_, PhD thesis (2013) &lbrack;[arXiv:1211.7360](http://arxiv.org/abs/1211.7360)&rbrack;
