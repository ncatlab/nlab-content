...
be a differential of degree +1 that squares to 0. Hence $CE(X,\pi)$ is the [[Chevalley-Eilenberg algebra]] of some [[Lie algebroid]]. This is the **Poisson Lie algebroid** of $(X,\pi)$.
...
Under [[Lie integration]] a Poisson Lie alghebroid is supposed to yield a [[symplectic groupoid]].

#References#

A review is for instance in appendix A of

* [[Dmitry Roytenberg]], _Courant algebroids, derived brackets and even symplectic supermanifolds_ ([arXiv](http://arxiv.org/abs/math/9910078))