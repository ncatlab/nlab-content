...
A map between [[compact metric spaces]] $p : E\to B$ is called a 
...
[[proper map]] $p : E\to B$ is a **shape fibration** if for any compact $C\subset B$ the restriction of $p$ to a map $p^{-1}(C)\to C$ is a shape fibration between compact metric spaces. 
