...
Of course, where the monoidal product is not [[braided monoidal category|braided or symmetric monoidal]], due care must be exercised in distinguishing between different types of monoidal dual (left or right dual). 
