...
The [[site]] [[CartSp]] (Prop. \ref{TheDifferentiallyGoodOpenCoverCoverage}) is a [[cohesive site]] ([this Def.](geometry+of+physics+--+categories+and+toposes#OneCohesiveSite)), hence its [[sheaf topos]] is a [[cohesive topos]] (by [this Prop.](geometry+of+physics+--+categories+and+toposes#CategoriesOfSheavesOnCohesiveSiteIsCohesive)). Under the identification of Prop. \ref{SmoothSetsAreSheavesOnCartSp}, this means that:
