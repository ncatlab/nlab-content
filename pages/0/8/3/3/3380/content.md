...
A __totally convex space__ is a [[module for a monad|module]] for the [[monad]] on [[Set]] which sends a set $X$ to the [[closed ball|closed unit ball]] in the [[Banach space]] $\ell^1(X)$.
=--
