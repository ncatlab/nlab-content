...
To [[categorificartion|categorify]] this we'd like to replace $G$ with a [[2-group]], and replace $H$ with a "sub-2-group".  We then need to define the suitable analogue of the [[quotient]] $G/H$, and see in what sense $G$ acts transitively on this.
