...
1. If $R\;\rightrightarrows\; A$ is a kernel pair, then for any $f\colon B\to A$, the pullback $f^*R \;\rightrightarrows\; B$ is also a kernel pair.
...
+--{: .query}
[[Mike Shulman]]: I haven't checked the above all that carefully.
=--
