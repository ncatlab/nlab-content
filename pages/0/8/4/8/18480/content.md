...
The term *weakly connected trail* [appears](#privatecommunication) *not to be attested* in the combinatorial literature, but is in tune with some usual conventions (e.g. trail in the sense of [ ](#DG2nd), weakly-connected digraph), and it is a concept central to [Power's proof](#Power1990).
...
* email correspondence with various mathematicians working in digraph theory {#privatecommunication}
