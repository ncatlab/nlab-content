...
The [[excisive functors]] naturally carry a [[smash product]] ([Lydakis 98, def. 5.1](#Lydakis98)) making the model structure for 1-excisive functors a [[symmetric monoidal model category]] ([Lydakis 98, section 12](#Lydakis98)), hence a [[symmetric smash product on spectra]]. A  [[monoid]] with respect to this smash product (hence a [[ring spectrum]]) is euivalrntly a [[functor with smash products]] ("FSP") as earlier considered in ([B&#246;kstedt 86](#B&#246;kstedt86)).
