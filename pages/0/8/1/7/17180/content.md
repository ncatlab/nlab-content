...
For $n = 1$ this is a model structure on [[excisive functors]] from ([[finite homotopy type|finite]]) pointed simplicial setrs to pointed simplicial sets ([Lydakis 98, theorem 9.2](#Lydakis98),[Biedermann-Chorny-R&#246;ndings 06, section 9](#BiedermannChornyRondings06)), hence (see [here](excisive+%28?%2C1%29-functor#SpectrumObjects)) a [[model structure for spectra]] ([Lydakis 98, theorem 11.3](#Lydakis98)). 
...
The smash product on functors appearing in ([Lydakis 98](#Lydakis98)) had earlier been considered under the name "FSP" (short for "functors with smash product") in 

* {#B&#246;kstedt86} [[Marcel Bökstedt]], _Topological Hochschild homology_. Preprint, Bielefeld, 1986

Further generalization of this, in particular to [[enriched functors]] and to  [[n-excisive functors]] for $n \geq 1$ is discussed in
