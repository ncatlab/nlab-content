...
Here a proof consists of exhibiting a [[term]] of the corresponding type (showing that it is [[inhabited]]), hence a proof is a typing [[judgement]]
for a term of the type representing the proposition.
See also _[[proofs as programs]]_.

### Formal proof
 {#FormalProof}

Formal proofs are [[induction|inductively]] defined and hence fully circumscribed methods for producing a proof in the above sense
