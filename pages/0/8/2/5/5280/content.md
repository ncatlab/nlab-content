...
Now we set up a comparison with one of the "standard proofs", namely the one given in [Wikpedia](https://en.wikipedia.org/wiki/Schr%C3%B6der%E2%80%93Bernstein_theorem#Proof) that is attributed to Julius K&#246;nig. We can instead consider the fixed point as a union of finitary approximations 
