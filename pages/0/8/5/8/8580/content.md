...
Fundamentally, a language for [[physics]] is to be a language about _existence_. A language in which we can express [[judgements]] of the form:

> There is a thing $x$ of type $X$.

For instance:

> There is a [[gauge field]] $\nabla$ in the [[standard model of particle physics|standard model]] $[X,\mathbf{B}\left(U\left(1\right)\times U\left(2\right)\times U\left(3\right)\right)_{conn}]$ of gauge fields on [[spacetime]] $X$.

To be predictive, a language for physics is moreover to be a language in which we can make [[natural deduction|natural deductions]] to deduce more such [[judgements]] from given ones. For instance
...
The formal language for such _[[natural deduction]]_ of _[[judgements]]_ about existence of _[[terms]]_ of some _[[type]]_ is called _[[type theory]]_. The following table indicates the central elements of this language.
