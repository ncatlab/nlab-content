...
* The [[boolean domain]] $\mathbb{2}$ is a [[sigma-frame|$\sigma$-frame]] iff $LPO_{\mathbf{N}}$ holds. This implies that the classical notion of [[Dedekind real numbers]] can be constructed with respect to the $\sigma$-frame $\mathbb{2}$. However, the classical Dedekind real numbers does not coincide with the constructive notion of [[Dedekind real numbers]] constructed using the set of [[truth values]] $\Omega$ unless full [[excluded middle]] holds. 
