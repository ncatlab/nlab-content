...
A [[functor]] $U:D\to C$ is _monadic_ iff it has a left adjoint $F:C\to D$ and the adjunction $F\dashv G$ 'comes from' the induced [[monad]] on $C$ -- that is, $U$ _monadic_ iff $F\dashv U$ is a [[monadic adjunction]].
