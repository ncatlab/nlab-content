...
* a dependent product of witnesses that the [[fiber]] of $s$ at each term $b:\mathbb{Z}$ is a [[contractible type]]
$$\kappa:\prod_{b:\mathbb{Z}} \sum_{p:\sum_{a:\mathbb{Z}} f(a) =_\mathbb{Z} b} \prod_{q:\sum_{a:\mathbb{Z}} f(a) =_\mathbb{Z} b} p =_{\sum_{a:\mathbb{Z}} f(a) =_\mathbb{Z} b} q$$
=--
