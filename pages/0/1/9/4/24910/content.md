...
In [[dependent type theory]], the type of classes relative to the [[Tarski universe]] $U$ is the function type $V_U \to \mathrm{Prop}_U$ from the [[material set theory|material]] [[cumulative hierarchy]] [[higher inductive type]] constructed from $U$ to the type of $U$-small [[h-propositions]]. 

## Definition

Let $(U, T)$ be a [[Tarski universe]]. The [[cumulative hierarchy]] relative to $U$ is a type $V_U$ generated by the following:
