...
* If $C$ is [[extensive category|extensive]], then its coherent topology is generated by the [[regular coverage|regular topology]] together with the [[extensive topology]].  (In fact, the coherent topology is [[superextensive site|superextensive]].)
