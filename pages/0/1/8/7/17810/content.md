...
is not just a $\mathbb{Z}$-graded supercommutative superalgebra with the [[extra property]] that it is 
...
in degree 1, subject to the relation $\beta^{1/2} \beta^{1/2} = \beta$. Then the induced $\mathbb{R}[\beta, \beta^{-1}]$-algebra is
