...
Some authors leave out (3), which allows $\empty$ itself to be a Grothendieck universe.  Other authors use the set $\mathbb{N}$ of [[natural number]]s in place of $\empty$ in (3), which prevents the countable set $V_\omega$ of [[hereditarily finite set]]s from being a Grothendieck universe.
