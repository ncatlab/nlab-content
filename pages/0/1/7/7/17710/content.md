...
The usual [[quantum mechanics]] based on [[Schrödinger picture]] [[wave functions]] can be reformulated using a different distribution which behaves in some aspects more like a [[probability distribution]], except that it is negative for some points in [[phase space]]. 
...
* [[Eugene P. Wigner]]: _On the quantum correction for thermodynamic equilibrium_,  Phys. Rev. **40** 5 (1932) 749--759
