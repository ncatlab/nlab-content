...
By prop. \ref{WaveFronSetsForKGPropagatorsOnMinkowski} the [[wave front set]] of $\Delta_H$ has all cotangents on the first variables future pointing

<center>
<img src="https://ncatlab.org/nlab/files/HadamardPropagator.png" width="60">
</center>

and hence all those on the second variables past pointing. 
...
The [[time-ordered product]] on [[regular polynomial observables]] (def. \ref{CausalOrderingTimeOrderedProductOnRegular}) is [[isomorphism|isomorphism]] to the pointwise product of [[observables]] (def. \ref{Observable}) via the [[linear isomorphism]]
