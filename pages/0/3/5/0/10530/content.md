...
A [[2d superconformal field theory]] in which the holomorphic sector (the "right movers") has $N=2$ [[supersymmetry]], while the antiholomorphic sector (the "left movers") has no supersymmetry (or the other way around), is traditionally denoted as $N = (2,0)$ supersymmetry.
...
An attempt to formalize this mathematically in terms of [[sheaves of vertex operator algebras]] and the [[chiral de Rham complex]] is in
