...
Persistent homology is a homology theory adapted to a computational context. It keeps track of homology classes which stay 'persistent' when the approximate image of a space gets refined to higher resolutions.  
