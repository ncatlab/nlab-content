...
but beware that [Scull 01](#Scull01) claims that the statement about [[minimal models]] there is not correct. Corrected statements for finite groups as well as generalization to [[compact Lie groups]], at least to the [[circle group]], is due to:
...
* Rekha Santhanam, Soumyadip Thandar, §2 of: *Equivariant Intrinsic Formality* &lbrack;[arXiv:2301.06824](https://arxiv.org/abs/2301.06824)&rbrack;
