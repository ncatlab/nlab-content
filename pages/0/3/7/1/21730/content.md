...
Retrofunctors generalise both [[bijective on objects functor|bijective-on-objects functors]] and [[discrete opfibrations]]. 
...
and a map sending each pair $(a \in A, u : \varphi_{0}a \to b \in B)$ to a [[morphism]] $\varphi_{1}(a, u) : a \to a'$ in $A$ such that 
...
* $\varphi_{1}$ preserves composition: $\varphi_{1}(a, v \circ u) = \varphi_{1}(a', v) \circ \varphi_{1}(a, u)$. 
