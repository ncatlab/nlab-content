...
Rabinowitsch (who according to one famous [story](http://mathoverflow.net/a/45195/2926) later renamed himself Rainich -- but see the follow-up [here](https://mathoverflow.net/questions/416577/identity-of-j-l-rabinowitsch-of-rabinowitsch-trick) casting doubt on the story), showed how to deduce the Strong Nullstellensatz from the Weak Nullstellensatz. Often this is described as Rabinowitsch's "trick" (i.e., something involving a stroke of cleverness), but see the remark below which places the trick conceptually within the general method of localization. 
