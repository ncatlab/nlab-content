...
Countable [[dense directed loop graph|dense]] linear orders without endpoints are unique up to isomorphism, and are canonically modeled by the [[rational numbers]] $(\mathbb{Q}, \lt )$.
