...
For $\Gamma$ any graph, we write $\big[ \Gamma\big]$
for the [[equivalence class]] under this [[equivalence relation]] which it represents.
...
+-- {: .num_defn #GraphsWithDirectLoopsVanish}
###### Definition
**(no tadpoles)**
