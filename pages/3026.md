...
For a simple example: the real projective plane $\mathbb{RP}^2$ is the one-point compactification of the 'open' M&ouml;bius strip, as line bundle over $S^1$. This is a special case of the more general observation that $\mathbb{RP}^{n+1}$ is the Thom space of the tautological line bundle over $\mathbb{RP}^n$. 
