...
([Illmann 83, theorem 7.1, corollary 7.2](#Illmann83)) Recalled as ([ALR 07, theorem 3.2](#ALR07)).

Moreover, if the manifold does have a boundary, then its G-CW complex may be chosen such that the boundary is a G-subcomplex. ([Illmann 83, last sentence above theorem 7.1](#Illmann83))
...
* {#Illmann83} Sören Illman, _The equivariant triangulation theorem for actions of compact Lie groups_, Math. Ann. 262 (1983), no. 4, 487–501. 
