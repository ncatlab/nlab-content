...
nature of [[regular polynomial observables]], this is given by [[conjugation]] of the pointwise product ([this equation](A+first+idea+of+quantum+field+theory#eq:ObservablesPointwiseProduct)) with $\mathcal{T}$ ([this equation](Wick+algebra#eq:OnRegularPolynomialObservablesPointwiseTimeOrderedIsomorphism))
...
###### Definition
**([[interacting field algebra]] [[structre]] on [[regular polynomial observables]])**
