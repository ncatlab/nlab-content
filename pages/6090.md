...
We consider now the [[axioms]] for a perturbative S-matrix of a [[Lagrangian field theory]] as used in  [[causal perturbation theory]] (def. \ref{PerturbativeSMatrixOnMinkowskiSpacetime} below).
...
Let $(E,\mathbf{L})$ be a [[free field theory]] [[Lagrangian field theory]] ([this def.](A+first+idea+of+quantum+field+theory#FreeFieldTheory)), and $(E_{\text{BV-BRST}}, \mathbf{L}')$ be a [[gauge fixing]] ([this def.](A+first+idea+of+quantum+field+theory#GaugeFixingLagrangianDensity)) with [[graded manifold]] BV-BRST [[field bundle]] $E_{\text{BV-BRST}}$ ([this remark](A+first+idea+of+quantum+field+theory#FieldBundleBVBRST)). Let $\Delta_H$ be the [[2-point function]] of a compatible choice of [[Hadamard vacuum state]] (the [[Wightman propagator]]), so that $(PolyObs(E_{\text{BV-BRST}})[ [\hbar] ], \star_H)$ is the corresponding [[Wick algebra]] [[algebra of quantum observables|of quantum observables]].
...
Then a _perturbative [[S-matrix]]_ for [[perturbative QFT|perturbation theory]] around this [[free quantum field theory]] is a [[function]]

$$
  S
    \;\colon\;
  PolyLocObs(E_{\text{BV-BRST}})[ [\hbar] ]( \langle g, j\rangle  )
    \longrightarrow
  PolyObs(E_{\text{BV-BRST}})_{mc}((\hbar))[ [ g,j ] ]
$$

from polynomial [[local observables]] to [[microcausal polynomial observables]] with formal paramaters adjoined as indicated ([[Laurent series]] in [[Planck's constant]] $\hbar$ and [[formal power series]] in [[interaction]] [[coupling constant]] $g$ and [[source field]] coupling $j$)

such that the following conditions hold::

1. (perturbation)

   There exist [[multilinear map|multi-]][[linear continuous functionals]] of the form
