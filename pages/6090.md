...
_while the input of [[causal perturbation theory]] is a [[Lagrangian field theory]],
...
$$
  \array{
    ...
    \array{
      \text{perturbative algebraic}
      \\
      \text{quantum field theory}    }
    \\
    \underset{\text{(ancient)}}{\,}
    &
...
allows to obtain a well defined [[inductive limit]]-algebra
...
which are locaized in spacetime as the spacetime localization region varies:
...
(While the elements $K$ in (eq:AdiabaticSwitchingRelationGeneratingFunctions) need not be unique themselves,
