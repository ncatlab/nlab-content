...
[[algebra of observables]], also a _[[state on a star-algebra|state]]_ 
  ...
  it is not to be expected to be a _[[vacuum]]_ state for the [[interacting field theory]] in a suitable sense. Rather, just as the [[interacting field algebra of observables]] $\mathcal{A}_{int}$ is a [[deformation]] of the free field algebra of observables ([[Wick algebra]]), there ought to be a corresponding deformation of the free [[Hadamard vacuum state]] $\langle- \rangle$ into an "interacting vacuum state" $\langle - \rangle_{int}$.
