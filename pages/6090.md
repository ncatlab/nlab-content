...
$$
  \left \mathbf{\Phi}(x)_{int} \langle
  \;=\;
...
Assume then that there exists a corresponding functional of the [[field histories]] $\Gamma(\Phi)$, which behaves like a functional [[Legendre transforms]] of $W$ in that it satisfies the functional version of the defining equation of Legendre transforms (first derivatives are [[inverse functions]] of each other, see [this equation](Legendre+transformation#eq:DerivativesOfLegendreTransformsAreInverseFunctions)), in that
...
$$
 ...
 \Gamma
  \left(
    \underset{
       \left\langle \mathbf{\Phi}(x)_{int} \right\rangle
    }{
    \underbrac{
...
This is then read as a quantum version of the [[principle of extremal action]] (prop. \ref{A+first+idea+of+quantum+field+theory#PrincipleOfExtremalAction})
formulated now not for the [[field histories]] $\Phi(x)$, but for the [[vacuum expectation values]] $\langle \mathbf{\Phi}(x)_{int}\rangle$ of their corresponding [[interacting quantum field observables]], and subject to [[source fields]].
