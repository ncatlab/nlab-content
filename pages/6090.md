...
for the [[complex vector space|complex]] [[topological vector space]] 
of [[formal power series]] in three [[variables]] $\hbar$ ("[[Planck's constant]]"),
$g$ ("[[ciupling constant]]") and $j$ ("[[source field]]") with  [[coefficients]] in the [[topological vector space]] of, respectively, 
...
may be regarded as [[spacetime]]-dependent "[[couopling constants]]" with compact support, 
called _[[adiabatic switching|adiabatically switched]] couplings_.

Similarly then

$$
  LocObs(E_{\text{BV-BRST}})[ [ \hbar, g, j ] ] \otimes_{\mathbb{C}}\langle g , j \rangle
$$
...
$$
  \mathcal{S}
    \;\colon\;
  LocObs(E_{\text{BV-BRST}})[ [\hbar , g, j] ] \otimes_{\mathbb{C}} \mathbb{C}\langle g,g\rangle
    \longrightarrow
  PolyObs(E_{\text{BV-BRST}})_{mc}((\hbar))[ [ g, j ] ]
$$
...
1. ([[perturbative quantum field theory|perturbation]])
   ...
   $$
     ...
     \left(
       {\, \atop \,}
       LocObs(E_{\text{BV-BRST}})[ [\hbar, g, j] ] \otimes_{\mathbb{C}} \mathbb{C} \langle g, j \rangle
       {\, \atop \,}
