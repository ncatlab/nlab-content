A __symmetric set__ (or symmetric simplicial set) is a [[simplicial set]] $X$ equipped with additional _transposition maps_ $t^n_i: X_n \to X_n$ for $i=0,\ldots,n-1$.  These transition maps generate an [[action]] of the [[symmetric group]] $\Sigma_{n+1}$ on $X_n$ and satisfy certain commutation relations with the face and degeneracy maps.
