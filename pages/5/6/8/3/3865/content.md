...
Finally there will be some counterexamples, phenomenons that contradict the intuition built from bounded operators [here] (/nlab/show/unbounded+operator#counterexamples).
