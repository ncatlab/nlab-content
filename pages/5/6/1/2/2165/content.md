...
Complex conjugation is the nontrivial [[field]] [[automorphism]] of $\mathbb{C}$ which leaves ${\mathbb{R}}$ invariant. In other words, the Galois group $Gal({\mathbb{C}}/\mathbb{R})$ is cyclic of order two and generated by complex conjugation.
...
[[!redirects complex number systems]]
