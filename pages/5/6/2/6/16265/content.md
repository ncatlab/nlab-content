...
+-- {: .proof} 
###### Proof 
Suppose we have _proper_ inclusions $f_j: A_j \hookrightarrow B_j$. Choose basepoints $x_j \in B_j \setminus A_j$ and, letting $\prod_i B_i \stackrel{\pi_j}{\to} B_j$ be the product projection and $A_j \stackrel{i_j}{\to} \sum_A_i$ the coproduct inclusion, define a map $f: \sum_j A_j \to \prod_j B_j$: 
