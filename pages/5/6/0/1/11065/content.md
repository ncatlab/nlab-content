...
Possible realization of chiral fermions in [[string phenomenology]] is given by [[intersecting D-brane models]] ([here](intersecting+D-brane+model#ChiralFermions)) lifting to [[M-theory on G₂-manifolds]] ([here](M-theory+on+G2-manifolds#EnhancedGaugeGroups)) at [[ADE-singularities]]
