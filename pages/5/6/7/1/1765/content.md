Let $f : R\to S$ be the extension of $k$-algebras (where $k$ is a commutative unital [[ring]]). The corresponding __canonical coring__ or __Sweedler coring__ is the $R$-[[coring]] $C = S\otimes_R S$ with coproduct $\Delta : C\to C\otimes_R C \cong S\otimes_R S\otimes_R S$, $\Delta: s_1\otimes s_2 \mapsto s_1\otimes 1 \otimes s_2$ and counit $\epsilon : C\to R$ given by $\epsilon: s_1 \otimes s_2 \mapsto s_1 s_2$.  
