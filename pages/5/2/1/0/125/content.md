...
Traditionally, the composite is written $g \circ f$, following the notation introduced by the followers of Leibniz for composition of functions. This can be abbreviated as simply $g f$. On the other hand, reading a diagram
$$\array{
 x & \to^f & y & \to^g & z
}$$
