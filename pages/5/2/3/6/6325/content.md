...
The _Stone-von Neumann theorem_ (due to M. Stone and [[John von Neumann]]) says that there is -- up to [[isomorphism]] -- a unique [[irreducible representation|irreducible]] [[unitary representation]]s of the [[Heisenberg group]] on finitely many generators (equivalently: of the [[associative algebra|algebra]] of [[canonical commutation relations]]).
