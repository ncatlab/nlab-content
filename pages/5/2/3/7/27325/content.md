...
Recall that a [[light profinite set]] is a [[countable set|countable]] [[limit]] of [[finite sets]]. A **light condensed set** is a [[sheaf]] on the [[site]] of [[light profinite sets]] with finite jointly surjective families of maps as covers. 
