...
A _geometric $\infty$-stack_ is an [[∞-stack]] over a [[geometry (for structured (∞,1)-toposes)|geometry]] with [[function algebras on ∞-stacks|function theory]]  $(\mathcal{O} \dashv Spec)$ which is an [[groupoid object in an (∞,1)-category|∞-groupoid]] that is degreewise an $\infty$-stack in the image of $Spec$.
...
> The text below follows ([To&#235;n 00](#Toen00)). Needs to be expanded and ([To&#235;n-Vezzosi 04](#ToenVezzosi04), [Lurie](#Lurie)) needs to be brought into the picture... 
...
1. the target map $d_1 : K_1 \to K_0$ is (...sufficiently well behaved...)
