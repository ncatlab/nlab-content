...
Unitary operators are the [[automorphism]]s of Hilbert spaces since they preserve the basic structure of the space, e.g. the topology.  The group of all unitary operators from a given Hilbert space to itself is sometimes called the [[unitary group]] $U(\mathcal{H})$ or  _Hilbert group_ of $H$ and is denoted Hilb($H$).
