...
1. the canonical smooth [[functor]] $X_\bullet \to \mathbb{H}(X_0)$ to the [[Haefliger groupoid]] of the manifold of objects is [[faithful functor|faithful]], i.e. gives a [[representable morphism of stacks]];
