...
A **functional** is a map $V \to k$ in $Vect_k$ from a [[vector space]] to the ground [[field]]. In the case that $V$ is a [[TVS]], then by functional we usually mean a continuous functional. 
