...
What is called _Gaussian elimination_ is an [[algorithm]] for solving systems of [[linear equations]]. It proceeds by encoding the system as a suitable [[matrix]] and then applying [[elementary row operations]] to bring  it into [[upper triangular form]].
