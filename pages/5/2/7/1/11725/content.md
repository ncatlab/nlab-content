...
In [[algebraic geometry]] there is no exponential sequence, the closest analogs being the [[Kummer sequence]] and the [[Artin-Schreier sequence]]. But in [[logarithmic geometry]] there is again a kind of exponential sequence (e.g. [Brylinski 94, page 15](#Brylinski94))
