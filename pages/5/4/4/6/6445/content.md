__Matroid__ is one of the basic structures of combinatorics with several different ways of encoding/defining and presenting the generalization of the idea of a linearly independent basis in a vector space. There is also a similar concept of an [[oriented matroid]]; every oriented matroid has an underlying matroid. 
