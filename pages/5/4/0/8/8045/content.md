...
theory_) is a style of [[set theory]] that contrasts with [[structural set theory]].  In a material set theory, the elements of a set exist independently of that set.  (The terminology 'material', or at least 'materialistic', goes back at least to [Friedman 1997](#Friedman1997).)
...
* [[Harvey Friedman]] (1997). [Foundational Completeness](https://cs.nyu.edu/pipermail/fom/1997-November/000143.html). FOM, 1997 November.
  {#Friedman1997}
