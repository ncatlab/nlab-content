...
The **mod $p$-Steenrod algebra** $\mathcal{A}_{\mathbb{F}_p}$ is the [[Hopf algebra]] over $\mathbb{F}_p$ which is
...
The $\mathbb{F}_p$-[[linear dual]] of the mod $p$-Steenrod algebra (def. \ref{SteenrodAlgebraForHFp}) is itself naturally a [[Hopf algebra]] (with coproduct the linear dual of the original product, and vice versa), called the **dual Steenrod algebra** $\mathbb{A}_{\mathbb{F}_p}^\ast$.
