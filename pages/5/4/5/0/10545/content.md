...
For any prime $p$, the mod-$p$ Steenrod algebra furthermore has the structure of a [[Hopf algebra]], non-commutative but co-commutative. Under forming [[linear duals]] this gives the _dual Steenrod algebra_, traditionally denoted $\mathcal{A}_\ast$ instead of $\mathcal{A}^\ast. This is a [[Hopf algebra]] that is commutative, but non-co-commutative.

The dual Steenrod algebra is a special case of the commutative and non-co-commutative [[Hopf algebroid]] structure canonically induced on the self [[generalized homology]] $E_\bullet(E)$ of any [[ring spectrum]] $E$ for which $E_\bullet \to E_\bullet(E)$ is a [[flat morphisms]]. Therefore in this general case one sometimes speaks of "$E$-Steenrod algebras".

The [[Ext]]-groups between [[comodules]] for these Hopf algebroids prominently appear on the second page of the $E$-[[Adams spectral sequence]], see there for more.
