...
A functor is dense iff it is (left) adequate in the sense of Isbell i.e. if the corresponding [[nerve|nerve functor]] is [[full and faithful functor|fully faithful]]. 
