...
For many topologists, analysts and so on, the *noun* '[[compact space|compact]]' means "a compact Hausdorff space". Some topological schools distinguish a "compact space" (not necessarily including the [[Hausdorff space|Hausdorff]] property) and a "compactum" (Hausdorff); and similarly a "paracompact space" and a "paracompactum". In [[algebraic geometry]], in contrast, one usually says __quasicompact space__ to denote a topological space which is compact but not necessarily Hausdorff. Indeed, the [[Zariski topology]] on an [[algebraic variety]] and the topology of an &#233;tal&#233; space of a [[sheaf]] (even over a Hausdorff topological space) are typically not Hausdorff.
