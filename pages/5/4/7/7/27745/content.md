...
* [personal page](http://sebastien.bardin.free.fr/)

* [GoogleScholar page](https://scholar.google.fr/citations?user=5tee-l8AAAAJ&hl=en)

## Selected writings

On [[formal method|formal]] [[quantum circuit]] [[software verification]] via [[QBricks|`QBricks`]]:
...
Generally on [[software verification]] ([[formal methods]]) for [[quantum computing]]/[[quantum algorithms]]:
