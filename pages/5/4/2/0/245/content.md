A _braided monoidal category_ is a [[monoidal category]] equipped with a natural isomorphism
$$ B_{x,y} : x \otimes y \to y \otimes x $$
called the _braiding_, which must satisfy an axiom called the [[hexagon identity]].  Intuitively speaking, the braiding lets us 'switch' objects in a tensor product.  
...
Eventually we should include all these diagrams here!  Unfortunately I don't know an easy way to do this yet.