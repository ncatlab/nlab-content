...
of the background solution $\varphi$ (eq:FunctionsOnInfinitesimalNeighbourhoodOfBackgroundSolution) to the BV-complex  
...
$$
  im\left( \Gamma_\Sigma^{ev}(V_\Sigma(E,\varphi)) \overset{\delta_{BV}}{\to} \Omega^{0,0}_\Sigma(E,\varphi) \right)
$$
...
$$
  ker\left( \Gamma_\Sigma^{ev}(V_\Sigma(E,\varphi)) \overset{\delta_{BV}}{\to} \Omega^{0,0}_\Sigma(E,\varphi)\right)
$$
