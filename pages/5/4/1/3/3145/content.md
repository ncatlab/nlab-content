...
Michael Jerome Hopkins is a mathematician at Harvard University. He got his PhD from Northwestern University in 1984, advised by [[Mark Mahowald]], and became a world leading researcher in [[algebraic topology]] and ([[stable homotopy theory|stable]]-)[[homotopy theory]].

Among notable achievements are his work on the [[Ravenel conjectures]], the introduction and discussion of the [[generalized cohomology theory]] _[[tmf]]_  and its [[string orientation of tmf|string orientation]], a formalization and construction of [[differential cohomology]], the proof of the [[Kervaire invariant]] problem.  More recently via [[Jacob Lurie]]'s work on the [[cobordism hypothesis]] Hopkins participates in work related to the foundations of [[quantum field theory]].


* [personal page](https://people.math.harvard.edu/~mjh/)

* [institute page](https://www.math.harvard.edu/people/hopkins-michael/)

* [MathGenealogy page](https://www.genealogy.math.ndsu.nodak.edu/id.php?id=5672)

* [Wikipedia entry](http://en.wikipedia.org/wiki/Michael_J._Hopkins)

* [inSpire page](https://inspirehep.net/authors/1051886)

* [GoogleScholar page](https://scholar.google.com/citations?user=csg4lNEAAAAJ&hl=en)
...
On the [[stable homotopy theory]] of the [[loop spaces]] of [[special unitary group]] and of [[quaternionic unitary groups]] (with early discussion of [finite-dimensional complex orientation](complex+oriented+cohomology+theory#ReferencesFiniteStageOrientations) of [[generalized cohomology theories]]):
...
* {#DevinatzHopkinsSmith88} [[Ethan Devinatz]], [[Michael Hopkins]], [[Jeffrey Smith]], _Nilpotence and Stable Homotopy Theory I_, Annals of Mathematics Second Series **128** 2 (1988) 207-241 &lbrack;[jstor:1971440](https://www.jstor.org/stable/1971440)&rbrack; 

* {#DevinatzHopkinsSmith98} [[Ethan Devinatz]], [[Michael Hopkins]], [[Jeffrey Smith]], _Nilpotence and Stable Homotopy Theory II_, Annals of Mathematics Second Series **148** 1 (1998) 1-49 &lbrack;[jstor:120991](https://www.jstor.org/stable/120991)&rbrack;
...
* {#HopkinsHovey92} [[Michael Hopkins]], [[Mark Hovey]]: _Spin cobordism determines real K-theory_, Mathematische Zeitschrift **210** (1992) 181–196 &lbrack;[doi:10.1007/BF02571790](https://doi.org/10.1007/BF02571790), [[HopkinsHoveyCobordismK.pdf:file]]&rbrack;


The construction of [[tmf]] was originally announced, as joint work with [[Mark Mahowald]] and [[Haynes Miller]], in 

* {#Hopkins94} [[Michael Hopkins]], section 9 of _Topological modular forms, the Witten Genus, and the theorem of the cube_, Proceedings of the International Congress of Mathematics, Z&#252;rich (1994) &lbrack;[[Hopkins_TopModFormsAtICM.pdf:file]], [doi:10.1007/978-3-0348-9078-6_49](https://doi.org/10.1007/978-3-0348-9078-6_49)&rbrack;
  > (There the spectrum was still called "$eo_2$" instead of "$tmf$".) 


On [[elliptic genera]], the [[Witten genus]] and the [[string orientation of tmf]]:

* {#AndoHopkinsStrickland01} [[Matthew Ando]], [[Michael Hopkins]], [[Neil Strickland]], _Elliptic spectra, the Witten genus and the theorem of the cube_, Invent. Math. **146** (2001) 595-687  &lbrack;[doi:10.1007/s002220100175](https://doi.org/10.1007/s002220100175), [pdf](http://www.math.rochester.edu/people/faculty/doug/otherpapers/musix.pdf), MR1869850&rbrack;
...
* [[Michael Hopkins]]: *[[Complex oriented cohomology theories and the language of stacks]]*, lecture notes (1999) &lbrack;[pdf](https://web.math.rochester.edu/people/faculty/doug/otherpapers/coctalos.pdf), [[HopkinsComplexOrientedCohomology.pdf:file]]&rbrack;

* {#Hopkins} [[Mike Hopkins]] (talk notes by [[Michael Hill]]), _Stacks and complex oriented cohomology theories_ Talbot lecture notes (2007) &lbrack;[pdf](http://math.mit.edu/conferences/talbot/2007/tmfproc/Chapter08/MikesTalk1.pdf)&rbrack;
...
* [[Matthew Ando]], [[Andrew Blumberg]], [[David Gepner]], [[Michael Hopkins]], [[Charles Rezk]], _Units of ring spectra, orientations, and Thom spectra via rigid infinite loop space theory_, Journal of Topology, **7** 4 (2014) &lbrack;[arXiv:1403.4320](https://arxiv.org/abs/1403.4320), [arXiv:10.1112/jtopol/jtu009](https://doi.org/10.1112/jtopol/jtu009)&rbrack;

* {#ABGHR14} [[Matthew Ando]], [[Andrew Blumberg]], [[David Gepner]], [[Michael Hopkins]], [[Charles Rezk]], _An $\infty$-categorical approach to $R$-line bundles, $R$-module Thom spectra, and twisted $R$-homology_, Journal of Topology **7**  3 (2014) 869-893 &lbrack;[arXiv:1403.4325](http://arxiv.org/abs/1403.4325), [doi:10.1112/jtopol/jtt035](https://doi.org/10.1112/jtopol/jtt035)&rbrack;



On [[topological quantum field theory]]:

* [[Dan Freed]], [[Mike Hopkins]], [[Jacob Lurie]], [[Constantin Teleman]]: *[[Topological Quantum Field Theories from Compact Lie Groups]]* in P. R. Kotiuga (ed.): *A celebration of the mathematical legacy of Raoul Bott* AMS (2010) 367-403 &lbrack;[arXiv:0905.0731](http://arxiv.org/abs/0905.0731), [doi:10.1090/crmp/050](https://doi.org/10.1090/crmp/050), [ISBN:978-0-8218-4777-0](https://bookstore.ams.org/view?ProductCode=CRMP/50)&rbrack;
...
* [[Daniel S. Freed]], [[Michael Hopkins]], [[Constantin Teleman]], 
  ...
  1. _[[Loop Groups and Twisted K-Theory]] I_, 
     ...
     &lbrack;[arXiv:0711.1906](http://arxiv.org/abs/0711.1906), [doi:10.1112/jtopol/jtr019](https://doi.org/10.1112/jtopol/jtr019)&rbrack;

  1. _[[Loop Groups and Twisted K-Theory]] II_, 

     J. Amer. Math. Soc. **26** (2013) 595-644  

     &lbrack;[arXiv:0511232](http://arxiv.org/abs/math/0511232), [doi:10.1090/S0894-0347-2013-00761-4](https://doi.org/10.1090/S0894-0347-2013-00761-4)&rbrack;

  1. _[[Loop Groups and Twisted K-Theory]] III_, 

     Annals of Mathematics **174** (2011) 947-1007 

     &lbrack;[arXiv:math/0312155](http://arxiv.org/abs/math/0312155), [doi:10.4007/annals.2011.174.2.5](http://dx.doi.org/10.4007/annals.2011.174.2.5)&rbrack;
