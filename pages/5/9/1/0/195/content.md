...
It is common to use [[foundations of mathematics]] in which 'set' is an undefined term; this is [[set theory]] as a foundation.  In a [[pure set|pure]] [[material set theory]] like [[ZFC]], every object is a set.  Even in a [[structural set theory|structural approach]] such as [[ETCS]], it is common for every object to be a [[structured set]] in some way or another.  Even if sets are not at the bottom of your foundations, still they are probably close.
