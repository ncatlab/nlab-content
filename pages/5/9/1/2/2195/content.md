...
1. (interchanging [[coordinate]] [[multiplication]] with [[partial derivatives]])
   ...
   $$
     ...
     \widehat{ x^a f } = \frac{i}{2 \pi} \partial_a \widehat f
     \phantom{AAAAA}
     \widehat{ \partial_a f} = 2\pi i k_a \widehat f
   $$
...
$$
  \begin{aligned}
    \widehat {x^a f}(k)
    & \coloneqq
    \int x^a f(x) e^{-2 \pi i \vec k \cdot \vec x}
    \, dvol(x)
    \\
    & =
    \frac{i}{2\pi} \int f(x) \frac{\partial}{\partial k_a} e^{-2 \pi i \vec k \cdot \vec x}
     \, dvol(x)
    \\
    & =
    \frac{ i}{2\pi} 
    \frac{\partial}{\partial k_a}
    \int  f(x)  e^{-2 \pi i \vec k \cdot \vec x}
   \, dvol(k)
    \\  
    & = \frac{i}{2\pi}\frac{\partial}{\partial k_a}
    \widehat{f}(k)
  \end{aligned}
$$
...
$$
  \begin{aligned}
    \widehat{ \partial_a f }(k)
     & =
    \int 
      \left( \frac{\partial}{\partial x^a} f(x) \right)
      e^{-2 \pi i \vec k \cdot \vec x}
      dvol(x)
    \\
    & =
    - \int f(x) \frac{\partial}{\partial x^a} e^{-2 \pi i \vec k \cdot \vec x}
    dvol(x)
    \\
    & =
    + 2\pi i k_a \widehat{f}(k)
  \end{aligned}
$$
