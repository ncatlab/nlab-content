...
If $X$ is a "grouplike H-space", in that it is a topological [[magma]] such that left multiplication acts by [[weak homotopy equivalences]], then the [[homotopy fiber]] of the Hopf construction $X \ast X \to \Sigma X$ over any point is
