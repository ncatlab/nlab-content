...
*  In a $2$-crossed module as above the structure $\partial_2: L \to M$ is a [[crossed module]], but $\partial_1: M\to N$ is not as the Peiffer identity does not hold.  The _[[Peiffer commutator]]_, which measures the failure of that identity, may not be trivial, but it will be an boundary element and the Peiffer lifting gives a structured way of getting an element in $L$ that maps down to it.