...
If $A$ is a [[Ring|commutative unital ring]], then we look at the [[bimodule]] $\Omega_K(A)$ over $A$ generated by $d a$, subject to relations 
...
Let us call $\Omega^1(A)$ the $A$-bimodule usual 1-forms. In that case $A=C^\infty(R)$ and any $A$-bimodule morphism $\mu:\Omega_K(A)\to M$ factors through the ordinary 1-forms: 
