...
Suppose $A$ is a [[commutative algebra]] over a field $k$.   We may define K&#228;hler differentials either by an explicit construction or by a universal property.  

The construction is as follows. The module of **K&#228;hler differentials** $\Omega^1_K(A)$ over $A$ is generated by symbols $d a$ for all $a\in A$, subject to these relations:
