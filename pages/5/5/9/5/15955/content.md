...
$${}^L G\to {}^L H$$
between the [L-groups](http://en.wikipedia.org/wiki/Langlands_dual) of two [[reductive algebraic group|reductive groups]] over $\Q$ should induce a transfer map from automorphic representations for $G$ to automorphic representations of $H$.
