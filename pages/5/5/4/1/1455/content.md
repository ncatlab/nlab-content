...
To a [[category theory|category theorist]], [[algebras over a monad]] may seem more common and natural than algebras over just an endofunctor.  In fact, when $C$ and $F$ are well-behaved, then algebras over an endofunctor $F$ are equivalent to algebras over a certain monad, the [[algebraically-free monad]] generated by $F$.
