...
A von Neumann algebra or $W^*$-algebra is an important and special kind of [[operator algebra]], relevant to [[measure theory]] and [[quantum mechanics]] (as well as other things).
...
Fix a [[complex number|complex]] [[Hilbert space]] $H$ and consider the algebra $B(H)$ of [[bounded operators]] on $H$.  A __von Neumann algebra__ on $H$ is a unital $*$-subalgebra of $B(H)$ that is closed in the [[weak operator topology]], or equivalently in the [[ultraweak topology]].  As such is automatically closed in the [[norm topology]], the von Neumann algebras form a (particularly nice) class of concrete $C^*$-[[C-star-algebra|algebras]].
