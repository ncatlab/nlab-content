...
* In particular, if $\kappa$ is the "size of the universe" --- e.g. an [[inaccessible cardinal]] for which we have chosen to call sets of cardinality $\lt\kappa$ [[small set|small]], then it is an arity class.  In this case we call $\kappa$-ary objects **infinitary** or $\infty$-ary.
...
In [[constructive mathematics]], however, not every arity class may arise from a regular cardinal.  (Arguably, however, in constructive mathematics one should consider "regular sets of cardinalities" instead of regular cardinals anyway.)
