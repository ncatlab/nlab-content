...
such that every left [[Bousfield localization of model categories|Bousfield localization]] of the [[Reedy model structure]] on $\mathbf{ssSet}$ induces a cofibrantly-generated left proper model structure on $\mathbf{RelCat}$ making the adjunction a [[Quillen equivalence]]. In particular, there exists a model structure on $\mathbf{RelCat}$ that is Quillen equivalent to the [[model structure for complete Segal spaces]] on $\mathbf{ssSet}$.
=--
...
* Dwyer, W. and D. M. Kan, _Simplicial localizations of categories_. Journal of Pure and Applied Algebra 17 (1980) pp. 267&#8211;284.

* Barwick, C. and D. M. Kan, _Relative categories: Another model for the homotopy theory of homotopy theories_. Indagationes Mathematicae 23 (2012) pp. 42&#8211;68.