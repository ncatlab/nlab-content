...
1. The [[universal property]] of the limit is expressed by an [[equivalence of categories]] rather than a [[bijection]] of [[sets]].  This means that 
...
where $[D,Cat]$ denotes the 2-category of [[2-functors]] $D\to Cat$ and [[pseudonatural transformations]] between them and [[modifications]] between those.
...
a [[pseudofunctor]] to the [[2-category]] [[Cat]], then 

* its [[lax colimit]] is given by the [[Grothendieck construction]] $\int F$;

* its [[pseudo-colimit]] if given by formally inverting [[Cartesian morphism]]s in the Grothendieck construction.

This appears in [[SGA4]] Expos&#233; VI, Section 6. It also appears as [[Higher Topos Theory|HTT, corollary 3.3.4.3]] where it is generalized from [[Cat]] to [[(∞,1)Cat]]: see at _[[(∞,1)-colimit]]_ the section _[(∞,1)-Colimits in (∞,1)Cat](http://ncatlab.org/nlab/show/limit+in+a+quasi-category#ColimitsInInfinityCat)_ .
