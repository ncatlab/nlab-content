...
This appears as [[SGA4]] Expos&#233; VI Section 6:. Also as [[Higher Topos Theory|HTT, corollary 3.3.4.3]], see at [[(∞,1)-colimit]] the section [(∞,1)-Colimits in (∞,1)Cat](http://ncatlab.org/nlab/show/limit+in+a+quasi-category#ColimitsInInfinityCat).
