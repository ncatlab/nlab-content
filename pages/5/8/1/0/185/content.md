...
I am not sure about ring vs algebra, however, I am for using the word "smooth" instead of the symbol $C^\infty$. This is similar to the term "smooth map" to mean $C^\infty$ map.
--- Colin Tan
