...
Setoids are used in [[algebra]] to generalize from algebraic structures defined using [[equality]] to algebraic structures defined using [[equivalence relations]], such as
