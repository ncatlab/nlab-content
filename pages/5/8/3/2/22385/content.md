...
Sometimes, the term "setoid" is used in the mathematics literature for a set equipped with an [[equivalence relation]], rather than a set equipped with a pseudo-equivalence relation. However, in the nLab we shall take setoids as those sets equipped with a pseudo-equivalence relation, and use a different term, such as "thin groupoid" or "(0,1)-dagger category" or "symmetric proset" for a set equipped with an equivalence relation. 
