...
As touched upon above, there exist various different approaches to object-oriented programming, including the class-based approach of [Java](https://en.wikipedia.org/wiki/Java_%28programming_language%29), the prototype-based approach of [Self](https://en.wikipedia.org/wiki/Self_%28programming_language%29) or JavaScript, and the 'everything is an object'-approach of [Smalltalk](https://en.wikipedia.org/wiki/Smalltalk). 
