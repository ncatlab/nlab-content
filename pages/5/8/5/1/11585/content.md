...
On [[linear logic]] and [[quantum circuit diagrams]]:

* {#LagoFaffian12} [[Ugo Dal Lago]], [[Claudia Faggian]], _On Multiplicative Linear Logic, Modality and Quantum Circuits_, EPTCS **95** (2012) 55-66 &lbrack;[arXiv:1210.0613](http://arxiv.org/abs/1210.0613), [doi:10.4204/EPTCS.95.6](https://doi.org/10.4204/EPTCS.95.6)&rbrack;


On ([[categorical semantics]] for) [[dynamic lifting]]  in the [[quantum programming language]] "[[Quipper]]":
