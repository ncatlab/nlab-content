...
While the Griffiths complex structure on the intermediate Jacobian is not K&#228;hler/not an [[polarized variety|algebraic polarization]] as the Weil complex structure is, it still has an [[r-convex polarization]] and there is a [[symplectomorphism]] which is an [[isomorphism]] between the Griffiths and the Weil intermediate Jacobians as real symplectic manifolds
