While an [[algebraic definition of higher category|algebraic]] definition of [[strict omega-category|strict omega-categories]] is comparatively straightforward, algebraic definitions of fully weak $\omega$-categories are difficult to work with (although definitions exist, such as those of Batanin, Leinster, and Penon).
