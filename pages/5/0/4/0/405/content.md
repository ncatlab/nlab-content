...
Typcially there is a functor from $\Box$ to [[Top]] sending the $n$-cube to the topological $n$-cube $[0,1]^n$.
...
The symmetric cube category is also called the [[semicartesian monoidal category|semicartesian]] cube category, as well as the "BCH" cube category after its use by [Bezem, Coquand, & Huber (2013)](#BezemCoquandHuber2013).
[Isaacson (2011)](#Isaacson2011) uses a cube category with both symmetries and a connection.
...
Cartesian cube categories (possibly with additional structure) are used for the semantics of [[cubical type theory]].
