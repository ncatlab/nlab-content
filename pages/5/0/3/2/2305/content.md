The **de Rham complex** of a [[manifold]] is the [[cochain complex]] which in degree $n \in \mathbb{N}$ has the [[vector space]] $Omega^n(X)$ of degree-$n$ [[differential form]]s on $X$. The coboundary map is the deRham _[[exterior derivative]]_.
