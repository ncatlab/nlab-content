...
###Example###
For the endofunctor on [[Set]], $H(X) = 1 + X$, the terminal coalgebra is $\bar{\mathbb{N}}$, the [[extended natural numbers]]. Define a function $add: \bar{\mathbb{N}} \times \bar{\mathbb{N}} \to 1 + \bar{\mathbb{N}} \times \bar{\mathbb{N}}$:

$$
add(n, m) =
\begin{cases}
(n - 1, m) & if n \gt 0; \\
(0, m - 1) & if n = 0 and m \gt 0; \\
* & if m = n = 0.
\end{cases}
$$
...
###Reference###
* Ji&#345;&#237; Ad&#225;mek, [Introduction to Coalgebra](www.tac.mta.ca/tac/volumes/14/8/14-08.pdf)
