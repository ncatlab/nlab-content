...
Generalized [[homotopical cohomology theory]] of [[sheaf|sheaves]] with values in a [[model category]] is naturally formulated in terms of morphisms in the [[homtopy category] of a suitable [[homotopical category]] of sheaves. Typically the weak equivalences in this homotopical category are _locally_ the weak equivalences in the target category such that the category of sheaves is not quite or not easily turned into a [[model category]]. Still, it is often a [[category of fibrant objects]] which is like a model category without any assumption on cofibrations but with the assumption that all objects are fibrant.
