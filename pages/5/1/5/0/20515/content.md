...
On the [[phase space]] of [[first-order formulation of gravity|first-order]] [[gravity]] ([[general relativity]]) in a local formulation that allows to decompose spacetime into pieces and then re-glue ([[BV-BFV formalism]]):
