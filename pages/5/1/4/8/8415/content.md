...
In some cases, the terminology 'compactification' is applied to certain cases where $i$ is not an embedding (does not map [[homeomorphism|homeomorphically]] to its image equipped with the subspace topology), particularly in the case of [[Stone-∞ech compactification]] of general topological spaces. 
