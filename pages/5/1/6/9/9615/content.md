...
Arguably though, a more appropriate notion, at least for coding theorists, is that an isomorphism (often called an _equivalence_) of codes consists of a [[monomial matrix]] which, when interpreted as a linear isomorphism using the assigned linear bases, carries $V$ onto $W$.  
