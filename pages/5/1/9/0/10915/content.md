...
The real constant $\pi$ (occasionally called _Ludolph's number_ -- make that _very_ occasionally, nowadays) is the minimal positive root of the real function $sin_\mathbb{R} : \mathbb{R}\to\mathbb{R}$, which is the unique solution to the differential equation/[[initial value problem]]
$$ sin ' ' = - sin $$
$$ sin 0 = 0 $$
$$ sin' 0 = 1 .$$
