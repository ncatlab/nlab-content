...
_Propositional resizing_ is an axiom often assumed in [[homotopy type theory]] that states that all [[mere propositions]] are [[essentially small type|small]]. This is a form of [[impredicativity]]: without it, no universes can be shown to be closed under [[power sets]].
