...
One can argue that, therefore, only [[strict deformation quantization]] is _actual_ quantization, this point is amplified for instance in [Gukov-Witten 09, section 1.4](#GukovWitten09), where it says
...
> Generally speaking, [[physics]] is based on $[$ strict $]$ quantization, rather than $[$ formal $]$ deformation quantization,
although conventional quantization sometimes leads to problems that can be treated by deformation quantization.
