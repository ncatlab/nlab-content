...
: Stating this in another form, to say that "$A$ is in the relation $R$ to $B$" is to say that $A$ is in a certain relation to $R$.  Let us separate this out thus:  "$A$ is in the relation $R^1$ (where $R^1$ is the relation of a relate to the relation of which it is the relate) to $R$ to $B$".  But $A$ is here said to be in a certain relation to the relation $R^1$.  So that we can express the same fact by saying, "$A$ is in the relation $R^1$ to the relation $R^1$ to the relation $R$ to $B$", and so on _ad infinitum_.
