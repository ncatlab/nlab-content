...
* [[Paul-André Melliès]], _The parametric continuation monad_ ([[MelliesContinuation.pdf:file]])

* [[Paul-André Melliès]], Nicolas Tabareau, _Linear continuation and duality_ ([pdf](http://hal.inria.fr/docs/00/33/91/56/PDF/linear-control.pdf))
