...
The _descent theorem_ asserts that
if $R \to A$ is [[faithfully flat]] then its Amitsur complex is [[exact sequence|exact]].

## References

The Amitsur complex was introduced in 

* S. Amitsur, _Simple algebras and cohomology groups of arbitrary fields_, Transactions of the American Mathematical Society
