An orthogonal matrix is a square matrix $A$ satisfying $A^T A = 1$ where $A^T$ is the transpose of $A$.
...
* related $n$Lab pages include [[orthogonal group]], [[Gram-Schmidt orthogonalization]]
