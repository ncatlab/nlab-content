...
A [[site]] being _$\infty$-connected_ means that it satisfies sufficient conditions such that the [[(∞,1)-category of (∞,1)-sheaves]] over it is a [[∞-connected (∞,1)-topos]]
...
A a [[site]] is **$\infty$-connected** over [[∞Grpd]] if
...
The [[(∞,1)-sheaf (∞,1)-topos]] $Sh_{(\infty,1)}(C)$ over an $(\infty,1)$-cohesive site $C$, regarded as an [[(∞,1)-site]], is a ([[n-localic (∞,1)-topos|1-localic]]) [[locally ∞-connected (∞,1)-topos]]
