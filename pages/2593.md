...
consisting of the $\mathfrak{h}$-[[invariant|invariant elements]] of the [[tensor product]] of the [[exterior algebra]] of the [[coset]] $\mathfrak{g}/\mathfrak{h}$ with $V$.

On this graded vector space, the [[dual maps]] of the [[Lie bracket]] $[-,-]$, extended as a graded [[derivation]] to the exterior algebra, and the [[Lie algebra action]] $\rho$ define a [[differentia]]
