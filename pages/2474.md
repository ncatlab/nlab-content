...
A $C^*$-algebra is a [[Banach algebra]] $(A, {\|-\|})$ over the [[complex numbers]] equipped with an [[involution]] $(-)^\ast$ compatible with [[complex conjugation]] (that is: a Banach [[star-algebra]]) that satisfies the _$C^*$-identity_
$$ 
  {\|{A^* A}\|} = {\|{A^*}\|} \, {\|{A}\|} 
$$
