...
| higher unitary structures | $\array{ && \mathbf{B} (PU \times SO) \\ && \downarrow^{\mathrlap{ \mathbf{dd} - \mathbf{W}_3 }} \\ && \mathbf{B}^2 U(1) }$ | [[circle n-bundle with connection|circle 2-bundle]] |  [[B-field]] | [[twisted spin^c structure]]  | Freed-Witten anomaly for type II string on D-brane  |
...
#### $String^{\mathbf{c}_2}$-structure -- Green-Schwarz mechanism

(...)


#### $Fivebrane^{\mathbf{c}_4}$-structure -- dual Green-Schwarz mechanism
