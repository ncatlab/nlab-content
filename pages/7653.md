...
This page provides a survey of and introduction to such examples, organized along a _[Table of twists](#TableOfTwists)_. For further reading and more details see the list of [related entries](#RelatedEntries) and the list of [references](#References) below.

We start with an introduction to the general notion of twisted smooth cohomology by way of the simple but instructive example

* I) [Geometric structures (generalized, exceptional)](#VielbeinFields),

which already serves as a blueprint for all of the examples to follow, and which we use to introduce the general machinery.
...
Then we proceed in direct analogy, but now with ordinary [[gauge fields]] generalized to the genuine [[higher gauge fields]] of string theory, and discuss aspects of the main classes of examples of twisted smooth cohomology in string theory:
...
There are various refinements of this story, which go beyond the intended scope of this page. As an outlook we mention
...
### $Spin^c$-, $String^c$-, $Fivebrane^c$-structures 
 {#TwistedK}
