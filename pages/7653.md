...
1. and the $E_8$ bundle picks up a connection. 

This means that the above defining homotopy pullback for $\mathbf{CField}$ goes over
...
forms that exhibits this in de Rham cohomology. Let $F_\omega$ be the [[curvature]]
...
[[Bianchi identity]] is twisted to become ([SSS](#SSS), [FSSa](#FSSa))
