...
#### **b)** Twisted differential String-structure -- Green-Schwarz mechanism
...
#### **c)** Twisted differential Fivebrane structure -- dual Green-Schwarz mechanism

(...)


#### **d)** Twisted differential $String^{\mathbf{c}_2}$-structure: M-theory flux quantization
