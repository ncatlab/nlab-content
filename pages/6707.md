...
Twisted $spin^c$-structures appear similarly as the conditions for the analogous quantum anomaly cancellation, but now of the open [[type II superstring]] ending on a [[D-brane]]. This is also called the **Freed-Witten anomaly cancellation**. See the [references below](ReferencesAnomalyCancellation) for details.
