...
If $S$ on the other hand is a category of _all test spaces_ in some sense, such as
...
Objects in a gros topos may be thought of as [[space and quantity|generalized spaces]] _modeled on $S$_ in the sense described at [[motivation for sheaves, cohomology and higher stacks]].

For instance if $S = Diff$ we may think of objects in $Sh(Diff)$ as [[smooth space]]s and of objects in the [[(infinity,1)-category of (infinity,1)-sheaves]] on $S$ as [[smooth infinity-stack]]s.
