...
###### Proposition
**(canonical [[Hadamard vavuum state|vacuum]] [[state on a star algebra|states]] on abstract [[Wick algebra]])**
...
* $\langle - \rangle_{\Phi_0}$ is a _[[coherent state]]_.


=--

([Dütsch 18, def. 2.12, def. 5.28, exercise 5.30, equations (5.178)](#Duetsch18))
