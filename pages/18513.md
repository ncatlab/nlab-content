...
By definition of the [[Wightman propagator]] (or else by [this prop.](Hadamard+distribution#WaveFronSetsForKGPropagatorsOnMinkowski)), the [[wave front set]] of powers of $\Delta_H$ has all cotangent [[wave vectors]] on the first variables future pointing
