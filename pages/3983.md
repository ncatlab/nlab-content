...
One says that there is a functor (actually two functors) from the category of Fr&ouml;licher space to the category of topological spaces so we can say that a Fr&ouml;licher space has topological property $P$ if the corresponding topological space has it.
...
In other sections, namely [[examples of Frölicher spaces]] and [[Frölicher spaces and Isbell envelopes]]  we used the notion of a _Hausdorff_ Fr&ouml;licher space.
...
# More on Hausdorff Fr&ouml;licher Spaces # {#hausdorff}
