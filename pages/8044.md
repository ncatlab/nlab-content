...
Russell's paradox is closely related to the classical [[liar paradox]] ("this sentence is false"), to G&ouml;del's [[incompleteness theorem]], and to the [[halting problem]] --- all use [[diagonalization]] to produce an object which talks about itself in a contradictory or close-to-contradictory way.
