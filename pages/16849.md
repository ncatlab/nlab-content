A **bipartite graph** is a [[graph]] $G$ whose vertices can be [[vertex coloring|2-colored]], i.e., such that there exists a graph homomorphism $G \to K_2$.  Note that a bipartite graph cannot have any loops, although it may have multiple edges.
