...
The Hitchin moduli space is a [[hyperkähler manifold]]. In complex structure $I$ it can be seen as the moduli space of Higgs bundles on $C$, and in complex structures $J$ and $K$ it can be seen as the moduli space of $G$-local systems on $C$.
