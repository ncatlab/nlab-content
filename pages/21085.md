...
V-natural in $A \in \mathbf{C}$ and $B \in \mathbf{D}$ and V-dinatural in $M \in \mathbf{M}$, which additionally satisfies some axioms.

Generalized Tambara modules are the copresheaves of the category of optics. 
