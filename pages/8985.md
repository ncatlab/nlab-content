...
+-- {: .proof}
###### Proof
The last statement is almost obvious using Lemma \ref{WellPointedAlgebras} above. Well-pointedness for $S$ follows adapting Lemma \ref{WellPointedQuotient} to the case of a jointly epimorphic family of arrows $\{S_i\to S\}$, like the colimiting cocone for $S$.
=--
