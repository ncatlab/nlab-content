...
generated by a single simplex $x \in E_n$ subject to the relatoin $d_i x = 0$ for all $i$. This is the **$n$-sphere** as a spectrum.
...
As for [[simplex|simoplices]], there are canonical [[horn]] inclusion morphisms of combinatorial spectra
...
A condition entriely analogous to the [[Kan fibration]] condition on [[Kan complex|Kan simplicial sets]] leads to the notion of **Kan combinatorial spectrum**.
