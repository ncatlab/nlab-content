...
+--{: .query}
[[Mike Shulman|Mike]]: Are you sure about that last condition?  I remember a condition more like "for each $x\in E_n$ there is some finite $m<n$ such that all faces of $x$ in $E_m$ are the basepoint.
=--
