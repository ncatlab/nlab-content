_Higher category theory_ generalizes [[category theory]], the study of [[categories]], to the study of higher categories, known as $n$-[[n-category|categories]] (or, when $n \to \infty$, as $\infty$-[[∞-category|categories]] or $\omega$-[[ω-category|categories]], or, when the degree of invertibility is important, as $(n,r)$-[[(n,r)-category|categories]]).
