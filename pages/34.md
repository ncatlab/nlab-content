_higher category theory_ generalizes the study in [[category theory]] of [[category|categories]] to the study of higher categories, known as [[n-categories]] or, when $n\to \infty$, as  [[∞-categories]] or [[ω-categories]], or, when the degree of invertibility is important, as [[(n,r)-category|(n,r)-categories]]

Higher category theory is supposed to be to the theory of [[infinity-groupoid]]s and [[topology]]/[[homotopy theory]] as [[category theory]] is to the study of [[groupoid]]s (and hence of [[group]])s.

The general study of [[homotopy theory]] itself is the theory of [[Higher Topos Theory|(infinity,1)-category theory]].
