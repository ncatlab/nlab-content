...
## As a Fr&eacute;chet Manifold

In this section, we will describe the structure of a loop space as a Fr&eacute;chet manifold in detail.  The construction is quite standard, and a partial list of references and further reading can be found at the end of this page.
...
The structure of loop spaces as Fr&eacute;chet manifolds is covered in chapter 42 of \ref{km} and in various other articles, many of which cover extensions of the basic construction to other mapping spaces.  In particular,
