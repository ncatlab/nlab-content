...
TODO: _What is the most general such lemma?_
...
Let $D$ be an [[∞-category]], $C$ a [[small]] ∞-category, and $u : C \to D$ a fully faithful functor. Let $\tau$ and $\rho$ be quasi-topologies on $C$ and $D$, respectively. Suppose that:
...
=--
Here, a _quasi-topology_ is a collection of sieves closed under pullback and $\bar\tau$ is the coarsest topology containing a quasi-topology $\tau$.
