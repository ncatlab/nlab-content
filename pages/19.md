...
* The theory of categories as primitive mathematical [[universe]]s or [[space]]s (nothing as fancy as a [[topos]]). As a space a category is a simplicial sets such that the Segal maps are isomorphisms. The simplicial set is the nerve of the category.
...
* A theory of presheaves with some properties on the full subcategory [0]-> <- ->[1]-> <- <- -> <-[2] of Δ.
