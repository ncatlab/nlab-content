...
_Todd_: Okay, here are some responses. First, please don't be put out Rafael if I seemed to correct you after you wrote "What is the inverse functor to the nerve functor?" -- I'm just playing it safe and going by exactly what you wrote, even if you yourself knew what you were talking about. Second, the condition you are after says that a simplicial set $X$ is isomorphic to the nerve of a category if, for each $n \geq 0$, the canonical map 
$$X_n \to X_1 \times_{X_0} X_1 \times_{X_0} \ldots \times_{X_0} X_1$$ 
