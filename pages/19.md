...
* A presheaf with some properties on the full subcategory [0]-> <- ->[1]-> <- <- -> <-[2] of Δ.

+-- {: .query}
_Rafael_: I don't like this definition but maby others do. How do i edit multiple arrows, they are supposed to be on top of each other. Anyone remembering the properties?
=--
