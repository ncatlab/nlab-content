...
There are multiple notions of axiom K: for individual types, for type families and Tarski universes, and for hierarchies of universes. 
...
$$K: \prod_{x:A} \prod_{p:a =_A a} p =_{a =_A a} \mathrm{refl}_A(a)$$
