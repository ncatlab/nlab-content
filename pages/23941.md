...
A *Bravais lattice* (terminology originating in the study of [[crystals]] in [[solid state physics]]) is the *equivalence class* of a [[crystal]] lattice.

Mathematically, this the [[equivalence class]] of the corresponding [[crystallographic group]] $\Lambda \rtimes G_{pt} \;\subset\; \mathbb{R}^d \rtimes \mathrm{O}(d)$ under [[conjugation]] by ambient [[linear transformations]] $\phi \,\in\,$ [[GL(n)|$GL(d)$]]:
