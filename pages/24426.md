...
Moreover $r_{n};(s_{n};r_{n}) = (r_{n};s_{n});r_{n} = e_{n};r_{n} = (\frac{1}{n!} \underset{\sigma \in \mathfrak{S}_{n}}{\sum}\sigma);r_{n}$ $ = \frac{1}{n!} \underset{\sigma \in \mathfrak{S}_{n}}{\sum}\sigma;r_{n} = \frac{1}{n!} \underset{\sigma \in \mathfrak{S}_{n}}{\sum}r_{n}=\frac{1}{n!}(n!r_{n})=r_{n}=r_{n};1$. We know that $r_{n}$ being an epimorphism and thus $s_{n};r_{n}=1$.
