...
* A locally path-connected space has the nice property that path-components are the same as components. It is also true in this case that $X^I \to X\times X$ is open.
...
* CW-complexes are the most well-connected spaces, having a contractible basis of open sets (this is stronger than local contractibility).