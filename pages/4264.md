...
If $X$ is a [[sober space]], we tend to identify it with its locale of opens.


## Properties

A locale has __[[locale with enough points|enough points]]__ if it is [[isomorphisms|isomorphic]] to the locale of opens of some space $X$.
