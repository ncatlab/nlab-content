...
The perimeter of a [[regular polygon]] (strictly speaking, a [[regular polygonal line]]) with $n$ sides and [[circumradius]] $r$ is given by the sequence of functions $P:\mathbb{N} \to (\mathbb{R} \to \mathbb{R})$

$$P(n)(r) = r n \sin\left(\frac{\tau}{n}\right)$$

which [[embedding|embeds]] in the $\mathbb{R}_+$-[[action]] $P^\prime:\mathbb{R}_+ \to (\mathbb{R} \to \mathbb{R})$, defined as

$$P^\prime(n)(r) = r n \sin\left(\frac{\tau}{n}\right)$$

The limit of $P^\prime$ as $P$ goes to infinity is the circumference of a circle with radius $r$:

$$C(r) = \lim_{n \to \infty} P^\prime(n)(r) = \lim_{n \to \infty} r n \sin\left(\frac{\tau}{n}\right) = r \lim_{m \to 0} \frac{\sin(\tau m)}{m} = r \lim_{m \to 0} \frac{\partial_m \sin(\tau m)}{\partial_m m} = \lim_{m \to 0} \frac{\tau r \cos(\tau m)}{1} = \tau r$$
=--
