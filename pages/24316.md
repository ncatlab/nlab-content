...
A *compact connected space* is a [[topological space]] which is both [[compact topological space|compact]] and [[connected topological space|connected]].

## In homotopy type theory
 {#InHomotopyTypeTheory}

Here is a characterization considered in some texts on ([[cohesive homotopy type theory|cohesive]]) [[homotopy type theory]] (?):
