...
Similarly, there is $2$-morphism $\epsilon\colon L \circ R \to id_Y$, called the __counit__ of the adjunction (in older texts, called a "back adjunction" or "end adjunction").  (This is the co-identity of the [[comonad]] $L \circ R$.)
