...
Sometimes the positive [[rational numbers]] $\mathbb{Q}_{+}$ are used instead of $(0, \infty)$, such as in the construction of the [[Cauchy real numbers]] and the [[HoTT book real numbers]]. These premetrics are called **rational premetrics**, and the associated spaces **rational premetric spaces**. 
