...
\begin{example}
  For $n \in \mathbb{N}$ the [[symmetric group]] $Sym(n)$ is finitely generated by the set of [[transposition permutations]], or in fact just by the set of adjacent transpositions, leading to the *[[Kendall tau distance]]*.
\end{example}
