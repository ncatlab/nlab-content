...
1. ($X$ has a cover of Zariski open immersions of affine $k$-schemes) The exists a family $(U_i)_i$ of open affine subfunctors of $X$ such that for all fields $K\in M_k$ we have that $X(K)=\coprod_i U_i(K)$.

=--

+-- {: .num_remark}
###### Remark
The category of $k$-schemes is closed under finite limits, forming open- and closed subfunctors, and scalar extension. It is also closed under taking small coproducts. 
