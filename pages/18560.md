...
Such a  profunctor is usually written as $F\colon  C &#x21F8; D$. Composition of (∞,1)-profunctors in $(\infty, 1)Prof$ is by the "tensor product of (∞,1)-functors" [[homotopy coend]] construction: if $H\colon A &#x21F8;  B$ and $K\colon B &#x21F8;  C$, their composite is given as a functor $C^{op}\times A \to \infty Grpd$ by
