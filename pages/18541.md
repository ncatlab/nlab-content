...
Let $u_1 \in \mathcal{D}'(X_1)$ and $u_2 \in \mathcal{D}'(X_2)$ be [[distributions]]. Then there is a unique distribution $u_1 \otimes u_2 \in \mathcal{D}'(X_1 \times X_)$ such that for all pairs of [[bump functions]] $b_1 \in C_c^\infty(x)$ and $b_2 \in C^\infty(X_2)$ its value on their tensor product according to def. \ref{TensorProductOfSmoothFunctions} is
...
* {#Hoermander90} [[Lars Hörmander]], section 5.1 of _The analysis of linear partial differential operators_, vol. I, Springer 1983, 1990
