...
Importantly, following an idea by Joyal, the topological topos $\mathcal{E}:=Sh_J(\Sigma)$ allows one to represent the [[geometric realization]] functor as the inverse image of a [[geometric morphism]] from $\mathcal{E}$ to the topos of [[simplicial set]]s.
