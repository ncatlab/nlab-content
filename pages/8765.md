...
* $i \colon \Theta_0 \to \Theta$ for the [[wide subcategory|wide]] non-full subcategory on the morphism induced from morphisms of the underlying [[ω-graphs]]  (this means these morphisms in $\Theta_0$ send $n$-globes to single $n$-globes, not to pastings of them).
