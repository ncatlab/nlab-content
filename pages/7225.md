...
The Prüfer $p$-groups are the only infinite groups whose [[subgroups]] are [[total order|totally ordered]] by inclusion. They are often useful as [[counterexamples in algebra]]; for example, a Pr&uuml;fer group is an Artinian but not a Noetherian $\mathbb{Z}$-module. 
