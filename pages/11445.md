...
In [[physics]] ([[string theory]]) where ([[gauge field|gauge]]) [[field (physics)|fields]] are [[cocycles]] in some ([[differential cohomology theory|differential]]) [[cohomology theory]], real-oriented cohomology theory is that of [[orientifold]] [[spacetimes]].
