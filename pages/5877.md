...
* In [[linear algebra]] an [[idempotent]] linear [[operator]] $P:V\to V$ is called a projection onto its [[image]]. In functional analysis, one sometimes requires additionally that this idempotent is in fact self-adjoint. 