...
On a [[globally hyperbolic spacetime]] $M$ the Klein-Gordon equation has unique advanced and retarded [[Green functions]], $\Delta_R \in \mathscr{D}'(M\times M)$ and $\Delta_A \in \mathscr{D}'(M\times M)$ respectively.
...
According to [Radzikowski 96](#Radzikowski96), the constraints on the wavefront sets of important Green functions and bisolutions can be diagrammatically illustrated as follows below. Note that the primed [[wavefront set]] of a distribution on $M\times M$ is defined as $WF'(\Delta) = \{ (x,y;p,-q) \in T^*(M\times M) \mid (x,y;p,q) \in WF(\Delta) \}$.


| [[Green function]] for [[Klein-Gordon operator]] | $\phantom{AA}$ primed [[wave front set]] |
|---|---|
| [[Feynman propagator]] | $\array{E_F = \\ \phantom{A} \\ \phantom{A} \\ \phantom{A}}$ <img src="https://ncatlab.org/nlab/files/FeynmanPropagator.png" width="60"> | 
| [[advanced propagator]] | $\array{\Delta_A = \\ \phantom{A} \\ \phantom{a}}$ <img src="https://ncatlab.org/nlab/files/AdvancedGreenFunction.png" width="60"> |
| [[retarded propagator]] | $\array{\Delta_R = \\ \phantom{A} \\ \phantom{a}}$  <img src="https://ncatlab.org/nlab/files/RetGreenFunction.png" width="60"> |
| [[causal propagator]] | $\array{\Delta_{S} = \\ \phantom{A} \\ \phantom{a}}$  <img src="https://ncatlab.org/nlab/files/RetGreenFunction.png" width="60"> $\array{- \\ \phantom{A} \\ \phantom{a}}$  <img src="https://ncatlab.org/nlab/files/AdvancedGreenFunction.png" width="60"> |
| [[Dirac propagator]] | $\array{E_D =  \\ \phantom{A} \\ \phantom{a}}$  <img src="https://ncatlab.org/nlab/files/RetGreenFunction.png" width="60"> $\array{+ \\ \phantom{A} \\ \phantom{a}}$ <img src="https://ncatlab.org/nlab/files/AdvancedGreenFunction.png" width="60"> |
| [[Hadamard propagator]] | $\array{\omega = \\ \phantom{A} \\ \phantom{a}}$ <img src="https://ncatlab.org/nlab/files/AdvancedGreenFunction.png" width="60"> $\array{- \\ \phantom{A} \\ \phantom{a}}$ <img src="https://ncatlab.org/nlab/files/FeynmanPropagator.png" width="60"> |
...
* {#DuistermaatHoermander72} [[J. J. Duistermaat]], [[Lars Hörmander]], _Fourier integral operators. II_, Acta Mathematica 128 (1972), 183-269 ([doi](http://dx.doi.org/10.1007/bf02392165))
