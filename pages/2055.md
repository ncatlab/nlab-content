...
* [Deferential Geometry](http://deferentialgeometry.org) -- wiki started by Garrett Lisi. Constructing a concise and beautiful theoretical description of reality unifying General Relativity, Quantum Field Theory, and the Standard Model using the foundations and language of basic differential geometry.
...
* [PolyMath](http://michaelnielsen.org/polymath1/index.php?title=Main_Page) Wiki for massively collaborative online mathematical projects.
...
* [Foundations of Mathematics](http://www.cs.nyu.edu/mailman/listinfo/fom) is where Harvey Friedman works openly on his research. Also moderated by Stephen Simpson, 
Martin Davis, Andreas Blass, William Tait, John Baldwin and Alasdair Urquhart.

* [Azimuth Project](https://forum.azimuthproject.org/discussions) led by [[John Baez]] is an online hub for mathematicians, scientists and engineers working together to address global warming and other potential catastrophes.
...
* [Disquisitiones Mathematicae](http://matheuscmss.wordpress.com) (dynamical systems, ergodic theory, randomness in number sequences, Ricci flow)
