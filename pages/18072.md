...
The incarnation of the concept of [[string]] without [[worldsheet]] [[supersymmetry]] is the _bosonic string_ of [[bosonic string theory]]. In contrast to the [[spinning string]]/[[superstring]].

## Definition

### In symplectic geometry / geometric quantization

See the reference [below](#ReferencesSymplecticGeometryAndGeometricQuantization)
...
* {#Yu} Yue Yu, _Symplectic geometry and geometric quantization for the open bosonic string in the BRST formalism_, Physics Letters B, Volume 216, Issue 1-2, (1989) p. 75-80.
