...
Also on the closely related area of the theory of open topological strings and string-theoretical _mirror symmetry_ has categorical languege -- not  the least through work of Kontsevich and collaborators on generalized geometries -- has categorical language become indispensable. In these areas of mathematica-theoretical physics categroy theoretic language is so well established that its use is not much noticed anymore among practitioners. This is the clearest sign of a natural language. This language needs to be researched in [dissertation](http://editing-services.org/dissertation-thesis.php). Its theory is difficult, but it is more convenient if it would be described in details.    
