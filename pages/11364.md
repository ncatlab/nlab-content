...
The _modular group_ $\Gamma$ is the subgroup $PSL_2(\mathbb{Z}) \hookrightarrow PSL_2(\mathbb{C})$ consisting of M&ouml;bius transformations $z \mapsto \frac{a z + b}{c z + d}$ where $a, b, c, d \in \mathbb{Z}$ and $a d - b c = 1$. 
