...
Let $k$ be a [[field]], and let $\mathbb{P}^1(k)$ be the [[projective line]] over $k$. A _M&ouml;bius transformation_ (also called a _homography_, a _linear fractional transformation_, or a _fractional linear transformation_ which is my own preference -- Todd) is a function $f: \mathbb{P}^1(k) \to \mathbb{P}^1(k)$ defined by the rule 
