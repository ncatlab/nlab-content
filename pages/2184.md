...
Part of the reason for the importance of simple graphs is that many "topological" properties of graphs ([[planar graph|planarity]], first [[Betti number]], etc.) are preserved under barycentric subdivision.
