...
In both cases, since every real quadratic function is [[continuously differentiable]], due to the [[inverse function theorem]], $g$ and $h$ are defined as solutions to the first-order nonlinear [[ordinary differential equation]]
...
The **continuous quadratic formula**, **smooth quadratic formula**, or **analytic quadratic formula** is the evaluation of the two branches at zero, if zero is in the domain of $g$ and $h$:
