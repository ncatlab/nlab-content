...
A [[topos]] $E$ over a topos $S$, i.e. equipped with a [[geometric morphism]]
...
1. it is a [[locally connected topos]]: there exists a 
...
* the [[sheaf topos]] $Sh(CartSp)$ on [[CartSp]] is a cohesive topos.

* the [[(∞,1)-category of (∞,1)-sheaves]] $(\infty,1)Sh(CartSp) = $ [[∞LieGrpd]] on [[CartSp]] is a cohesive $(\infty,1)$-topos
