...
We find that fairly evident and nai&iuml;ve sounding statements in ordinary language turn under this translation into what is generally regarded as fairly sophisticated constructions. So this table also serves to show how the general abstract discussion here is not just a means in itself. It is instead a means that helps to reason about complicated aspects of reality.
