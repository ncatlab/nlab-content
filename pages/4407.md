...
We recall that a _real closed field_ is an [[ordered field]] such that every positive element has a [[square root]], and every polynomial of odd degree has a root. Clearly, the polynomial $x^2 + 1$ need not have a root in a real closed field.
