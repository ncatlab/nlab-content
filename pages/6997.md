...
Now we require $S$ to have a [[tight apartness]] $\ne$, which induces a tight apartness on each $X^{n_i}$ (via [[existential quantification]]), and we require the operations $f_i$ to be [[strongly extensional function|strongly extensional]].  
