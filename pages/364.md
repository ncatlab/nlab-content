...
On [[(∞,1)-category theory]] via the [[homotopy 2-category of (∞,1)-categories]] ([[formal (infinity,1)-category theory|formal $(\infty,1)$-category theory]]):
...
On the [[relation between type theory and category theory|categorical semantics]] of [[univalence|univalent]] [[homotopy type theory]] in [[(infinity,1)-topos|$\infty$-topoi]] (proof of [[Awodey's conjecture]]):
