...
Therefore the issue expressed with the term "non-renormalizable" at this point is hence not a mathematical [[obstruction]], but a physical sentiment: The need to specify an infinite set of further physical constants to specify a [[theory (physics)|physical theory]] is (or has been) felt to defeat the purpose or meaning of having specified a [[theory (physics)|physical theory]]. 
