...
* The action monad $X\mapsto M\times X$ on [[Set]] is [[commutative monad|commutative]] if and only if $M$ is commutative as a monoid. In that case the left and right action monads coincide up to isomorphism.
