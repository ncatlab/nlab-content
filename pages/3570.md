...
We have a inverse system ([[pro-object]]) of topological spaces all of which have the [[homotopy type]] of a [[polyhedron]], ... in fact always the same polyhedron, $S^1$.  Note that by our use of a specific [[cofinal]] family of neighbourhoods of $S_W$, indexed by the [[natural number]]s, we have an _inverse sequence_. That was a choice and we could have chosen differently or not at all. The ability to pick a sequence of neighbourhoods is related to the fact that we are considering a **compact metric space**. 
