...
Now we set up a comparison with one of the standard proofs involving a [[back-and-forth argument]], say the one given in [Wikipedia](https://en.wikipedia.org/wiki/Schr%C3%B6der%E2%80%93Bernstein_theorem#Proof) that is attributed to Julius K&ouml;nig. We can instead consider the maximal fixed point as a union of finitary approximations 
