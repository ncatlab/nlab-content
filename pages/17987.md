...
> This page is going to contain an introduction to [[topological K-theory]]. 
...
What is called _[[topological K-theory]]_ is a fundamental tool in the field of _[[topology]]_ and _[[homotopy theory]]_. Topological K-theory has an elementary definition but far-reaching applications and results in diverse fields of pure [[mathematics]], as well as in [[mathematical physics]].
...
useful [below](#TheSpectrumKU) for constructing the [[KU]] [[spectrum]]
...
## Topological K-theory as Generalized cohomology
...
* [[spectra]], [[stable homotopy category]]
...
The proof of the [[Hopf invariant one]] theorem using the [[Adams operations]] in [[topological K-theory]] is due to
