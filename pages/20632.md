...
A [[metrisable space|metrisable]] topological space $Y$ is an _absolute neighborhood retract_ if for _any_ embedding $Y\subset Z$ as a [[closed subspace]] in a [[metrisable topological space]] $Z$, $Y$ is a [[neighborhood retract]] of $Z$.
