...
The limiting $E_\infty$ operad is the resolution of the ordinary commutative monoid operad $Comm$. Its algebras are [[commutative algebra in an (infinity,1)-category|homotopy commutative monoid objects]] such as $E_\infty$-[[E-infinity-ring|rings]]s.

## References

A discussion of $E_k$ in the context of [[(∞,1)-operad]]s is in

* [[Jacob Lurie]], _[[Ek-Algebras]]_ ([pdf](http://www.math.harvard.edu/~lurie/papers/DAG-VI.pdf))
