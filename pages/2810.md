...
The **$E_k$-operad** or **little $k$-cubes operad** is the [[operad]] or [[(infinity,1)-operad]] whose $n$-ary operations are parameterized by rectilinear disjoint embeddings of $n$ $k$-dimensional cubes into another $k$-dimensional cube.
