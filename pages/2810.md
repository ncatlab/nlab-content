...
The **$E_k$-operad** or **little $k$-cubes operad** is the [[operad]] or [[(infinity,1)-operad]] whose $n$-aray operations are parameterized by rectilinear disjoint embeddings of $n$ $k$-dimensional cubes into another $k$-dimensional cube.
...
The limiting $E_\infty$-operad is the resolution of the ordinary commutative monoid operad $Comm$. Its algebras are [[commutative algebra in an (infinity,1)-category|homotopy commutative monoid objects]] such as [[E-infinity ring]]s. 

## References ##

A discussion of $E_k$ in the context of [[(infinity,1)-operad]]s is in
