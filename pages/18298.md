...
The [[category]] $FinVect$ of [[finite dimensional vector spaces]] over a [[tlopological field]] is canonically a [[Top]]-[[enriched category]], as is hence its [[product categories]] $FinVect^{n}$. Any [[Top]]-[[enriched functor]]
...
induces a construction of a new topological vector bundle $\widehat{F}(\mathcal{V}_1,, \cdots, \mathcal{V}_n)$ from any [[n-tuple]] $(\mathcal{V}_1, \mathcal{V}_2 , \cdots, \mathcal{V}_n)$ by taking its [[fiber]] over a point $b \in B$ in the base space to be
...
(e.g. [Milnor & Stasheff 1974, p. 32](#MilnorStasheff74)).


For example:

* if $F \,\coloneqq\, (-)^\ast \,\colon\, Finvect \longrightarrow FinVect$ is the operation of foming [[dual vector spaces]], then $\widehat{F}$ constructs the fiberwise [[dual vector bundle]]
