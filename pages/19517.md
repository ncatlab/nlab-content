...
1. a _derived adjunction counit_ at an object $c \in \mathcal{C}$ is a composition of the form
   ...
   1. $\emptyset \underoverset{\in Cof_{\mathcal{D}}}{i_{R(P(c))}}{\longrightarrow} Q(R(P(c))) \underoverset{\in W_{\mathcal{D}} \cap Fib_{\mathcal{D}}}{p_X}{\longrightarrow} R(P(c))$ is a [[cofibrant resolution]] in $\mathcal{D}$. 
