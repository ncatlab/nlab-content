...
$$
  \begin{aligned}
    \exp_{\mathcal{T}}(-V) \star_F \{-S', \exp_{\mathcal{T}}(V) \star_F  A \}
    & =
    \exp_{\mathcal{T}}(-V)
      \star_F
    \left(
      \{-S', \exp_{\mathcal{T}}(V) \star_F  A \}_{\mathcal{T}}
      - 
      i \hbar 
      \Delta_{BV}\left(
        \exp_{\mathcal{T}}(V) \star_F A
      \right)
    \right)
    \\
    & = 
    ...
    \{-S', A\}
    - 
    i \hbar \left(  \Delta_{BV}(V) + \tfrac{1}{2}\{V,V\} \right) \star_{F} A
    \pm
    i \hbar {V,A}
    +  
    \Delta_{BV}(A)
