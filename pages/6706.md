...
This is called the (quantum) _[[master Ward identity]]_ (MWI, see example \ref{MasterWardIdentityClassical} below) on [[regular polynomial observables]].
...
(In [Hollands 07, prop. 4](Ward+identity#Hollands07) and [Rejzner 13, (37)](Ward+identity#Rejzner13)) it is equation (eq:QuantumMasterOnRegularObservablesBVDifferentialOfSMatrixInTerms) itself that is called the _[[master Ward identity]]_.)

Next we show that the [[quantum master equation]] implies the [[quantum master Ward identity]].

(Beware that in [Hollands 07, prop. 4](Ward+identity#Hollands07) and [Rejzner 13, (37)](Ward+identity#Rejzner13)) it is equation (eq:QuantumMasterOnRegularObservablesBVDifferentialOfSMatrixInTerms) itself that is called the _[[master Ward identity]]_.)
...
This equation is called the _classical Master Ward identity_ ([Dütsch-Fredenhagen 02, (90)](master+Ward+identity#DuetschFredenhagen02), [Brennecke-Dütsch 07, (5.5)](master+Ward+identity#BrennecketDuetsch07), following [Dütsch-Boas 02](master+Ward+identity#DuetschBoas02)). 

That the [[master Ward identity]] has a natural interpretation in [[BV-BRST formalism]] was first observed in ([Hollands 07, (342)-(345)](Ward+identity#Hollands07)).
