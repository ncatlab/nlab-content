...
$$
 Ctxt_1, \cdots, Ctxt_k \vdash Jdgmt_1, \cdot, Jdgmt_l
$$
...
"If $Ctxt_1$ and $Ctxt_2$... are given then one of $Jdgmt_1, \cdots, Jdgmt_l$ is a consequence".
...
$$
  \vec \phi(x) \vdash_{\vec x} \vec \psi(x)
  \,.
$$
...
Rules for formal manipulation of sequents are called _[[sequent calculi]]_. See there for more details.
