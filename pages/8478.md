...
where the author provides a modern foundation for logic based on a clear separation of the notions of judgment and proposition (see at [[Martin-Löf dependent type theory]]) sequents are discussed on pages 29-30, following [Gentzen](#Gentzen) in terminology but not adopting the symmetry between antecedent and succedent that is part of [[Gentzen]]'s _[[sequent calculus]]_.

Referring explicitly to these lectures, sequents are renamed _hypothetical judgements_ in section 3 of
