...
A similar regularization to the [[action functional]] of the [[membrane]] (the [[M2-brane]]) would have to involve objects replacing matrices which instead of a binary [[Lie bracket]] $[-,-]$ have a trinary bracket $[-,-,-]$. ([Park-Sochichiu 08](#ParkSochichiu08), [Sato09](#Sato09), [DeBellis-Sämann-Szabo 11](#DeBellisSaemannSzabo11)).
...
For this to work a clear understanding of the nature of these trinary brackets is required. After the success of the [[BLG model]] for the [[M2-brane]] several authors proposed that these are to be thought of as Flippov "[[3-Lie algebras]]" ([Park-Sochichiu 08](#ParkSochichiu08), [Sato09](#Sato09), [DeBellis-Sämann-Szabo 11](#DeBellisSaemannSzabo11)). However, by the discussion there, following ([MFFMER 08](n-Lie+algebra#MFFMER08)) it seems natural to think of "3-Lie algebras" as really being [[Lie 2-algebras]] equipped with a binary [[invariant polynomial]].
...
* J.-H. Park, C. Sochichiu, _Taking  the square root of Nambu-Goto action and
obtaining Filippov-Lie algebra gauge theory action_, Eur. Phys. J. C 64 (2009) 161 ([arXiv:0806.0335](http://arxiv.org/abs/0806.0335))
 {#ParkSochichiu08}

* J. DeBellis, [[Christian Sämann]], [[Richard Szabo]], _Quantized Nambu-Poisson manifolds in a 3-Lie algebra reduced model_, JHEP 1104 (2011) 075
