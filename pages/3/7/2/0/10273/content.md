...
From this we can completely classify all complex Clifford algebras, i.e. $Cl(V,Q)$ for a complex vector space $V$. Note that in this case there is up to similarity just one quadratic form. We denote $Cl(V,Q)$ by $\mathbb{C}l(V)$ in this case. 
