...
\begin{example}\label{RightTransferAlongAdjointEquivalence}
...
\end{example}
This is straightforward to check directly, even without the above existence theorems (e.g. [math.se:a/2220718](https://math.stackexchange.com/a/2220718/58526)).
...
\begin{example}
A *[[counterexample]]* is provided as Example 3.7 of ([Goerss & Schemmerhorn 2007](#GoerssShemmerhorn07)). Let $k$ be a field of characteristic 2 and consider the adjunction
$$
...
* {#GoerssShemmerhorn07} [[Paul Goerss]], [[Kristen Schemmerhorn]], [§3.2](http://arxiv.org/PS_cache/math/pdf/0609/0609537v2.pdf#page=20) of: *Model Categories and Simplicial Methods*, Notes from lectures given at the University of Chicago, August 2004, in: *Interactions between Homotopy Theory and Algebra*, Contemporary Mathematics **436** AMS (2007) &lbrack;[arXiv:math.AT/0609537](http://arxiv.org/abs/math.AT/0609537), [doi:10.1090/conm/436](http://dx.doi.org/10.1090/conm/436)&rbrack;

* [[Clemens Berger]], [[Ieke Moerdijk]], Section 2.5 of: *Axiomatic homotopy theory for operads*, Comment. Math. Helv. **78** (2003) 4  &lbrack;[arXiv:math/0206094](https://arxiv.org/abs/math/0206094), [doi:10.1007/s00014-003-0772-y](https://doi.org/10.1007/s00014-003-0772-y), [pdf](http://www.math.uu.nl/publications/preprints/1242.pdf)&rbrack;

These arguments all go back (cf. [Goerss & Shemmerhorn 2007, p. 20](#GoerssShemmerhorn07)) to:

* {#Quillen67} [[Daniel Quillen]], §II.4 in: *[[Homotopical Algebra]]*, Lecture Notes in Mathematics **43**, Springer (1967) &lbrack;[doi:10.1007/BFb0097438](https://doi.org/10.1007/BFb0097438)&rbrack;


The above proof of acyclicity in the presence of path objects is taken from:

* {#Rezk02} [[Charles Rezk]], *Every homotopy theory of simplicial algebras admits a proper model*, Topology Appl. **119** 1 (2002) 65-94 &lbrack;[arxiv:math/0003065](https://arxiv.org/abs/math/0003065)&rbrack;
