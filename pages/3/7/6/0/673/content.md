...
* _$Con(ZF+\neg WISC)$, [pdf](http://ncatlab.org/nlab/files/notWISC2.pdf), (2012) (Please note that Corollary 12 is not yet proved true as stated. What _is_ true is that WISC is independent of [[ZFA]], as long as one allows a [[proper class]] of [[urelement|atoms]].)
...
* _Internal categories, anafunctors and localisations_, [arXiv:math/1101.2363](http://arxiv.org/abs/1101.2363) or [updated version](http://ncatlab.org/davidroberts/files/DRoberts_anafunctors.pdf) submitted for publication. This is developed from the first chapter from my thesis. 

* [Latest working version](http://ncatlab.org/davidroberts/files/anafunctors_2012-11-12.pdf) of _Internal categories, ..._ (updated 16 November 2012).

* _The inner automorphism 3-group of a strict 2-group_, joint with [[nLab:Urs Schreiber|Urs Schreiber]], Journal of Homotopy and Related Structures, vol. 3(1), 2008, pp.193&#8211;245 (available at the arXiv:[0708.1741](http://arxiv.org/abs/0708.1741))
* _Yang-Mills theory for bundle gerbes_, joint with [[nLab:Mathai Varghese|Mathai Varghese]] , Journal of Physics A 39:6039-6044, 2006 (available at the arXiv:[hep-th/0509037](http://arxiv.org/abs/hep-th/0509037))
