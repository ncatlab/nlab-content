...
Put differently: the multiplicative monoid of nonzero [[principal ideals]] of $R$ is a [[commutative monoid]] [[free object|freely generated]] by irreducible principal ideals. It follows that if $K$ is the [[field of fractions]] of $R$, so that the [[group]] of units $K^\times$ is the complement of $0$, then the [[quotient group]] $K^\times/R^\times$ is an abelian group that is freely generated by the set of cosets $f R^\times$ with $f$ ranging over irreducible elements. As a side remark, we observe that in this circumstance the exact sequence 
