...
What is known as **Tychonoff's theorem** ([Tychonoff 35](#Tychonoff35)) is a basic [[theorem]] in the field of [[topology]]. It states that the  [[product topological space]] (with its [[Tychonoff topology]]) of an arbitrary [[set]] of [[compact topological spaces]] is itself [[compact space|compact]].
