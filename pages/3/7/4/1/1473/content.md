...
A [[continuous function|map]] $g$ is [[proper map|proper]] ([Bourbaki, General Topology, I\S10.2, Thm.1(d), p.101](#BourbakiGeneralTopology)) iff for each ultrafilter $U$ on each set $X$ it holds
...
with the following topology [Bourbaki, General Topology, I\S6.5, Definition 5, Example](#BourbakiGeneralTopology):
...
The Tychonoff theorem follows from the [[universal property]] of the [[product]].
