...
What is known as the **Tychonoff theorem** or as **Tychonoff's theorem** ([Tychonoff 35](#Tychonoff35)) is a basic [[theorem]] in the field of [[topology]]. It states that the  [[product topological space]] (with its [[Tychonoff topology]]) of an arbitrary [[set]] of [[compact topological spaces]] is itself [[compact space|compact]].
...
where he says that the proof is the same as the one he gave for a product of intervals in 
...
Many authors later gave alternative proofs, here are some:
