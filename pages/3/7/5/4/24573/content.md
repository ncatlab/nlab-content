...
* [personal page](http://www.daviddeutsch.org.uk/)

* [Wikipedia entry](https://en.wikipedia.org/wiki/David_Deutsch)

## Selected writings

Introducing the model of [[quantum computation]] based on [[quantum Turing machines]]:
...
and based on [[quantum circuits]] of [[quantum gates]]:
...
On [[algorithms]] for which [[quantum computation]] is expected to exhibit [[quantum supremacy]] (specifically what is now called the *[[Deutsch-Jozsa algorithm]]*):
