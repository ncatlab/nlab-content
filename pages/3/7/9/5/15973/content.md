...
One may give an abstract definition of an [[elliptic complex]] over a [[complex analytic space]]: an elliptic pair is the datum of an $\mathbb{R}$-[[constructible sheaf]] $F$ and a complex $\mathcal{M}$ of $\mathcal{D}$-[[D-module|modules]], such that the intersection $$char(\mathcal{M})\cap SS(F)=T^*_M M\subset T^*M$$
