...
(this is a [[left adjoint]] ...) See for now ([Strickland 2009](#Strickland), Proposition 2.22), for the weak Hausdorffification of a compactly-generated topological space. Note in particular that the construction of the weak Hausdorffification of a compactly-generated space is a quotient by a closed equivalence relation given by a one-step construction (the intersection of all closed equivalence relations on the space), as opposed to the equivalence relation generated by a possibly transfinite procedure as in the Hausdorffification of an arbitrary topological space.
