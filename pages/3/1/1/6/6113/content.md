...
Formalization of suspension spectra in [[dependent linear homotopy type theory]] (see also on the "[[exponential modality]]" [here](!-modality#RealizationInLinearHomotopyTypeTheory)):
