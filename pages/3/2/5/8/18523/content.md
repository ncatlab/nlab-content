...
In [[microlocal analysis]] the _propagation of singularities theorem_ ([Duistermaat-H&#246;rmander 72, section 6.1](#DuistermaatHoermander72)) characterizes the [[wave front set]] of a [[distribution|distributional]] solution to a suitable [[differential equation]] in terms of the [[principal symbol]] of the corresponding [[differential operator]]: It says roughly that the singularity wave fronts of the solution propagate along the [[Hamiltonian flow]] of the [[principal symbol]] of the differential operator (regarded as a function on the [[cotangent bundle]] with its canonical [[symplectic manifold]] structure).
...
Moreover, $WF(u)$ is invariant under the [[flow]] induced by the [[Hamiltonian vector field]] of $q$ with respect to the canonical [[symplectic manifold]] structure on the cotangent bundle.

([Duistermaat-H&#246;rmander 72, theorem 6.1.1](#DuistermaatHoermander72))

## Examples

For $(X,e)$ a [[globally hyperbolic spacetime]] and $P$ a [[hyperbolic differential operator]] such as the [[wave operator]]/[[Klein-Gordon operator]], then the wave front set of any solution $f$ to $P f = 0$ is a union of [[lightlike]] [[geodesics]] and their [[cotangent vectors]].
