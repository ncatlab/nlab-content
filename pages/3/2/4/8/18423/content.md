...
The following proof (from [June 2021](https://ncatlab.org/nlab/revision/shape+via+cohesive+path+∞-groupoid/6), [here](https://nforum.ncatlab.org/discussion/11361/shape-via-cohesive-path-groupoid/#Comment_93145)) as a direct consequence of Prop. \ref{SmoothShapeModelityGivenBySmoothPathInfinityGroupoid} is that appearing in [SS21, §3.3.1](#SS21). We later learned that the statement also appears as [Clough 2021, Theorem B/Cor. 6.4.8](#Clough21), where it is proven independently, now implying a proof of Prop. \ref{SmoothShapeModelityGivenBySmoothPathInfinityGroupoid}.
