...
A  _pseudo-order_ (also called _strict total order_ or _strict linear order_) is the irreflexive version of a [[total order]].  A __pseudo-order set__ is a [[set]] equipped with a pseudo-order.
