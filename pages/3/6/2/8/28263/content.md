...
Lemma \ref{w2_pinp} and the [[Whitney sum formula]] imply that, in general, the direct sum of two vector bundles with pin⁺ structures is not pin⁺, due to the presence of $w_1$ cross terms in the formula for $w_2$ of a direct sum. This has a few consequences.
...
[Giambalvo](#Giambalvo73) computed the pin⁺ bordism groups. [Kirby-Taylor](#KTgeo) calculate through $\Omega_4$ using arguments from geometric topology.
...
1. For all $n\ge 0$, there is a $\mathbb{Z}/2^{4n+1}$ summand of $\Omega_{8n}^{Pin^+}$, generated by the bordism class of $\mathbb{RP}^{8n}$ with either of its two pin⁺ structures.
2. For all $n\ge 0$, there is a $\mathbb{Z}/2^{4n+4}$ summand of $\Omega_{8n+4}^{Pin^+}$, generated by the bordism class of $\mathbb{RP}^{8n+4}$ with either of its two pin⁺ structures.
