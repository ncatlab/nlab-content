...
\begin{proposition}
All pin⁺ bordism groups are [[modules]] over the [[spin bordism]] ring $\Omega^Spin$ and modulo the [[spin bordism]] [[submodule]] generated by $\mathbb{R}P^{4n}$ are $\mathbb{Z}_2$ [[vector spaces]].
\end{proposition}
