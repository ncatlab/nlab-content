...
The **analytic Markov's principle** states that the [[strict order]] on the [[Dedekind real numbers]] is a [[stable relation]]: for all [[real numbers]] $r \in \mathbb{R}$ and $s \in \mathbb{R}$, $\neg \neg (r \lt s)$ implies $r \lt s$. 
