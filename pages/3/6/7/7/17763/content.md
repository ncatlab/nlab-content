...
##Idea 
Let $\Gamma^{op}$ (see [[Segal's category]]) be the [[skeleton]] of the category of [[finite set|finite]] [[pointed sets]].  We write $\underline{n}$ for the finite pointed set with $n$ non-basepoint elements.  Then a **$\Gamma$-set** is a functor $X\colon \Gamma^{op}\to Set$.
