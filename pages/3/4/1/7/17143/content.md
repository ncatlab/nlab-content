...
Observe that the [[circle group]] $U(1)$ is naturally identified with the [[unit sphere]] in $\mathbb{C}$: $U (1) \simeq S(\mathbb{S})$. Therefore the [[sphere bundle]] of the universal complex line bundle is equivalently the [[principal U(1)-bundle]]
