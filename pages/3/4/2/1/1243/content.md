...
Given a ring $R$, an element $m$ in an $R$-[[module]] $M$ is **torsion element** if there is a nonzero element $r$ in $R$ such that $r m=0$. A **torsion module** is a module whose elements are all torsion. A torsion-free module is a module whose elements are not torsion, other than $0$. Torsion and torsion-free classes of objects in an [[abelian category]] were introduced axomatically as a [[torsion theory]] (or torsion pair) in the thesis 
