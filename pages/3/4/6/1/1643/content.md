A __magma__ is a [[set]] $S$ equipped with a binary operation, that is a [[function]] from $S \times S$ to $S$.
...
More generally, in any [[monoidal category]] $M$, a **magma object** or **magma in $M$** is an object $X$ equipped with a morphism $m: X \otimes X \to X$.