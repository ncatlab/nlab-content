...
The following is just a specialization of the previous expos&#233; where $Y=id$ is the identity and $\Sigma:=\mathfrak{S}\subset \mathfrak{A}$ is a sub-$\sigma$-algebra:
