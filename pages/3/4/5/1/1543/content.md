...
Historically this quotient property of a free continuous action was sometimes taken as the very definition of "principal bundle" without requiring local triviality, e. g. in ([Serre, 1949-1950](#Serre)), where this perspective is attributed to [[Henri Cartan]]. A standard modern textbook following this tradition is ([Husem&#246;ller](#Husemoeller)).

Therefore in order to avoid ambiguous terminology in the following, we will now follow ([Palais](#Palais)) and refer to this alternative definition of principal bundle as that of _Cartan principal bundle_.
...
See also most textbooks on _[[differential geometry]]_, for instance
