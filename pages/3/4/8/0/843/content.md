...
$$
  ...
  Hom_{c}(C' \star \{\bottom\}, C)
  \,,
$$
where

* $C' \star \{\bottom\}$ denotes the category $C'$ with a freely adjoined [[terminal object]] $\bottom$;

* $Hom_{c}(\cdots)$ denotes the subset of functors which send $\bottom$ to $c$.

The idea of the definition of [[over category]] in the context of [[quasi-category|quasi-categories]] is to mimic this universal property. This relies crucially on generalizing the construction $C' \star \{\bottom\}$ to the context of quasi-categories, in terms of the [[join of quasi-categories]].
