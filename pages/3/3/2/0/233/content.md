...
The right $R$-modules can be considered as $Ab$-functors $\mathbf{B}R^{op}\to Ab$. Then the usual tensor product (over $\mathbb{Z}$) $M\otimes N$ of a right and left $R$-modules can be considered as a functor
$\mathbf{B}R^{op}\otimes \mathbf{B}R\to Ab$. The coend $\int^R M\otimes N$ computes then to $M\otimes_R N$. 
