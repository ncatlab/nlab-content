...
For $A$ a [[dg-algebra]], its [[chain homology]] $H_\bullet(A)$ inherits an [[A-infinity algebra]] structure by [[Kadeishvili's theorem]]. Then for every $n \in \mathbb{N}$ the $n$-ary $A_\infty$-product on elements $ (a_1, \cdots, a_n) \in H_\bullet(A)^n$ is *often* given, up to a sign, by the Massey product $\langle a_1, \cdots, a_n\rangle$.

For $n = 3$ this is due to [Stasheff](#Stasheff), where all $A_\infty$-products are Massey products. For general $n$ the situation is discussed in [BMM 2020](#BMM20) (where it is also shown that the earlier claim in [LPWZ, theorem 3.1](#LPWZ), that still all $A_\infty$-products are Massey products, is wrong for $n \gt 3$).
...
On the relation of Massey products to [[A-infinity algebra]] structures, for $n = 3$:

* {#Stasheff} [[Jim Stasheff]], Chapter 12 of: _H-spaces from a homotopy point of view_, Lecture Notes in Mathematics **161**, Springer (1970) &lbrack;[doi:10.1007/BFb0065896](https://doi.org/10.1007/BFb0065896)&rbrack;
 
A statement for higher $n$ was claimed in  

* {#LPWZ} D.-M. Lu, J. H. Palmieri, Q.-S. Wu, J. J. Zhang, Theorem 3.1 and Corollary A.5 of, _$A_\infty$-structures in Ext algebras_, J. Pure Appl. Alg. **213** (2009) 2017--2037 &lbrack;[arXiv:math/0606144](http://arxiv.org/abs/math/0606144)&rbrack;
 
but the situation is more subtle, as explained in:
...
* [[Bruno Vallette]], item 1.4 in: _Algebra+Homotopy=Operad_ &lbrack;[arXiv:1202.3245](http://arxiv.org/abs/1202.3245)&rbrack;

* {#ValetteLoday} [[Bruno Vallette]], [[Jean-Louis Loday]], sections 9.4.10 to 9.4.12 of: _Algebraic Operads_ &lbrack;[pdf](http://math.unice.fr/~brunov/Operads.pdf)&rbrack;
