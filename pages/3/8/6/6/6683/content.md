...
Notice that the worldvolume $SU(N)$ gauge group enhancement at an $\mathbb{Z}_k$-[[ADE singularity]] is akin to the [[enhanced gauge symmetry|gauge symmetry enhancement]] of the [[effective field theory]] for [[M-theory on G₂-manifolds]] at the same kind of singularities (see at _[M-theory on G₂-manifolds -- Nonabelian gauge groups](M-theory+on+G2-manifolds#EnhancedGaugeGroups)_).
