...
$$\mathrm{hId}_A(a, b, p, x, y) \equiv \mathrm{Id}_{\mathbb{2}, A}(\mathrm{rec}_{\mathbb{2}, A}(x, y), p, \mathrm{ind}_{\mathbb{2}, \lambda b.B(\mathrm{rec}_{\mathbb{2}, A}(b))}(y, z))$$
