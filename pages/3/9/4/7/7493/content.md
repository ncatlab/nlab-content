...
Let $\mathcal{C}_{1}$, $\mathcal{C}_2$ be two [categories](http://ncatlab.org/nlab/show/category) with the same objects.
Let $\mathcal{D}$ be a [2-category](http://ncatlab.org/nlab/show/2-category).
Let $F_{1}$ $\colon \mathcal{C}_{1} \rightarrow \mathcal{D}$ and $F_{2}\colon \mathcal{C}_{2} \rightarrow \mathcal{D}$ be [2-functors](http://ncatlab.org/nlab/show/2-functor) such that $F_{1}(x) = F_{2}(x) = F(x)$ for all objects in $\mathcal{C}_1$ and $\mathcal{C}_2$. Let $\mathcal{E}$ be a fixed class of commutative squares that are preserved under [horizontal](http://ncatlab.org/nlab/show/horizontal+composition) and [vertical composition](http://ncatlab.org/nlab/show/vertical+composition) of the form:
...
* They must be compatible with the horizontal composition of mixed squares, that is for every [horizontal composition](http://ncatlab.org/nlab/show/horizontal+composition) of mixed squares $\mathcal{C}_1$, $\mathcal{C}_1$:
...
<svg width="640" height="480" xmlns="http://www.w3.org/2000/svg" xmlns:se="http://svg-edit.googlecode.com" se:nonce="81238">
 <g>
  ...
  <text font-weight="normal" id="svg_81238_221" xml:space="preserve" text-anchor="middle" font-family="Fantasy" font-size="18" y="108" x="313" stroke-width="0" stroke="#000000" fill="#000000">F (h'&#8728;g')</text>
  ...
  <text id="svg_81238_233" font-weight="normal" xml:space="preserve" text-anchor="middle" font-family="Fantasy" font-size="18" y="308.5" x="233" stroke-width="0" stroke="#000000" fill="#000000">F (h&#8728;g)</text>
...
* They must be compatible with the vertical composition of mixed squares, that is for every [vertical composition](http://ncatlab.org/nlab/show/vertical+composition) of mixed squares $\mathcal{C}$, $\mathcal{C}'$:
...
<svg width="640" height="480" xmlns="http://www.w3.org/2000/svg" xmlns:se="http://svg-edit.googlecode.com" se:nonce="81238">
 <g>
  ...
  <text id="svg_81238_53" fill="#000000" stroke="#000000" stroke-width="0" x="299" y="180" font-size="18" font-family="Fantasy" text-anchor="middle" xml:space="preserve" font-weight="normal">F (e'&#8728;f')</text>
  <text id="svg_81238_54" fill="#000000" stroke="#000000" stroke-width="0" x="499" y="236" font-size="18" font-family="Fantasy" text-anchor="middle" xml:space="preserve" font-weight="normal">F (e&#8728;f)</text>
...
J. Ayoub, Les six op&#233;rations de Grothendieck et le formalisme des cycles &#233;vanescents dans le monde motivique. I., Ast&#233;risque No. 314 (2007), x+466 pp. (2008) [MR2009h:14032](http://www.ams.org/mathscinet-getitem?mr=2423375); II. Ast&#233;risque No. 315 (2007), vi+364 pp. (2008) [MR2009m:14007](http://www.ams.org/mathscinet-getitem?mr=2438151); also a file at K-theory archive [THESE.pdf](http://www.math.uiuc.edu/K-theory/0761/THESE.pdf)
