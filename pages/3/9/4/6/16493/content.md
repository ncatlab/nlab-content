...
* [personal page](http://geoffroy.horel.org)

* [GoogleScholar page](https://scholar.google.com/citations?user=QeH5ahcAAAAJ&hl=en)

* [MathGenealogy page](https://www.mathgenealogy.org/id.php?id=185361)
...
A [[model category]]-[[structure]] on the category of [[simplicial categories]] (in the sense of [[simplicial objects in Cat]]) presenting [[(infinity,1)-categories|$(\infty,1)$-categories]]:

* {#Horel15} [[Geoffroy Horel]], *A model structure on internal categories*, Theory and Applications of Categories, **30** 20 (2015) 704-750 &lbrack;[tac:30-20](http://www.tac.mta.ca/tac/volumes/30/20/30-20abs.html), [arXiv:1403.6873](http://arxiv.org/abs/1403.6873)&rbrack;

On [[integral homotopy theory]]:
