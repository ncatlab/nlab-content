...
p-adic _Hodge theory_ is the study of properties of p-adic (&#233;tale, de Rham, logarithmic cristalline) [[cohomology]] (and [[motives]]) of [[non-archimedean manifolds]]. The p-adic Hodge structure of a (proper or semi-stably compactified) p-adic analytic variety is essentially given by a relation between three important invariants of the given variety:
...
using Beilinson's approach, through derived de Rham cohomology.
