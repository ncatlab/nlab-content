...
This "non-constructive" nature of classical logic eventually led people to consider alternative and hence _non-classical_ systems of logic, such as [[constructive logic]]/[[intuitionistic logic]], where the [[principle of excluded middle]], and possibly other principles of classical logic, are not considered by default.  There is still a close relation between classical and [[constructive logic]]. For example a [[proposition]] is provable in classical logic precisely if its [[double negation]] is provable in [[constructive logic]] ("[[double negation translation]]").
