...
A pure subobject is a [[monomorphism]] $A \rightarrowtail B$ -- hence a [[subobject]] $A$ of some [[object]] $B$ in some [[category]] -- which is a _[[pure morphism]]_: such that any sufficiently small system of [[equations]] involving constants in $A$ that admits a solution in $B$ also admits a solution in $A$. This generalises the classical notions of 'pure group' and 'pure submodule'.
