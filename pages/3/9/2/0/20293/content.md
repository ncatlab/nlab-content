...
\begin{theorem}
Every [[weakly Lindelöf]] spaces with [[countably locally finite set of subsets|$\sigma$-locally finite]] [[topological base|base]] is [[second countable space|second countable]].
\end{theorem}
