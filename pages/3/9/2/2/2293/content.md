...
More generally, one may consider a derived version of [[noncommutative algebraic geometry]] represented by [[A-∞ categories]] ([Katzarkov-Kontsevich-Soibelman](#KatzarkovKontsevichPantev)). 
...
1. to generalize the algebraic geometry allowing the notion of derived [[moduli space]]s (moduli stacks if you wish), which extend or replace the usual [[moduli space]]s. Locally these moduli spaces should correspond to the deformation theory problem which geometrically 
...
Homological mirror symmetry is one of the main motivations and statements of the [[derived noncommutative algebraic geometry]] of the first kind.
...
This formal aspect is supposedly related to the infinitesimal picture of the moduli stacks considered by Toen et al. and it generalizes more classical approaches to the [[deformation theory]] like Illusie's [[cotangent complex]] (cf. also smooth obstruction theory of Fantechi-Behrend). See also motivic aspects in the entry
