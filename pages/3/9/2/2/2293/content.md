...
1. to generalize the algebraic geometry allowing the notion of derived [[moduli space]]s (moduli stacks if you wish), which extend or replace the usual [[moduli space]]s which are in some cases their truncations. Locally these moduli spaces should correspond to the deformation theory problem which geometrically 
