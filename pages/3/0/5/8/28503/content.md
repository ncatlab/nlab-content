...
|:--------|--------:|
|$\phantom{A}$$\top$ | $\phantom{A}$additive [[truth]] |
|$\phantom{A}$$\bot$ | $\phantom{A}$additive [[falsehood]] |
|$\phantom{A}$$0$ | $\phantom{A}$multiplicative [[falsehood]] |
|$\phantom{A}$$1$ | $\phantom{A}$multiplicative [[truth]] |
...
| $\phantom{A}$$^\bot$$\phantom{A}$ | $\phantom{A}$[[negation]]$\phantom{A}$ |  