...
Originally [[Henri Poincaré]] made the following observation:

+-- {: .num_theorem #TraditionalPoincareDuality}
###### Theorem

Let $X$ be a [[closed manifold]] that is [[orientation|orientable]]. Then the [[cap product]] with any choice of [[orientation]] in the form of a [[fundamental class]] $[X]$ induces [[isomorphisms]] the form
