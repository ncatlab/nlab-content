...
$Semi Lat$ is given by a finitary [[variety of algebras]], or equivalently by a [[Lawvere theory]], so has all the usual properties of such categories.  The __[[free object|free]] semilattice__ on a [[set]] $X$ is the __finite [[powerset]]__ $\mathcal{P}_{fin}(X)$ of $X$, that is the set of [[finite set|finite]] subsets of $X$.  (Note that this exists even in [[predicative mathematics]], as long as we are allowed to define sets by [[recursion]] over [[natural numbers]], although you have to construct it by general nonsense instead of as a subset of the full powerset.)
