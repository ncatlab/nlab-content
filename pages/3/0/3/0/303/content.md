Enriched functors are used in place of [[functor]]s in [[enriched category theory]].

Given two categories $C, D$ enriched in a monoidal category $V$, an __enriched functor__ $F: C \to D$ consists of 
