...
Gauge-Higgs unification is naturally combined with [[GUT|grand unification]] of gauge groups, whence one then also speaks of _gauge-Higgs grand unification_ (e.g. [Hosotani-Yamatsu 15](#HosotaniYamatsu15)). Also the [[Connes-Lott models]] realize gauge-Higgs unification, in a [[non-commutative geometry|non-commutative geometric]] [[KK-compactification]].

Attractive aspects of gauge-Higgs unification include the following:

1. a potential for providing a mechanism behind the Higgs-sector in the [[standard model of particle physics]] which could possibly solve the [[naturalness]]/[[hierarchy problem]] (e.g. [Kaul 08](#Kaul08), [Csáki-Tanedo 13](#CsakiTanedo13)). 

   As such, gauge-Higgs unification is a possible alternative to [[MSSM]]-models.

1. a mechanism for ruling out [[proton decay]] in [[GUT]]-models, see [below](#NoProtonDecay).
...
Gauge-Higgs grand unification is claimed to predict stability of the [[proton]], hence no [[proton decay]] ([Hosotani-Yamatsu 15](#HosotaniYamatsu15), [Furui-Hosotani-Yamatsu 16, Sec. 2.6](#FuruiHosotaniYamatsu16) [Hosotani 17, Section 6](#Hosotani17)).
...
* Jason Carson, Nobuchika Okada, _125 GeV Higgs boson mass from 5D gauge-Higgs unification_, Progress of Theoretical and Experimental Physics, Volume 2018, Issue 3, March 2018, 033B03 ([doi:10.1093/ptep/pty018](https://doi.org/10.1093/ptep/pty018))
...
[[!redirects Hosotani mechanism]]
[[!redirects gauge-Higgs grand unification]]
