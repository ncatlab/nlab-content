...
Setting $M= Ker\,s,$ $N= Im\,s$ and
$\partial = t | M,$ then the action of $N$ on $M$ by conjugation  within $G$ makes
$\partial:M\to N$ into a crossed module. Conversely if $\partial: M\to N$ is a
crossed module, then setting $G = M\rtimes N$ and letting $s,t$ be defined by 
$$
s(m,n) = (1,n)
$$
and
