...
* for all $x \in R$ and $y \in R$, $(x y)^* = 1 + x (y x)^* y$
...
* Wikipedia, [Conway semiring](https://en.wikipedia.org/wiki/Conway_semiring)
...
[[!redirects Conway semiring]]
[[!redirects Conway semirings]]

[[!redirects Conway rig]]
[[!redirects Conway rigs]]
