...
Any regular category $C$ admits a subcanonical [[Grothendieck topology]] whose covering families are generated by single [[regular epimorphisms]].  If $C$ is exact or has pullback-stable coequalizers, then it is a [[stack]] for its regular topology.
