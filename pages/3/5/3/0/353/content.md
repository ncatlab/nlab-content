...
Finally, it is sometimes useful to subsume degenerate cases in the general pattern of $n$-categories, such as [[0-categories]] ([[sets]]), [[(0,1)-categories]] ([[posets]]) and even *[[(-1)-categories]]* ([[truth values]]) and *[[(-2)-categories]]* (the [[terminal category|singleton category]]).
