A morphism $i = (i,i^\sharp):Y\hookrightarrow X$ of algebraic [[schemes]] is a __closed immersion__ if, as a topological space, $i(Y)$ is a closed subspace of $X$, $i$ is a homeomorphism on the image, and the [[comorphism]] $i^\sharp:\mathcal{O}_X\to f_*\mathcal{O}_Y$ is a surjective map of rings. 
