...
=--
The relation $I$ is usually referred to as *independence*.  Its complement $D = (\Sigma \times \Sigma) - I$ is called the _dependency_ relation.  It will be reflexive and symmetric. (Such a sense of 'dependency relation' is interpreted in a slightly different way from that in the use of dependency graphs in project planning.
