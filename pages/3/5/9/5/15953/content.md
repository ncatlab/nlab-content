...
The **symmetric topos** is the topos analogue of the [[symmetric algebra]] construction. Its importance stems from the property that $\Sigma\mathcal{E}$ classifies topos distributions on $\mathcal{E}$
