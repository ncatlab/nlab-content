...
* The [[univalence axiom]] implies [[function extensionality]], which is generally not true in type theories in general. 

* Given the [[univalence axiom]] in [[homotopy type theory]], one could prove that every [[proset]] is a [[poset]]. 

## Higher inductive types

* The existence of the [[interval type]] in [[type theory]] implies [[function extensionality]]. 
