...
$$
Here by [[fibrant replacement]] we may assumethat the right vertical map is again a [[Serre fibration]], as indicated, in which case it is a [[covering space]]-projection whose fibers are the desired cohomology groups. This implies the claim by the *[fundamental theorem of covering space theory](covering+space#FundamentalTheoremOfCoveringSpaces)*.
\end{proof}
