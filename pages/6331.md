...
The second statement follows by the same argument, after using over any patch $U_j \xhookrightarrow{\iota_J} B$ of the given open cover that:
$$
  \begin{array}{ll}
    \iota_j^\ast
    Map
    ...
    \big)
    &
    \text{by [this Prop.](parameterized+homotopy+theory#FiberwiseMappingSpaceBetweenTrivialFibrations)  }
  \end{array}
$$ 
\end{proof}
