...
Equivalently, a function $f:\mathbb{R} \to \mathbb{R}$ is **smooth** if it comes with a [[sequence]] of functions $D^{(-)}f:\mathbb{N} \to (\mathbb{R} \to \mathbb{R})$ and a sequence of functions $M^{(-)}f:\mathbb{N} \to (\mathbb{Q}_+ \to \mathbb{Q}_+)$ in the positive rational numbers, such that 
