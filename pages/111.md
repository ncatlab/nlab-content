...
The attentive reader will note that we said a category has a 'collection' of objects and a 'collection' of morphisms.  A category is said to be [[small category|small]] if these collections are sets &mdash; as opposed to proper classes, for example.  (The alternatives depend on ones [[foundations|foundations for mathematics]].)
