...
A  [[homotopical category]] is a [[category]] $C$ equipped with the information that some of its [[morphism]], a subcategory $W \superset Core(C)$ are to be regarded as "weakly invertible". One way to make precise what this means is simplicial localizaton:
...
(where $\pi_0$ is the  [[simplicial homotopy group|0th simplicial homotopy set]]).
