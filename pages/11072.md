...
* Nick Benton , Gavin Bierman , Valeria De Paiva , Martin Hyland, *Linear lambda-Calculus and Categorical Models Revisited* (1992), [citeseer](http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.31.6958)
 {#BBPH92}

* R. F. Blute (a1), J. R. B. Cockett (a2) and R. A. G. Seely.  *! and ? – Storage as tensorial strength* [doi](https://doi.org/10.1017/S0960129500001055), [pdf](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.26.7317&rep=rep1&type=pdf)
 {#BCS96}

* Paul-Andre Mellies, *Categorical semantics of linear logic*, 2009. [pdf](https://www.irif.fr/~mellies/papers/panorama.pdf)
 {#Mellies09}
