...
_Toby_:  OK, I approve of that attitude, at least while definitions are in flux as they are now.  But since 'e.g.' implies to me that there may be nonequivalent alternatives, and we don\'t expect that to be the case, so I rephrased in a slightly vaguer way that no longer gives that impression ... at least, not to me.
=--
