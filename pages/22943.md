...
* Special properties of $0$ that are needed since distributivity doesn\'t hold: $0 0 = 0$, $(x + 0 y) z = x z + 0 y$, and $/(x + 0 y) = /x + 0 y$;
* Although $0 /0$ doesn\'t simplify, it\'s an [[absorbing element]] for addition: $0 /0 + x = 0 /0$; and
