...
We state the definition of pointwise continuity in terms of [[epsilontic analysis]], definition \ref{EpsilonDeltaDefinitionOfPointwiseContinuity} below. First recall the relevant concepts:
...
1. a ternary [[relation]] $(-)\sim_{(-)} (-)\colon X \times (0,\infty) \times X \to \Omega$ (the "premetric") from the [[Cartesian product]] of the set with the positive [[real numbers]] and with itself again to the set of [[truth values]]. 
