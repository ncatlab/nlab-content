...
2. A functor $P : K^o \to CCC$, i.e., a contravariant functor from $K$ to the category of [[cartesian closed categories]] and [[functors]] preserving the CC structure.
...
4. Such that for any $\Delta \in K$, the functor $P(\pi) : P(\Delta) \to P(\Delta \times U)$ induced from the projection $\pi : \Delta \times U \to \Delta$ has a right adjoint $\forall : P(\Delta \times U) \to P(\Delta)$ satisfying a [[Beck-Chevalley condition]].
