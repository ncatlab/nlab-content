...
Almost quaternionic structure: [[reduction of structure group|reduction of the stucture group]] along the inclusion $GL_n(\mathbb{H}) \hookrightarrow Gl_{4 n}(\mathbb{R})$, for $\mathbb{H}$ the [[quaternions]].
