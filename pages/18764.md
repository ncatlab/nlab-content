...
are called _[[formally adjoint differential operators]]_ if there exists a [[bilinear map|bilinear]] [[differential operator]]
...
$$
  P \;\colon\;\Gamma_\Sigma(E) \overset{}{\longrightarrow} \Gamma_\Sigma(\tilde E^\ast)
$$ 

be a Green hyperbolic differential operator (def. \ref{GreenHyperbolicDifferentialOperator}) with [[formally adjoint differential operator]]

$$
  P^\ast \;\colon\;\Gamma_\Sigma(E) \overset{}{\longrightarrow} \Gamma_\Sigma(\tilde E^\ast)
$$ 

in that there is a [[bilinear map|bilinear]] [[differential operator]]
...
Then the [[causal Green function]] intertwines the $P$-Poisson bracket with the $P$-Peierls bracket in that for every [[Cauchy surface]] $\Sigma_p \hookrightarrow \Sigma$ and all 
