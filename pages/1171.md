...
A [[sequential convergence space|subsequential space]] is a pseudotopological space that may be defined using only [[sequence]]s instead of arbitrary nets/filters.
