An object $A$ in a [[monoidal category]] $C$ is **dualizable** if it has an [[adjoint]] when regarded as a 1-cell in the one-object [[bicategory]] $\mathbf{B}C$ corresponding to $C$.  Its adjoint in $\mathbf{B}C$ is called its **dual** in $C$ and often written as $A^*$.
