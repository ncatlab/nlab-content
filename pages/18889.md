...
### Scaling transformation and Mass dimensio
...
$$
  \rho^{ 2 mdim_{sp} }  \Delta_{F, 1/\rho, sp}( \rho x )
  \;=\;
  \Delta_{F,1,sp}(x)
$$
...
The [[Feynman propagator]] of the [[real scalar field]] on [[Minkowski spacetime]] is

[this prop.](Feynman+propagator#FeynmanPropagatorAsACauchyPrincipalvalue)
...
Hence the mass dimension of the real scalar field is $(p+1)/2 - 1$
...
The [[star product]] induced by the [[Feynman propagator]] satisfies
