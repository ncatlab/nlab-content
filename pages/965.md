...
The category $Sup$ of suplattices and suplattice homomorphisms admits a [[tensor product]] which represents "bilinear maps," i.e. functions which preserve joins separately in each variable.  A monoid in this monoidal category is a [[quantale]], including [[frame]]s as a special case.
