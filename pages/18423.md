...
For precursor discussion see 
[nForum comment 55210 (Nov 2015)](https://nforum.ncatlab.org/discussion/6816/the-shape-of-function-objects/?Focus=55210#Comment_55210).

The following proof (from [June 2021](https://ncatlab.org/nlab/revision/shape+via+cohesive+path+∞-groupoid/6), [here](https://nforum.ncatlab.org/discussion/11361/shape-via-cohesive-path-groupoid/#Comment_93145)) is that appearing in [SS21, §3.3.1](#SS21). We later learned that the statement also appears as [Clough 2021, Theorem B/Cor. 6.4.8](#Clough21).
...
The statement of the smooth Oka principle is also 

* {#Clough21} [[Adrian Clough]], *A Convenient Category for Geometric Topology*, PhD thesis &lbrack;[pdf](https://repositories.lib.utexas.edu/bitstream/handle/2152/114981/CLOUGH-DISSERTATION-2021.pdf), [[Clough-ConvenientCategory.pdf:file]]&rbrack;
