...
+-- {: .query} 
I have seen several assertions around the nLab of the sort "string diagrams are proof nets" or "proof nets are string diagrams". The precise content of such assertions is still murky to me and needs to be clarified. Let's please hold off on further such assertions until we can get this sorted out in discussion. 
=-- 
