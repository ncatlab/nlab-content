...
+-- {: .query} 
There are altogether too many repeated assertions around the nLab of the sort "string diagrams = proof nets". Let's please hold off on these until we can get this matter sorted out once and for all. 
=-- 
