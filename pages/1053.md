...
+-- {: .query} 
I have seen several assertions around the nLab of the sort "string diagrams are proof nets" or "proof nets are string diagrams". It seems to me that these are fuzzy statements (I have to squint a little to imagine the possible truths they might convey). I would prefer to hold off on further such assertions until we can get this clarified in discussion. 
=-- 
