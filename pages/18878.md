...
This is also the statement of the [[main theorem of perturbative renormalization]].
...
it only remains to see that this expression indeed happens to be a [[local observables]], hence that its
spacetime support is on the [[diagonal]].
