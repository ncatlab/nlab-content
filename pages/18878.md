...
Now for any vertex prop. \ref{CausalFactorizationSatisfiedByCompositionOfSMatrixWithVertexRedefinition} $\mathcal{S} \circ \mathcal{Z}$ is itself an S-matrix scheme.
