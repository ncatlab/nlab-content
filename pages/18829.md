...
$$
  ...
  \Leftrightarrow
   \phantom{AAA}
  \iota_{\partial_p} \left(  d \psi + i \theta \right)
  = 
  0
  \,,
$$
...
for $\psi \colon \mathbb{R} \to \mathbb{C}$ any [[smooth function]], called a _[[wave function]]_.
...
$$
  ...
  \begin{aligned}
    \{q,p\}
    & = 
    \iota_{v_q} \iota_{v_p} \omega
    \\
    & = 
    - \iota_{\partial_p} \iota_{\partial_q} d p \wedge d q
    =
    \\
    & = 
    + 1 
...
$$
  \begin{aligned}
    ...
    \\
    & = 
   \left(i \frac{\partial}{\partial q}\psi(q)\right) e^{i q p}
   +
   \underset{ = 0}{
     \underbrace{
       \underset{ = - p \Psi(q,p) }{
         \underbrace{
           \psi(q) \left( i \frac{\partial}{\partial q} e^{i q p}\right)  
         }
       }
    } 
  }
   ...
   \\
   = \left( i \frac{\partial}{\partial q}\psi(q)\right)e^{i p q}
  \,.
$$
