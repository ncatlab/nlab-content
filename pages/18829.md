...
The result is the  "[[Moyal star product|Moyal]]-[[star product]]" (def. \ref{StarPoduct} below).  This is the [[exponentiation]] of the [[integral kernel]] of the [[Poisson bracket]] plus possibly a symmetric shift (prop. \ref{SymmetricContribution} below), and as such is a _[[formal deformation quantization]]_ of the original commutative pointwise product (def. \ref{FormalDeformationQuantization} below). 
...
Consider a [[gauge fixing|gauge fixed]] (def. \ref{GaugeFixingLagrangianDensity}) [[free field theory|free]] [[Lagrangian field theory]] (def. \ref{FreeFieldTheory}) with BV-BRST-extended [[field bundle]] 
...
and the resulting [[non-commutative algebra]] stucture
