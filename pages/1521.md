...
A little later more indications accumulated that the push-forward appearing in the _$n$-Caf&eacute; quantum conjecture_ is the push-part in a pull-push operation, where a quantum [[sigma model]] with target space $X$ and background field $\nabla : X \to V$ classifying a bundle $P \to X$ assigns to a [[cobordism]] [[cospan]] $\Sigma_in \to \Sigma \leftarrow \Sigma_{out}$ the pull-push operation through the [[span]] $[\Sigma_{in},P] \leftarrow [\Sigma, P] \to [\Sigma_{out}, P]$.
