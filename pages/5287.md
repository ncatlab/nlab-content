...
by the [[product law]] for [[differentiation]], where now $\nabla f \coloneqq (g^{a b} \partial f)$ is the [[gradient]] and $(v,w) \coloneqq g_{a b} v^a w b$ the [[inner product]]. Here one just needs to carefully record the relative signs that appear.
