...
* (a) *symmetry protected topological* ("SPT", [Gu & Wen 09](#GuWen09), [PBTO 09](#PBTO09)) 

or more generally

* (b) *symmetry enriched topological* ("SET", [CGLW 11, p. 3](#CGLW11), [CLM 12, p. 2](#CLM12))  
...
In case (a) one in addition requires that the underlying topological phase (forgetting the symmetry) *is* trivial, while in case (b) this constraint is not implied.
...
one may regard the $G$-symmetry as "protecting" an SPT phase from decaying and as  "enriching" one plain phase to two distinct SET phases -- whence the terminology.
...
* {#CLM12} Gil Young Cho, Yuan-Ming Lu, and Joel E. Moore, *Gapless edge states of background field theory and translation-symmetric Z2 spin liquids*, Phys. Rev. B **86** 125101 (2012) $[$[arXiv:10.1103/PhysRevB.86.125101](https://doi.org/10.1103/PhysRevB.86.125101)$]$
