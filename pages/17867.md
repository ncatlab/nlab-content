...
"Geometric algebra" is essentially a synonym for _[[Clifford algebra]]_, specifically over the [[ground field]] of [[real numbers]], or, to some extent, for the [[spin geometry]] formulated in terms of such Clifford algebra. The term "geometric algebra" is used and preferred in a school of thought following [Hestenes 66](#Hestenes66) that emphasizes the usefulness of making abstract Clifford algebra explicit in the exposition of geometry and physics, mostly on [[Minkowski spacetime]]. 
