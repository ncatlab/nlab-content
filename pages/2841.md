...
A [[metrisable space|metrisable]] topological space $Y$ is an _[[absolute neighborhood retract]]_ if for _any_ embedding $Y\subset Z$ as a [[closed subspace]] in a [[metrisable topological space]] $Z$, $Y$ is a neighborhood retract of $Z$.
