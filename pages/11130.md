...
Rabinowitsch, who later renamed himself Rainich (see the story [here](http://mathoverflow.net/a/45195/2926)), showed how to deduce the Strong Nullstellensatz from the Weak Nullstellensatz. Often this is described as Rabinowitsch's "trick" (i.e., something involving a stroke of cleverness), but see the remark below which places the trick conceptually within the general method of localization. 
