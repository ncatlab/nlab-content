...
On [[M-theory on Spin(7)-manifolds]], [[F-theory on Spin(7)-manifolds]] and [[Witten's Dark Fantasy]]:
...
On [[axion]]-driven [[cosmic inflation]] in [[F-theory]]:

* {#Grimm14} [[Thomas Grimm]], _Axion Inflation in F-theory_ ([arXiv:1404.4268](http://arxiv.org/abs/1404.4268))

On [[F/M-theory on elliptically fibered Calabi-Yau 4-folds]]:
...
On [[flux compactifications]] in [[F-theory]]:
...
On [[5d Chern-Simons theory]] in [[5-dimensional supergravity]]:
