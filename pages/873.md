...
A **subset** of a [[set]] $A$ is a set $B$ with a term $p:A \subseteq B$. 

Every subset has an [[injection]] $i:A \hookrightarrow B$ if and only if the [[axiom of choice]] holds for sets in the type theory. 
