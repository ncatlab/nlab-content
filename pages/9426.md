...
_Fermat's last theorem_ is the statement, that for $n\gt 2$ this equation has no solutions in rationals (or, equivalently, has no solutions in integers). In other words, the Fermat's curve has no $\mathbf{Q}$-[[rational points]]. 
...
Therefore, while Fermat's theorem is generally accepted as proven now, the methods used in the proof go far beyond the mathematics known at [[Pierre de Fermat]]'s time. Moreover [[Ribet's theorem]] and the [[modularity theorem]] are useful conceptual statements in [[arithmetic geometry]], quite different in character from the content of Fermat's last theorem in itself:
