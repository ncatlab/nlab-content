...
with the subscript notation as explained in $n$lab entry [[quasitriangular Hopf algebra]]. The main examples come from quantized function algebras (that is, roughly, dual of quantized enveoping algebras). 