...
This appears in [[SGA4]] Expos&eacute; VI, Section 6. It also appears as [[Higher Topos Theory|HTT, corollary 3.3.4.3]] where it is generalized from [[Cat]] to [[(∞,1)Cat]]: see at _[[(∞,1)-colimit]]_ the section _[(∞,1)-Colimits in (∞,1)Cat](http://ncatlab.org/nlab/show/limit+in+a+quasi-category#ColimitsInInfinityCat)_ .
