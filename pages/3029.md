...
The [[ω-nerve]] (or [[Duskin nerve]]) $N \mathbf{B}(A \to \hat G) \in $ [[sSet]] of this is a (3-[[coskeleton|coskeletal]]) [[Kan complex]] that realizes this as a [[truncated object of an (infinity,1)-category|2-truncated]]  [[∞-groupoid]]. 
...
which in [[Kan complexes]]/[[simplicial sets]] is [[presentable (infinity,1)-category|presented]] by  the [[zigzag]] of  [[n-functors]] between [[strict ω-groupoid]] (sequence of [[2-anafunctors]]) of the form
