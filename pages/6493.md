...
If a ([[differentiable stack|differential]], [[topological stack|topological]] or [[algebraic stack|algebraic]]) stack (or, in particular, an [[orbifold]]) is represented by a groupoid, then the inertia groupoid of that groupoid represents its inertia stack. In particular, an orbifold corresponds to a Morita equivalence class of a proper étale groupoid. The inertia groupoid $\Lambda G$ of $G$ is the Morita equivalence class of the (proper étale) action groupoid for the action of $G_1$ by conjugation on the subspace $S\subset G_1$ of closed loops.  
