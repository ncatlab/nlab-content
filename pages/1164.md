Given a [[topological group]] $G$ the __orbit category__ $\mathrm{Or}\, G$ (denoted also $\mathcal{O}_G$) is a (usually [[skeleton|skeletal]]) category whose objects are homogeneous spaces ($G$-orbit types) $G/H$ where $H$ is a closed subgroup of $G$ and morphisms are $G$-equivariant maps.
