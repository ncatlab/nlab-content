...
In an [[intensional type theory]] such as [[homotopy type theory]], in order for [[setoids]] to behave correctly, both the vertex and edge types have to be [[h-sets]], rather than general [[types]]. 
