...
A setoid is **thin** if its underlying loop directed pseudograph is a loop digraph. In both cases, the pseudo-equivalence relation becomes an **[[equivalence relation]]**. 
