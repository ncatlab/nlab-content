...
In [[graph theory]], a set equipped with a partial order is an acyclic [[directed  graph]], with the partial order representing the reachability relation of the graph, and the linear extension of the reachability relation is called a **topological order**. 
