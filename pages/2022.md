...
Given a [[causet]] $C$, a **Hasse diagram** $H$ is the [[directed graph]] whose [[quiver]] $F(H)$ is [[equivalence|equivalent]] to $C$ and whose edges satisfy the [[covering relation]].
