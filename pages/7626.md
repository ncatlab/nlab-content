...
{:highlight: .un_remark style="border:solid #009900;background: #00dd00;border-width:2px 1px;padding:4px 1em;margin:0 1em;"}
...
(Compare also [Wilczek 1990, p. 5](#Wilczek90), which offers a quantum particle "[[bound state|bound]]" to a classical & infinite [[solenoid]] -- hence a 2d [[magnetic monopole]] [[defect]] -- as a decent model for an anyon.)
...
> *Anyon braiding statistics is the effect on the quantum [[ground state]] of [[adiabatic theorem|adiabatic]] [[braiding]] of [[codimension]]=2 [[defects]] in their [[configuration space of points|configuration space]].*

This notion of anyon "statistics" is at least tacitly implicit in much of the literature on anyons in [[topological quantum computation]], such as in the popular graphics depicting anyon [[worldlines]] as the [[Wilson lines]] in [[Chern-Simons theory]].
