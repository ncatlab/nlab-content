...
This is of interest already for $F \simeq \ast$, as then it expresses generalized cohomology in terms of cordinary cohomology with coefficients in the base cohomology ring. (Often "Atiyah-Hirzebruch spectral sequence" is taken to refer to only this case, while the general case is then referred to as "Serre spectral sequence for generalized cohomology" or the like.)
