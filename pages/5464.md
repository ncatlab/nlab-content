...
modern language.  (See [LawETCS](#LawETCS), or [LaRo](#LaRo) for a good expository
...
or 'restricted' Zermelo with Choice; see [MaMo](#MaMo)).  It is also known what
...
is isomorphic to $X_{i}$.  See Section&nbsp;8 of [McLECS](#McLECS) for details.
...
instance [MaMo](#MaMo) or [JohSE](#JohSE).
...
Example&nbsp;ref{egsheaves}(\ref{egshfbundle}).  See [MaMo](#MaMo) for details.
...
instance Section&nbsp;C5.3 of [JohSE](#JohSE).
