...
The object $A$ is __finitely presented__ if it is the quotient of a [[congruence]] $R \rightrightarrows F$ such that $R$ is also free on a finite set.  (Or maybe we don\'t demand that this is a congruence but accept any [[coequaliser]] of this form?)  This should not be confused with a [[finitely presentable object]].
