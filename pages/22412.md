...
* for the property of closure under finite products, we demand that $C$ has finite products and $L$ has finite [[biproducts]] (or, equivalently, that $L$ has finite products and is enriched over [[commutative monoids]]); (this can be extended with conditions to guarantee Cartesian closure; see the CHAD paper below;)
