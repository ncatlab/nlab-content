...
Recall that given a [[local BV-BRST complex]] (example  \ref{LocalBVBRSTComplexIsDerivedCriticalLocusOfEulerLagrangeForm}) with [[BV-BRST differential]] $s$, then the space of
...
Moreover, the [[differential graded-commutative superalgbra]] of [[auxiliary fields]] is a [[contractible chain complex]]
