...
+--{: .un_defn}
######Definition ######
A __relational structure__ is a tuple $\mathfrak{F}$ whose first component $W$, is a non-empty set, and whose remaining components are relations on $W$. (We assume that there is at least one realtion given.) 
=--
