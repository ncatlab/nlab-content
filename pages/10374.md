...
where "on shell" means up to the ideal generated by the [[classical field theory|classical]] [[free field theory|free]] [[equations of motion]]. Hence for the case of [[local observables]] of the form $div J$, the quantum Ward identity expresses the possible failure of the original [[conserved current]] to actually be conserved, due to both quantum effects ($\hbar$) and interactions ($g$). This is the form in which Ward identities are usually understood.
