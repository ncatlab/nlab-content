...
[^fine]: Apparently the 'etendu' in the title of Lawvere's monograph is not a misspelling of a noun, but rather is intended adjectivally as part of a back translation of a (hypothetical) French expression 'ensembles &eacute;tendus', perhaps a nonce invention of Lawvere's, who may have been writing under the influence of conversations with Grothendieck during the latter's visit to Buffalo in 1973. See this [nForum thread](http://nforum.mathforge.org/discussion/5805/etendue/) for some relevant commentary. 
