...
Now homotopy groups are defined in terms of homotopies, so it seems to me that the homotopy groups of the two categories should correspond. Why do we define the homotopy groups of a simp ab group to be the homology groups of it's moore complex? 
