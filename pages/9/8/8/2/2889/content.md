...
Motivic cohomology is a cohomology theory for schemes which in many ways plays the r&#244;le of [[singular cohomology]] in algebraic geometry. It was first conjectured to exist by [[Alexander Beilinson]] and [[Stephen Lichtenbaum]] in the early 1980s, and it was then defined by [[Vladimir Voevodsky]] in the mid 1990s.
...
We give three definitions of motivic cohomology with integral coefficients, in _reverse historical order_: the first two, due to Voevodsky, work for arbitrary schemes. The third, due to Bloch and later generalized by Levine, only works for [[smooth schemes]] over [[Dedekind domain]]s. All definitions are known to agree for [[smooth scheme]]s over [[field]]s, but the equivalence of any pair of them is an open question for more general schemes. It is generally accepted that the Bloch&#8211;Levine definition produces the desired motivic cohomology groups as far as it applies, but there is no consensus beyond that.
...
### As cohomology with coefficients in Eilenberg-MacLane objects {#ChowGroupsAsInfStackCohomology}

From the [[nPOV]] and from the point of view of the [[motivic homotopy theory]] of Morel and Voevodsky, one would like the motivic cohomology of $X$ to be representable in the unstable and stable [[motivic homotopy theory|motivic homotopy categories]] over $X$. Voevodsky gave a definition of motivic cohomology in this setting by defining _motivic Eilenberg&#8211;Mac Lane spaces and spectra_. Below we only discuss the definition of these motivic Eilenberg&#8211;Mac Lane objects in the (stable) motivic homotopy category over a field. The definition in general is essentially the same, but it relies on the notion of finite correspondence over more general bases which is technical.

To define an Eilenberg-MacLane space representing an interesting cohomology theory the first guess might be to apply the general definition of an [[Eilenberg-MacLane object]] in the [[Nisnevich (∞,1)-topos]], which amounts to taking the constant Eilenberg-MacLane-space-valued sheaf, and then take its $\mathbb{A}^1$-localization. This is no good:

1. Philosophically: because the unstable motivic homotopy theory is not itself an $(\infty,1)$-topos.

2. Technically: The general construction would naturally yield an $S^1$-spectrum, but we want a $\mathbb{P}^1$-spectrum. This is not easy: Voevodsky states in his [ICM-talk article](#ICM) (on p. 596) that every morphism $\mathbb{P}^1 \wedge K(\mathbb{Z},n) \rightarrow K(\mathbb{Z},n+1)$ is trivial in the $\mathbb{A}^1$-homotopy category.
...
Let $X$ (resp. $Y$) be the cartesian product of $n$ (resp. $n-1$) copies of the projective line. The point at infinity gives a family of $n$ maps $u_i : Y \to X$. Then a model of the [[Eilenberg-MacLane object]] $K(\mathbb{Z}(n), 2n)$ is the sheaf of sets obtained as the quotient (in the category of Nisnech sheaves of abelian groups) of $L(X)$ by the subsheaf generated by the images of the maps $L(u_i) : L(Y) \to L(X)$.
...
In the mid 1990s [[Vladimir Voevodsky]] gave the first definition of the motivic cohomology of a scheme $X$ as the [[hypercohomology]] of certain [[complexes of sheaves]] $\mathbb{Z}(q)$ on the [[Zariski site|Zariski]] [[site]] of $X$ (an analog of the [[category of open subsets]] of a [[topological space]]). The complexes $\mathbb{Z}(q)$, $q\geq 0$, are called the **motivic complexes**; the existence of such complexes was predicted as part of the so-called Beilinson dream.

+-- {: .num_defn}
###### Definition
The motivic cohomology of a [[scheme]] $X$ is the [[abelian sheaf cohomology]], more specifically hypercohomology, of the complexes of sheaves $\mathbb{Z}(q)$ on the Zariski site:

$$ H^{p,q}(X,\mathbb{Z}) := H^p_{Zar}(X,\mathbb{Z}(q)) $$
=--

This is [MaVoWe, Definition 3.4](#MaVoWe) and it is the "official" definition.

Voevodsky's definition, for smooth schemes over fields, has been shown to have most properties that Grothendieck and Beilinson had demanded of the hypothetical cohomology theory, including the now proved [[Bloch-Kato conjecture]], except that to date it hasn't been shown that the cohomology groups vanish in negative degree, as they should. This open question is known as the _Beilinson vanishing conjecture_.

#### As hom-sets in the derived category of motives

Voevodsky also gave an accompanying definition of an integral version of the [[derived category]] of the hypothetical category of [[mixed motive|mixed motives]] (see there for the definition) and showed that the motivic cohomology appears as derived hom-complexes in his derived category of mixed motives (see [MaVoWe, rop. 14.16](#MaVoWe) for a precise statement).


#### References ##

* [[Carlo Mazza]], [[Vladimir Voevodsky]] and [[Charles Weibel]], _Lectures in motivic cohomology_ ([web](http://math.rutgers.edu/~weibel/motiviclectures.html) [pdf](http://www.claymath.org/library/monographs/cmim02.pdf))  {#MaVoWe}
...
* [[Spencer Bloch]], _Algebraic Cycles and Higher $K$-Theory_, Adv. Math. 61 (1986), pp. 267&#8211;304 {#Bloch86}

* [[Marc Levine]], [_Techniques of localization in the theory of algebraic cycles_](http://www.uni-due.de/~bm0032/publ/TechLoc.pdf), J. Algebraic Geom. 10 (2001), pp. 299&#8211;363 {#Levine01}
