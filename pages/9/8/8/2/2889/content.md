...
The _motivic [[cohomology]]_ of a [[scheme]] $X$ is the [[abelian sheaf cohomology]] of [[sheaf|sheaves]] on the Zariski or [[etale cohomology|etale]] [[site]] of $X$ (an analog of the [[category of open subsets]] of a [[topological space]]) with coefficients in a complex of sheaves $A$ called the **motivic complex**.
