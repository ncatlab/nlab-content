...
$$
  (-1)Grpd := \{\bot, \top\}
$$
Actually, since for other values of $n$, $n$-groupoids form not just an $(n+1)$-category but an $(n+1,1)$-category, we should expect the $0$-category of $(-1)$-groupoids to be a $(0,1)$-category, or $1$-[[1-poset]].  This simply means a [[partial order|poset]], and indeed truth values do always form a poset, classically ($\bot \leq \top$).
