...
Supersymmetric quantum mechanics was introduced or at least became famous with ([Wittem 82](#Wittem82)). As explained at the end of ([Witten 85](#Witten85)), [[Edward Witten|Witten]] had come to consider this while looking at the point particle limit of the [[superstring]] [[sigma-model]]. The superstring sigma-model is a kind of supersymmetric quantum mechanics on [[loop space]] (see also at [[2-spectral triple]]) and ordinary supersymmetric quantum mechanics is obtained from this in the limit of vanishing loop size (see e.g [Schreiber 04](#Schreiber04)).
...
* {#FGR97} [[Jürg Fröhlich]], Oiver Grandjean, [[Andreas Recknagel]], _Supersymmetric quantum theory, non-commutative geometry, and gravitation_  Lecture Notes Les Houches (1995) ([arXiv:hep-th/9706132](http://arxiv.org/abs/hep-th/9706132)).
