...
Given the existence of transitive closures, pure sets can be identified with subsets of transitive sets, and hence (given Mostowski's lemma) with subsets of extensional well-founded relations.  This latter characterization is complete structural, and thus can be used to model [[pure sets]] in [[structural set theory]].
