...
A __grammar__ is an explicit or implicit set/system of organizational rules governing some system of signs (see [[semiotics]]), for example a cultural code, a language, or a logical system.
In particular, a grammar should help distinguish well formed or meaningful expressions. Regarding that the meaning of a sign is part of the system, grammar in general may contain rules concerning or depending on semantics, though sometimes one restricts grammar to form.
...
Related entries include [[formal grammar]], [[linguistics]], [[syntax]], [[syntax (linguistics)]], [[semiotics]], [[tree]]
