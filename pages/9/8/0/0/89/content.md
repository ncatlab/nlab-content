...
In the original sense, a _Morita equivalence_ between two [[rings]] is two [[bimodules]] between them that behave as [[inverses]] to each other under [[tensor product of modules]], up to isomorphism of bimodules. This just the [[equivalence in a 2-category|2-categorical concept of equivalence]] for the two rings regarded as [[objects]] in the [[2-category]] of rings, with [[bimodules]] as [[1-morphisms]] and bimodule homomorphsims ([[intertwiners]]) as [[2-morphisms]] (see [here](bimodule#AsMorphismsInA2Category)).
