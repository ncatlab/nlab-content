...
+-- {: .num_remark} 
###### Remark 
Interpreted literally, $0$-category or $(0, 0)$-category would be an $\infty$-category such that every $j$-cell for $j \gt 0$ is an equivalence, and any two such $j$-cells that are parallel are equivalent. The picture that apparently emerges from this description might suggest a set equipped with an [[equivalence relation]], or a what is sometimes called a [[setoid]], or something even more complicated than that. One *could* thus say that a $0$-category is a "setoid", when considered just up to [[isomorphism of categories|isomorphism]]. But it is more appropriate in higher category theory to consider these things up to equivalence rather than up to isomorphism; when we do this, a $0$-category is equivalent to a set again. 
=-- 
