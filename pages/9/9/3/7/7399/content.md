...
surface, i.e. $Xsetminus G$ is a union of open cells. Two dessins d'enfants $(X_1 , G_1 )$ and $(X_2 , G_2 )$ are called equivalent if there exists a homeomorphism $f : X_1 \to X_2$ 
such that $f (G_1 ) = G_2$ .
