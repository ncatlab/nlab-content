...
\end{aligned}
$$
Since $d_{CE(\mathfrak{g})}t)$ lies in the sub-gca of $W(\mathfrak{g})$ generated by $\mathfrak{g}^*$, the element $f(d_{CE(\mathfrak{g})}t))$ is determined by $f\vert_{\mathfrak{g}^*}$. 
