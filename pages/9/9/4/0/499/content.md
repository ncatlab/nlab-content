...
#Yoneda embedding as free cocompletion#
...
$$\hat{F}: Set^{S^{op}} \to D,$$
meaning that $\hat{F} y_S \cong F$ and $\hat{F}$ preserves small colimits. Indeed, the desired $\hat{F}$ is [[adjunction|left adjoint]] to the functor 
