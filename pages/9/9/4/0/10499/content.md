...
This is a paraphrase of the results in ([Porta-Shaul-Yekutieli 10](#PortaShaulYekutieli10)):

First of all, by our simplifying assumption that $\mathfrak{a}$ is generated by a single element the running assumption of "weak proregularity" in ([Porta-Shaul-Yekutieli 10, def.3.21](#PortaShaulYekutieli10)) is trivially satisfied.

Then in view of ([Porta-Shaul-Yekutieli 10, corollary 3.31](#PortaShaulYekutieli10)) the statement of ([Porta-Shaul-Yekutieli 10, theorem 6.12](#PortaShaulYekutieli10)) is the [characterization of reflectors](reflective+sub-(infinity,1)-category#CharacterizationOfReflectors) as discussed at _[[reflective sub-(∞,1)-category]]_, and formally dually so for the coreflection. With the fully faithfulness that goes with this the equivalence of the two inclusions on the level of [[homotopy categories]] given by ([Porta-Shaul-Yekutieli 10, theorem 6.11](#PortaShaulYekutieli10)) implies the canonical equivalence of the two [[sub-(∞,1)-categories]] and this means that $\Pi_{\mathfrak{a}}$ and $\flat_{\mathfrak{a}}$ are the [[adjoint pair]] induced from the reflection/coreflection [[adjoint triple]].
