...
There is another topology on the join of spaces, due to [[John Milnor|Milnor]], which appears in his [[Milnor construction|construction of universal bundles]].
 
+-- {: .num_defn #MilnorJoin }
###### Definition
 
Milnor’s join $X \mathbin{\bar\star} Y$ has the same underlying set as $X \star Y$ and the coarsest topology which makes $t \colon X \mathbin{\bar\star} Y$ (given on $X \times I \times Y$ by $(x,t,y)\mapsto t$, constantly $0$ on $X$, and constantly $1$ on $Y$) and the projections $\pi_1 \colon t^{-1}([0,1)) \to X$ and $\pi_2 \colon t^{-1}((0,1]) \to Y$ continuous.
...
* [[John Milnor]], _Construction of Universal Bundles_, _II_, Ann. of Math. __63__:3 (1956) 430-436, [doi:10.2307/1970012](https://doi.org/10.2307/1970012)
