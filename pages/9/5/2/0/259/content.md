...
* Compare with the definition of a [[Kan complex]] in which _all_ horns are required to have fillers: a quasi-category is a structure slightly weaker than a Kan complex. Indeed, while we can think of a Kan complex an an $(\infty)$-[[groupoid]] in which _all_ morphisms are [[equivalence]]s, a quasi-category is a model for an $(\infty,1)$-[[infinity comma one category|category]] in which only all $n$-morphisms for $n \geq 2$ are required to be [[equivalence]]s.
