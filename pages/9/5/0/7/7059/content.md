...
The axioms add to [[homotopy type theory]] two [[idempotent monad|idempotent]] [[monads (in programming theory)]] called $\sharp$ ("sharp") and $\flat$ ("flat"), together with a compatibility condition between them.
