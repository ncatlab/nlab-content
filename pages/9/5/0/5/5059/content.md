...
(It also happens in some lower dimensions, where however the corresponding [[Neveu-Schwarz-Ramond string]] develops a [[conformal anomaly]] after [[quantization]] (a "[[non-critical string]]"). This classification of cocycles is part of what has come to be known as the _[[brane scan]]_ in superstring theory, see below.)
