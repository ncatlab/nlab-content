...
For a glimpse of [[André Joyal|A. Joyal]]'s original approach to the spectrum using distributive lattices see Joyal (1975) or Coquand-Lombardi-Schuster (2007).  For higher categorical variations on the theme _spectrum_ (of a ring) see Lurie (2009).
