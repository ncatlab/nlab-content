...
*  [[Toby Bartels]]:
   ...
   *  I\'ve completed migrating all old redirect pages to history pages; all links within the body of the Lab should now take you immediately to the target page.  (There are a few victims of a bug, but I\'ll straighten that out with Jacques.)  I have [more comments](http://www.math.ntnu.no/~stacey/Mathforge/nForum/comments.php?DiscussionID=39) on the Forum.


***

[[2008 changes|First list]] --- [[2009 June changes|Previous list]] --- [[2009 August changes|Next list]] --- [Current list](http://www.math.ntnu.no/~stacey/Mathforge/nForum/?CategoryID=5)
