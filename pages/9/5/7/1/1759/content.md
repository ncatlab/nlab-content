...
[[Zoran]]: but the plurals are NOT there -- if I write [[apple]]s I did not use the code for plural. So why needed to recgnize somethning what is NOT used. I will stop creating any plural links if they are going to be changed.
