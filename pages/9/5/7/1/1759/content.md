...
* [[Zoran ?koda]]: wrote a version (to be expanded) of [[Legendre polynomial]]. I encountered a problem that sqrt{fraction} puts sqrt only such that the numerator is under the root. I do not know how one should write correctly. Toby thank you for the tip for getting the
