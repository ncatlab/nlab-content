...
* [personal page](https://www.cs.umd.edu/~dgottesm/)

* [Perimeter Institute page](https://perimeterinstitute.ca/people/daniel-gottesman)

* [Wikipedia entry](https://en.wikipedia.org/wiki/Daniel_Gottesman)

* [inSpire page](https://inspirehep.net/authors/1007876)

* [GoogleScholar page](https://scholar.google.com/citations?user=373HnhYAAAAJ&hl=en)


## Selected writings

Introducing [[stabilizer codes]] for [[quantum error correction]]:
...
Further on [[quantum error correcting codes]] and the [[error threshold theorem]]:

* [[Daniel Gottesman]], *Theory of fault-tolerant quantum computation*, Phys. Rev. A **57** (1998) 127-137 &lbrack;[doi:10.1103/PhysRevA.57.127](https://doi.org/10.1103/PhysRevA.57.127)&rbrack;
