...
An [[instanton]] in plain [[Yang-Mills theory]] on a 4-[[dimension|dimensional]] [[manifold]] $K^{(4)}$ necessarily has a [[positive number|positive]] characteristic [[radius]]. Indeed, in the [[moduli space]] of instantons the would-be point of vanishing characteristc radius corresponds to a [[singularity]] which is unphysical, in that it is not part of the [[phase space]] of the [[theory (physics)|theory]].

But also the [[gauge field]] of [[heterotic string theory]] admits [[instanton]]-configurations on a transversal 4-space, and these are pullbacks of ordinary [[Yang-Mills instantons]] on the [[Euclidean space|Euclidean]] 4-manifold $K^{(4)}$ to a $(6+4)$-dimensional [[product manifold]]-[[spacetimes]] 

\[
  \label{ProductSpacetime}
  X^{(9+1)} \;\simeq\; Q^{(5+1)} \times K^{(4)}
\] 
...
A circumstantial but widely accepted argument ([[folklore]]) due to [Witten 96](#Witten96) says that this is indeed the case, and that these _small instantons_ in [[heterotic string theory]] are identified with heterotic [[NS5-branes]] [[wrapped brane|wrpped]] on the $Q^{(5+1)}$-factor in (eq:ProductSpacetime) and carrying an exotic [[Sp(1)]]-[[gauge field]] on their worldvolume, identified with the [[SU(2)]]-structure group of a single instanton. 
