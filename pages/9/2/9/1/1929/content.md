...
A _quantum heap_ is a dual version of a notion of a [[heap]] internalized to the [[monoidal category]] of $k$-vector spaces, with usual tensor product over $k$. A quantum heap is to a [[Hopf algebra]] what a heap is to a [[group]]. 

##Definition##
__Quantum heap__ is an associative unital algebra $(H,\mu,\eta)$ 
...
* Tomasz Brzezinski, Joost Vercruysse, _Bimodule herds_, ([arXiv:0805.2510](http://arXiv.org/abs/math/0805.2510))
