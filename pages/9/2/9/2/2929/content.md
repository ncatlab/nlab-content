...
A **bicategory of relations** is a [[cartesian bicategory]] which is [[locally posetal 2-category|locally posetal]] and moreover in which for every object $X$, the diagonal $\Delta\colon X\to X\times X$ and $\nabla\colon X\times X\to X$ satisfy the Frobenius condition:
