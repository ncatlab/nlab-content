...
Given a left $H$-comodule algebras $E$ and $F$, one considers also the category ${}_E\mathcal{M}_F^H$ of two-sided relative Hopf modules (sometimes also called the category of relative Hopf bimodules. It is equivalent to the category ${}_{E\otimes F^{op}}\mathcal{M}_F^H$. See [Caen. et al 2007](#Marcus2007).
