...
We also have the _interchange law_ (also[^1] called _Godement law_ or _middle 4 interchange law_): because $comp$ is a functor it commutes with composition in the hom-categories, so we have (writing vertical composition with $\circ$ and horizontal as juxtaposition):
$$
 (\beta' \circ \beta)(\alpha' \circ \alpha) = (\beta' \alpha') \circ (\beta \alpha)
$$

[^1]: Cf. e.g. Jean-Marc Cordier, Timothy Porter: Homotopy Coherent Category Theory, Trans. Amer. Math. Soc., Volume 349, Number 1, January 1997, Pages 1&#8211;54, Section 7
