...
The fine-grained description in the previous subsection \ref{more} can be repackaged as saying that a 2-category is a [[sesquicategory]] that satisfies the interchange axiom, i.e., the last axiom (12) which gives the horizontal composite construction. This description is essentially patterned after the "five rules of functorial calculus" introduced by [Godement](#God) for the special case [[Cat]]. 
...
The long list of compatibility properties enumerated in the previous subsection, all except the last, are concisely summarized in the definition of sesquicategory as recalled above. For example, property (8) just says that left whiskering, being a functor, preserves vertical composition. 

In summary, a sesquicategory consists of "stuff" and structure as described in subsection \ref{more}, satisfying properties 1-11. A 2-category is then a sesquicategory that further satisfies the interchange axiom (12). Some further illumination of this point of view can be obtained by contemplating [[string diagrams]] for 2-categories, where the interchange axiom corresponds to isotopies of (planar, progressive) string diagrams during which the relative heights of nodes labeled by 2-cells are interchanged. 
