...
Given a [directed graph](http://en.wikipedia.org/wiki/Directed_graph) $G$ with nodes denoted by
...
a discrete space is the [graded differential algebra](http://en.wikipedia.org/wiki/Differential_graded_algebra) (DGA) generated by the projections
...
\pi_{i,j} 
&= \pi_i (d\pi_j) \pi_j \\
&= \pi_i [d\pi_j - \pi_j (d\pi_j)] \\
&= (1-\delta_{i,j}) \pi_i d\pi_j
\end{aligned}$$

**Question: Does anyone know why this isn't aligned?**
