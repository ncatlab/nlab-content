...
a discrete space is the space generated by the graded-differential algebra of projections

$$\pi_i:G_0\to G_0, \pi_i(e_j) = \delta_{i,j} e_j.$$

###Generating a Discrete Space

The algebra $\mathcal{A}$ of projections is commutative and satisfies the relations
...
which, in particular, provides the skew-commutative relation
