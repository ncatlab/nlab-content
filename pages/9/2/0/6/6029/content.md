...
However, even so, abstractly the formalization of the concept of a _particle_ within [[QFT|QFTs]] is somewhat subtle.

If the quantum field theory is on [[Minkowski space]] and comes with a [[Hilbert space|Hilbert]] [[space of states]] on which the  [[Poincare group]] of translations, rotations, and boosts in Minkowski space acts, the massive _particle_ excitations of the theory can be found in the discrete spectrum of the time translation operator as the [[irreducible representation|irreducible]] [[unitary representations of the Poincare group]].
For QFTs on [[curved spacetime|curved]] [[spacetimes]], the situation is more subtle.

Often, QFTs are considered as [[quantizations]] of given [[Lagrangians]]. In these cases, one often identifies their particle content with that explicitly encoded by the Lagrangian. Notably, when that arises from [[second quantization]] of some 1-dimensional [[sigma-model]], the particles of the theory are those described by these sigma-models.

## What is a particle?
 {#WhatIsAParticle}

The fundamental concept of modern [[physics]] is that of [[quantum field theory]] (QFT); the concept of a particle is derived from that, and need not make sense in every case. ("That's why it's called 'field theory'.")


 In the perspective of the [[Schrödinger picture]], a $(d+1)$-dimensional [[QFT]] is given by a [[functor]] $Z$ on a [[category of cobordisms]] (possibly with [[geometry|geometric]] structure, such as a [[pseudo-Riemannian metric]] structure) between $d$-dimensional [[manifolds]] ("[[FQFT]]"). It is crucial to notice that one such QFT always has **two different interpretations**:
...
Hence one may want to/need to consider an intricate pattern of "branes within branes". For instance, the [[worldsheet]] [[gravity]] of the [[string]] may itself arise from quantizing other strings for which that worldsheet is the target spacetime ([[world sheets for world sheets|Green 87]]).
...
We consider a [[QFT]] which is a [[3d TQFT]] of [[Chern-Simons theory]] type and discuss some aspects of the notion of a _particle_ in that context.

Assume for the sake of argument that we agree to think of the 3d TQFT as a realization of [[3d quantum gravity]], as indicated there.  Then this means that, as an [[FQFT]], the system assigns to every closed [[surface]] a [[space of quantum states]] to be thought of as the space of states of the [[observable universe]] in that 2+1-dimensional world. A state encodes the field of [[gravity]]. It would be somewhat subtle to extract from just the [[FQFT|functorial]] [[3d TQFT]] the intrinsic notion of particle-quanta. In general, given a [[TQFT]] in the form of an [[FQFT]], there is essentially no established way to go about determining what the particle-quanta would be that an observer "in this universe" would see.
