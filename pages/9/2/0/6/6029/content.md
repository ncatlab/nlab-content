...
In fact, an argument due to ([Witten 92](A-model#Witten92)) says that if [[Chern-Simons theory]] [[3d TQFT]] is the [[second quantization]] of anything, then not of particles but of [[topological strings]] ([[A-model]]). See also ([Costello 06](A-model#Costello06)) and see at _[TCFT -- Worldsheet and effective background theories](TCFT#ActionFunctionals)_ for more on this.
