...
A (quasi)-prometric base is precisely a filter base whose generated filter is a (quasi)-prometric.  We may also speak of a (quasi)-prometric __subbase__ as a [[filter subbase]] (that is, an arbitrary collection) whose generated filter base is a (quasi)-prometric base, or equivalently whose generated filter is a (quasi)-prometric.  A pre-(quasi)-prometric is always a (quasi)-prometric subbase, but not conversely; but thinking too hard about subbases risks more centipedes.
