...
A __proper class__ is a class whose cardinality is not the [[cardinal number]] of any set.  This is a less [[evil]] version of the previous definition; however, in some foundations these are actually equivalent.
