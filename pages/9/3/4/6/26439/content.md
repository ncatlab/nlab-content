...
The *$\pi$-calculus* is a [[computational]] model for [[concurrency|concurrent processes]] that communicate messages through named channels. It subsumes [[λ-calculus]].
...
The central [[inference rule|reduction rule]] of the $\pi$-calculus is the following:
$$
  \overline{n}\langle a\rangle.P\mid n(b).Q
    \;\longrightarrow\; 
  P\mid Q_{a\mapsto b}
  \,.
$$
...
[[context|Typing contexts]] are lists of hypotheses of the form $n \colon T$ where $n$ is a channel name and $T$ is a simple type.
...
[Caires and Pfenning 2010](#Caires2010) established a correspondence between [[dual intuitionistic linear logic|dual intuitionistic]] [[linear logic]] (DILL) and session typed $\pi$-calculus.
