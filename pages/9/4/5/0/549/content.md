...
Quillen's small object argument is a method for constructing functorial [[weak factorization system|weak factorization systems]] that are **cofibrantly generated** by a set of maps $I$. 

This is notably used in the theory of [[model category|model categories]] and in particular [[cofibrantly generated model category|cofibrantly generated model categories]].
...
Examples of categories where the argument applies that are not [[presentable category|presentable]] include the category [[Top]] of [[topological space]].
