...
* The local model structure on simplicial sheaves provides a model for [[infinity-stack homotopically|infinity-stacks]], as described on [page 11](http://arxiv.org/PS_cache/math/pdf/0604/0604504v3.pdf#page=11) of To&#235;n: _Higher and derived stacks: a global overview_ ([arXiv](http://arxiv.org/abs/math.AG/0604504))
