...
This was based on earlier work of Giry's advisor, [[Bill Lawvere]]. In the paper, there are allegedly a few minor [[analysis|analytically]] incorrect points and gaps in proofs, observed by later authors. 
...
Burroni, [Lois distributives. Applications aux automates stochastiques](http://www.tac.mta.ca/tac/volumes/22/7/22-07.pdf), TAC 22, 2009 pp.199-221

where she derives stochastic [[automata]] as algebras for a suitable [[distributive law]]
 on the monoid and Giry monads. She also points out that the 'Giry' monad appears already in
