...
On the identification of the [[special unitary Lie algebra]] [[su(n)|$\mathfrak{su}(n)$]], as $n \to \infty$, with the [[Lie algebra]] of [[area-preserving diffeomorphisms]] of [[surfaces]] $\Sigma$ (cf. also at *[Quantization of the M2-brane to the BFSS matrix model](M2-brane#LightConeQuantizationOfM2BranesToBFSSMatrixModel)*):
...
for [[special linear Lie algebra|$\mathfrak{sl}(n;\mathbb{N})$]] and $\mathfrak{su}(n,n)$:
