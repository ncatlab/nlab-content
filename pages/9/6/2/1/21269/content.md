...
An *ordinary tangle* is a [[dimension of a manifold|1-dimensional]] [[manifold]] [[manifold with boundary|with boundary]] that is [[embedding of smooth manifolds|embedded]] into the 2-cube (or 3-cube), such that the [[boundary]] is embedded into chosen chosen pair opposing sides of the cube. Thus, one may think of a tangle as a [[knot]] (if it is [[connected topological space|connected]]) or generally a [[link]] that was cut at several points and the resulting strands pulled apart at their endpoints to opposite sides of the cube. 
...
**([[Shum's theorem]])**
\linebreak
  The [[category of framed tangles]] is [[equivalence of categories|equivalently]] the [[free construction|free]] [[ribbon category]] generated by a single [[object]].
\end{proposition}
