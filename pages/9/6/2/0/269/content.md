...
Also, it turns out that the second and third of the above disadvantages of [[cubical set]]s over [[simplicial set]]s in [[homotopy theory]] can be dealt with to some extent.
...
1. Good notions of tensor product, because of the rule $I^m \times I^n \cong I^{m+n}$, and hence easy conceptual handling of homotopies.  This is exploited in the paper by Brown and Higgins on tensor products,  and also in the paper 

* Al-Agl, F.~A., Brown, R. and Steiner, R. Multiple categories: the equivalence of a globular and a
  cubical approach. _Adv. Math._ 170~(1) (2002) 71--118.

It is a key feature in using higher homotopy groupoids to prove homotopy classification results.  
...
* [[Ronnie Brown]] and P. Higgins,  Tensor products and homotopies for $\omega$-groupoids and crossed complexes.
