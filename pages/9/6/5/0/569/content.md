...
is called the **endofunctor category** of $C$.  The objects of $End(C)$ are endofunctors $F: C \to C$, and the morphisms are natural transformations between such endofunctors.  The endofunctor category is a [[strict monoidal category|strict]] [[monoidal category]], thanks to our ability to compose endofunctors:
