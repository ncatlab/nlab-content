...
Still a bit more helpful structure on top of a bare model category is that of a [[simplicial model category]]. Here, after a choice of cofibrant and fibrant resolutions of objects, the derived hom spaces are given already by the [[sSet]]-[[hom objects]]. This we discuss below in _[For a simplicial model category](#EnrichedHomsCofToFib)_.
