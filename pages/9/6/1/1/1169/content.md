...
One problem with the notion of Reedy category is that it violates the [[principle of equivalence]]: it is not invariant under [[equivalence of categories]].  It's not hard to see that any Reedy category is necessarily [[skeletal category|skeletal]].  In fact, it's even worse: a Reedy category cannot have _any_ [[identity|nonidentity]] [[isomorphisms]]!  
