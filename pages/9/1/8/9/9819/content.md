...
* [[Matilde Marcolli]], [[Gonçalo Tabuada]] _Unconditional noncommutative motivic galois groups_,([arXiv:1112.5422](https://arxiv.org/pdf/1112.5422.pdf)).
...
?](http://mathoverflow.net/questions/127633/what-are-the-possible-motivic-galois-groups-over-mathbb-q?rq=1).

[Mathoverflow, Why would the category of Motives be Tannakian?](http://mathoverflow.net/questions/71660/why-would-the-category-of-motives-be-tannakian).
...
Regarding that this approach is related to Hodge theory periods, and that QFT can be attacked using the Batalin-Vilkovsky formalism, Barannikov has developed
further the Batalin-Vilkovisky geometry and related Hodge theory in a direction which is probably a ground for better understanding of motivic Galois group as well. 
