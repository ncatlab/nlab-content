...
on $S$ if it contains all (component) projections $S^{n}\to S$ and is closed under composition ("superposition"). These data correspond to finitary algebraic theories, for what one has many formalisms. 
