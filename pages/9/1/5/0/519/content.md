...
Sometimes people call $\tilde f$ the "adjoint" of $f$, and vice versa, but this is potentially confusing because it is the _functors_ $L$ and $R$ which are adjoint.  Other possible terms are _conjugate_, _transpose_, and [[mate]].
