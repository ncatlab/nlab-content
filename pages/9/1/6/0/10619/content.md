...
### As the $2n$-form component of the Chern character on cofiber space
...
$$
  \psi^k_{\mathbb{Q}} \;\colon\; V_{2n} \;\mapsto\; k^n \cdot V_{2 n}
$$
...
Since the [[Adams operations are compatible with the Chern character]], these are the components of the [[Chern character]] of these K-theory classes which are of homogeneous degree in [[ordinary cohomology]]:
...
We see that another interpretation of the e-invariant is as measuring how much of a $2n$-form component on $C_f$ is picked up by the Chern character of the unit K-theory class pulled back from $S^{2(n + n')}$.
