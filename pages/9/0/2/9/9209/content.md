...
He argues that it is better to use Kelly's tensor product of finitely cocomplete categories, which agrees with Deligne's tensor product when the latter exists. 
