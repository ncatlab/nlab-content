...
This appears for instance as ([EGNO, prop. 1.46.2](#EGNO)). Without the finiteness constraints and using the tensor product of categories with finite colimits, this appears as ([Chirvasitu&Johnson-Freyd 11, example 2.2.7](#ChirvasituJohnson-Freyd11)).
