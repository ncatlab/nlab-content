...
The *knots-quivers correspondence* &lbrack;[KRSS19](#KRSS19)&rbrack; is a certain identification between [[knot invariants|invariants]] of [[knots]] and data encoded by [[quiver representation|representations]] of corresponding [[quivers]].
...
On relating the [[quivers]] appearing in  [[D=3 N=2 SYM|$D=3$, $\mathcal{N}=2$ SYM]] and [[D=4 N=2 SYM|$D=4$, $\mathcal{N}=2$ SYM]] [[quiver gauge theories]]:
