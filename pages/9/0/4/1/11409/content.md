...
Weak K&#246;nig's lemma lends its name one the so-called Big Five systems of [[reverse mathematics]], namely $WKL_0$, and (over a certain weak fragment of second-order arithmetic) is equivalent to many results in classical elementary analysis.
