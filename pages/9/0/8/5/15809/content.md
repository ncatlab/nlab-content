...
$$
  \mathbf{L}_{D4}^{WZ}
  \;\propto\; 
  C_1 \wedge \langle F \wedge F\rangle
  \,.
$$
...
* Massimo D'Elia, Francesco Negro, _Theta dependence of the deconfinement temperature in Yang-Mills theories_, Phys. Rev. Lett. 109, 2012 ([arXiv:1205.0538](https://arxiv.org/abs/1205.0538))
...
For more see at _[Green-Schwarz sigma model -- References -- For D-branes](Green-Schwarz+action+functional#ReferencesForDBranes)_.
