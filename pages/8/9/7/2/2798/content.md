...
Together with the fact that $i^*: dSet \to SSet$ is a right Quillen functor (with respect to the Joyal [[model structure on simplicial sets]]) this also implies that $dSet$ is an $SSet_{Joyal}$ [[enriched model category]].
