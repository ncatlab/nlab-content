Let $P$ be a [[commutative ring]] together with two types of structure on the set-valued functor $Hom(P, -)$ it [[representable functor|represents]]:
