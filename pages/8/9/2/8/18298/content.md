...
* (local triviality) there exists 
  ...
  1. an [[isomorphism]] of vector space objects in $Top_{/U}$ 
     ...
     where  $[U \times \mathbb{R} \overset{pr_1}{\to} X]$ and $[U \times_X E \overset{pr_1}{\to} U]$ are regarded as a vector space objects in $Top_{U}$ in the canonical way.
...
1. for each $i \in I$ a [[homeomorphism]]
   ...
   $$
     U_i \times \mathbb{R} \overset{\simeq}{\longrightarrow} \pi^{-1}(E)
   $$

   from the [[product topological space]] of $U_i$ with the [[real numbers]] (equipped with their [[Euclidean space]] [[metric topology]]) to the restriction of $E$ over $U_i$ 
