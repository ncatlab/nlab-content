...
in the ordinary 1-category of $n$-groupoids or spaces, using a replacemten $\hat X \stackrel{\simeq}{&#8608;} X$ of $X$ by an acyclic fibration (called "[[hypercover]]" in this context) (for instance the &#268;ech groupoid associated with an open cover of $X$). 
