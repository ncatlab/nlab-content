...
2. the subcategory of (n-1)-coherent objects in $\mathbf{H}$ is closed under finite products.
...
An [[(∞,1)-site]] is *finitary* if every covering sieve is generated by a finite family of morphisms. If $C$ is a finitary (∞,1)-site with finite limits, then the (∞,1)-topos of [[(∞,1)-sheaves]] on $C$ is coherent and locally coherent.
