...
Both types of absolute colimits admit pleasant characterizations.  On the one hand, for a particular colimit diagram in $C$, the following are equivalent:

* The colimit is absolute.

* The colimit is preserved by the [[Yoneda embedding]] $C \hookrightarrow [C^{op},Set]$.

This is basically because the Yoneda embedding is the [[free cocompletion]] of $C$.  By looking at preservation by particular [[representable functors]], one can extract explicit necessary and sufficient conditions for a colimit of a particular shape to be absolute; see e.g. [[absolute coequalizer]].
