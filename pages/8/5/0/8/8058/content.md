...
In complex analysis, the Lambert $W$-function is a multi-branched function inverse to the function $f(z) = z e^z$. Among other things, it is important in the enumeration of tree-like structures, for instance [[tree|rooted trees]], and in the combinatorial study of the [[Lagrange inversion formula]]. 
