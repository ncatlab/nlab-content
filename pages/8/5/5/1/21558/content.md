...
The _interval groupoid_ or _[[interval object]] in [[groupoids]]_ or _free-standing isomorphism_ or, if you insist, the "[[walking structure|walking]] isomorphism", is the [[groupoid]]:
\[
  I_\sim
  \;\coloneqq\;
  \big\{
...
\begin{defn}
The _interval groupoid_ or _free-standing isomorphism_ is the [[groupoid]] generated by two objects $0$ and $1$ and one [[morphism]] $0 \cong 1$, which is an [[isomorphism]] by definition of a groupoid. 
\end{defn}

\begin{defn}
Equivalently, the _interval groupoid_ or _free-standing isomorphism_ is the [[category]] generated by two objects $0$ and $1$, one arrow $0 \rightarrow 1$, one arrow $1 \rightarrow 0$, and the equations:
\[
...
\begin{prpn}
Let $\mathcal{A}$ be a category. Let $\mathcal{I}$ denote the interval groupoid.
