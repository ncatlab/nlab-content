...
[[strict omega-categories]] with _strict_ inverses are far from modelling all homotopy types, strict $\omega$-categories with all weak inverses are sufficient. Something like this shown in ([Kapranov-Voevodsky](#KapranovVoevodsky)). 
