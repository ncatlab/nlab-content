...
The notion of an $\infty$-groupoid is a generalization of that of a [[group]] and [[groupoid]]s to [[higher category theory]].

An $\infty$-groupoid -- equivalently an [[(∞,0)-category]] -- is an [[∞-category]] in which, for all natural numbers $k$, all [[k-morphism]]s are [[equivalences]]. 

The collection of all $\infty$-groupoids forms the [[(∞,1)-category]] [[∞Grpd]].

Special cases of $\infty$-groupoids include [[groupoid]]s, [[2-groupoid]]s, [[3-groupoid]]s, [[n-groupoid]]s, [[delooping]]s of [[group]]s, [[2-group]]s, and [[∞-group]]s.
...
The [[(∞,1)-category]] of all $\infty$-groupoids is modelled along these lines by the Quillen [[model structure on simplicial sets]], whose fibrant-cofibrant objects are precisely the Kan complexes:
$$
...
There are various model categories which are [[Quillen equivalence|Quillen equivalent]] to $sSet_{Quillen}$. For instance, the standard [[model structure on topological spaces]], a [[model structure on marked simplicial sets]], and many more. All these present [[∞Grpd]].

Moreover, the corresponding  [[homotopy category of an (∞,1)-category]] $Ho(\infty Grpd)$, a category whose objects are the [[homotopy types]] of the $\infty$-groupoids, is given by the [[homotopy category]] of the [[category of presheaves]] over any _[[test category]]_. See there for more details.

Every other algebraic definition of an [[omega-category]] is supposed to yield an equivalent notion of an $\infty$-groupoid when restricted to $\omega$-categories whose [[k-morphism]]s are all invertible. This is the statement of the [[homotopy hypothesis]], which is a theorem for Kan complexes and algebraic Kan complexes and regarded as a consistency condition for other definitions.

 
Notably, in [[Pursuing Stacks]] and the earlier letter to [[Larry Breen]], [[Alexander Grothendieck]] initiated the study of $\infty$-groupoids and the homotopy hypothesis with his original definition of [[Grothendieck weak infinity-groupoid]]s, which has recently attracted renewed attention.
...
[[pointed object|Pointed]] [[0-connected]] $\infty$-groupoids are the [[delooping]]s of [[∞-group]]s. (See _[[looping and delooping]]_.)

These are presented by [[simplicial group]]s. Notably, abelian simplicial groups are a model for abelian $\infty$-groupoids (more precisely, [[HA|H$\mathbb{Z}$]]-[[(∞,1)-module|modules]]). Under the [[Dold-Kan correspondence]], these are equivalent to non-negatively graded [[chain complex]]es, which are therefore also a model for abelian $\infty$-groupoids. In this way, much of [[homological algebra]] is really the study of special (structured) $\infty$-groupoids.
