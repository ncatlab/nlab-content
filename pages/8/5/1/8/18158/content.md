...
Starting with [[affine space]] $k^n$, then the idea of the Zarsiki topology is to take as the _[[closed subsets]]_ those defined by the vanishing of any set of [[polynomials]] over $k$ in $n$ [[variables]], hence the solution sets to [[equations]] of the form
