...
An **amnestic functor** is a functor $U : \mathcal{D} \to \mathcal{C}$ that reflects [[identity morphism|identity morphisms]]: more precisely, for any [[isomorphism]] $f$ in $\mathcal{D}$, if $U f = id$, then $f = id$.
