...
**Kinship** is the collection of relations and rules concerning real or fictive consanguinity and alliance that derive from the social organisation of the  biological reproduction of individuals. Kinship relations play an important role for individuals as well as for society as a whole.
...
Lawvere makes at the end of his [paper](#Law99), the interesting suggestion to use as [[abstract general]] not the category corresponding to $M_2$ but the [[category]] $\mathcal{C}$ based on the diagram of three parallel arrows 
