...
Here $\Omega$ is the truth-value object or [[subobject classifier]] which, in the case of a topos of group actions, is the set $\{\emptyset , G\}\cong\{0,1\}$ with trivial action $0\cdot g=0$ and
$1\cdot g=1$ for all $g\in G$. Whence in $\mathcal{K}$ the truth-value object $\Omega =(\{0,1\}, id, id)$ is a matrilineal endogamic system with two classes.
...
$$
\begin{matrix} 
 & \rightarrow&#160;& \\  \cdot &\rightarrow & \cdot \\ & \rightarrow &
\end{matrix}
$$
