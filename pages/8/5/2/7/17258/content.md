...
Hence, the category $\mathcal{K}$ has a rich mathematical structure and naturally admits not only finite products $S\times T$ that play an important role already in [Corr&#232;ge (1965)](#Cour65) but also more 'exotic' operations like exponentials $T^S$ and, in particular, power systems $\Omega^S$.
...
First steps in [[topos theory]] can undertaken with [Lawvere-Schanuel (1997)](#LawSchan97) whereas the level of sophistication then increases steadily from
