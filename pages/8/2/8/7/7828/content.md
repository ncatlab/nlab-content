...
(e.g.[Karoubi 01](#Karoubi01), [Dugger 03, corollary 7.6](#Dugger03)) and this way where in complex K-theory one has [[KU]]-[[modules]] ([[∞-modules]]), so in KR-theory one has $KO$-modules.
...
* {#Karoubi01} [[Max Karoubi]], _A descent theorem in topological K-theory_, K-theory 24 (2001), no. 2, 109&#8211;114.
...
and some basics are collected in
