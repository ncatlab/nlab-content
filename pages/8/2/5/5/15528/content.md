...
As a result, in constructive mathematics not every [[Bézout domain]] that is a [[unique factorization domain]] is a [[principal ideal domain]], as $\mathbb{Z}$ is both a Bézout domain and a unique factorization domain, but is not a principal ideal domain. However, every [[principal ideal domain]] is still a Noetherian Bézout domain. 
