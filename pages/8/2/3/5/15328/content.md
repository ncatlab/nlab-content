...
**Lindstr&#246;m's theorems** are important results in classical [[model theory]] due to the Swedish logician [[Per Lindström]] that give abstract characterizations of standard (unsorted finitary) [[first-order logic]] ('abstract' in the sense of not referring to the [[syntax|syntactic]] make up of the formulas).
