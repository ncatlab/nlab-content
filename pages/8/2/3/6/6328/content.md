...
* In the __Schr&#246;dinger picture__, (named after [[Erwin Schrödinger]]) states are propagated through [[time]], while observables are held fixed; the axiomatic formalization of this is given by [[cobordism category]] [[representation]]s in [[FQFT]].
...
* The [[Dirac (interaction) picture]] is a mixture of these two approaches: dynamics is split into a free (or otherwise solvable) part and an [[perturbation theory|interaction or perturbation]]; one of these is take to affect the states, the other the observables.
