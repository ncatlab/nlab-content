...
Weak homotopy equivalences are named after _[[homotopy equivalences]]_. They an be identified with homotopy equivalences after one allows to replace the [[domains]] by a [[resolution]]. The corresponding notions in [[homological algebra]] are [[quasi-isomorphisms]] and [[chain homotopy]]-equivalences.
...
We say two spaces $X$ and $Y$ habe the same **(weak) [[homotopy type]]** if they are equivalent under the [[equivalence relation]] _generated_ by weak homotopy equivalence.
