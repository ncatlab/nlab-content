...
If we work with [[locales]] instead of topological spaces, then the a closed point $0$ in $V$ still has an open subspace of $V$ as its formal dual, and we use this in the place of $V \setminus \{0\}$.
