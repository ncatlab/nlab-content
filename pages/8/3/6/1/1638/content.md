...
Moreover, for any globular operad $P$, one can show that the "cofibrant replacement" obtained as above from the adjunction $\omega Cptd_P \rightleftarrows P Alg$ is the same as the "canonical" cofibrant replacement [[comonad]] obtained from the [[natural weak factorization system]] on $P Alg$ generated by the boundary inclusions $F_P \partial_n \to F_P 2_n$.  This is proven in
