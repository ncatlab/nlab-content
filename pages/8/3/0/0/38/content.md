...
[[Lie group]] is a [[group]] [[internalization|internal to]] [[Diff]]. The [[Lie algebras]] over real or complex numbers appear as the linearization of real or complex Lie groups; the infinitesimal version of Lie groups are [[local Lie group]]s. The relation between real Lie algebras and real Lie groups was established by [[Lie's three theorems]] and the study of this correspondence is the classical Lie theory in narrow sense. 
