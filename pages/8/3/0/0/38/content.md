...
Classical [Lie theory](http://en.wikipedia.org/wiki/Lie_theory) is the theory of [[group|groups]] [[internalization|internal to]] [[Diff]] -- [[Lie group|Lie groups]] -- and their relation to their linear approximation -- [[Lie algebra|Lie algebras]].  The relation between Lie algebras and Lie groups was established by [[Lie's three theorems]].
