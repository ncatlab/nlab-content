...
The interval category in [[homotopy type theory]] is more commonly called the **interval preorder** or the **interval poset**, and consists of the booleans type $\mathbb{2}$ and a [[inductive type]] [[type family|family]] $\leq_\mathbb{2}$ on the [[booleans type]] $\mathbb{2}$ generated by 
