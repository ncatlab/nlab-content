...
The walking morphism serves as a [[combinatorial]] model for the [[directed space|directed]] [[interval]]. It is the directed canonical [[interval object]] in [[Cat]]. As a result, it may be called the **directed interval** or **directed interval category**. It may also be called the **interval** or **interval category**, although both terms are overloaded: 
...
It is also commonly called the **interval preorder** or the **interval poset** (since it is indeed a [[poset]]). The notation $I$ comes from this fact. 
...
In the event that the [[bridge types]] are [[identity types]], such as in [[higher observational type theory]], this results in the usual notion of an [[interval type]]. 
...
The directed interval as a higher inductive type: 
