...
... demand only that field is locally given by smooth 1-form  (Maxwell's equations + Poincar&#233; lemma) and that a well-defined $U(1)$-valued holonomy exists (action functional for electrically charged particle) ... this already implies that we are dealing with a line bundle...old argument: "Dirac string"... modern complete argument: Barrett's description of bundle in terms of its holonomy homomorphism...
