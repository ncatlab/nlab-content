...
The _Schanuel topos_ is the [[sheaf topos]] $Sh(FinSet^{op}_{mono},J)$ where $FinSet^{op}_{mono}$ is the opposite of the [[FinInj|category of finite sets and monomorphisms]] and the coverage is the collection of all sieves generated by singletons $\{f\}\quad.$
