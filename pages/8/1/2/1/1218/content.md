...
This appears as ([Losik, theorem 3.1.1](#Losik)), as variant of the analogous statement for [[Banach manifolds]] in ([Hain](#Hain)). The fact that maps between Fr&#233;chet spaces are smooth if and only if they send smooth curves to smooth curves was proved earlier in ([Fr&#246;licher, th&#233;or&#232;me 1](#Frolicher))
...
* [[Alfred Frölicher]], _Applications lisses entre espaces et vari&#233;t&#233;s de Fr&#233;chet_, C. R. Acad. Sci. Paris S&#233;r. I Math. \textbf{293} (1981), no. 2, 125&#8211;127. [BnF](http://gallica.bnf.fr/ark:/12148/bpt6k5533894s/f31.image)
{#Frolicher}
