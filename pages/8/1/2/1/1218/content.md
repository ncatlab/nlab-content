...
Diffeological spaces were originally described by [[Jean-Marie Souriau]] in 1980. They have subsequently been developed by [[Patrick Iglesias-Zemmour]] who is writing a textbook on the subject.
...
Als [[Banach manifolds]] embed [[full and faithful functor|fully faithfully]] into the category of diffeological spaces ([Hain](#Hain)).

### Embedding of locally convex vector spaces into diffeological spaces

Generally, maps between [[locally convex vector spaces]] are smooth precisely if they send smooth [[curves]] to smooth curves. ([Kriegl-Michor, cor. 3.14](#KrieglMichor))
...
This appears as ([Losik, theorem 3.1.1](#Losik)), as variant of the analogous statement for [[Banach manfiolds]] in ([Hain](#Hain)).
...
The embedding of [[locally convex vector spaces]] into diffeological spaces is disucssed around corollary 3.14 in 
