...
This is in contrast to traditional [[ZFC|Zermelo-Fraenkel]]-style "[[material set theory]]"  where the fact that elements and sets are the same type of objects primitive global set-membership relation "$\in$" forces one to think of all elements of sets as sets themselves, hence of sets-of-sets-of-sets-..., a feature that is almost never actually used or even considered in [[mathematics]], away from the study of [[material set theory]] itself.
