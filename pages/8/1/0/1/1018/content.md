...
$$
\array{
FX&\stackrel{Ff}{\rightarrow}&FY&\stackrel{F\gamma}{\leftarrow}&FX&\stackrel{Fg}{\rightarrow}&FY\\
\stackrel{\alpha_X}{\downarrow}&\stackrel{\alpha_f}{\Rightarrow}&\stackrel{\alpha_Y}{\downarrow}&&\stackrel{\alpha_X}{\downarrow}&\stackrel{\alpha_g}{\Rightarrow}&\stackrel{\alpha_Y}{\downarrow}\\
GX&\stackrel{Gf}{\leftarrow}&GY&\stackrel{G\gamma}{\rightarrow}&GX&\stackrel{Gg}{\rightarrow}&GY\\
}
$$
the only possible commutativity condition of $2$-morphisms holds: 
