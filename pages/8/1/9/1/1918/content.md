...
<table markdown="1"><tr><th>Stronger condition &#8595;\Weaker condition &#8594;</th> <th>Distinct</th> <th>Topologically distinct</th></tr>
<tr><th>Topologically distinct</th> <td>$T_0$</td></tr>
<tr><th>Separated</th> <td>$T_1$</td> <td>$R_0$</td></tr>
<tr><th>Separated by neighbourhoods</th> <td>$T_2$</td> <td>$R_1$</td></tr>
<tr><th>Separated by closed neighbourhoods</th> <td>$T_{2\frac{1}{2}}$</td> <td>$R_{1\frac{1}{2}}$</td></tr>
<tr><th>Separated by a function</th> <td>Completely $T_2$</td> <td>Completely $R_1$</td></tr></table>
...
Well, I\'m tired now, but here are the main issues:
*  anything below $T_2$ (at least) can be defined in terms of [[convergence space|convergence]],
*  defining things for [[locales]] can be tricky,
*  one must find the right definitions for [[constructive mathematics]],
*  all of these situations allow for finer hair-splitting and bifurcation of definitions.
