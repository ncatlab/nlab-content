...
1. the [[subgroup]] $\langle \sigma,\alpha,\phi\rangle$ of $Aut(D)$ generated by the permutations (called the _monodromy group_ of $M$) acts [[transitive action|transitively]] on $D$;
