...
In common parlance, the term 'forgetful functor' has no precise definition, being simply used whenever a functor is obviously defined by forgetting something.  Many forgetful functors of this sort have left or right adjoints (and many are actually [[monadic functor|monadic]] or comonadic), leading to the paradigmatic adjunction "free $\dashv$ forgetful."
