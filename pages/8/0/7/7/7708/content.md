...
A special class of examples of this is the notion of [[structure model theory]]. In this case one defines a "language" o$L$ that describes the constants, functions (say operations) and relations and which we want to equip sets, and then sets equipped with those operations and relationss are called $L$-[[structure in model theory|structures]] for that language. We instead say [[model]] of a [[theory]] when we restrict to those structures which satisfy the axioms of a theory.
