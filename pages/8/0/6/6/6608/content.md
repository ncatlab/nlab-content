An element in a tensor product of $k$ vector spaces $V_1\otimes V_2\otimes\ldots\otimes V_k$ is said to be __decomposable__ if it can be written in the form $v_1\otimes v_1\otimes\ldots\otimes v_k$ where $v_i \ion V_i$ for $i = 1,ldots, k$. 
