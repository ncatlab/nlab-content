...
For a [[regular category]] $C$, the _regular coverage_ on $C$ is the [[coverage]] in which each [[covering]] family has just one element which is a [[regular epimorphism]].

The [[Grothendieck topology]] generated from a regular coverage is called the _regular topology_.

It is the [[subcanonical site|subcanonical]] [[Grothendieck topology]] whose covering families are generated by single [[regular epimorphisms]]: the [[regular coverage]].  
