...
The big pro-étale site on all schemes over a separably closed field $k$ is almost (check) cohesive over the pro-étale site of a point. ([Scholze a](#Scholzea))
...
The [[differential cohomology diagram]] for stable objects in condensed cohesive $(\infty, 1)$-toposes is discussed at ([Scholze b](#Scholzeb)).
...
* {#Scholzea} [[Peter Scholze]], _Answer to 'What is the precise relationship between pyknoticity and cohesiveness?'_, ([MathOverflow](https://mathoverflow.net/a/356836/447)).

* {#Scholzeb} [[Peter Scholze]], _Answer to 'Cohesion relative to a pyknotic/condensed base'_, ([MathOverflow](https://mathoverflow.net/q/384318/)).

* {#BarHai19} [[Clark Barwick]], [[Peter Haine]], _Pyknotic objects, I.  Basic notions_, ([arXiv:1904.09966](https://arxiv.org/abs/1904.09966))

* {#Scholzec} [[Peter Scholze]], _Answer to 'Condensed / pyknotic approach to orbifolds?'_, ([MathOverflow](https://mathoverflow.net/q/384099/))
