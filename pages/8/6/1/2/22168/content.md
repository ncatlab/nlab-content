...
{#AlmostCohesionInIntroduction} Analogously, the [[gros topos]] of [[pro-étale topos|pro-étale]] [[arithmetic geometry|arithmetic]]/[[algebraic geometry]], while not cohesive over [[sets]], is *almost* cohesive over [[pyknotic sets]], namely over the [[sheaf topos]] on the [[pro-étale site]] of the point -- the only [[axiom]] that seems to fail is that the  extra left adjoint (the [[shape modality]]) does not [[preserved limit|preserve]] all [[finite products]].  This and the analogous statement for the respective [[hypercomplete (infinity,1)-topos|hypercomplete $\infty$-toposes]] is claimed in [Scholze 2020](#Scholze2020), see also [Scholze a](#Scholzea). 
