...
Equivalently, $S\hookrightarrow X$ is coisotropic if the subalgebra of $C^\infty(X)$ consisting of functions vanishing on $S$ is closed under the Poisson bracket.
...
* A&#239;ssa Wade, _On the geometry of coisotropic submanifolds of Poisson
