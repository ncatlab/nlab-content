...
1. a [[closed category|closed]] [[monoidal category|symmetric monoidal]] structure 

2. and [[model category]] structure

on a category.

[[closed category|Closed]] [[monoidal category|symmetric monoidal categories]] satisfying the pushout-product axiom are called [[monoidal model category|monoidal model categories]] and hence are in particular [[closed monoidal homotopical category|closed monoidal homotopical categories]].

This is relevant in [[enriched homotopy theory]], which pairs [[enriched category theory]] with [[homotopy theory]].

#Definition#

Let $C$ be a [[closed category|closed]] [[monoidal category|symmetric monoidal category]] equipped with a [[model category]] structure. 
