...
Finally what makes this _locally covariant_ is that the resulting assignment of formal power series algebras of obervables to spacetimes is required to still be a [[functor]] satisfying [[causal locality]] (a [[local net]]). It is in this sense that the output of the procedure is an [[algebraic quantum field theory]] in the sense of the [[Haag-Kastler axioms]], only that instead of [[C*-algebras]] it assigns [[formal power series]] [[star-algebras]].

In summary, constructing a locally covatriant perturbative quantum field theory means to 
...
and the observation that the [[causal perturbation theory]] [Epstein-Glaser 73](#EpsteinGlaser73) of lends itself to a construction of locally covariant perturvative QFT is due to
...
The observation that this construction produces [[formal deformation quantization]] of the classical field theory was made for just the [[free field]] part in 
...
and for interacting [[scalar field]] [[phi^4 theory]] in
