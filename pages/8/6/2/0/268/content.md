...
The cubical category is used to define [[cubical set]]s.

##Remarks##

Among all [[geometric shapes for higher structures]] cubes are best suited for describing Gray-like [[tensor product]]s of higher structures: there is geometrically obvious way in which to combine the cubical $n$-cube $[n]$ and the cubical $m$-cube $[m]$ to the cubical $n+m$-cube $[n] \otimes [m] := [n+m]$. This makes $\Box$ into a [[monoidal category]]. It also induces the canonical monoidal structure on [[cubical set]]s and then on [[omega-category|omega-categories]].
