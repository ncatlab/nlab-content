...
$$
(\Gamma C)_n = \bigoplus_{k \in \{0, ..., n \}, \alpha : \{ 0, ..., n \} \twoheadrightarrow \{ 0, .., k \} \text{ surjective } } C_k
$$
...
A Hermitian form on the realization $|\Gamma(V_*)|$ of a [[chain complex]] of $\mathbb{C}$-modules has the confounding property that, while such a form may result from the [geometric realization](https://ncatlab.org/nlab/show/geometric+realization#OfSimplicialSets) of 
$$
