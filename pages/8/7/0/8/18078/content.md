...
which we may and do assume this to be normalized:
...
To bring out this relation, consider now the [[quotient algebra]] of $\mathbb{C}\big(G^\omega\big)$ by the canonical [[augmentation ideal]] of the group algebra of the extension group, ie. by the two-sided [[ideal]] in $\mathbb{C}\big(G^\omega\big)$ generated by the [[kernel]] of the [[linear map]]
...
$$
  ...
  \end{array}
$$
(using in the last step that $(\mathrm{e}, 0)$ is the [[neutral element]] of $G^\omega$, so that $U(\mathrm{e}, 0)$ is the [[unit element]] in the group algebra).

Therefore the [[quotient algebra]] $\mathbb{C}\big(G^\omega\big)\big/ ker(\epsilon)$ is that generated by $U(G) \,\equiv\, U\big(G \times \{0\}\big)$ subject to the relations
