...
However, note that a generalization from [[Rel]] to the bicategory [[Prof]] of categories and [[profunctors]] is not possible: in general an adjoint pair of profunctors determines only a [[semifunctor]], which can be improved to a [[functor]] if the codomain category is [[Cauchy complete]]. For this reason, algebraic structures modeling profunctors such as [[proarrow equipments]] and [[virtual double categories]] include notions of functor in addition to profunctor.
