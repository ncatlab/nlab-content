...
&#268;ech cohomology is a way of computing [[cohomology]] in  [[(infinity,1)-topos]] of [[infinity-stacks]] that are [[localization of an (infinity,1)-category|localized]] with respect to [[?ech covers]].

&#268;ech cohomology is more an algorithm for computing cohomology (see [[?ech methods]]) than 
