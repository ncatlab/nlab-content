...
&#268;ech cohomology if the [[cohomology]] theory of the [[(infinity,1)-topos]] of [[infinity-stack]] that are [[localization of an (infinity,1)-category|localized]] not with respect to all [[hypercover]]s but only with respect to all [[Cech cover]]s.
