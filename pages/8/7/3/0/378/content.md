...
* generating cofibrations the [[horn]] inclusions $\Lambda^i[n] \to \Delta[n]$;

* generatic acyclic cofibrations the [[boundary]] inclusions $\partial \Delta[n] \to \Delta[n]$.
...
A proof (in fact two variants of it) using Kan's $Ex^\infty$ functor (see [[Kan fibrant replacement]]) is given in section 2 of
...
* [[Paul Goerss]], [[Rick Jardine]], _[[Simplicial homotopy theory]]_ (Birkh&#228;user) ([ps](http://www.maths.abdn.ac.uk/~bensondj/html/archive/goerss-jardine.html)).
