...
and in degree 2 it is

$$
  Q(\mathbf{B}^1 U(1))_2 =  \coprod_{U_0 \to U_1 \to U_2 \to U(1)} U_0
  \,.
$$
...
$$
  ...
  \omega_{U_1 \to U_2 \to U(1)} + f^* \omega_{U_0 \to U_1 \to U(1)}
  \,.
$$
...
$$
  \array{
    ...
    & \nearrow && \searrow
    \\
    Q(\mathbf{B}U(1)) &&\to&& \mathbf{\flat}_{dR} \mathbf{B}^2(U(1))
  }
  \,.
$$

This way the above argument applies indeed after all, and the result follows.


For $\mathbf{B}^n U(1)$ with $n \gt 1$ the argument should be analogous.
