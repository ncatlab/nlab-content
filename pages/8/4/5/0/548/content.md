...
By the discussion there, every _[[∞-group]]_ has a _presentation_ by a [[simplicial group]]. More precisely, the [[(∞,1)-category]] $?Grp$ is [[presentable (∞,1)-category|presented]] by the [[model structure on simplicial groups]] (for instance under [[simplicial localization]])
