...
which follows directly from the defining formula $P(A|B) = P(A \wedge B)/P(B)$ for [[conditional probability]].  The rule may also be written in the expanded form
...
In [[quantum mechanics]], the [[collapse of the wavefunction]] can be seen as a generalization of Bayes\'s Rule to [[quantum probability theory]].  This is key to the [[Bayesian interpretation of quantum mechanics]].
