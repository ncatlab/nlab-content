...
* In pure constructive logic, there are multiple inequivalent definitions of [[real numbers]].
  ...
  * While every real number with a [[locator]] is a [[Cauchy real number]], not every [[Cauchy real number]] has a [[locator]]. That every [[Cauchy real number]] has a locator implies that the Cauchy reals coincide with the HoTT reals, because the limit of every Cauchy sequence of real numbers with a locator is a real number with a locator. 
