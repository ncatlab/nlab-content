...
* An extreme form of constructive [[predicative mathematics]] is to reject the use of [[implication]] and the [[universal quantifier]] completely and work in [[coherent logic]]; in coherent logic, excluded middle and double negation cannot be formed, since negation can only be formed as a [[sequent]] rather than a [[formula]] in the [[predicate logic]]. Examples of this include [[dependent type theory]] which does not make use of [[function types]] and [[dependent function types]], as well as mathematics done inside an [[arithmetic pretopos]]. 
