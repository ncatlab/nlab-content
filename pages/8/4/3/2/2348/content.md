...
When intepreted as a [[binary relation]], $\Delta_X$ is the [[equality relation]] on $X$, sometimes.  This relation is both [[functional relation|functional]] and [[entire relation|entire]]; when interpreted as a [[function]], it is the [[identity function]] on $X$.  Note that there is an obvious [[bijection]] $a \mapsto (a,a)$ from $X$ to $X^2$; thus, we can also interpret the diagonal as a [[function]] from $X$ to $X^2$, called the [[diagonal function]].
