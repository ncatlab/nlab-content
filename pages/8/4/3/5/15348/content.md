...
* $\mathcal{J}_2=Sh(M_2,J)$ where $M_2$ is the free monoid on two generators $a, b$ and $J$ is the coverage whose only covering family on the unique object $\ast$ of $M_2$ is $\{a:\ast\rightarrow \ast ,b:\ast\rightarrow\ast\}$. So $\mathcal{J}_2$ is in a fact a [[Grothendieck topos]].

* $\mathcal{J}_2$ is an [[étendue]] ([[Peter Freyd]]).

##Generalizations
The idea that $\mathcal{J}_2$ is the first in a row seems to have originated with Lawvere (1989, p.298).
