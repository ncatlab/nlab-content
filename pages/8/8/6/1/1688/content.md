...
This 2-sided ideal is a biideal and $S(I_S) \subset I_S$, hence
it induces a bialgebra map
$$ S : T(V)/I_S \rightarrow (T(V)/I_S)^{\mathrm{cop}}. $$
It follows that $H(C) = T(V)/I_S$ is a Hopf algebra, the {\bf free
Hopf algebra} on $C$.
...
into $T(V)$ and projection $T(V) \rightarrow H(C)$.
