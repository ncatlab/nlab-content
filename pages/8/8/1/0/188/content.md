...
* For $A$ a monoid it makes sense to write $\mathbf{B}A$ for the corresponding category with single object $\bullet$  and with $A$ as its [[homset]], $A = Hom_{\mathbf{B}A}(\bullet, \bullet)$. This realizes every monoid as a monoid of [[endomorphism]]s.
