...
If (as in a [[measure space]], a [[Cheng space]], or a [[localisable measurable space]]), we have a notion of [[null sets]] (or [[full sets]]) in $X$ and $Y$, then we may allow a measurable function to be an __[[almost function]]__: a [[partial function]] whose domain is full.  At the same time, we require the [[preimage]] of a full set in $Y$ to be full in $X$ (in addition to the condition above) to have a __measurable almost function__.  Additionally, we consider two measurable almost functions to be [[equal]] (or [[equivalent]] if one prefers) if they are __[[almost equality|almost equal]]__: their [[equaliser]] is full.
