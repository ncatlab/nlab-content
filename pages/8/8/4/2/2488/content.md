...
an [[object]] $A \in \mathcal{C}$ is called **$n$-truncated**, for $n \in \mathbb{N}$, if for all objects $X \in \mathcal{C}$ the [[hom-∞-groupoid]] $\mathcal{C}(X,A)$ is $n$-truncated according to Def. \ref{nTruncatedInfinityGroupoid}.
