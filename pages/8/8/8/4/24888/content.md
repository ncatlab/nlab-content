...
| $\mathbb{R}_{U}^\mathrm{loc} \flat$ | locally $U$-small localic real cohesion | Given [[type universe]] $U$, $R$ is a $U$-[[localic completion]] of an [[Archimedean field|Archimedean]] [[ordered field|ordered]] [[lattice]] [[field]]. Same as locally $U$-small real cohesion in the presence of local [[excluded middle]] for $U$. $R$ becomes $U$-small if $U$ has [[propositional resizing]], which is necessary for doing [[univalent mathematics]] inside a [[univalent universe]] $U$. |
