...
A function between [[preodered sets]] is called *monotone* if it respects the (pre)[[ordering]].

When [[preordered sets]] are regarded as [[categories]] ([[(0,1)-categories]]) monotone functions are equivalently the *[[functors]]* between these.
