...
Sen conjectured the statement, now known as _Sen's conjecture_ that the "depth" of this tachyon potential, i.e. the energy density difference between this local maximum and this local minimum corresponds precisely to the energy density of the space-fillind D25-[[brane]] that is seen in perturbative string theory. This would mean that the condensation of the bosonic string's tachyon corresponds to the decay of the unstable space-filling D25 brane. 
...
#Relation of n-categorical physics#

* open closed string field theory is controled by [[Jim Stasheff]]'s [[open-closed homotopy algebra]]s.
