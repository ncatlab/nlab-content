...
For a modern example of this kind, with only 1 stalk, consider the nonarchimedean field of germs of holomorphic functions at the origin of the field $\mathbb{C}$ of complex numbers is playing an important role in mirror symmetry as the base field for the geometry of families of Calabi-Yau manifolds in large volume limit (cf. Kontsevich, Soibelman [doi:10.1007/0-8176-4467-9](http://dx.doi.org/10.1007/0-8176-4467-9), [arxiv:math/0406564v1.pdf](http://arxiv.org/PS_cache/math/pdf/0406/0406564v1.pdf)).  
