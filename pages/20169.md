...
Observe that we  have a $G$-equivariant [[homeomorphism]] between the representation sphere of $V$ and the [[unit sphere]] in $\mathbb{R} \oplus V$, where $\mathbb{R}$ is the 1-dimensional [[trivial representation]]  ([this Prop.](representation+sphere#RepresentationSpheresAsUnitSpheres))
