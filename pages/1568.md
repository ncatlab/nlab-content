...
An ideal is a __[[maximal ideal]]__ if it is maximal among *proper* ideals.  A maximal ideal in a rig (including in a distributive lattice, but not in every lattice) is necessarily [[prime ideal|prime]] (see below); conversely, a prime ideal in a [[Boolean algebra]] is necessarily maximal. 
