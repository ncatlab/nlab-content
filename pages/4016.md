...
For instance, the existence of a measurable cardinal is equivalent to the existence of an [[exact functor]] $F: Set \to Set$ that is not naturally isomorphic to the identity.  This was essentially proved by V. Trnkov&aacute;, and it was rediscovered by Blass in his paper "Exact functors and measurable cardinals".
