...
|--|--|--|--|--|
| $\,\mathbb{C}\,$ | $\,$[[Kähler manifold]]$\,$ | $\,$[[unitary group|U(n)]]$\,$ | $\,2n\,$ | $\,$[[Kähler forms]] $\omega_2\,$ |
|  | $\,$[[Calabi-Yau manifold]]$\,$ | $\,$[[special unitary group|SU(n)]]$\,$ | $\,2n\,$ | |
...
| | $\,$[[hyper-Kähler manifold]]$\,$ | $\,$[[symplectic group|Sp(n)]]$\,$ | $\,4n\,$ | $\,\omega = a \omega^{(1)}_2+ b \omega^{(2)}_2 + c \omega^{(3)}_2\,$ ($a^2 + b^2 + c^2 = 1$)  |
