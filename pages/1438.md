...
In many cases, initial algebras can be constructed in [[recursion|recursive]] fashion, using the following special case of a theorem due to Ad&aacute;mek. 
