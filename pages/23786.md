...
* The [[free object|free]] [[commutative algebra|commutative $\mathbb{N}$-algebra]] on the unit type $\mathbb{1}$ with $s(r) \coloneqq r + 1$ and $\mathcal{C}(r)$ for all $r \in \mathbb{N}[*]$, where $*:\mathbb{1}$, is a model of Nelson arithmetic. 
