...
In [[homotopy type theory]] with the [[univalence axiom]] and in [[simplicial type theory]] there should be an [[(infinity,2)-category|$(\infty,2)$-category]] PreCat whose objects are precategories and whose morphisms are functors between precategories.

PreCat should be a sub-$(\infty,2)$-category of the $(\infty,2)$-category $(\infty,1)Cat$ of [[(infinity,1)-category|$(\infty,1)$-categories]]. 
