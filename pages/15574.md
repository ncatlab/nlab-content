...
An [[adjoint triple|adjoint string]] $i_!\dashv i^*\dashv i_*$ yields two [[adjoint modalities]] $\Box _i\dashv\lozenge _i$ on $\mathcal{B}$, namely $\Box_i := i_!i^*$ and $\lozenge_i :=i_*i^*$.

The [[modalities]] yield notions of _[[modal types]]_, which may be called

* the _i-sheaves_ , $X\in\mathcal{B}$ with $\lozenge _i X\simeq X$ (following the terminology at _[[Lawvere-Tierney operator]]_);
...
Let $i\leq j$, we say that the level $j$ _resolves the opposite_ of level $i$ (written $i\ll j$) if $\lozenge _j\Box_i=\Box _i$. A level $\bar{i}$ is called the _Aufhebung_ of level $i$ iff $i\ll\bar{i}$ and for any $k$ with $i\ll k$ then it holds that $\bar{i}\ll k$.
...
The condition $\lozenge _j\Box _i=\Box _i$ amounts to saying that any i-skeleton is a j-sheaf. The Aufhebung of a level is the smallest level that resolves its opposites or contradictions. Such a level need not exist in general for every level but in certain cases like [[presheaf toposes]] over [[graphic category|graphic categories]] or, more generally,  over _von Neumann regular categories_ ([Lawvere 2002](#Law02)), it does. The Aufhebungs relation is also called the _jump operator_ in [Lawvere (2009)](#Law09).
