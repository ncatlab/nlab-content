...
The condition $\bigcirc_j \Box_i=\Box_i$ amounts to saying that any $i$-skeleton is a $j$-sheaf. It ensures that $i$-skeleta are in the intersection of the $j$-skeleta and $j$-sheaves at the higher level $j$.
