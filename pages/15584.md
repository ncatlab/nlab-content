...
In the semigroup literature, they are called **unital left regular bands** or _left regular band monoids_ (cf. Brown ([2000](#brown00)), Margolis-Saliola-Steinberg ([2015](#MSS15))).
...
* The variety (in the sense of universal algebra) of graphic monoids is generated by $\Delta_1$ (cf. Lawvere ([1989b](#Law91))).
...
Note in particular that, somewhat surprisingly, the **associativity** in a unital left shelf comes for free! For more background see the comments on:
   ...
   * [The origin of the word "quandle"](https://golem.ph.utexas.edu/category/2015/05/the_origin_of_the_word_quandle.html#c049149), $n$-Category Caf&eacute;.
