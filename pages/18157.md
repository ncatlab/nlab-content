...
###### Proposition
If every net in $\{0, 1\}$ with its [[discrete topology]] has a converging subnet, then the [[law of excluded middle]] is true. 
=--
...
Given a proposition $p$, let us define the subset of $\{0, 1\}$ as 
