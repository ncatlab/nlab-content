...
on the [[Schwartz space]] (def. \ref{SchwartzSpace}) of [[functions with rapidly decreasing partial derivatives]]. The [[vector space]] of all tempered distributions is canonically a [[topological vector space]] as the [[dual space]] to the [[Schwartz space]], denoted
...
Every [[compactly supported distribution]] is a [[tempered distribution]] (def. \ref{TemperedDistribution}), yielding an [[continuous function|continuous]] [[linear map|lineae]] [[monomorphism|inclusion]]
