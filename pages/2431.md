...
The classical _Brown representability theorem_ says that certain contravariant [[functors]] on the [[homotopy category]] are [[representable functor|representable]].  This is used, for instance, to show that any [[generalized (Eilenberg-Steenrod) cohomology|generalized cohomology theory]] is representable by a [[spectrum]].

There are various generalizations, such as to homotopy categories of other [[model category|model categories]] and to [[triangulated category|triangulated categories]].  Note, however, that all of these generalizations require either
...
* [[Edgar Brown]], _Cohomology theories_
