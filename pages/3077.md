...
4. $R$ and $L$ are [[sequentially compact space|sequentially compact]] but not [[compact space|compact]]. (Being sequentially compact, they are also [[countably compact spaces]].) Thus, the image $f(L)$ under a continuous map $f: L \to \mathbb{R}$, being sequentially compact, is a compact subspace of $\mathbb{R}$. 
...
$$U_{n, c, d} \coloneqq B_{1/n}(t) \times (c, d) \subseteq H^{-1}([0, b)).$$ 
