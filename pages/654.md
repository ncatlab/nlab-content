...
* {#KapranovVoevodsky91} [[Mikhail Kapranov]], [[Vladimir Voevodsky]], *$2$-categories and Zamolodchikov tetrahedra equations* in _Algebraic groups and their generalization: quantum and infinite-dimensional methods, University Park, PA (1991) (eds: W. J. Haboush and B. J. Parshall), Proc. Sympos. Pure Math. 56 (Amer. Math. Soc., Providence RI 1994), pp. 177-259 &lbrack;[pdf](https://www.math.ias.edu/vladimir/sites/math.ias.edu.vladimir/files/1994_Kapranov_Voevodsky.pdf)&rbrack;
...
* [[John C. Baez]], [[Alissa S. Crans]], §3 of: *Higher-Dimensional Algebra VI: Lie 2-Algebras*, Theor. Appl. Categor. **12** (2004) 492-528 &lbrack;[arXiv:math/0307263](https://arxiv.org/abs/math/0307263)&rbrack;
...
The notion of 2-vector spaces with 2-linear maps between them as algebras with bimodules between them (subsuming the KV definition via algebras that are direct sums of the ground field) is due to 
...
Another systematic definition of 2-modules over [[2-rings]] (see there for more) is in 
