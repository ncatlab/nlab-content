One would like to embed an abstract [[group]] into a bigger group $K$ in which every [[automorphism]] of $G$ is obtained by restricting (to $G$) an [[inner automorphism]] of $K$ that fixes $G$ as a subset of $K$.  The holomorph is the universal (smalles) solution to this problem.
