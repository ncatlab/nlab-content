...
&=& \{ \mathbf{Meas}(X, \Delta_{\mathbb{N}}) \stackrel{J}{\longrightarrow} \Delta_{\mathbb{N}} \, | \,  \int_{i \in \mathbb{N}} J(f)[i] d\mathbf{p} = J\big( \widehat{X}(\mathbf{p})f \big) \quad  \forall f \in \mathbf{Meas}(X, \Delta_{\mathbb{N}})  \}
\end{array}
\end{equation}
