...
+-- {: .proof} 
###### Proof 
There are many characterizations of Pr&uuml;fer domains, but one is that the lattice of ideals is distributive, which is obviously the case if the lattice is linearly ordered. 
=-- 
