...
Every homomorphism $f \colon A \to B$ between PD algebras is [[K-orientation|K-orientable in KK-theory]]. The K-orientation is given by the element $f! \colon B \to A$ given as the composite
