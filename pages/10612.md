...
A quasifield (earlier also called a Veblen-Wedderburn system) is an algebraic structure with two [[binary operation]]s $+$ and $\cdot$ which is weaker than a [[division ring]] and which is motivated by [[synthetic projective geometry]]. There are left and right versions. 
