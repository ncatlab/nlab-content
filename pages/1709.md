...
The oldest meaning of twisted cohomology is that of cohomology with local coefficients.

tc = twisted cohomology

Searching MathSciNet for `twisted cohomology'led to the following chronology: It missed older references in whihc the phrase was not used but the concept was in the sense of local coefficient systems - ancient and honorable.
...
2001 Barlewtta & Dragomir tc and integrasbility
...
2007 Mickerlsson & Pellonpaa tc and tK
