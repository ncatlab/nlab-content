...
#### Remark
 ...
 _To distinguish the general notion of [[nLab:cohomology|cohomology]] in an arbitrary [[nLab:(infinity,1)-topos|(∞,1)-tops]] from the specific one in [[nLab:Top|Top]] one sometimes says [[nLab:nonabelian cohomology|nonabelian cohomology]] for the former. But notice that apart from allowing "nonabelian spaces" like $P \times_G A$ as coefficients, it also allows objects more general than topological spaces, namely generally [[nLab:infinity-stack|infinity-stack]]s.

The upshot of this is that the general [[nLab:(infinity,1)-topos|(∞,1)-topos]]-context suggests that the notion of twisted cohomology should be one that makes use only of natural [[nLab:(infinity,1)-category|(∞,1)-categorical]] constructions. Or, more simply, in any
