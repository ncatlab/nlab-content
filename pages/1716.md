...
* $\sum_i \phi_i(x) \equiv 1 \vorall x\in X$.

Numerable open covers form a [[site]]. Many classical theorems concerning bundles are stated for the numerable site. For example, the classifying space $BG$ actually classifies bundles which trivialise over a numerable cover. 
