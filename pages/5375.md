...
The term "anabelian" is supposed to be alluding to the fact that "the _less_ [[abelian group|abelian]] $\pi^{et}_1(X,x)$ is, the more information it carries about $X$." Precisely: an [[anabelian group]] is a non-[[trivial group]] for which every [[finite index subgroup]] has trivial [[center]].
...
written in response to [[Faltings]]' work on the [[Mordell Conjecture]]. And in

* [[Alexandre Grothendieck]], La Longue Marche à travers la Théorie de Galois ([link](https://github.com/gcarmonamateo/LaLongueMarche)).
...
* {#Uchida} K. Uchida. _Isomorphisms of Galois groups_, J. Math. Soc. Japan 28 (1976), no. 4, 617&#8211;620. 
