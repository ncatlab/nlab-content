...
Accordingly, one motivation for the idea of the multiverse as an explanation for the '[[naturalness|fine-tuning]]' we seem to find in own universe for the presence of complex life. The thought here is that were the laws of nature to be ever so slightly other than they are, or their constants very slightly different, then the universe would not have been to able to evolve to support complex, intelligent life forms (see [SEP: Fine-tuning](https://plato.stanford.edu/archives/fall2017/entries/fine-tuning/)). Then an account which proposes that a vast number of universes exist governed by laws spanning some full range of possibilities removes the surprise that we should live in such a special universe, since any form of life as ourselves could only occur within such a universe. 
