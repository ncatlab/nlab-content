...
The idea of a Fermat theory seems to have been invented by [[Anders Kock]].  But as the name suggests, it has its roots in an old observation of Fermat.  Namely: if $f : \mathbb{R} \to \mathbb{R}$ is a [[polynomial]] function, then
