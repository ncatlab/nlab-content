...
On the other hand, the first portion, that proves that $R[\mathrm{i}]$ is algebraically closed whenever $R$ is a [[real closed field]], can be provable or can be not provable in constructive mathematics, depending upon what definition of a real closed field one uses in the proof. 
