...
Let $H \lt G$ be a [[subgroup]] of rank $p^l$, and consider the left [[group action|action]] of $G$ on right [[cosets]] of $H$:
...
* Wikipedia, *[Sylow theorems](https://en.wikipedia.org/wiki/Sylow_theorems)*
