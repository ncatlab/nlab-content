...
+-- {: .num_defn #LinearDualOfATopologicalVectorSpace}
###### Definitions
...
+-- {: .num_example #DualityBetweenVectorsAndCovectors}
###### Example
**(duality between [[vectors]] and [[covectors]])**

* [[tensor|Tensors]] in finite-dimensional [[differential geometry]] make heavy use of the duality between [[tangent spaces]] and [[cotangent spaces]].  That [[infinite-dimensional manifold|infinite-dimensional differential geometry]] is much harder is largely because this duality is no longer perfect.

=--


+-- {: .num_example #VonNeumannAlgebras}
###### Example
...
+-- {: .num_example #SpacesOFDistributionsAsDualVectorSpaces}
###### Example
**(spaces of [[distributions]])**

The standard [[topological space|topology]] on the spaces $\mathcal{D}'$ of [[distributions]] is the dual space topology according to def. \ref{LinearDualOfATopologicalVectorSpace}. 

(e.g. [H&#246;rmander 90, p. 38](#Hoermander90))

=--

See _[[Riesz representation theorem]]_ for more examples from [[functional analysis]].
