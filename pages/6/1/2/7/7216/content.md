...
A dual space is a [[dual in a closed category]] of [[vector spaces]] (or similar [[algebraic structure]]s).
...
The space $V$ is called __[[reflexive Banach space|reflexive]]__ if this natural transformation is a [[natural isomorphism]].  The reflexive spaces include all finite-dimensional discrete vector spaces or modules over [[fields]] or [[division rings]], as well as all [[Hilbert spaces]], the [[Lebesgue spaces]] $L^p$ over a [[localizable measure|localisable measure space]] for $1 \lt p \lt \infty$, and others.


## Dual spaces as dual objects

In general, the duality between $V$ and $V^*$ does *not* make $Vect$ into a [[monoidal category with duals]].  However, if we restrict to spaces of [[F-finite|finite]] [[dimension]] or to [[Hilbert spaces]], then we get [[compact closed categories]].
...
[[tensor|Tensors]] in finite-dimensional [[differential geometry]] make heavy use of the duality between [[tangent spaces]] and [[cotangent spaces]].  Infinite-dimensional differential geometry is much harder, largely because this duality is no longer perfect (except on [[Hilbert manifold]]s).
