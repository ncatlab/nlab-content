...
\begin{imagefromfile}
    "file_name": "VorticesSchematics.jpg",
    "width": 300,
    "unit": "px",
    "margin": {
        "top": -40,
    ...
    "caption": "From [Thuneberg](#Thuneberg)"
\end{imagefromfile}
...
* {#Thuneberg} Erkki Thuneberg, *[Superfluidity and Quantized Vortices](http://ltl.tkk.fi/research/theory/vortex.html)*
...
Discussion via the [[representation theory]] of [[volume-preserving diffeomorphisms]]:
