...
The proof is given at [[Polish space]]. It follows that infinite closed sets in a Polish space have cardinality either $\aleph_0$ or $2^{\aleph_0}$ (compare [[continuum hypothesis]]). 
