...
We may make this yet more concrete as follows. By the discussion at _[[dependent linear type theory]]_ and _[[schreiber:Quantization via Linear homotopy types]]_, the [secondary integral transforms](dependent+linear+type+theory#SecondaryIntegralTransforms) on [[linear types|linear types]] which formalize aspects of [[path integral quantization]] are all controled by the actoin of $\prod_W W^\ast$ on [[linear type theory|linear types]]. Of course an intrinsic randomness is the very hallmark of [[quantum mechanics]], which is the actual reality, hence we see that in [[linear homotopy type theory]] the relation of $\prod_W W^\ast$ to aspects of randomness is stronger still.
