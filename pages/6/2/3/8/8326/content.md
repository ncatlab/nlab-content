...
We may determine this further. Since $(\rightrightarrows \dashv \rightsquigarrow)$ is again an opposition of the form $(\bigcirc \dashv \Box)$, we may ask for a type that is co-accidence for $\rightsquigarrow$ according to def. \ref{Localization}. We write $\mathbb{R}^{0|1}$ for this type

$$
  \rightsquigarrow \;\simeq\; coloc_{\mathbb{R}^{0|1}}
  \,.
$$
...
$$
  \array{
     ...
     && & \bot && \bot 
     \\
     &&  coloc_{\mathbb{R}^{0|1}}=& \rightsquigarrow &\dashv& \R 
     \\
...
$$
  \array{
     ...
     \\
      &&& && coloc_{\mathbb{R}^{0|1}} = & \rightsquigarrow &\dashv& \R && & \stackrel{rheonomic}{}
     \\
      &&& && & \vee &\stackrel{super}{}& \vee
     \\
     &&& \stackrel{infinitesimal/reduced}{} &\overline{\Re} & / & \Re &\dashv& \Im &  &  & 
...
1. determinate negations II:
   ...
   * $\rightsquigarrow \simeq coloc_{\mathbb{R}^{0|1}}$ for $\mathbb{R}^{0|1} \in SuperMfds \hookrightarrow SuperFormalSmooth\infty Grpd$ the ordinary [[nLab:odd line]].
...
| $&#643; \simeq loc_{\mathbb{R}}$ | $\rightsquigarrow \simeq coloc_{\mathbb{R}^{0\vert 1}}$ |
