...
Dually there is the [[nLab:empty type]] $\emptyset$. As a concept, this is the concept with no instance. As such this may be thouhgt of as the concept of "not being": since any instance of that concept would at least be (namely be an instance of the concept), but there is no such instance.
...
1. The initial opposition of prop. \ref{InitialOpposition} is the [[nLab:Cartesian product]]$\dahsv$[[nLab:internal hom]]-adjunction of the [[nLab:empty type]]
