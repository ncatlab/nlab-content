...
in other words we have the following situation, in view of p. 11 of _[[Some Thoughts on the Future of Category Theory]]_:

$$
   \array{
      reines Sein && Dasein && Realit&#228;t
      \\
     ...
     && && \bot
      \\
      \emptyset &\subset& \int & \subset & \int_{inf}
      \\
      \bot && \bot && \bot 
      \\
      \ast &\subset& \flat & \subset & \flat_{inf}
      \\
      & & \bot && 
      \\
      & & \sharp      
