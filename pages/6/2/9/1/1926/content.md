...
an [[(infinity,1)-topos]] is a collection of generalized
_spaces_, namely of [[presheaf|presheaves]] 
(precisely: of [[(infinity,1)-sheaf|(infinity,1)-sheaves]])
on some [[site]] $S$.

A [[structured (infinity,1)-topos]] $T \simeq Sh_\infty(S)$ is 
an [[(infinity,1)-topos]] equipped
...
A **homotopical topology** on an [[(infinity,1)-category]] $C$ is
...
For $G$ a geometry, and $T \simeq Sh_\infty(S)$ an [[(infinity,1)-topos]],
a **$G$-structure on the $(\infty,1)$-topos $T$** making it a 
[[structured (infinity,1)-topos]] is a [[(infinity,1)-functor]]
