...
Then for $n \in \mathbb{N}$ the [[n-image]] factorization/$(n-1)$-Postnikov stage of $f$ is given by the [[strict ∞-groupoids]] $im_n(f)$ with
...
* M. Bullejos E. Faro, and M. A. Garc&#237;a-Munoz, _Postnikov Invariants of Crossed Complexes_ ([arXiv:math/0409339](arxiv.org/abs/math/0409339)).
 {#BFGM}
