...
$X^*$ is [[Hausdorff space|Hausdorff]] (hence a [[compact Hausdorff space]]) if and only if $X$ is already both Hausdorff and [[locally compact space|locally compact]] (see prop. \ref{HausdorffOnePointCompactification}).
