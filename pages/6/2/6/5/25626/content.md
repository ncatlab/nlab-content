...
A _tensorial costrength_ (or simply _costrength_) for a functor $F : V \to V$ on a monoidal category $V$ is, in essence, the [[opposite category|dual]] of a [[tensorial strength]]. Whereas a strength provides morphisms of the form:
...
When $V$ is symmetric, tensorial left-costrengths are equivalently tensorial right-costrengths, and in this setting, one usually drops “left-” or “right-” and simply talks about tensorial costrengths.
