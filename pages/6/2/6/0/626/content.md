...
* putting strings next to each other denotes the [[tensor product]];

* braiding strings over each other corresponds to -- yes, the [[braided monoidal category|braiding]] (if any);

* bending strings around corresponds to dualities on the corresponding [[dualizable object]] (if any).
