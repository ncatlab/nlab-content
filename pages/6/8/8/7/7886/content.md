...
1. There exists a categorical equivalence $D\to C$, where $D$ is an $n$-category.
...
+-- {: .un_cor #cor2.3.4.19}
###### Corollary 2.3.4.19
Let $X$ be a [[nLab:Kan complex]]. Then is is equivalent to an $n$-category iff it is $n$-truncated.
=--
