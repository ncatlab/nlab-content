...
Therefore the stable splitting theorem \ref{StableSplittingOfMappingSpacesOutOfEuclideanSpace} may equivalently be read as expressing the mapping space functor as the [[limit]] over its [[Goodwillie-Taylor tower]].
