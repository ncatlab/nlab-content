...
* A boolean $W$-topos with the axiom of choice is a framework for classical mathematics including the axiom of choice; a [[well-pointed category|well-pointed]] boolean $W$-topos with the axiom of choice is precisely a model of [[ETCS]].
