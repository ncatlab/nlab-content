...
* A _$W$-topos_ is of course a topos that has $W$; it is sufficient that the topos have a [[natural numbers object]] (see van den Berg & Moerdijk), so this is often called a _topos with NNO_.  These are widely studied as frameworks for (non-predicative) [[constructive mathematics]], while a [[Boolean topos|Boolean]] $W$-topos is a framework for ordinary classical mathematics.  (You still need to add the [[axiom of choice]] to get [[ETCS]].)
