...
* A _topos_ is a pretopos that has [[power object]]s, or equivalently has a [[subobject classifier]] and is [[cartesian closed category|cartesian closed]].  A topos is automatically a $\Pi$-pretopos.
