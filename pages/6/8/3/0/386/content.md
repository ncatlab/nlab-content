...
(In all of the following "occupied" is a [[constructivism|constructive]] substitute for "nonempty".)
...
* Sometimes, one wishes to generalize the category $\dot{\Delta}$ to contain also the empty totally ordered set. This is called the _augmented_ simplex category and presheaves on it are _augmented simplicial sets._
