...
* Alternatively, one could add [[strict transport]] across [[judgmental equality of terms]] as [[strict equivalences of types]], whether using the [[strict equivalence type]] or using the [[natural deduction]] [[inference rules]] of [[strict negative copies]]. This results in a simpler formal theory, since one doesn't need any of the structural and congruence rules for judgmental equality of types. 
