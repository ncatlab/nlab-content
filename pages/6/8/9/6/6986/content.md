...
There is no [[∞-reduction]] rule, since there are no constructors to compose with the eliminator.  However, there is an [[∞-conversion]] rule, which says that for any term $e\colon \emptyset\vdash c\colon C$ in a context including a term of type $\emptyset$, we have
