...
*  A weak [[homotopy equivalence]] between topological spaces is a continuous function that induces (for all choices of basepoint) an isomorphism of all [[homotopy group]]s.