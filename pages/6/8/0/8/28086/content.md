...
An **$H^*$-algebra** is a [[complex numbers|$\mathbb{C}$]]-[[associative unital algebra|algebra]] $A$ that is simultaneously a [[Hilbert space]] $(A, \langle \cdot, \cdot \rangle_A)$ with a compatible [[star-algebra]] [[structure]], namely with an [[antilinear map|anti-linear]] [[involution]] $\dagger \colon A \to A$ such that
