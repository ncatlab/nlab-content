...
Below is [[Jon Awbrey]]'s take on propositions as types.  Since everything is ultimately reduced to combinatory algebra, possibly we could move this material to [[propositions as types in combinatory algebra]]?
...
This amounts to a _paraphrastic definition_ (Quine, 1967) of the operator $\mathop{I}$, where the syntactic frame "$x = x \underline{\phantom{I}}$" is the defining context, or _definiens_, and $\mathop{I}$ is the object to be defined, or _definiendum_.
...
1.  "The general idea of contextual definition goes back to Jeremy Bentham (1843, vol. 8, pp. 246--247), who called it _paraphrasis_ and saw in it a method of accounting for fictions by explaining various purported terms away.  A mathematical application of the method became familiar in the differential operators;  and it is with this illustration that the selection from Whitehead and Russell begins."  (Quine, 1967, p. 216).

# References and Further Reading #

* Bentham, Jeremy (1843), _The Works of Jeremy Bentham_, John Bowring (ed.), London, UK.  Reprinted, Russell and Russell, New York, NY, 1962.

* Quine, W.V. (1967), Introductory Note to "Whitehead and Russell (1910), Incomplete Symbols : Descriptions", pp. 216--223 in Jean van Heijenoort (ed., 1967), _From Frege to G&#246;del : A Source Book in Mathematical Logic, 1879--1931_, Harvard University Press, Cambridge, MA.

* Sch&#246;nfinkel, Moses. (1924), "On the Building Blocks of Mathematical Logic", Stefan Bauer-Mengelberg (trans.), pp. 355--366 in Jean van Heijenoort (ed., 1967), _From Frege to G&#246;del : A Source Book in Mathematical Logic, 1879--1931_, Harvard University Press, Cambridge, MA.
...
* Smullyan, R. (1985), _To Mock a Mockingbird, And Other Logic Puzzles, Including an Amazing Adventure in Combinatory Logic_, Alfred A. Knopf, New York, NY.

* Hindley, J.R. and Seldin, J.P. (1986), _Introduction to Combinators and $\lambda$-Calculus_, London Mathematical Society Student Texts No.&nbsp;1, Cambridge University Press, Cambridge, UK.

* Lambek, J. and Scott, P.J. (1986), _Introduction To Higher Order Categorical Logic_, Cambridge University Press, Cambridge, UK.
