...
By evaluation on $X =$[[BU(n)|$B U(1)$]], the [[classifying space]] for [[complex line bundles]] (the [[circle 2-group]]), every [[multiplicative cohomology theory|multiplicative]] [[complex oriented cohomology theory]] $E$ gives rise to a [[formal group]] over the [[graded ring]] $\pi_\bullet(E)$ (see [there](complex+oriented+cohomology+theory#FormalGroupLaw)).
