...
In [[type theory]], $\beta$-reduction is a process of "computation", which generally replaces more complicated terms with simpler ones.
...
The most common example is when $T$ is a [[function type]] $A\to B$.
