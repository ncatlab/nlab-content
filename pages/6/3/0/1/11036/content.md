...
Under the [[categorical semantics]] of (multiplicative intuitionistic) [[linear logic]] in [[monoidal categories]], proof nets are closely related to the [[string diagrams]] in these categories, "with boxes" to account for the [[exponential modality]] (e.g. [Melli&#232;s 06](#Mellies06)). More generally they are closely related to [[Kelly-Mac Lane graphs]].

Hence in with [[linear logic]]/[[linear type theory]] interpreted as [[quantum logic]]/[[quantum computation]], proof nets correspond to [[quantum circuits]] or [[Feynman diagrams]] ([Blute Panangaden](#BlutePanangaden)).
