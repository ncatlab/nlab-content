...
[[Per Martin-Lof]]'s original [[dependent type theory]], which had the additional rule $Type:Type$, was shown to be inconsistent by [[Girard's paradox]].  In the 1980's, Meyer, Reinhold, and Howe (see references) showed that this paradox could be modified to construct a looping combinator.
