...
For instance in a category of [[Hilbert spaces]], regarded as semantics for bare multiplicative [[linear type theory]], then projections correspond to (closed) linear subspaces. These are just the propositions in the corresponding [[quantum logic]]. If we regard a propositions _as_ its corresponding projection, then it is natural to consider it also as being the _application_ of this projection, in that the truth of the proposition is thought of as the image of applying this projection. In terms of [[quantum physics]] this relation between propositions (about a [[quantum mechanical system]]) and the projection onto the corresponding subspace of the [[space of quantum states]] is what is referred to as the "[[wave function collapse|collapse]] of the [[wave function]]".


## References

* Kurt Engesser, Dov Gabbay, Daniel Lehmann, _A New Approach to Quantum Logic_, vol. 8 of Studies in Logic, College Publications, London, UK, 2007. ([pdf](http://www.dcs.kcl.ac.uk/staff/dg/QuantumLogic-draft.pdf)) 


[[!redirects propositions as projections]]
