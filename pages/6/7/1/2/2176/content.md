...
\rowlines{solid solid none none none solid none solid none solid none solid none none none solid}}
&amp; \phantom{xxxx} f \phantom{xxxx}
&amp; \phantom{xxxx} \mathop{E}f|_{p \: q} \phantom{xxxx}
&amp; \phantom{xxxx} \mathop{E}f|_{p \: \text{&#x2997;} q \text{&#x2998;}} \phantom{xxxx}
&amp; \phantom{xxxx} \mathop{E}f|_{\text{&#x2997;} p \text{&#x2998;} \: q} \phantom{xxxx}
&amp; \phantom{xxxx} \mathop{E}f|_{\text{&#x2997;} p \text{&#x2998;&#x2997;} q \text{&#x2998;}} \phantom{xxxx}
\\
f_{0}
&amp; \text{&#x2997;} \: \text{&#x2998;}
&amp; \text{&#x2997;} \: \text{&#x2998;}
...
\rowlines{solid solid none none none solid none solid none solid none solid none none none solid}}
&amp; \phantom{xxxx} f \phantom{xxxx}
&amp; \phantom{xxxx} \mathop{D}f|_{p \: q} \phantom{xxxx}
&amp; \phantom{xxxx} \mathop{D}f|_{p \: \text{&#x2997;} q \text{&#x2998;}} \phantom{xxxx}
&amp; \phantom{xxxx} \mathop{D}f|_{\text{&#x2997;} p \text{&#x2998;} \: q} \phantom{xxxx}
&amp; \phantom{xxxx} \mathop{D}f|_{\text{&#x2997;} p \text{&#x2998;&#x2997;} q \text{&#x2998;}} \phantom{xxxx}
\\
f_{0}
&amp; \text{&#x2997;} \: \text{&#x2998;}
&amp; \text{&#x2997;} \: \text{&#x2998;}
...
<br>
<font size="+2">$\text{Conjunction} \: p q : X \to \mathbb{B}$</font></td>
...
The structure of these differential fields can be described as follows.  With each point of $X$ there is associated an object of the following type:  a proposition about changes in $X$, that is, a proposition $g : \mathop{d}X \to \mathbb{B}$.  In this frame of reference, if $X^\circ$ is the universe that is generated by the set of coordinate propositions $\{ p, q \}$, then $\mathop{d}X^\circ$ is the differential universe that is generated by the set of differential propositions $\{ \mathop{d}p, \mathop{d}q \}$.  These differential propositions may be interpreted as indicating &ldquo;$\mathop{change in} \: p$&rdquo; and &ldquo;$\mathop{change in} \: q$&rdquo;, respectively.

A differential operator $\mathop{W}$, of the first order type that we have been considering, takes a proposition $f : X \to \mathbb{B}$ and gives back a differential proposition $\mathop{W}f : \mathop{E}X \to \mathbb{B}$.  In the field view of things, we see the proposition $f : X \to \mathbb{B}$ as a scalar field and we see the differential proposition $\mathop{W}f : \mathop{E}X \to \mathbb{B}$ as a vector field, specifically, a field of propositions about contemplated changes in $X$.

The field of changes produced by $\mathop{E}$ on $p q$ is shown in the next venn diagram:
...
<br>
<font size="+2">$\text{Enlargement} \: \mathop{E}(p q) : \mathop{E}X \to \mathbb{B}$</font>
</td></tr>
...
The differential field $\mathop{E}(p q)$ specifies the changes that need to be made from each point of $X$ in order to reach one of the models of the proposition $p q$, that is, in order to satisfy the proposition $p q$.

The field of changes produced by $\mathop{D}$ on $p q$ is shown in the following venn diagram:
...
<br>
<font size="+2">$\text{Difference} \: \mathop{D}(p q) : \mathop{E}X \to \mathbb{B}$</font>
</td></tr>
