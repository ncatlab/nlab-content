...
The difference between geometric and logical functors between toposes is, in a certain sense, a [[categorification]] of the difference between a homomorphism of [[frames]] and a homomorphism of [[Heyting algebras]].  When the latter are [[complete lattice|complete]], these are the same objects with the same [[isomorphisms]] but different morphisms.  However, while frame homomorphisms are a natural categorification of geometric functors, a more precise categorification of Heyting algebra homomorphisms would be [[Heyting functors]], which preserve the internal first-order logic, but not the higher-order logic as logical functors do.
