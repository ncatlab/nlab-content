A **logical functor** is a [[functor]] between [[toposes]] which preserves all the topos structure.  This should not be confused with a [[geometric morphism]], which is a different sort of morphism between toposes that treats them more "geometrically."
