...
[[distributive law|Distributive laws]] between a monad and a comonad are so-called _mixed_ distributive laws; a special case has been rediscovered in physics under the name _entwining structures_ (Brzezi&#324;ski, Majid 1997). Their theory is often studied in the connection with the theory of comonads in the bicategory of rings, modules and morphisms of modules, that is [[coring]]s. There is a homomorphism of bicategories from a bicategory of entwinings to a bicategory of corings ([&#352;koda 2008](http://front.math.ucdavis.edu/0805.4611)) [Stafford DUI Lawyer](http://www.andrewflusche.com/), which is an analogue of the 2-functor $comp$ (R. Street, _Formal theory of monads_, JPAA 1972) of strict 2-categories in the case of distributive laws of monads (recall also that a distributive law among monads corresponds to a monad in the 2-category of monads).
