...
$$
  ...
  \qquad
  \frac{\Gamma \vdash t:\Box A \qquad x:\Box A \vdash u:B}
       {\Gamma \vdash \mathsf{extend}\ x = t\ \mathsf{in}\ u:\Box B}
$$

In [[Haskell]], comonads are defined by the following typeclass:
...
See also the definition of a [[monoidal comonad]].

## Examples

* [[necessity]]

* [[writer comonad]], [[store comonad]]
