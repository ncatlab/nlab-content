...
A family, $\mathcal{H}$, of subgroups of $G$ is called _$n$-generating if the nerve, $N(\mathfrak{H})$, of the corresponding coset covering is [[n-connected space|(n-1)-connected]], i.e., $\pi_i N(\mathfrak{H}) = 0$ for $i\lt n$.
