A **locally cartesian closed category** is a [[category]] $C$ with a [[terminal object]] and all of whose [[slice category|slice categories]] $C/x$ are [[cartesian closed category|cartesian closed]].
