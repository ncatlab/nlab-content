...
1. Elmendorf's theorem can be generalized to the case when we consider only a family $\mathcal{H}$ of closed subgroups of $G$ rather than all of them; see [Stephan](#Stephan10).

1. There is an evident generalization of the [[orbit category]] of a fixed group to the [[global orbit category]]. Under this generalization an analog of Elmendorf's theorem plays a central role in [[global equivariant homotopy theory]] ([Rezk 14](#Rezk14)).
