...
We define $\pi_{1}(L)$, the fundamental group of $L$, to be the quotient of $F(L)$ by the normal subgroup generated by words of the form $a_3^{-1} a_2^{-1} a_1^{-1} a_2$, for any crossing of $L$ as depicted [[labelled_crossing.pdf|here:file]], irrespective of the orientation of the horizontal arcs.
