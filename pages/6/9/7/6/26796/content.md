...
The *Schur complement* of (i,j)-entry of a block $2\times 2$ [[matrix]]
...
These expressions are related to [[quasideterminants]], Gauss elimination procedure and [[matrix inverse]]. Typically the case at main diagonal are used compatibly with a standard choice of the shape of triangular matrices in Gauss procedure.
