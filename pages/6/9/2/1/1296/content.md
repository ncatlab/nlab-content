...
Following [Serre 1953](#Serre53), one then defines the category $A/T$ whose objects are the objects of $A$ and where the morphisms in $A/T$ are defined by 
$$\mathrm{Hom}_{A/T}(X,Y) \coloneqq \mathrm{colim}\, \mathrm{Hom}_A(X',Y/Y'),$$
