...
* Each AWFS $(L, R)$ on $K$ induces a [[right-connected double category]] $R$-$\mathbb{A}lg$, whose category of objects and horizontal morphisms is $K$, whose category of vertical morphisms and cells is $R$-$Alg$. 
...
A precursor to the notion appears in:
...
The modern notion, missing the distributivity axiom, was introduced in:
...
The missing axiom was introduced in:
...
* {#BourkeGarnerI} [[John Bourke]] and [[Richard Garner]], _Algebraic weak factorisation systems I: Accessible AWFS_, Journal of Pure and Applied Algebra 220, 2016. [arXiv:1412.6559](http://arxiv.org/abs/1412.6559), [doi:10.1016/j.jpaa.2015.06.002](https://doi.org/10.1016/j.jpaa.2015.06.002)
...
* Ignacio Lopez Franco, *Cofibrantly generated lax orthogonal factorisation systems* &lbrack;[arxiv](https://arxiv.org/abs/1510.07131)&rbrack;
...
* [[Emily Riehl]], §12.4 in: *[[Categorical Homotopy Theory]]*, Cambridge University Press (2014) &lbrack;[doi:10.1017/CBO9781107261457](https://doi.org/10.1017/CBO9781107261457), [pdf](http://www.math.jhu.edu/~eriehl/cathtpy.pdf)&rbrack;


The following dissertation section is entirely written after learning of [Riehl (2008)](#Riehl2008), but has complementary examples and may dive deeper into some proofs:
