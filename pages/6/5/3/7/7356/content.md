...
_F-theory_ is a toolbox for describing [[type IIB string theory]] backgrounds -- _including_ [[non-perturbative effects]] induced from the presence of [[D7-branes]] and [[(p,q)-strings]] -- in terms of [[complex numbers|complex]] [[elliptic fibrations]] whose fiber modulus $\tau$ encodes the [[axio-dilaton]] (the [[string coupling constant]] and the degree-0 [[RR-field]]) transforming under the $SL(2, \mathbb{Z})$ [[S-duality]]/[[U-duality]] [[group]]. See also at _[[duality in string theory]]_.
