...
Let $Et/S$ be the category of [[étale scheme]]s of finite type over a [[Noetherian scheme]] $S$. An [[(∞,1)-presheaf]] $F$ on $Et/S$ is said to satisfy _Nisnevich excision_ if the following conditions hold:
