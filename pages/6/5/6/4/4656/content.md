...
A __composable pair of morphisms__ in a given [[category]] $C$ consists of [[objects]] $X,Y,Z$ of $C$ and a [[pair]] of [[morphisms]] $f\colon X \to Y$ and $g\colon Y \to Z$.  The [[composite]] of this composable pair is the morphism $g \circ f\colon X \to Z$.
