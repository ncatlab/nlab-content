...
In the case where $C = Set$ and $S$ is [[small]], an important general principle is that the category of presheaves on $S$ and [[natural transformation|natural transformations]] between them is the _free cocompletion_ of $S$. In more detail, the [[Yoneda embedding]] 
...
where $S \cdot d$ is notation for [[power|copowering]] or [[tensor|tensoring]] an object $d$ of $D$ by a set $S$ (in this case, a coproduct of an $S$-indexed set of copies of $D$). This formula recurs frequently throughout this wiki; see also [[nerve]], [[Day convolution]]. 
