...
In the case where $C = Set$ and $S$ is [[small category|small]], an important general principle is that the category of presheaves on $S$ and [[natural transformation|natural transformations]] between them is the _free cocompletion_ of $S$. In more detail, the [[Yoneda embedding]] 
$$y_S: S \to Set^{S^{op}}$$ 
