...
such that multiplication by $p$ of the generator of the bottom group in the middle group does _not_ yield the generator of the top group.
...
the generator 1 of the bottom group lifts to the element $(0,1)$ in the middle group, and multiplication of that by $p$ is $(0,0)$ instead of $(1,0)$, where the latter is the generator of the top group.
...
$$
  Hom(f,A) \;\colon\; Hom(C,A) \longrightarrow Hom(B,A)
$$
...
+-- {: .num_example #ClassicalAdamsSpectralSequence}
###### Examples
