...
At this point there are two options: either one can take it that the standard model of cosmology _predicts_ the existence of vast amounts of dark matter and dark energy, because only with this assumption is the model consistent with observations (but then it is very well so). On the other hand, one might feel that with all this dark matter assumed, the model has become too contrived to be "natural", and that instead this is a hint that the [[theory (physics)|theory]] of Einstein gravity is not quite right. This is sociologically currently  a minority position, but it is certainly intellectually a possible standpoint; it goes by the name _[[MOND]]_, see there for more discussion.
