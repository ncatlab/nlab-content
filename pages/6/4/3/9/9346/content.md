...
It may be good to compare to established and (essentially) uncontroversion [[theory (physics)|theories]]. 
...
1. check what the theory demands for the remaing parameters -- these are the _predictions_ of that model in that theory;
