...
1. If however you feel more generally theoretically inclined, say because you are a theoretical physicists wondering about the possibilities of [[quantum field theory]] in general, or if you are even a mathematician, happy to handle theories that are not supposed  have direct relation to [[experiment]], then the situation may be very different. 
...
In string theory this happens with _all_ the parameters. (Except for one single constant: the "string tension". From the perspective of "[[M-theory]]" even that disappears.) There is no external choice of parameter, but there remains the choice of studying "solutions to the equations of motion" (which in string theory means: choices of 2d [[CFT]]s) which might model observed physics. 
