...
The wave front set is the sub-bundle of the [[cotangent bundle]] that consists of all those directions (non-zero co-vectors) such that the local [[Fourier transform]] of the distribution is not rapidly decaying in this direction ([H&#246;rmander 90, section 8.1](#Hoermander90)). 
