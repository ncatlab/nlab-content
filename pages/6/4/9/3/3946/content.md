...
For instance the [[product of distributions]] is well defined precisely if the sum of their wave front sets does not intersect the zero-section ([[Hörmander's criterion]], [H&#246;rmander 90, theorem 8.2.10](#Hoermander90)).
...
([Bengel 77, prop. 3.1](convolution+of+distributions#Bengel77))
