...
* The [[holonomy]] of $x$ for every principal $G$-bundle with connection with a [[semisimple Lie group|semisimple structure group]] $G$ vanishes.
...
A discussion of holonomic equivalence of curves can be found in

* Francis Bischoff, Darrick Lee, _Thin Homotopy and the Signature of Piecewise Linear Surfaces_, [arXiv](https://arxiv.org/abs/2506.16657).

* Tamer Tlas, _On the holonomic equivalence of two curves_, [arXiv](https://arxiv.org/abs/1311.6611).
