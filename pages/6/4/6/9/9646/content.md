...
The concept of _scattering_ refers to [[physics|physical]] process in which some matter or wave which has stable, say linear trajectory (or wave distribution) in distant past, comes into the area where it interacts with some localized perturbation (or other such waves), which results in different stable state (or distribution of states) in far future.  Examples include light scattering, scattering of matter beams, scattering of solitons and multisolitons (which preserve their identity after a long while), 
