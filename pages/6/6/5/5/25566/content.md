...
The list commenced in 1990. From 1990 to 2023, the mailing list was hosted by Mount Allison University (categories@mta.ca) and moderated by [[Bob Rosebrugh]]. In 2023, the mailing list was transitioned to Macquarie University (categories@mq.edu.au) and is currently moderated by [[Jean-Simon Lemay]].
...
* For 11 March 1990 (the start) to July 2009 (when a change in Outlook led to a halt in archiving), there are compiled monthly digests, organised in yearly/monthly folders here: <https://www.mta.ca/~cat-dist/archive/>
