...
* [institute page](https://www.quantumcomplexity.org/milegu/)

* [GoogleScholar page](https://scholar.google.com/citations?user=ZBDAby4AAAAJ&hl=en)

## Selected writings

On [[quantum circuits]] for [[quantum computation]] as ([[geodesic]], if optimal) [computational paths](computation#ReferencesConceptualizationViaPathLifting):
