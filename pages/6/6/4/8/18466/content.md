...
for $V$ the [[interaction]] term, and "$T$" indicating the [[time-ordered product]]. Causal perturbation theory proceeds by [[axiom|axiomatizing]] the key properties of this "[[adiabatic switching|adiabatically switched]]" [[S-matrix]] and then proving by [[induction]] that solutions to these axioms exist, and identifying the finite dimensional lfreedom at each induction step with the [[renormalization]] freedom.
