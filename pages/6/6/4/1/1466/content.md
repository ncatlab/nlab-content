...
A collection of entourages satisfying (1--3) (and the extra constructive axiom, if appropriate) is a **subbase** for a uniformity; a collection satisfying (1--5) is a **base**.  Every subbase generates a base by closing up under finite intersections; every base generates a uniformity by taking the upward closure.
