...
1. $\mathcal{F} \coloneqq ClsSub(G) \subset Sub(G)$ is the set of all [[closed topological space|closed]] subgroups
...
More generally there may be more weak equivalences in $G Act(KTop)_{\mathcal{F}}$ then there are $G$-[[homotopy equivalences]]:
