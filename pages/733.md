...
Directed sets are heavily used in point-set topology and analysis, where they serve as index sets for [[net|nets]] (aka Moore–Smith sequences).  In this application, it is important that a directed set need not be a poset, since a net need not preserve the preorder in any way but by default still preserves equality.  (But in principle, one could force a directed set to be a poset by allowing a net to be an [[entire relation]]; this has practical consequences for the meaning of [[sequence]] in the absence of [[countable choice]].)
